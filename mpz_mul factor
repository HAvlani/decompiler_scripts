...
int mpz_mul()
{
    ...
    else if (((int)v9->field_4) != 0)
    {
        ...
        v17 = ((int)(((((long long)((((int)v4) ^ ((int)v4) >> 31) - (((int)v4) >> 31))) + v16) * 64 - 1 >> 6) + 1));
        ...
        if (((long long)((v12->field_4 ^ v12->field_4 >> 31) - (v12->field_4 >> 31))) < v16)
        {
            ...
            v5 = 0;
            v8 = ((long long)v0);
            v6 = ((char)(*(v10 + (v15 << 3) + 8) == 0));
            v12 = ((int)v11->field_0);
            v11->field_0 = v17;
            tmp_13 = rax<8>;
            v11->field_8 = v10;
            v4 = ((long long)(((char)(v8 >> 31 & 1 ^ 1))? ((int)(v15 - tmp_13)) : ((int)(tmp_13 - v15))));
