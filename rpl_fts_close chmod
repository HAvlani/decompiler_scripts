...
int rpl_fts_close()
{
    ...
    struct_2 *|struct_1 * v10;  // rbp
    struct_2 *|unsigned long v11;  // rdi
    ...
    else if (((long long)(v1 & 4)) == 0)
    {
        v7 = fchdir(v14->field_28);
        if (v7 == 0)
        {
            v1 = close(v14->field_28);
            if (v1 != 0)
            {
        ...
        if ((v7 == 0 || ((int)v15) == 0) && (v7 == 0 || v1 != 0) && (v7 != 0 || v1 != 0))
        {
            v15 = ((long long)v10->field_0);
            /* goto 4217037; */
        }
