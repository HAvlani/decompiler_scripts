...
extern unsigned long long G_line;
...
int main()
{
    ...
    unsigned long|unsigned long long v14;  // [bp-0x8]
    ...
    *(ignore_patterns + 8) = ignore_patterns;
    ...
    rsp<8> = rsp<8> - 8 - 8 - 8;
    v13 = &g_4055fa;
    v39 = ((int)*(time_types + (long long)__xargmatch_internal() * 4));
    time_type = v39;
    v15 = v39;
    v14 = 1;
    rsp<8> = rsp<8> - 8 - 8 - 8;
    ...
    rsp<8> = rsp<8> - 8 - 8 - 8;
    v13 = &g_4056c1;
    v39 = ((int)*(quoting_style_vals + (long long)__xargmatch_internal() * 4));
    v15 = v39;
    v15 = v62;
    v14 = 1;
    rsp<8> = rsp<8> - 8 - 8 - 8;
    v13 = &g_40570b;
    v39 = ((int)*(indicator_style_types + (long long)__xargmatch_internal() * 4));
    indicator_style = v39;
    rsp<8> = rsp<8> - 8;
    v15 = &g_40579f;
    ...
    *(ignore_patterns + 8) = ignore_patterns;
    ...
    if (optarg != 0)
    {
        ...
        v13 = &g_405499;
        rsp<8> = rsp<8> + 8 + 8;
        v39 = ((int)*(when_types + (long long)__xargmatch_internal() * 4));
        v15 = v65;
        v14 = 1;
        rsp<8> = rsp<8> - 8 - 8 - 8;
        v13 = &g_405763;
        v57 = ((int)*(when_types + (long long)__xargmatch_internal() * 4));
        rsp<8> = rsp<8> + 8 + 8;
        v15 = v26;
        v14 = 1;
        rsp<8> = rsp<8> - 8 - 8 - 8;
    ...
    if (optarg == 0 || v39 == 1 || v39 == 2 && ((long long)v39) != 0)
    {
        indicator_style = 3;
    }
    print_hyperlink = v39;
    print_hyperlink = print_hyperlink & 1;
    print_with_color = v39;
