...
int read_utmp()
{
    ...
    unsigned int v6;  // ebp
    unsigned long long|struct_1 * v7;  // rsi
    struct_1 * v8;  // rdi
    ...
    while (true)
    {
        ...
        while (true)
        {
            if (v10->field_0 == 7 && v10->field_4 > 0 && ((long long)(v9 & 1)) != 0 && v10->field_2c != 0)
            {
                v2 = kill();
                if (v2 < 0)
                {
            ...
            if (v0 == v5 && v2 < 0 && v10->field_0 == 7 && v10->field_4 > 0 && ((long long)(v9 & 1)) != 0 && v10->field_2c != 0 && v2->field_0 != 3 || (v6 == 0 && v10->field_2c == 0 || v6 == 0 && v10->field_0 != 7 || v10->field_4 <= 0 && v10->field_0 == 7 && v10->field_2c != 0 || ((long long)(v9 & 1)) == 0 && v10->field_0 == 7 && v10->field_2c != 0 || v10->field_0 == 7 && v2 >= 0 && v10->field_2c != 0) && v0 == v5)
            {
