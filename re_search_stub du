...
int re_search_stub()
{
    ...
    unsigned long long|unsigned int v13;  // rax
    ...
    struct_0 *v25;  // r13
    unsigned long long|unsigned int v26;  // r14
    ...
    else if (v16 <= v26)
    {
        ...
        if (!(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>))) || v16 + v22 > v26 || ((long long)(((char)(0 != 0)) | ((char)(0 != 0)))) != 0)
        {
            v10 = ((int)(((long long)v21->field_38) >> 5)) & 3;
            if (v16 < v26)
            {
        ...
        if (v11 != 0)
        {
            if (((long long)(v21->field_38 & 16)) == 0)
            {
                ...
                if (*(v24) > v21 || !(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>))) || tmp_4 != 4)
                {
                    v21 = v20 * 16;
                    /* goto 4320153; */
                }
        ...
        if (v11 == 0 || ((long long)(v21->field_38 & 16)) != 0 || *(v24) <= v21 && ((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>)) && tmp_4 == 4)
        {
            v21 = 16;
            v20 = 1;
            v18 = 1;
        ...
        if (v1 != 0)
        {
            ...
            else
            {
                ...
                {
                    v27 = v18 + 1;
                    v13 = ((int)(((int)(((long long)v25->field_38) >> 1)) & 3));
                    ...
                    if (...)
                    {
                        ...
                        if (*(v24) > v17)
                        {
                            ...
                            do
                            {
                                ...
                                *(v13 + rdx<8> * 8) = 18446744069414584319;
                                v17 = v18;
                            }
                            while (*(v24) > v18);
                        }
                    }
                    v26 = ((int)((unsigned int)v26)) * 2;
