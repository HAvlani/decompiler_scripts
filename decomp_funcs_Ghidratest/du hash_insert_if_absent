...

{
  ...
  if ((long)uVar8 < 0) {
    ...
    if (-1 < (long)uVar5) goto LAB_0010c793;
LAB_0010c81a:
    fVar11 = (float)(uVar5 >> 1 | (ulong)((uint)uVar5 & 1));
    if (fVar10 <= (fVar11 + fVar11) * pHVar7->growth_threshold) goto LAB_0010c7aa;
LAB_0010c841:
    ...
    if (fVar11 <= pHVar7->growth_threshold * fVar10) goto LAB_0010c7aa;
    fVar10 = fVar10 * pHVar7->growth_factor;
    if (pHVar7->is_n_buckets == false) {
      fVar10 = fVar10 * pHVar7->growth_threshold;
    }
    if (fVar10 < _DAT_00123e48) {
      if (_DAT_00123e4c <= fVar10) {
        uVar8 = (long)(fVar10 - _DAT_00123e4c) ^ 0x8000000000000000;
      }
      else {
        uVar8 = (ulong)fVar10;
      }
...
LAB_0010c8a7:
    ...
    fVar10 = (float)uVar8;
    uVar5 = param_1->n_buckets;
    if ((long)uVar5 < 0) goto LAB_0010c81a;
LAB_0010c793:
    if ((float)uVar5 * pHVar7->growth_threshold < fVar10) goto LAB_0010c841;
LAB_0010c7aa:
    ...
    if (phVar6 == (hash_entry *)0x0) {
      ...
      if (phVar6 == (hash_entry *)0x0) goto LAB_0010c8a7;
    }
    else {
