...

{
  ...
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Convert blanks in each FILE to tabs, writing to standard output.\n",
                             5);
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "unexpand";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","unexpand");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
