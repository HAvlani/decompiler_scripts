...
{
  undefined2 *puVar1;
  anon_union_conflict11cf3_for___space *paVar2;
  bool bVar3;
  void *__src;
  _Bool _Var4;
  char cVar5;
  ...
  size_t __n;
  char cVar10;
  anon_union_conflict11cf3_for___space *__path;
  anon_union_conflict11cf3_for___space *__filename;
  size_t sVar11;
  long lVar12;
  undefined2 *puVar13;
        ...
        if (sVar11 == 1) {
          ...
          if ((&__path->field_0x1 < __dest) &&
            ...
            do {
              ...
              __dest = (undefined2 *)((long)__dest + -1);
            } while ((anon_union_conflict11cf3_for___space *)__dest != __path);
          }
        }
        else {
LAB_0010d515:
          ...
          *(char *)__dest = '\0';
          if (cVar14 == CAN_EXISTING) {
            while (__src = link_buffer.data, sVar11 = link_buffer.length - 1,
              ...
              if (_Var4 == false) goto LAB_0010d3c8;
            }
            if ((long)__n < 0) goto LAB_0010d5f4;
            if (local_d34 < 0x14) {
...
LAB_0010d393:
                ...
                local_d30 = strlen(name);
                uVar17 = __n + local_d30;
                if (extra_buffer.length <= uVar17) goto LAB_0010d393;
              }
LAB_0010d828:
                ...
                *(char *)__path = '/';
                ...
                if (&__path->field_0x1 < __dest) {
                  do {
                    ...
                    if ((anon_union_conflict11cf3_for___space *)puVar13 == __path) break;
                    puVar1 = __dest + -1;
                    __dest = puVar13;
                  } while (*(char *)puVar1 != '/');
                  bVar3 = true;
            ...
            if (*pcVar7 == '\0') goto LAB_0010d339;
            pcVar9 = (char *)(((long)pcVar7 - (long)name) + (long)__dest);
            *pcVar9 = '\0';
            __filename = (anon_union_conflict11cf3_for___space *)&DAT_00118dca;
            if (*(char *)__path != '\0') {
              __filename = __path;
            }
...
LAB_0010d790:
                  ...
                  if (cVar5 != '.') break;
                  cVar5 = pcVar9[2];
                  if (cVar5 == '\0') goto LAB_0010d790;
                  if (cVar5 == '.') {
                    if ((pcVar9[3] == '\0') || (pcVar9[3] == '/')) goto LAB_0010d790;
                    break;
                  }
                  pcVar7 = pcVar9 + 2;
                } while (cVar5 == '/');
                if (cVar14 != CAN_EXISTING) goto LAB_0010d650;
LAB_0010d678:
                piVar8 = __errno_location();
                bVar18 = *piVar8 != 0x16;
              }
              else {
                if (cVar14 == CAN_EXISTING) goto LAB_0010d678;
                if (*name != '\0') goto LAB_0010d650;
                iVar6 = faccessat(-100,(char *)__path,0,0x200);
                bVar18 = iVar6 != 0;
              }
LAB_0010d698:
...
LAB_0010d17f:
      if ((anon_union_conflict11cf3_for___space *)extra_buffer.data != &extra_buffer.__space) {
        rpl_free(extra_buffer.data);
      }
      if ((anon_union_conflict11cf3_for___space *)link_buffer.data != &link_buffer.__space) {
        rpl_free(link_buffer.data);
      }
      if (bVar18) {
        local_d78 = (char *)0x0;
        if ((anon_union_conflict11cf3_for___space *)rname_buffer.data != paVar2) {
          local_d78 = (char *)0x0;
        ...
        *(char *)__dest = '\0';
        ...
        if (local_d78 == (char *)0x0) goto LAB_0010d3c8;
      }
    }
  }
  else {
