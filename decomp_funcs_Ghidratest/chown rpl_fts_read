...
LAB_00106343:
            ...
            if (p_Var14->fts_info == 2) goto LAB_00106373;
          }
...
LAB_00106583:
    param_1->fts_cur = pFVar12;
    if (uVar6 == 0xb) goto LAB_00106600;
  }
  if (uVar6 != 1) {
    return pFVar12;
  }
