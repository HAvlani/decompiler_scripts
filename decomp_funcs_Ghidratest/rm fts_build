...
LAB_001062f8:
      ...
      if ((((sp->fts_options & 0x38U) == 0x18) && (p->fts_statp[0].st_nlink == 2)) &&
        ...
        if (lVar15 < 0x9fa1) {
          if ((lVar15 == 0) || (lVar15 == 0x6969)) goto LAB_00105fdd;
        }
        else if ((lVar15 == 0x5346414f) || (lVar15 == 0xff534d42)) goto LAB_00105fdd;
        if (type != 3) goto LAB_001062f8;
        bVar3 = false;
        bVar20 = true;
      }
      else {
...
break_without_closedir:
        if (local_4b == '\0') goto LAB_001061bf;
        goto LAB_00105d19;
      }
...
mem1:
        ...
        if ((sp->fts_compar == (anon_subr_int__ftsent_ptr_ptr__ftsent_ptr_ptr_for_fts_compar *)0x0)
          ...
          if (((uVar17 & 8) == 0) || ((bVar1 & 0xfb) == 0)) {
            ...
            if (uVar8 < 0xc) goto LAB_00105e20;
...
LAB_001061bf:
    if ((*(byte *)&sp->fts_options & 4) != 0) {
      if ((sp->fts_pathlen == local_a0) || (sVar18 == 0)) goto LAB_001061d6;
LAB_001061dc:
      *local_70 = '\0';
    }
