...

{
  ...
  if (idx < pstr->raw_mbs_idx) {
    ...
    lVar16 = idx;
    if (pstr->mbs_allocated != '\0') goto LAB_0010a49a;
    pstr->mbs = pstr->raw_mbs;
    if (idx == 0) goto LAB_0010a580;
LAB_0010a4a3:
...
LAB_0010a7ed:
        ...
        if (((lVar16 != lVar23) || (lVar3 <= lVar16)) || (pIVar5[lVar23] != lVar16)) {
          ...
          if (lVar23 < lVar3) {
            do {
              if (pstr->wcs[lVar23] != 0xffffffff) goto LAB_0010a8e4;
              lVar23 = lVar23 + 1;
            } while (lVar23 != lVar3);
LAB_0010aa88:
            pstr->valid_len = 0;
            ...
            if (lVar23 == lVar3) goto LAB_0010aa88;
LAB_0010a8e4:
...
LAB_0010a519:
    ...
    if (1 < iVar10) {
      if (pstr->is_utf8 != '\0') {
        ...
        if (pbVar15 <= pbVar24) {
LAB_0010a97d:
          if ((*pbVar24 & 0xc0) == 0x80) goto LAB_0010a970;
          puVar20 = pstr->trans;
...
LAB_0010a6a1:
      ...
      if (lVar11 < idx) {
        ...
        pstr->valid_len = sVar22;
        wc2 = wVar17;
        if (wVar17 == 0xffffffff) goto LAB_0010aaa1;
LAB_0010a722:
...
LAB_0010a750:
    ...
    lVar11 = pstr->len - lVar16;
    lVar18 = pstr->stop - lVar16;
    if (pstr->mbs_allocated == '\0') goto LAB_0010a519;
...
LAB_0010a51d:
    ...
    pstr->len = lVar11;
    pstr->stop = lVar18;
    if (iVar10 < 2) goto LAB_0010a658;
    if (pstr->icase == '\0') {
      build_wcs_buffer(pstr);
    }
    else {
      rVar9 = build_wcs_upper_buffer(pstr);
      if (rVar9 != _REG_NOERROR) goto LAB_0010a54d;
    }
  }
  pstr->cur_idx = 0;
  rVar9 = _REG_NOERROR;
...
LAB_0010a970:
  pbVar24 = pbVar24 + -1;
  if (pbVar24 < pbVar15) goto LAB_0010a6a1;
  goto LAB_0010a97d;
}
