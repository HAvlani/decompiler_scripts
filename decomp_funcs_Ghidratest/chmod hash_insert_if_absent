...

{
  ...
  if ((long)uVar8 < 0) {
    ...
    if (-1 < (long)uVar5) goto LAB_00107043;
LAB_001070ca:
    fVar11 = (float)(uVar5 >> 1 | (ulong)((uint)uVar5 & 1));
    if (fVar10 <= (fVar11 + fVar11) * pHVar7->growth_threshold) goto LAB_0010705a;
LAB_001070f1:
    ...
    if (fVar11 <= pHVar7->growth_threshold * fVar10) goto LAB_0010705a;
    fVar10 = fVar10 * pHVar7->growth_factor;
    if (pHVar7->is_n_buckets == false) {
      fVar10 = fVar10 * pHVar7->growth_threshold;
    }
    if (fVar10 < _DAT_0010bc48) {
      if (_DAT_0010bc4c <= fVar10) {
        uVar8 = (long)(fVar10 - _DAT_0010bc4c) ^ 0x8000000000000000;
      }
      else {
        uVar8 = (ulong)fVar10;
      }
...
LAB_00107157:
    ...
    fVar10 = (float)uVar8;
    uVar5 = param_1->n_buckets;
    if ((long)uVar5 < 0) goto LAB_001070ca;
LAB_00107043:
    if ((float)uVar5 * pHVar7->growth_threshold < fVar10) goto LAB_001070f1;
LAB_0010705a:
    ...
    if (phVar6 == (hash_entry *)0x0) {
      ...
      if (phVar6 == (hash_entry *)0x0) goto LAB_00107157;
    }
    else {
