...

{
  ...
  *(byte *)&token->opr = bVar10;
  uVar12 = (uint)syntax;
  if (iVar8 < 2) {
    if (bVar10 == 0x5c) goto LAB_001105e0;
    ...
    *(uint *)&token->field_0x8 =
    ...
    if (bVar10 < 0x40) {
LAB_00110514:
      if (bVar10 < 10) goto switchD_001105d4_caseD_5c;
      switch(bVar10) {
      case 10:
        iVar8 = 1;
...
LAB_001106de:
        ...
        break;
      default:
        goto switchD_001105d4_caseD_5c;
      case 0x24:
...
LAB_001105bb:
    ...
    case 0x7b:
      iVar8 = 1;
      iVar7 = 1;
      if ((uVar12 & 0x1200) != 0x1200) goto LAB_0011054f;
      goto LAB_0011081b;
    case 0x7c:
      if ((uVar12 & 0x8400) == 0x8000) goto LAB_001106de;
      break;
    case 0x7d:
      iVar8 = 1;
      iVar7 = 1;
...
switchD_001105d4_caseD_5c:
    ...
    if (bVar10 != 0x5c) {
      ...
      if (0x3f < bVar10) goto LAB_001105bb;
      goto LAB_00110514;
    }
LAB_001105e0:
    lVar1 = lVar3 + 1;
...
LAB_00110acb:
        if (input->offsets_needed == '\0') {
          ...
          if ((bVar10 & 0x80) != 0) goto LAB_0011061f;
        }
        goto LAB_0011062b;
      }
      pwVar11 = input->wcs + lVar1;
