...

{
  ...
  uVar4 = dcgettext(0,"Usage: %s [-WIDTH] [OPTION]... [FILE]...\n",5);
  ...
  if (puVar10 == (undefined1 *)0x0) {
    ...
    if (pcVar5 != (char *)0x0) {
      ...
      if (iVar3 != 0) {
        puVar10 = &DAT_0010803a;
        goto LAB_00104142;
      }
    }
    uVar4 = dcgettext(0,"Full documentation <%s%s>\n",5);
    puVar10 = &DAT_0010803a;
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/",&DAT_0010803a);
    pcVar5 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
