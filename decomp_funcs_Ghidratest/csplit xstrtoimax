  ...
  *piVar4 = 0;
  ...
  if (pcVar3 == s) {
    if (valid_suffixes != (char *)0x0) {
      ...
      if (cVar1 == '\0') goto LAB_00116193;
      sVar12 = LONGINT_OK;
      pcVar7 = strchr(valid_suffixes,(int)cVar1);
      lVar5 = 1;
      sVar13 = sVar12;
      if (pcVar7 != (char *)0x0) goto LAB_00116214;
    }
    sVar14 = LONGINT_INVALID;
    goto LAB_00116193;
  }
  if (*piVar4 == 0) {
    ...
    sVar14 = LONGINT_INVALID;
    if (*piVar4 != 0x22) goto LAB_00116193;
    sVar13 = LONGINT_OVERFLOW;
    sVar12 = LONGINT_OVERFLOW;
  }
  lVar8 = lVar5;
  sVar14 = sVar12;
  if ((valid_suffixes == (char *)0x0) || (cVar1 = *pcVar3, cVar1 == '\0')) goto LAB_0011618c;
  pcVar7 = strchr(valid_suffixes,(int)cVar1);
  if (pcVar7 == (char *)0x0) {
switchD_00116256_caseD_43:
...
LAB_00116214:
  ...
  case 't':
    ...
    if (pcVar7 == (char *)0x0) goto switchD_0011622c_caseD_46;
    cVar2 = pcVar3[1];
    if (cVar2 == 'D') {
LAB_001165b0:
      iVar9 = 2;
    ...
    case 'E':
      ...
      goto LAB_001164a4;
    default:
      goto switchD_00116256_caseD_43;
    case 'G':
    case 'g':
      lVar11 = 1;
      lVar6 = 0x400;
...
LAB_001163ac:
    lVar10 = lVar5 * lVar6;
    if (SEXT816(lVar10) != SEXT816(lVar5) * SEXT816(lVar6)) goto LAB_001162c3;
    lVar8 = lVar6 * lVar10;
...
LAB_001162b6:
    lVar8 = lVar5 * 0x200;
    if (SEXT816(lVar8) != SEXT816(lVar5) * SEXT416(0x200)) goto LAB_001162c3;
    break;
  case 'c':
    lVar11 = (long)iVar9;
    break;
  case 'w':
    lVar8 = lVar5 * 2;
    lVar11 = (long)iVar9;
    if (SEXT816(lVar8) != SEXT816(lVar5) * SEXT816(2)) goto LAB_00116553;
  }
LAB_00116441:
  *ptr = pcVar3 + lVar11;
  sVar14 = sVar13;
