...

{
  ...
  if ((((prVar2->init_state->nodes).nelem == 0) && ((prVar2->init_state_word->nodes).nelem == 0)) &&
    ...
    if ((start != 0) && (local_2c4 = _REG_NOMATCH, last_start != 0)) goto LAB_001184b3;
    last_start = 0;
    start = 0;
  }
  bVar38 = true;
...
LAB_00118171:
    ...
    if ((1 < nmatch) || ((prVar2->field_0xb0 & 2) != 0)) {
      if (0x1ffffffffffffffe < (ulong)mctx.input.bufs_len) goto LAB_001190be;
      mctx.state_log = (re_dfastate_t **)malloc(mctx.input.bufs_len * 8 + 8);
      pprVar23 = mctx.state_log;
      if (mctx.state_log != (re_dfastate_t **)0x0) goto LAB_001181d7;
      goto LAB_00119113;
    }
LAB_001181d7:
    local_288 = 8;
...
joined_r0x001182ee:
      ...
      if (local_288 == 7) {
        ...
        do {
          if (local_2b0[puVar3[(byte)string[match_first]]] != '\0') goto LAB_001184e0;
          match_first = match_first + 1;
          bVar8 = true;
        } while (match_first != lVar37);
        goto LAB_0011844e;
      }
      if (local_288 == 8) goto LAB_001184fa;
      if ((int)local_288 < 6) {
        if (3 < (int)local_288) {
          if (lVar29 <= start) {
            bVar8 = false;
            while( true ) {
              ...
              match_first = match_first + -1;
              bVar8 = true;
              if (match_first < lVar29) goto LAB_00118480;
            }
            if (bVar8) {
              start = match_first;
              IVar21 = match_first;
        ...
        if (lVar37 <= start) goto forward_match_found_start_or_reached_end;
        do {
          if (local_2b0[(byte)string[match_first]] != '\0') goto LAB_001184e0;
          match_first = match_first + 1;
          bVar8 = true;
        } while (match_first != lVar37);
        goto LAB_0011844e;
      ...
      while( true ) {
        ...
        if ((match_first < lVar29) || (lVar37 < match_first)) goto LAB_00118480;
      }
      goto LAB_001184fa;
    }
    goto LAB_00118480;
...
LAB_0011844e:
      ...
      start = match_first;
      IVar21 = match_first;
      if (local_2b0[uVar18] == '\0') goto LAB_00118480;
    }
  }
LAB_001184fa:
  match_first = IVar21;
  ...
  if ((char)prVar24->field_0x68 < '\0') {
    ...
    if ((uVar30 & 1) == 0) {
      if (uVar30 == 0) goto LAB_001185e0;
      if ((uVar30 & 6) == 6) {
        prVar24 = prVar4->init_state_begbuf;
      }
      else if ((uVar30 & 2) == 0) {
        if ((uVar30 & 4) == 0) goto LAB_001185e0;
    ...
    if (prVar24 == (re_dfastate_t *)0x0) goto LAB_001190be;
  }
LAB_001185e0:
      ...
      if (mctx.input.cur_idx < mctx.input.stop) {
        ...
        do {
          ...
          if (((lVar36 < mctx.input.bufs_len) || (mctx.input.len <= mctx.input.bufs_len)) &&
            ...
            if (rVar15 != _REG_NOERROR) goto LAB_001190be;
            bVar10 = prVar24->field_0x68;
            uVar18 = mctx.input.cur_idx;
            prVar4 = mctx.dfa;
          }
                ...
                if ((prVar4->nodes[lVar7].field_0xa & 0x10) != 0) {
                  ...
                  if ((uVar30 & 0x3ff00) != 0) {
                    ...
                    if ((uVar30 & 4) == 0) {
                      if ((uVar30 & 8) != 0) {
                        uVar31 = uVar14 & 1;
                        goto joined_r0x00118c8b;
                      }
                    }
                    else {
                      if ((uVar14 & 1) == 0) goto LAB_00118dd6;
                      uVar31 = uVar30 & 8;
joined_r0x00118c8b:
                      if (uVar31 != 0) goto LAB_00118dd6;
                    }
                    if ((((uVar30 & 0x20) != 0) && ((uVar14 & 2) == 0)) ||
                       (((uVar30 & 0x80) != 0 && ((uVar14 & 8) == 0)))) goto LAB_00118dd6;
                  }
                    ...
                    if ((reg_errcode_t)eps_via_nodes.alloc == _REG_NOERROR) {
                      ...
                      if (prVar19 == (re_dfastate_t *)0x0) {
                        ...
                        *pprVar23 = prVar19;
                        ...
                        if ((reg_errcode_t)eps_via_nodes.alloc != _REG_NOERROR) goto LAB_00119068;
                        uVar30 = re_string_context_at
                                           (&mctx.input,next_state_log_idx + -1,mctx.eflags);
                        pprVar23 = mctx.state_log + next_state_log_idx;
                        prVar19 = re_acquire_state_context
                      ...
                      if ((prVar19 != (re_dfastate_t *)0x0) ||
                         ((reg_errcode_t)eps_via_nodes.alloc == _REG_NOERROR)) goto LAB_00118dd6;
                    }
LAB_00119068:
                    idx = idx & 0xffffffff00000000U |
                          (ulong)(uint)(reg_errcode_t)eps_via_nodes.alloc;
                    goto joined_r0x00119072;
                  }
                }
LAB_00118dd6:
                lVar20 = lVar20 + 1;
...
LAB_00118742:
              if (mctx.state_log != (re_dfastate_t **)0x0) goto LAB_0011874d;
              goto LAB_00118760;
            }
...
LAB_00118760:
          if (prVar19 == (re_dfastate_t *)0x0) {
            pprVar23 = mctx.state_log;
            if ((int)idx != 0) goto LAB_00119113;
            if ((mctx.state_log == (re_dfastate_t **)0x0) ||
            ...
            do {
              ...
              if ((int)idx != 0) {
                if (prVar19 == (re_dfastate_t *)0x0) goto LAB_001187ee;
                break;
              }
...
LAB_001187ee:
    ...
    if (rVar15 == _REG_NOERROR) {
      ...
      if ((bVar10 & 0x40) != 0) {
        ...
        idx = idx & 0xffffffff00000000U | (ulong)(uint)rVar15;
        if (rVar15 != _REG_NOERROR) goto LAB_00119b58;
        bVar10 = prVar24->field_0x68;
      }
      local_25b = false;
      goto LAB_00118617;
...
LAB_00118fd0:
    start = start + iVar12;
    match_first = start;
    if ((start < lVar29) || (lVar37 < start)) goto LAB_00118480;
    goto joined_r0x001182ee;
  }
  if (uVar18 == 0xfffffffffffffffe) goto LAB_00119113;
  bVar10 = preg->field_0x38;
  mctx.match_last = uVar18;
  if ((bVar10 & 0x10) == 0) {
    if (nmatch < 2) {
      if (prVar2->nbackref == 0) {
        if (nmatch != 0) goto LAB_001188d2;
        goto free_return;
      }
LAB_00119133:
...
LAB_0011914b:
      ...
      if (0x1ffffffffffffffe < uVar18) goto LAB_00119113;
      num = uVar18 + 1;
...
LAB_001192f1:
        ...
        if (local_2f0 == (re_dfastate_t **)0x0) goto LAB_001190b2;
        while( true ) {
          ...
          if ((*pprVar23 != (re_dfastate_t *)0x0) || (*local_2f0 != (re_dfastate_t *)0x0)) {
            ...
            rpl_free(local_2f0);
            if (rVar15 != _REG_NOERROR) goto LAB_001192f1;
            goto LAB_001193b0;
          }
          do {
            num = uVar18;
    ...
    mctx.last_node = check_halt_state_context(&mctx,mctx.state_log[uVar18],uVar18);
    if (((prVar2->field_0xb0 & 1) != 0) || (prVar2->nbackref != 0)) goto LAB_0011914b;
  }
  else {
    if (prVar2->nbackref != 0) goto LAB_00119133;
LAB_001193f0:
    pprVar23 = mctx.state_log;
...
LAB_00119a80:
      ...
      prev_match.u._0_8_ = 0;
      prev_match.u._8_8_ = 8;
      if (fs == (re_fail_stack_t *)0x0) goto LAB_001190be;
LAB_00119ab3:
      prev_match.u._8_8_ = 8;
      prev_match.u._0_8_ = 0;
...
LAB_0011975d:
        ...
        if ((lVar29 == IVar22) && (IVar21 == mctx.last_node)) {
          if (fs != (re_fail_stack_t *)0x0) goto LAB_001196d8;
          rpl_free(eps_via_nodes.elems);
          if (prev_match.u._16_8_ != local_2f8) {
            rpl_free(prev_match.u._16_8_);
          }
...
LAB_001196d8:
          ...
          while ((prVar27->rm_so < 0 || (prVar27->rm_eo != -1))) {
            sVar33 = sVar33 + 1;
            prVar27 = prVar27 + 1;
            if (nmatch == sVar33) goto LAB_00119706;
          }
...
LAB_00119706:
            rpl_free(eps_via_nodes.elems);
            if (prev_match.u._16_8_ != local_2f8) goto LAB_00119726;
            goto LAB_00119755;
          }
...
LAB_001199d2:
                ...
                rpl_free(eps_via_nodes.elems);
                if (prev_match.u._16_8_ == local_2f8) goto LAB_00119ab3;
                goto LAB_00119a80;
              }
              lVar36 = lVar36 + 1;
              lVar37 = IVar21;
...
LAB_00118b7d:
            if (-1 < IVar21) goto LAB_00118a50;
            if (IVar21 != -2) goto LAB_00119c21;
          }
LAB_00119b2f:
          rpl_free(eps_via_nodes.elems);
          goto LAB_00119b3c;
        ...
        if ((prVar34->field_0xa & 0x10) == 0) {
          if (prVar34->field_0x8 != 4) goto LAB_00119613;
...
LAB_00119d3f:
            ...
            IVar22 = idx;
            if (_Var11 == false) goto LAB_00119b2f;
            IVar21 = *prVar9->edests[(long)local_310].elems;
            IVar26 = re_node_set_contains();
            if (IVar26 != 0) goto LAB_00118b7d;
