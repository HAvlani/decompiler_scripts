...
LAB_00112248:
    ...
    if ((long)uVar15 < (long)(uVar1 - 1)) goto LAB_0011220a;
...
LAB_001126d0:
        ...
        if (local_148 == (fs_res *)0x0) goto LAB_0011229d;
      }
      else {
LAB_00112157:
        ...
        if (local_148 == (fs_res *)0x0) {
          if (utimecmpat::lexical_block_0::ht == (Hash_table *)0x0) goto LAB_0011229d;
          goto LAB_001126d0;
        }
...
LAB_001124e7:
      if (((long)uVar15 < (long)uVar1) || ((iVar13 <= iVar16 && (bVar17)))) goto LAB_0011220a;
      if (((long)uVar1 < (long)uVar6) ||
         ((uVar1 == uVar6 && (iVar16 < iVar13 - iVar13 % (int)uVar14)))) goto LAB_00112248;
