...

{
  ...
  if (dest_nodes->nelem == 0) {
    ...
    if (err != _REG_NOERROR) goto LAB_0011ac79;
...
LAB_0011ad50:
      ...
      if (0 < dest_nodes->nelem) {
        do {
          ...
          if (rVar7 != _REG_NOERROR) goto LAB_0011ad50;
          lVar21 = lVar21 + 1;
              ...
              if (0 < lVar14) {
                ...
                do {
                  while( true ) {
                    ...
                    plVar15 = plVar15 + 1;
                    if (plVar19 + lVar14 == plVar15) goto LAB_0011b2f3;
                  }
...
LAB_0011b305:
    ...
    err = local_7c;
    if (local_7c != _REG_NOERROR) goto LAB_0011ac79;
            ...
            do {
              if (((lVar14 == prVar23->node) &&
                ...
                if (_err == (re_dfastate_t **)0x0) {
                  ...
                  if (err == _REG_NOERROR) goto LAB_0011af95;
                }
                else {
LAB_0011af95:
                  local_68 = lVar14;
                ...
                if (_err == (re_dfastate_t **)0x0) goto LAB_0011ac79;
                goto LAB_0011b16c;
              }
LAB_0011b070:
              lVar20 = lVar20 + 1;
