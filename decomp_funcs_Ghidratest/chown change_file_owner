...
LAB_001038fe:
    if (*param_7 == 0) goto LAB_00103995;
    goto LAB_00103908;
  case 6:
    if (*(char *)(param_7 + 1) == '\0') {
LAB_0010394a:
...
LAB_00103d70:
        iVar9 = *param_7;
        if (iVar9 == 2) goto LAB_00103728;
        if (param_3 == 0xffffffff) {
LAB_00103d9a:
          if ((param_4 == 0xffffffff) || (__stat_buf->st_gid == param_4)) goto joined_r0x0010371b;
          ...
          iVar7 = 2;
          uVar19 = 1;
          if (uid == param_3) goto LAB_00103d9a;
        }
        goto LAB_001037c8;
      }
      if (*param_7 == 0) {
...
LAB_00103c46:
      ...
      if (uVar8 == 0x8000) {
        ...
        uVar18 = 0x10900;
        if (uVar8 != 0x4000) goto LAB_00103c46;
      }
      ...
      if (iVar9 < 0) {
        ...
        if (*piVar10 == 0xd) {
          if ((__stat_buf->st_mode & 0xf000) == 0x8000) {
            ...
            if (-1 < iVar9) goto LAB_00103e88;
            if (*piVar10 != 0xd) goto LAB_001037a3;
          }
          iVar7 = param_1->fts_cwd_fd;
          goto LAB_00103c46;
        }
...
LAB_00104090:
      ...
      if ((__stat_buf->st_ino == local_e8.st_ino) && (__stat_buf->st_dev == local_e8.st_dev)) {
        if (((param_5 == 0xffffffff) || (param_5 == local_e8.st_uid)) &&
          ...
          if (iVar7 != 0) goto LAB_00104090;
          iVar7 = close(iVar9);
          if (iVar7 != 0) goto LAB_001037a3;
        }
        else {
          piVar10 = __errno_location();
          iVar7 = *piVar10;
    ...
    if ((param_5 == 0xffffffff) || (__stat_buf->st_uid == param_5)) {
      if (param_6 == 0xffffffff) {
        ...
        goto LAB_0010375c;
              ...
              ((__stat_buf->st_ino != *p_Var2 || (__stat_buf->st_dev != p_Var2[1])))) {
        if (__stat_buf->st_gid != param_6) goto LAB_00103718;
LAB_0010375c:
        cVar6 = *(char *)(param_7 + 4);
        goto LAB_00103760;
      }
LAB_00103b40:
    ...
    if (bVar20 && bVar21) {
      uVar19 = 1;
      if (*param_7 != 0) goto LAB_0010390b;
    }
    else {
      p_Var2 = *(__ino_t **)(param_7 + 2);
      if (((p_Var2 != (__ino_t *)0x0) && (*p_Var2 == __stat_buf->st_ino)) &&
         (__stat_buf->st_dev == p_Var2[1])) goto LAB_00103b40;
LAB_00103718:
      iVar9 = *param_7;
joined_r0x0010371b:
      if (iVar9 != 0) goto LAB_00103728;
    }
    uVar19 = 1;
    iVar7 = 4;
LAB_001037c4:
...
LAB_0010410e:
    ...
    if (*(char **)(param_7 + 8) == pcVar14) goto LAB_0010390b;
    rpl_free(pcVar14);
    cVar6 = *(char *)(param_7 + 1);
  }
  if (cVar6 == '\0') {
