...
LAB_00115719:
      ...
      if (local_170 != 0) goto LAB_00115630;
      local_170 = 1;
      if (*(char *)&local_178->__count == '\0') {
        if (local_164 == 0) goto LAB_00115630;
        goto LAB_0011562a;
      }
LAB_0011573d:
                    /* WARNING: Subroutine does not return */
...
LAB_00115028:
        ...
        if (sStack240 == 0xffffffffffffffff) {
          ...
          if (sStack240 != 0xfffffffffffffffe) {
            if (sStack240 == 0) {
              sStack240 = 1;
              if (*local_f8 != 0) goto LAB_0011573d;
              if (uStack228 != 0) goto LAB_0011562a;
            }
        ...
        if ((bVar10 != 0) && (bVar5 = bVar10, local_1c0 * 5 <= uVar12)) goto LAB_00115158;
LAB_00114fa9:
        sVar7 = sStack240;
        uVar13 = uVar12 + 1;
...
LAB_00114b07:
          ...
          if ((*(uint *)(is_basic_table + (ulong)(bVar10 >> 5) * 4) >> (bVar10 & 0x1f) & 1) == 0) {
            ...
            if (local_70 == 0) {
              local_70 = 1;
              if (*(char *)&local_78->__count != '\0') goto LAB_0011573d;
              iter = (mbuiter_multi *)(ulong)local_64;
              if (local_64 != 0) goto LAB_0011562a;
            }
            local_68 = '\x01';
            iVar6 = mbsinit(&local_84);
            if (iVar6 != 0) {
            ...
            if ((char)uStack188 == '\0') {
              ...
              if (sStack176 == 0xffffffffffffffff) {
                ...
                if (sStack176 != 0xfffffffffffffffe) {
                  if (sStack176 == 0) {
                    sStack176 = 1;
                    if (*local_b8 != 0) goto LAB_0011573d;
                    if (uStack164 != 0) goto LAB_0011562a;
                  }
                  local_a8 = CONCAT31(local_a8._1_3_,1);
                  iVar6 = mbsinit(pmVar14);
                  if (iVar6 != 0) {
...
LAB_00114dfc:
              ...
              if ((char)local_a8 == '\0') goto LAB_00114dfc;
LAB_00114cb1:
              if (uStack164 == 0) goto LAB_001149ad;
              if (local_68 == '\0') goto LAB_00114dfc;
...
LAB_00114aad:
      uStack252 = CONCAT31(uStack252._1_3_,1);
      if (uStack228 == 0) goto LAB_001149ad;
      bVar10 = 9 < local_1c0 & bVar5;
      if ((bVar10 != 0) && (bVar5 = bVar10, local_1c0 * 5 <= uVar12)) {
LAB_00115158:
        local_1c8 = uVar12 - local_1a0;
        if (local_1c8 == 0) {
          if (local_13c == '\0') goto LAB_00115388;
          if (local_128 != '\0') {
LAB_001153e5:
            if (local_124 == 0) goto LAB_0011521b;
          }
LAB_001153f6:
          bVar5 = 1;
        }
        else {
          if (local_13c == '\0') goto LAB_001151a3;
          if (local_128 != '\0') goto LAB_001151fc;
LAB_00115180:
          do {
            local_138 = (mbstate_t *)((long)&local_138->__count + local_130);
            local_1c8 = local_1c8 + -1;
            local_13c = '\0';
            if (local_1c8 == 0) goto LAB_00115388;
LAB_001151a3:
            if (local_148 == '\0') {
...
LAB_00115268:
              ...
              if (local_130 == 0) {
                local_130 = 1;
                if (*(char *)&local_138->__count != '\0') goto LAB_0011573d;
                if (local_124 != 0) goto LAB_0011562a;
              }
              local_128 = '\x01';
              iVar6 = mbsinit(pmVar14);
              if (iVar6 != 0) {
...
LAB_0011521b:
          ...
          pbVar8 = local_190;
          if (bVar5 != 0) goto LAB_00114944;
        }
        local_1a0 = uVar12;
        if ((char)local_e8 == '\0') goto LAB_00114fa9;
      }
      uVar13 = uVar12 + 1;
      if (local_168 == '\0') goto LAB_00114fa9;
      sVar7 = sStack240;
      if (uStack228 == local_164) goto LAB_00114b07;
LAB_00114e1a:
    ...
    if (bVar10 != 0) {
      ...
      while( true ) {
        ...
        if (bVar5 == bVar10) {
          ...
          pbVar8 = param_1;
          if (bVar10 == 0) goto LAB_00114944;
          while( true ) {
            lVar2 = uVar11 - uVar13;
            if (param_1[lVar2] == 0) goto LAB_001149ad;
            uVar11 = uVar11 + 1;
