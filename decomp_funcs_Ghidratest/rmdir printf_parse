...
LAB_00107726:
    do {
      ...
      if (bVar15 == 0x27) {
        ...
        if (bVar15 != 0x49) goto LAB_00107788;
  ...
  sVar20 = 0xffffffffffffffff;
  if (*pbVar16 != 0x24) goto LAB_00107726;
  uVar12 = 0;
  do {
    pbVar17 = (byte *)format;
    ...
    while( true ) {
      ...
      if (9 < (byte)(bVar15 - 0x30)) goto switchD_00107a05_caseD_26;
      pbVar17 = pbVar17 + 1;
      uVar14 = 0xffffffffffffffff;
      uVar11 = (ulong)((char)bVar15 + -0x30);
    }
  ...
  goto switchD_00107a05_caseD_26;
LAB_00107788:
  if (bVar15 != 0x2a) {
    uVar11 = local_80;
    pbVar16 = (byte *)format;
...
joined_r0x00107926:
    ...
    uVar11 = local_78;
    local_70 = uVar12;
    if (bVar15 != 0x2e) goto LAB_001077a2;
    bVar15 = pbVar16[1];
    ...
    if ((byte)(pbVar16[2] - 0x30) < 10) {
      ...
      if (*pbVar16 != 0x24) goto LAB_0010796e;
      uVar14 = 0;
      do {
      ...
      uVar14 = uVar14 - 1;
      if (0xfffffffffffffffd < uVar14) goto switchD_00107a05_caseD_26;
...
LAB_0010796e:
      ...
      if (pcVar8->precision_arg_index == 0xffffffffffffffff) {
        ...
        local_70 = uVar12 + 1;
        uVar14 = uVar12;
        if (uVar12 == 0xffffffffffffffff) goto switchD_00107a05_caseD_26;
      }
    }
    __ptr = a->arg;
    if (uVar14 < uVar18) {
...
LAB_001077a2:
        ...
        do {
          ...
          if (bVar15 == 0x68) {
            ...
            if ((((bVar15 != 0x6c) && (bVar15 != 0x6a)) && ((bVar15 & 0xdf) != 0x5a)) &&
               (bVar15 != 0x74)) goto code_r0x001079f4;
            uVar4 = uVar4 + 8;
          }
          bVar15 = *pbVar16;
        } while( true );
    ...
    if (uVar18 < 0x800000000000000) {
      if (paVar2 == __ptr) {
        ...
        paVar6 = __ptr;
        __ptr = paVar10;
        if (paVar10 == (argument *)0x0) goto LAB_00107ff8;
LAB_001082a0:
...
LAB_001080bb:
      ...
      if (__ptr != (argument *)0x0) {
        paVar6 = paVar2;
        if (paVar2 == a->arg) goto LAB_001082a0;
        goto LAB_001080bb;
      }
      goto LAB_00108219;
    }
  ...
  if ((byte)(((byte *)format)[1] - 0x30) < 10) {
    ...
    if (*pbVar13 != 0x24) goto LAB_0010782d;
    uVar14 = 0;
    do {
      uVar12 = (ulong)(iVar5 + -0x30);
      pbVar16 = pbVar17;
...
LAB_0010782d:
    ...
    uVar14 = local_70;
    local_70 = local_70 + 1;
    if (bVar22) goto switchD_00107a05_caseD_26;
  }
  __ptr = a->arg;
  if (uVar14 < uVar18) {
    uVar12 = a->count;
LAB_001078e0:
  ...
  if (paVar2 != __ptr) {
    ...
    if (paVar6 != (argument *)0x0) {
      uVar12 = a->count;
      paVar10 = paVar2;
      if (paVar2 == __ptr) goto LAB_0010810d;
      goto LAB_001078dc;
    }
    goto out_of_memory;
  }
...
code_r0x001079f4:
  switch(bVar15) {
  case 0x25:
    goto switchD_00107a05_caseD_25;
  default:
    goto switchD_00107a05_caseD_26;
  case 0x41:
  case 0x45:
...
LAB_00108219:
    ...
    if (pcVar1 != __ptr_00) {
      ...
      if (pcVar8 != (char_directive *)0x0) {
        __ptr_00 = d->dir;
        uVar12 = d->count;
        if (pcVar1 != __ptr_00) goto LAB_00107b31;
        goto LAB_00107c7a;
      }
      goto LAB_00108219;
    }
...
LAB_00107b31:
    ...
    __ptr = a->arg;
    if (paVar2 == __ptr) goto LAB_00108008;
  }
  else {
    uVar18 = uVar18 * 2;
    if (uVar18 <= sVar20) {
...
LAB_00107ebf:
      ...
      if (__ptr != (argument *)0x0) {
        paVar6 = paVar2;
        if (paVar2 == a->arg) goto LAB_00107f9e;
        goto LAB_00107ebf;
      }
      goto LAB_00108219;
    }
out_of_memory:
    if (paVar2 == __ptr) goto LAB_00107ff8;
  }
  rpl_free(__ptr);
LAB_00107ff8:
  if (pcVar1 != d->dir) {
