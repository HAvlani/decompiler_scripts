            ...
            if (-1 < iVar7) {
              ...
              if (__dirp == (DIR *)0x0) {
                ...
                *piVar8 = 0;
                ...
                closedir(__dirp);
                *piVar8 = iVar7;
                if (iVar7 == 0) goto LAB_001055c0;
              }
            }
LAB_00105593:
            if (x->remove_empty_directories == false) goto LAB_001056e0;
            uVar14 = 0x27;
          }
          ...
          if (-1 < p_Var11->fts_level) goto LAB_00105747;
          goto LAB_001054a7;
        }
LAB_001055c0:
        if (ent->fts_level == 0) {
          ...
          if ((*pcVar10 == '.') &&
            ...
            uVar14 = quotearg_n_style(1,4,&DAT_00116c86);
            uVar15 = quotearg_n_style(0,4,&DAT_00116c87);
...
LAB_00105877:
        ...
        if (RVar5 == RM_OK) {
          if (is_empty_directory != T_YES) goto LAB_00105340;
      ...
      case 0xd:
        if ((((uVar1 == 6) && (x->one_file_system != false)) && (0 < ent->fts_level)) &&
          ...
          p_Var11 = ent->fts_parent;
          if (-1 < p_Var11->fts_level) goto LAB_001059bb;
          goto LAB_001059c2;
        }
      ...
      if (RVar5 != RM_USER_DECLINED) goto LAB_00105340;
      if (RVar6 == RM_OK) {
