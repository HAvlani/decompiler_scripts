...
ptrdiff_t mkancesdirs(char *file,savewd_conflict2 *wd,
...

{
  ...
  do {
    ...
    if (cVar1 == '/') {
      ...
      if (bVar9) {
        cVar5 = cVar1;
        if (pcVar8 == (char *)0x0) goto LAB_001071a9;
        if ((long)pcVar8 - (long)dir == 1) {
          pcVar7 = pcVar6;
          if (*dir == '.') goto LAB_001071a9;
          *pcVar8 = '\0';
LAB_001071e4:
        ...
        iVar3 = savewd_chdir((savewd_conflict1 *)wd,dir,options,(int *)0x0);
