...
/* WARNING: Removing unreachable block (ram,0x0010cc68) */
...

{
  ...
  if ((float10)_DAT_00123e4c <= value._0_10_) {
    uVar1 = (long)ROUND(value._0_10_ - (float10)_DAT_00123e4c) ^ 0x8000000000000000;
  }
  else {
  ...
  fVar2 = (float10)uVar1;
  if ((long)uVar1 < 0) {
    fVar2 = fVar2 + (float10)_DAT_00123e48;
  }
