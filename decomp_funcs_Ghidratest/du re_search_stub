...

{
  ...
  if (((length < lVar8) || ((-1 < range && (lVar8 < start)))) ||
    ...
    bVar2 = PTR_pthread_mutexattr_gettype_0012bfe8 != (undefined *)0x0 ||
            PTR_thrd_exit_0012bfd8 != (undefined *)0x0;
    if (PTR_pthread_mutexattr_gettype_0012bfe8 != (undefined *)0x0 ||
        PTR_thrd_exit_0012bfd8 != (undefined *)0x0) goto LAB_0011eb1e;
LAB_0011eb3e:
...
LAB_0011ed28:
    ...
    if (((bufp->field_0x38 & 6) == 4) && (nmatch = regs->num_regs, nmatch <= bufp->re_nsub)) {
      if ((long)nmatch < 1) goto LAB_0011ed28;
    }
    else {
...
LAB_0011ee91:
        ...
        if (((bVar3 & 3) == 1) && (cVar9 = '\x01', regs->num_regs < uVar7)) {
          ...
          if (prVar5 == (regoff_t *)0x0) goto LAB_0011ee91;
...
LAB_0011eccd:
      ...
      if ((cVar9 * '\x02' & 6U) == 0) goto LAB_0011ebf5;
    }
    lVar8 = pmatch->rm_so;
    if (ret_len != false) {
