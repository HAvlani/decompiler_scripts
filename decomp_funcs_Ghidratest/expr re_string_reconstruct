...

{
  ...
  if (idx < pstr->raw_mbs_idx) {
    ...
    lVar16 = idx;
    if (pstr->mbs_allocated != '\0') goto LAB_00114aea;
    pstr->mbs = pstr->raw_mbs;
    if (idx == 0) goto LAB_00114bd0;
LAB_00114af3:
...
LAB_00114e3d:
        ...
        if (((lVar16 != lVar23) || (lVar3 <= lVar16)) || (pIVar5[lVar23] != lVar16)) {
          ...
          if (lVar23 < lVar3) {
            do {
              if (pstr->wcs[lVar23] != 0xffffffff) goto LAB_00114f34;
              lVar23 = lVar23 + 1;
            } while (lVar23 != lVar3);
LAB_001150d8:
            pstr->valid_len = 0;
            ...
            if (lVar23 == lVar3) goto LAB_001150d8;
LAB_00114f34:
...
LAB_00114b69:
    ...
    if (1 < iVar10) {
      if (pstr->is_utf8 != '\0') {
        ...
        if (pbVar15 <= pbVar24) {
LAB_00114fcd:
          if ((*pbVar24 & 0xc0) == 0x80) goto LAB_00114fc0;
          puVar20 = pstr->trans;
...
LAB_00114cf1:
      ...
      if (lVar11 < idx) {
        ...
        pstr->valid_len = sVar22;
        wc2 = wVar17;
        if (wVar17 == 0xffffffff) goto LAB_001150f1;
LAB_00114d72:
...
LAB_00114da0:
    ...
    lVar11 = pstr->len - lVar16;
    lVar18 = pstr->stop - lVar16;
    if (pstr->mbs_allocated == '\0') goto LAB_00114b69;
...
LAB_00114b6d:
    ...
    pstr->len = lVar11;
    pstr->stop = lVar18;
    if (iVar10 < 2) goto LAB_00114ca8;
    if (pstr->icase == '\0') {
      build_wcs_buffer(pstr);
    }
    else {
      rVar9 = build_wcs_upper_buffer(pstr);
      if (rVar9 != _REG_NOERROR) goto LAB_00114b9d;
    }
  }
  pstr->cur_idx = 0;
  rVar9 = _REG_NOERROR;
...
LAB_00114fc0:
  pbVar24 = pbVar24 + -1;
  if (pbVar24 < pbVar15) goto LAB_00114cf1;
  goto LAB_00114fcd;
}
