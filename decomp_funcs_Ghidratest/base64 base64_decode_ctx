...

{
  ...
  while( true ) {
    ...
    if ((bool)uVar3) goto LAB_00103930;
    pcVar9 = in_00;
...
LAB_00103899:
      ...
      lVar8 = outleft;
      if ((_Bool)uVar3 == false) goto LAB_00103930;
...
LAB_0010390c:
      in = in_00;
      if (((3 < (long)inlen_00) || (!bVar13 && !bVar2)) || (bVar13)) goto LAB_00103899;
    }
    uVar3 = 1;
    lVar8 = outleft;
  }
