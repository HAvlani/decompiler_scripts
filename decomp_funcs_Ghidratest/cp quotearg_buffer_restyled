...
LAB_0010eedf:
  ...
  case custom_quoting_style:
    if (param_5 != custom_quoting_style) {
      local_70 = (char *)dcgettext(0,&DAT_0011568b,5);
      if (local_70 == "`") {
        local_70 = gettext_quote("`",param_5);
      }
      local_78 = (char *)dcgettext(0,&DAT_00115689,5);
      if (local_78 == "\'") {
...
LAB_0010ec28:
    ...
    if (bVar21) {
      ...
      if (!bVar23) {
        ...
        switch(uVar15) {
        case 0:
          if (bVar1) goto switchD_0010f490_caseD_0;
          bVar5 = false;
          uVar15 = 0;
          if ((param_6 & 1) != 0) goto code_r0x0010f42b;
          goto LAB_0010f21b;
        default:
switchD_0010f340_caseD_1:
          bVar22 = bVar1;
          if (sVar8 != 1) {
            ...
            do {
              ...
              if (sVar10 == 0xfffffffffffffffe) goto joined_r0x0010fb2a;
...
LAB_0010f0e4:
          ...
          bVar23 = bVar21;
          if ((!bVar20) || (!bVar22)) goto LAB_0010ee08;
          goto LAB_0010f0f7;
        case 0x23:
        case 0x7e:
LAB_0010f0db:
          bVar22 = param_5 == shell_always_quoting_style;
          if (uVar13 == 0) goto LAB_0010f0e4;
          goto LAB_0010ee05;
        case 0x25:
        case 0x2b:
        case 0x2c:
        ...
        case 0x79:
        case 0x7a:
          goto switchD_0010f340_caseD_25;
        case 0x27:
switchD_0010f340_caseD_27:
          bVar4 = bVar21;
          ...
          if (!bVar20) {
            ...
            bVar3 = false;
            bVar22 = false;
            goto joined_r0x0010ee2b;
          }
          goto force_outer_quoting_style;
        case 0x3f:
switchD_0010f340_caseD_3f:
          if (param_5 != shell_always_quoting_style) {
            if ((((param_5 == c_quoting_style) && ((param_6 & 4) != 0)) &&
              ...
              case '=':
              case '>':
                goto switchD_0010fa8e_caseD_21;
              default:
                break;
              }
            }
          ...
          goto force_outer_quoting_style;
        case 0x5c:
          if (param_5 != shell_always_quoting_style) goto switchD_0010ed30_caseD_5c;
          if (!bVar20) {
LAB_0010f378:
            uVar13 = uVar13 + 1;
            bVar21 = false;
        ...
        case 0x7b:
        case 0x7d:
switchD_0010f340_caseD_7b:
          bVar23 = param_4 != 1;
          if (param_4 == 0xffffffffffffffff) {
            bVar23 = param_3[1] != '\0';
          }
          bVar22 = param_5 == shell_always_quoting_style;
          if (!bVar23) goto LAB_0010f0db;
LAB_0010ee05:
          bVar23 = false;
          goto LAB_0010ee08;
        }
...
LAB_0010f21b:
          ...
          bVar21 = false;
          bVar22 = false;
          if (!bVar20) goto LAB_0010ee28;
          goto LAB_0010ed50;
        }
LAB_0010f250:
        bVar21 = false;
        goto joined_r0x0010f261;
      }
      if (local_c8 != 0) {
        ...
        if (param_4 < uVar13 + local_c8) goto LAB_0010f470;
        uVar25 = 0x10ece7;
        iVar7 = memcmp(__s1,local_98,local_c8);
        if (iVar7 != 0) goto LAB_0010f470;
        if (!bVar20) {
          uVar15 = (ulong)*__s1;
          switch(uVar15) {
          case 0:
            goto switchD_0010ed30_caseD_0;
          default:
            goto switchD_0010f340_caseD_1;
          case 7:
            goto switchD_0010f490_caseD_7;
          case 8:
            goto switchD_0010f490_caseD_8;
          case 9:
            goto switchD_0010ed30_caseD_9;
          case 10:
            goto switchD_0010f490_caseD_a;
          case 0xb:
            goto switchD_0010f490_caseD_b;
          case 0xc:
            goto switchD_0010f490_caseD_c;
          case 0xd:
            goto switchD_0010f490_caseD_d;
          case 0x20:
            goto LAB_0010f4b9;
          case 0x21:
          case 0x22:
          ...
          case 0x60:
          case 0x7c:
            goto switchD_0010ed30_caseD_21;
          case 0x23:
          case 0x7e:
            goto LAB_0010f4a1;
          case 0x25:
          ...
          case 0x7a:
            goto LAB_0010ed40;
          case 0x27:
            goto switchD_0010f340_caseD_27;
          case 0x3f:
            goto switchD_0010f340_caseD_3f;
          case 0x5c:
            goto switchD_0010ed30_caseD_5c;
          case 0x7b:
          case 0x7d:
            goto switchD_0010f340_caseD_7b;
          }
        }
        goto LAB_0010f10e;
      }
LAB_0010f470:
      ...
      switch(uVar15) {
      case 0:
switchD_0010f490_caseD_0:
        if (!bVar20) {
          bVar5 = false;
switchD_0010ed30_caseD_0:
...
LAB_0010f8cb:
            ...
            uVar15 = uVar18;
            if (uVar18 < param_2) goto LAB_0010f8cb;
          }
          uVar19 = uVar18 + 1;
          bVar22 = bVar21;
          if (param_5 != shell_always_quoting_style) {
      ...
      default:
        ...
        goto switchD_0010f340_caseD_1;
      case 7:
switchD_0010f490_caseD_7:
        bVar14 = 0x61;
        break;
      case 8:
switchD_0010f490_caseD_8:
        bVar14 = 0x62;
        break;
      case 9:
        bVar23 = false;
switchD_0010ed30_caseD_9:
        uVar15 = 9;
        bVar14 = 0x74;
        goto c_escape;
      case 10:
switchD_0010f490_caseD_a:
        bVar14 = 0x6e;
        goto LAB_0010f250;
      case 0xb:
switchD_0010f490_caseD_b:
        bVar14 = 0x76;
        goto LAB_0010f250;
      case 0xc:
switchD_0010f490_caseD_c:
        bVar14 = 0x66;
        break;
      case 0xd:
switchD_0010f490_caseD_d:
        bVar14 = 0x72;
        goto LAB_0010f250;
      case 0x20:
        bVar5 = false;
...
LAB_0010ed40:
      ...
      case 0x5c:
        bVar23 = false;
switchD_0010ed30_caseD_5c:
        if (((bool)(bVar1 & bVar20)) && (local_c8 != 0)) goto LAB_0010f378;
        uVar15 = 0x5c;
        bVar14 = 0x5c;
        goto c_escape;
      case 0x7b:
...
LAB_0010f148:
    ...
    uVar13 = local_90;
    bVar20 = bVar4;
    if (param_2 != 0 || local_90 == 0) goto LAB_0010fb95;
LAB_0010f526:
    *param_1 = 0x27;
    param_2 = local_90;
    local_90 = uVar13;
...
LAB_0010f908:
    ...
    uVar18 = uVar19;
    bVar3 = bVar2;
    if ((bool)(bVar1 ^ 1U | bVar24)) goto joined_r0x0010ee2b;
    goto LAB_0010ed50;
  }
  goto LAB_0010f10e;
joined_r0x0010fb2a:
...
LAB_0010f722:
    ...
    do {
      ...
      if (bVar22) {
        ...
        bVar24 = bVar22;
        if (uVar17 <= uVar13) goto LAB_0010edd8;
      }
      else {
