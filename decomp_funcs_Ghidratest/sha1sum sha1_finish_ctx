  ...
  if (uVar3 < 8) {
    if ((uVar3 & 4) == 0) {
      if ((uVar3 != 0) && (*(char *)puVar10 = (char)fillbuf._0_4_, (uVar3 & 2) != 0)) {
        *(undefined2 *)((long)puVar10 + (uVar3 - 2)) = *(undefined2 *)(&DAT_00109cde + uVar3);
      }
    }
    else {
      *(undefined4 *)puVar10 = fillbuf._0_4_;
      *(undefined4 *)((long)puVar10 + (uVar3 - 4)) = *(undefined4 *)(&DAT_00109cdc + uVar3);
    }
  }
  else {
    *puVar10 = CONCAT44(fillbuf._4_4_,fillbuf._0_4_);
    *(undefined8 *)((long)puVar10 + (uVar3 - 8)) = *(undefined8 *)(&DAT_00109cd8 + uVar3);
