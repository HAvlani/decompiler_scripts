...

{
  ...
  uVar4 = dcgettext(0,"Usage: %s [OPTION]... DIRECTORY...\n",5);
  __printf_chk(1,uVar4,pcVar5);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Create the DIRECTORY(ies), if they do not already exist.\n",5);
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "mkdir";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","mkdir");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
