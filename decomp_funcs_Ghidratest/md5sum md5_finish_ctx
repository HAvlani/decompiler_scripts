  ...
  if (uVar4 < 8) {
    if ((uVar4 & 4) == 0) {
      if ((uVar4 != 0) && (*(char *)puVar9 = (char)fillbuf._0_4_, (uVar4 & 2) != 0)) {
        *(undefined2 *)((long)puVar9 + (uVar4 - 2)) = *(undefined2 *)(&DAT_00109cde + uVar4);
      }
    }
    else {
      *(undefined4 *)puVar9 = fillbuf._0_4_;
      *(undefined4 *)((long)puVar9 + (uVar4 - 4)) = *(undefined4 *)(&DAT_00109cdc + uVar4);
    }
  }
  else {
    *puVar9 = CONCAT44(fillbuf._4_4_,fillbuf._0_4_);
    *(undefined8 *)((long)puVar9 + (uVar4 - 8)) = *(undefined8 *)(&DAT_00109cd8 + uVar4);
