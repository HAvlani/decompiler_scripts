          ...
          if (bVar2 != 6) {
            if ((bVar2 & 0xfd) == 5) {
              *in_RCX = _DAT_0011ec20;
              ...
              in_RCX[0x3e] = uVar7;
              in_RCX[0x3f] = uVar8;
              if (bVar2 != 2) goto LAB_0011035b;
            }
            else {
              if (bVar2 != 2) goto LAB_001101f6;
              *in_RCX = _DAT_0011ec20;
              in_RCX[1] = uVar6;
              in_RCX[2] = uVar7;
              in_RCX[3] = uVar8;
...
LAB_001101f6:
        lVar17 = lVar17 + 1;
        if (*in_RSI <= lVar17) goto LAB_0011035b;
      }
      bVar2 = *(byte *)pplVar1;
      *(undefined *)((long)in_RCX + (ulong)bVar2) = 1;
      ...
      if (sVar13 != sVar22) goto LAB_001101f6;
      wVar9 = towlower(local_154);
      sVar14 = wcrtomb((char *)local_190,wVar9,&local_150);
      if (sVar14 == 0xffffffffffffffff) goto LAB_001101f6;
      lVar17 = lVar17 + 1;
      *(undefined *)((long)in_RCX + (ulong)local_148) = 1;
    } while (lVar17 < *in_RSI);
  }
