...

{
  ...
  if ((long)uVar8 < 0) {
    ...
    if (-1 < (long)uVar5) goto LAB_00109133;
LAB_001091ba:
    fVar11 = (float)(uVar5 >> 1 | (ulong)((uint)uVar5 & 1));
    if (fVar10 <= (fVar11 + fVar11) * pHVar7->growth_threshold) goto LAB_0010914a;
LAB_001091e1:
    ...
    if (fVar11 <= pHVar7->growth_threshold * fVar10) goto LAB_0010914a;
    fVar10 = fVar10 * pHVar7->growth_factor;
    if (pHVar7->is_n_buckets == false) {
      fVar10 = fVar10 * pHVar7->growth_threshold;
    }
    if (fVar10 < _DAT_0010b498) {
      if (_DAT_0010b49c <= fVar10) {
        uVar8 = (long)(fVar10 - _DAT_0010b49c) ^ 0x8000000000000000;
      }
      else {
        uVar8 = (ulong)fVar10;
      }
...
LAB_00109247:
    ...
    fVar10 = (float)uVar8;
    uVar5 = param_1->n_buckets;
    if ((long)uVar5 < 0) goto LAB_001091ba;
LAB_00109133:
    if ((float)uVar5 * pHVar7->growth_threshold < fVar10) goto LAB_001091e1;
LAB_0010914a:
    ...
    if (phVar6 == (hash_entry *)0x0) {
      ...
      if (phVar6 == (hash_entry *)0x0) goto LAB_00109247;
    }
    else {
