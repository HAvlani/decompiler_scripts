...

{
  ...
  if ((((prVar2->init_state->nodes).nelem == 0) && ((prVar2->init_state_word->nodes).nelem == 0)) &&
    ...
    if ((start != 0) && (local_2c4 = _REG_NOMATCH, last_start != 0)) goto LAB_0010dfb3;
    last_start = 0;
    start = 0;
  }
  bVar38 = true;
...
LAB_0010dc71:
    ...
    if ((1 < nmatch) || ((prVar2->field_0xb0 & 2) != 0)) {
      if (0x1ffffffffffffffe < (ulong)mctx.input.bufs_len) goto LAB_0010ebbe;
      mctx.state_log = (re_dfastate_t **)malloc(mctx.input.bufs_len * 8 + 8);
      pprVar23 = mctx.state_log;
      if (mctx.state_log != (re_dfastate_t **)0x0) goto LAB_0010dcd7;
      goto LAB_0010ec13;
    }
LAB_0010dcd7:
    local_288 = 8;
...
joined_r0x0010ddee:
      ...
      if (local_288 == 7) {
        ...
        do {
          if (local_2b0[puVar3[(byte)string[match_first]]] != '\0') goto LAB_0010dfe0;
          match_first = match_first + 1;
          bVar8 = true;
        } while (match_first != lVar37);
        goto LAB_0010df4e;
      }
      if (local_288 == 8) goto LAB_0010dffa;
      if ((int)local_288 < 6) {
        if (3 < (int)local_288) {
          if (lVar29 <= start) {
            bVar8 = false;
            while( true ) {
              ...
              match_first = match_first + -1;
              bVar8 = true;
              if (match_first < lVar29) goto LAB_0010df80;
            }
            if (bVar8) {
              start = match_first;
              IVar21 = match_first;
        ...
        if (lVar37 <= start) goto forward_match_found_start_or_reached_end;
        do {
          if (local_2b0[(byte)string[match_first]] != '\0') goto LAB_0010dfe0;
          match_first = match_first + 1;
          bVar8 = true;
        } while (match_first != lVar37);
        goto LAB_0010df4e;
      ...
      while( true ) {
        ...
        if ((match_first < lVar29) || (lVar37 < match_first)) goto LAB_0010df80;
      }
      goto LAB_0010dffa;
    }
    goto LAB_0010df80;
...
LAB_0010df4e:
      ...
      start = match_first;
      IVar21 = match_first;
      if (local_2b0[uVar18] == '\0') goto LAB_0010df80;
    }
  }
LAB_0010dffa:
  match_first = IVar21;
  ...
  if ((char)prVar24->field_0x68 < '\0') {
    ...
    if ((uVar30 & 1) == 0) {
      if (uVar30 == 0) goto LAB_0010e0e0;
      if ((uVar30 & 6) == 6) {
        prVar24 = prVar4->init_state_begbuf;
      }
      else if ((uVar30 & 2) == 0) {
        if ((uVar30 & 4) == 0) goto LAB_0010e0e0;
    ...
    if (prVar24 == (re_dfastate_t *)0x0) goto LAB_0010ebbe;
  }
LAB_0010e0e0:
      ...
      if (mctx.input.cur_idx < mctx.input.stop) {
        ...
        do {
          ...
          if (((lVar36 < mctx.input.bufs_len) || (mctx.input.len <= mctx.input.bufs_len)) &&
            ...
            if (rVar15 != _REG_NOERROR) goto LAB_0010ebbe;
            bVar10 = prVar24->field_0x68;
            uVar18 = mctx.input.cur_idx;
            prVar4 = mctx.dfa;
          }
                ...
                if ((prVar4->nodes[lVar7].field_0xa & 0x10) != 0) {
                  ...
                  if ((uVar30 & 0x3ff00) != 0) {
                    ...
                    if ((uVar30 & 4) == 0) {
                      if ((uVar30 & 8) != 0) {
                        uVar31 = uVar14 & 1;
                        goto joined_r0x0010e78b;
                      }
                    }
                    else {
                      if ((uVar14 & 1) == 0) goto LAB_0010e8d6;
                      uVar31 = uVar30 & 8;
joined_r0x0010e78b:
                      if (uVar31 != 0) goto LAB_0010e8d6;
                    }
                    if ((((uVar30 & 0x20) != 0) && ((uVar14 & 2) == 0)) ||
                       (((uVar30 & 0x80) != 0 && ((uVar14 & 8) == 0)))) goto LAB_0010e8d6;
                  }
                    ...
                    if ((reg_errcode_t)eps_via_nodes.alloc == _REG_NOERROR) {
                      ...
                      if (prVar19 == (re_dfastate_t *)0x0) {
                        ...
                        *pprVar23 = prVar19;
                        ...
                        if ((reg_errcode_t)eps_via_nodes.alloc != _REG_NOERROR) goto LAB_0010eb68;
                        uVar30 = re_string_context_at
                                           (&mctx.input,next_state_log_idx + -1,mctx.eflags);
                        pprVar23 = mctx.state_log + next_state_log_idx;
                        prVar19 = re_acquire_state_context
                      ...
                      if ((prVar19 != (re_dfastate_t *)0x0) ||
                         ((reg_errcode_t)eps_via_nodes.alloc == _REG_NOERROR)) goto LAB_0010e8d6;
                    }
LAB_0010eb68:
                    idx = idx & 0xffffffff00000000U |
                          (ulong)(uint)(reg_errcode_t)eps_via_nodes.alloc;
                    goto joined_r0x0010eb72;
                  }
                }
LAB_0010e8d6:
                lVar20 = lVar20 + 1;
...
LAB_0010e242:
              if (mctx.state_log != (re_dfastate_t **)0x0) goto LAB_0010e24d;
              goto LAB_0010e260;
            }
...
LAB_0010e260:
          if (prVar19 == (re_dfastate_t *)0x0) {
            pprVar23 = mctx.state_log;
            if ((int)idx != 0) goto LAB_0010ec13;
            if ((mctx.state_log == (re_dfastate_t **)0x0) ||
            ...
            do {
              ...
              if ((int)idx != 0) {
                if (prVar19 == (re_dfastate_t *)0x0) goto LAB_0010e2ee;
                break;
              }
...
LAB_0010e2ee:
    ...
    if (rVar15 == _REG_NOERROR) {
      ...
      if ((bVar10 & 0x40) != 0) {
        ...
        idx = idx & 0xffffffff00000000U | (ulong)(uint)rVar15;
        if (rVar15 != _REG_NOERROR) goto LAB_0010f658;
        bVar10 = prVar24->field_0x68;
      }
      local_25b = false;
      goto LAB_0010e117;
...
LAB_0010ead0:
    start = start + iVar12;
    match_first = start;
    if ((start < lVar29) || (lVar37 < start)) goto LAB_0010df80;
    goto joined_r0x0010ddee;
  }
  if (uVar18 == 0xfffffffffffffffe) goto LAB_0010ec13;
  bVar10 = preg->field_0x38;
  mctx.match_last = uVar18;
  if ((bVar10 & 0x10) == 0) {
    if (nmatch < 2) {
      if (prVar2->nbackref == 0) {
        if (nmatch != 0) goto LAB_0010e3d2;
        goto free_return;
      }
LAB_0010ec33:
...
LAB_0010ec4b:
      ...
      if (0x1ffffffffffffffe < uVar18) goto LAB_0010ec13;
      num = uVar18 + 1;
...
LAB_0010edf1:
        ...
        if (local_2f0 == (re_dfastate_t **)0x0) goto LAB_0010ebb2;
        while( true ) {
          ...
          if ((*pprVar23 != (re_dfastate_t *)0x0) || (*local_2f0 != (re_dfastate_t *)0x0)) {
            ...
            rpl_free(local_2f0);
            if (rVar15 != _REG_NOERROR) goto LAB_0010edf1;
            goto LAB_0010eeb0;
          }
          do {
            num = uVar18;
    ...
    mctx.last_node = check_halt_state_context(&mctx,mctx.state_log[uVar18],uVar18);
    if (((prVar2->field_0xb0 & 1) != 0) || (prVar2->nbackref != 0)) goto LAB_0010ec4b;
  }
  else {
    if (prVar2->nbackref != 0) goto LAB_0010ec33;
LAB_0010eef0:
    pprVar23 = mctx.state_log;
...
LAB_0010f580:
      ...
      prev_match.u._0_8_ = 0;
      prev_match.u._8_8_ = 8;
      if (fs == (re_fail_stack_t *)0x0) goto LAB_0010ebbe;
LAB_0010f5b3:
      prev_match.u._8_8_ = 8;
      prev_match.u._0_8_ = 0;
...
LAB_0010f25d:
        ...
        if ((lVar29 == IVar22) && (IVar21 == mctx.last_node)) {
          if (fs != (re_fail_stack_t *)0x0) goto LAB_0010f1d8;
          rpl_free(eps_via_nodes.elems);
          if (prev_match.u._16_8_ != local_2f8) {
            rpl_free(prev_match.u._16_8_);
          }
...
LAB_0010f1d8:
          ...
          while ((prVar27->rm_so < 0 || (prVar27->rm_eo != -1))) {
            sVar33 = sVar33 + 1;
            prVar27 = prVar27 + 1;
            if (nmatch == sVar33) goto LAB_0010f206;
          }
...
LAB_0010f206:
            rpl_free(eps_via_nodes.elems);
            if (prev_match.u._16_8_ != local_2f8) goto LAB_0010f226;
            goto LAB_0010f255;
          }
...
LAB_0010f4d2:
                ...
                rpl_free(eps_via_nodes.elems);
                if (prev_match.u._16_8_ == local_2f8) goto LAB_0010f5b3;
                goto LAB_0010f580;
              }
              lVar36 = lVar36 + 1;
              lVar37 = IVar21;
...
LAB_0010e67d:
            if (-1 < IVar21) goto LAB_0010e550;
            if (IVar21 != -2) goto LAB_0010f721;
          }
LAB_0010f62f:
          rpl_free(eps_via_nodes.elems);
          goto LAB_0010f63c;
        ...
        if ((prVar34->field_0xa & 0x10) == 0) {
          if (prVar34->field_0x8 != 4) goto LAB_0010f113;
...
LAB_0010f83f:
            ...
            IVar22 = idx;
            if (_Var11 == false) goto LAB_0010f62f;
            IVar21 = *prVar9->edests[(long)local_310].elems;
            IVar26 = re_node_set_contains();
            if (IVar26 != 0) goto LAB_0010e67d;
