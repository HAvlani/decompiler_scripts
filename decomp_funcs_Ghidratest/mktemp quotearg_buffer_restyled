...
LAB_00103d5f:
  ...
  case custom_quoting_style:
    if (param_5 != custom_quoting_style) {
      local_70 = (char *)dcgettext(0,&DAT_00107a13,5);
      if (local_70 == "`") {
        local_70 = gettext_quote("`",param_5);
      }
      local_78 = (char *)dcgettext(0,&DAT_00107a11,5);
      if (local_78 == "\'") {
...
LAB_00103aa8:
    ...
    if (bVar21) {
      ...
      if (!bVar23) {
        ...
        switch(uVar15) {
        case 0:
          if (bVar1) goto switchD_00104310_caseD_0;
          bVar5 = false;
          uVar15 = 0;
          if ((param_6 & 1) != 0) goto code_r0x001042ab;
          goto LAB_0010409b;
        default:
switchD_001041c0_caseD_1:
          bVar22 = bVar1;
          if (sVar8 != 1) {
            ...
            do {
              ...
              if (sVar10 == 0xfffffffffffffffe) goto joined_r0x001049aa;
...
LAB_00103f64:
          ...
          bVar23 = bVar21;
          if ((!bVar20) || (!bVar22)) goto LAB_00103c88;
          goto LAB_00103f77;
        case 0x23:
        case 0x7e:
LAB_00103f5b:
          bVar22 = param_5 == shell_always_quoting_style;
          if (uVar13 == 0) goto LAB_00103f64;
          goto LAB_00103c85;
        case 0x25:
        case 0x2b:
        case 0x2c:
        ...
        case 0x79:
        case 0x7a:
          goto switchD_001041c0_caseD_25;
        case 0x27:
switchD_001041c0_caseD_27:
          bVar4 = bVar21;
          ...
          if (!bVar20) {
            ...
            bVar3 = false;
            bVar22 = false;
            goto joined_r0x00103cab;
          }
          goto force_outer_quoting_style;
        case 0x3f:
switchD_001041c0_caseD_3f:
          if (param_5 != shell_always_quoting_style) {
            if ((((param_5 == c_quoting_style) && ((param_6 & 4) != 0)) &&
              ...
              case '=':
              case '>':
                goto switchD_0010490e_caseD_21;
              default:
                break;
              }
            }
          ...
          goto force_outer_quoting_style;
        case 0x5c:
          if (param_5 != shell_always_quoting_style) goto switchD_00103bb0_caseD_5c;
          if (!bVar20) {
LAB_001041f8:
            uVar13 = uVar13 + 1;
            bVar21 = false;
        ...
        case 0x7b:
        case 0x7d:
switchD_001041c0_caseD_7b:
          bVar23 = param_4 != 1;
          if (param_4 == 0xffffffffffffffff) {
            bVar23 = param_3[1] != '\0';
          }
          bVar22 = param_5 == shell_always_quoting_style;
          if (!bVar23) goto LAB_00103f5b;
LAB_00103c85:
          bVar23 = false;
          goto LAB_00103c88;
        }
...
LAB_0010409b:
          ...
          bVar21 = false;
          bVar22 = false;
          if (!bVar20) goto LAB_00103ca8;
          goto LAB_00103bd0;
        }
LAB_001040d0:
        bVar21 = false;
        goto joined_r0x001040e1;
      }
      if (local_c8 != 0) {
        ...
        if (param_4 < uVar13 + local_c8) goto LAB_001042f0;
        uVar25 = 0x103b67;
        iVar7 = memcmp(__s1,local_98,local_c8);
        if (iVar7 != 0) goto LAB_001042f0;
        if (!bVar20) {
          uVar15 = (ulong)*__s1;
          switch(uVar15) {
          case 0:
            goto switchD_00103bb0_caseD_0;
          default:
            goto switchD_001041c0_caseD_1;
          case 7:
            goto switchD_00104310_caseD_7;
          case 8:
            goto switchD_00104310_caseD_8;
          case 9:
            goto switchD_00103bb0_caseD_9;
          case 10:
            goto switchD_00104310_caseD_a;
          case 0xb:
            goto switchD_00104310_caseD_b;
          case 0xc:
            goto switchD_00104310_caseD_c;
          case 0xd:
            goto switchD_00104310_caseD_d;
          case 0x20:
            goto LAB_00104339;
          case 0x21:
          case 0x22:
          ...
          case 0x60:
          case 0x7c:
            goto switchD_00103bb0_caseD_21;
          case 0x23:
          case 0x7e:
            goto LAB_00104321;
          case 0x25:
          ...
          case 0x7a:
            goto LAB_00103bc0;
          case 0x27:
            goto switchD_001041c0_caseD_27;
          case 0x3f:
            goto switchD_001041c0_caseD_3f;
          case 0x5c:
            goto switchD_00103bb0_caseD_5c;
          case 0x7b:
          case 0x7d:
            goto switchD_001041c0_caseD_7b;
          }
        }
        goto LAB_00103f8e;
      }
LAB_001042f0:
      ...
      switch(uVar15) {
      case 0:
switchD_00104310_caseD_0:
        if (!bVar20) {
          bVar5 = false;
switchD_00103bb0_caseD_0:
...
LAB_0010474b:
            ...
            uVar15 = uVar18;
            if (uVar18 < param_2) goto LAB_0010474b;
          }
          uVar19 = uVar18 + 1;
          bVar22 = bVar21;
          if (param_5 != shell_always_quoting_style) {
      ...
      default:
        ...
        goto switchD_001041c0_caseD_1;
      case 7:
switchD_00104310_caseD_7:
        bVar14 = 0x61;
        break;
      case 8:
switchD_00104310_caseD_8:
        bVar14 = 0x62;
        break;
      case 9:
        bVar23 = false;
switchD_00103bb0_caseD_9:
        uVar15 = 9;
        bVar14 = 0x74;
        goto c_escape;
      case 10:
switchD_00104310_caseD_a:
        bVar14 = 0x6e;
        goto LAB_001040d0;
      case 0xb:
switchD_00104310_caseD_b:
        bVar14 = 0x76;
        goto LAB_001040d0;
      case 0xc:
switchD_00104310_caseD_c:
        bVar14 = 0x66;
        break;
      case 0xd:
switchD_00104310_caseD_d:
        bVar14 = 0x72;
        goto LAB_001040d0;
      case 0x20:
        bVar5 = false;
...
LAB_00103bc0:
      ...
      case 0x5c:
        bVar23 = false;
switchD_00103bb0_caseD_5c:
        if (((bool)(bVar1 & bVar20)) && (local_c8 != 0)) goto LAB_001041f8;
        uVar15 = 0x5c;
        bVar14 = 0x5c;
        goto c_escape;
      case 0x7b:
...
LAB_00103fc8:
    ...
    uVar13 = local_90;
    bVar20 = bVar4;
    if (param_2 != 0 || local_90 == 0) goto LAB_00104a15;
LAB_001043a6:
    *param_1 = 0x27;
    param_2 = local_90;
    local_90 = uVar13;
...
LAB_00104788:
    ...
    uVar18 = uVar19;
    bVar3 = bVar2;
    if ((bool)(bVar1 ^ 1U | bVar24)) goto joined_r0x00103cab;
    goto LAB_00103bd0;
  }
  goto LAB_00103f8e;
joined_r0x001049aa:
...
LAB_001045a2:
    ...
    do {
      ...
      if (bVar22) {
        ...
        bVar24 = bVar22;
        if (uVar17 <= uVar13) goto LAB_00103c58;
      }
      else {
