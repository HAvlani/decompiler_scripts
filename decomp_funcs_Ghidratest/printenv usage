...

{
  ...
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"  -0, --null     end each output line with NUL, not newline\n",5);
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "printenv";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","printenv");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
