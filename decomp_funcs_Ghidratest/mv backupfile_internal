        ...
        if (pdVar14 != (dirent *)0x0) {
          while( true ) {
            ...
            *pcVar20 = cVar7 + '\x01';
            ...
            pcVar12 = pcVar16;
            bVar22 = bVar24;
            if (pdVar14 == (dirent *)0x0) goto LAB_0010bc90;
          }
          goto LAB_0010baa0;
        }
LAB_0010bc90:
        if (bVar24 != 2) goto LAB_0010bc9a;
LAB_0010bd88:
...
LAB_0010bdb0:
        ...
        iVar8 = sdir;
        pcVar12 = pcVar16;
        if ((long)sVar9 < 0xf) goto LAB_0010bca9;
        if (local_78 == 0) {
          piVar18 = __errno_location();
          if (iVar8 < 0) {
            uVar3 = *puVar19;
          ...
          if (-1 < local_78) goto LAB_0010be2b;
          lVar5 = 0xe;
          if (local_78 == -1) {
            lVar5 = local_78;
          }
...
LAB_0010be2b:
          lVar5 = local_78;
          if ((long)sVar9 <= local_78) goto LAB_0010bca4;
        }
        local_78 = lVar5;
