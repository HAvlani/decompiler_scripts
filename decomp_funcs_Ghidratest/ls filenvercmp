...
LAB_0010e320:
  ...
  if (*a == '.') {
    if (*b == '.') {
      ...
      if (bVar3) goto LAB_0010e320;
      if (bVar4 != false) {
        return 1;
      }
      if (a[1] == '.') {
        if (alen < 0) {
          if (a[2] == '\0') goto LAB_0010e3d3;
          goto LAB_0010e398;
        }
        if (alen != 2) goto LAB_0010e398;
LAB_0010e3d3:
        if (b[1] != '.') goto LAB_0010e3b9;
        uVar2 = 1;
      }
      else {
LAB_0010e398:
        if (b[1] != '.') goto LAB_0010e2b8;
        uVar2 = 0;
      }
      if (blen < 0) {
        if (b[2] == '\0') goto LAB_0010e3f0;
      }
      else if (blen == 2) {
LAB_0010e3f0:
        return uVar2 ^ 1;
      }
      if (uVar2 == 0) goto LAB_0010e2b8;
    }
LAB_0010e3b9:
    iVar1 = -1;
  }
