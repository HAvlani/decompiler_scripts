...

{
  ...
  *missing = false;
  ...
  if (uVar2 == 0) {
    ...
    iVar3 = blake2b_stream((FILE *)__stream,bin_result,digest_length >> 3);
    if (iVar3 == 0) {
    ...
    iVar3 = blake2b_stream(fp,bin_result,digest_length >> 3);
    if (iVar3 == 0) {
      iVar3 = rpl_fclose(fp);
      if (iVar3 == 0) {
        return true;
      ...
      iVar3 = *piVar5;
      iVar4 = rpl_fclose(fp);
      if (iVar4 == 0) goto LAB_00103e60;
      if (iVar3 != 0) goto LAB_00103e65;
    }
    iVar3 = *piVar5;
  }
LAB_00103e60:
