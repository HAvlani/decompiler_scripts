...

{
  ...
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Convert tabs in each FILE to spaces, writing to standard output.\n",
                             5);
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "expand";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","expand");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
