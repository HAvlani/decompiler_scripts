...
int backupfile_internal()
{
    ...
    struct_0 *|unsigned int|char|unsigned long long|char * v2;  // [bp-0xb0]
    unsigned long long v21;  // rax
    unsigned long long v22;  // rcx
    unsigned long|unsigned long long|unsigned int v23;  // rdx
    unsigned long long v24;  // rdx
    void *|struct_3 *|unsigned long long v25;  // rbx
    ...
    struct_5 *|struct_3 *|unsigned long long v39;  // r14
    void *v4;  // [bp-0xa0]
    struct_6 *|unsigned long long|unsigned int v40;  // r15
