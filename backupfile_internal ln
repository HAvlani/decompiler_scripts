...
extern struct_4 simple_backup_suffix;
...
int backupfile_internal()
{
    ...
    struct_3 *|unsigned int|char|unsigned long long|char * v2;  // [bp-0xb0]
    unsigned long long v20;  // rax
    unsigned long long v22;  // rcx
    unsigned long|unsigned long long|unsigned int v23;  // rdx
    unsigned long long v24;  // rdx
    void *|unsigned long long|struct_1 * v25;  // rbx
                    ...
                    while (true)
                    {
                        ...
                        while (true)
                        {
                            ...
                            if (v23 + v22 + r10<8> + 2 > v3)
                            {
                                ...
                                v7 = v22;
                                v2 = r9<8>;
                                v20 = realloc(v37, ((long long)(tmp_18 == 0)) | tmp_18);
                                v23 = v12;
                                v33 = v20;
                                if (v20 == 0)
                                {
                            ...
                            v33 = v37;
                            if (v23 + v22 + r10<8> + 2 <= v3 || v20 != 0)
                            {
                                v2 = r8<8>;
                                *(r8<8> + v27) = 32302;
                                *(r8<8> + v27 + 2) = 48;
                                v7 = r9<8>;
                                v18 = memcpy(r8<8> + v27 + v23 + 2, v25, v22 + 2);
