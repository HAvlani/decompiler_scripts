...
int fts_safe_changedir()
{
    ...
    char v1;  // [bp-0xd8]
    struct_0 *v10;  // rdi
    unsigned int|unsigned long v11;  // r13
    struct_0 *v12;  // r14
    unsigned int|unsigned long|unsigned long long v13;  // r15
    unsigned long v2;  // [bp-0xd0]
    unsigned int|unsigned long|unsigned long long v4;  // rax
    struct_1 *|unsigned long long v5;  // rcx
    unsigned long long v6;  // rdx
    struct_1 *v7;  // rbx
    unsigned int|unsigned long|unsigned long long v8;  // rbp
    ...
    if (v5 == 0 || v5->field_0 != 46 || v5->field_2 != 0 || v5->field_1 != 46)
    {
        if (((int)(v10->field_48 & 4)) == 0)
        {
            if (((int)v6) >= 0)
