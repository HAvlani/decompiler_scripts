...

{
  ...
  if (dest_nodes->nelem == 0) {
    ...
    if (err != _REG_NOERROR) goto LAB_00110cd9;
...
LAB_00110db0:
      ...
      if (0 < dest_nodes->nelem) {
        do {
          ...
          if (rVar7 != _REG_NOERROR) goto LAB_00110db0;
          lVar21 = lVar21 + 1;
              ...
              if (0 < lVar14) {
                ...
                do {
                  while( true ) {
                    ...
                    plVar15 = plVar15 + 1;
                    if (plVar19 + lVar14 == plVar15) goto LAB_00111353;
                  }
...
LAB_00111365:
    ...
    err = local_7c;
    if (local_7c != _REG_NOERROR) goto LAB_00110cd9;
            ...
            do {
              if (((lVar14 == prVar23->node) &&
                ...
                if (_err == (re_dfastate_t **)0x0) {
                  ...
                  if (err == _REG_NOERROR) goto LAB_00110ff5;
                }
                else {
LAB_00110ff5:
                  local_68 = lVar14;
                ...
                if (_err == (re_dfastate_t **)0x0) goto LAB_00110cd9;
                goto LAB_001111cc;
              }
LAB_001110d0:
              lVar20 = lVar20 + 1;
