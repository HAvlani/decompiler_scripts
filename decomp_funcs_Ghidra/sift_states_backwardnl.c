    ...
    if (rVar7 == _REG_NOERROR) {
      ...
      do {
        ...
        if (sctx->sifted_states[str_idx] == (re_dfastate_t *)0x0) {
          local_84 = local_84 + 1;
          if (mctx->max_mb_elem_len < local_84) goto LAB_0010d765;
        }
        else {
          local_84 = 0;
...
LAB_0010d580:
              ...
              if (((_Var6 != false) && (sctx->sifted_states[str_idx] != (re_dfastate_t *)0x0)) &&
                 (IVar9 = re_node_set_contains(), IVar9 != 0)) goto LAB_0010d5c1;
            }
            else {
...
LAB_0010d6de:
                ...
                if (sctx->sifted_states[iVar8 + idx] == (re_dfastate_t *)0x0) goto LAB_0010d6de;
