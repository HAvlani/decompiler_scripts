...
LAB_00105900:
    ...
    if (0xfffffffe < tmp) goto LAB_00105900;
    endpwent();
    if (pcVar9 != (char *)0x0) {
      cVar5 = *pcVar9;
      username = (char **)0x0;
...
LAB_001056ad:
      ...
      if (pgVar7 == (group *)0x0) goto LAB_001057c0;
      uVar1 = pgVar7->gr_gid;
      endgrent();
      separator = xstrdup(pcVar9);
      uVar12 = (ulong)uVar1;
