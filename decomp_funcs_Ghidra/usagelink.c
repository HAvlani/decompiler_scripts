...

{
  ...
  uVar4 = dcgettext(0,"Usage: %s FILE1 FILE2\n  or:  %s OPTION\n",5);
  ...
  if (puVar10 == (undefined1 *)0x0) {
    ...
    if (pcVar5 != (char *)0x0) {
      ...
      if (iVar3 != 0) {
        puVar10 = &DAT_00106004;
        goto LAB_00102b92;
      }
    }
    uVar4 = dcgettext(0,"Full documentation <%s%s>\n",5);
    puVar10 = &DAT_00106004;
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/",&DAT_00106004);
    pcVar5 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
