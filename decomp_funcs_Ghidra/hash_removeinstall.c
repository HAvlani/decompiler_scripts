...

{
  ...
  if ((pvVar3 == (void *)0x0) ||
     (table->n_entries = table->n_entries - 1, bucket->data != (void *)0x0)) goto LAB_0010deb3;
  ...
  if ((long)uVar4 < 0) {
    ...
    pHVar6 = table->tuning;
    fVar7 = fVar7 + fVar7;
    if ((long)uVar5 < 0) goto LAB_0010dfea;
LAB_0010df04:
    fVar8 = (float)uVar5;
  }
  else {
    ...
    fVar7 = (float)uVar4;
    uVar5 = table->n_buckets;
    if (-1 < (long)uVar5) goto LAB_0010df04;
LAB_0010dfea:
  ...
  if (fVar7 < fVar8 * pHVar6->shrink_threshold) {
    ...
    if (fVar8 < pHVar6->shrink_threshold * fVar7) {
      ...
      if (_DAT_00118f0c <= fVar7) {
        uVar4 = (long)(fVar7 - _DAT_00118f0c) ^ 0x8000000000000000;
      }
      else {
        uVar4 = (ulong)fVar7;
      }
