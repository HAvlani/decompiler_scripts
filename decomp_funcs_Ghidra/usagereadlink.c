...

{
  ...
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Print value of a symbolic link or canonical file name\n\n",5);
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "readlink";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","readlink");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
