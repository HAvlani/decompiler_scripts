            ...
            if ((cVar2 != '\x01') || ((uVar12 & 0x3ff) != 0)) {
              ...
              if ((uVar12 & 0x3ff) != 0) {
                if (dest == prVar11->entrance_nodes) {
                  ...
                  if (dest_00 == (re_node_set *)0x0) goto LAB_00109bb9;
                  prVar11->entrance_nodes = dest_00;
                  rVar9 = re_node_set_init_copy(dest_00,nodes);
                  if (rVar9 != _REG_NOERROR) goto LAB_00109bb9;
                ...
                if ((uVar12 & 1) == 0) {
                  if ((uVar12 & 2) != 0) {
                    uVar6 = context & 1;
                    goto joined_r0x00109bf6;
                  }
LAB_00109b3f:
                  if ((((uVar12 & 0x10) == 0) || ((context & 2) != 0)) &&
                     (((uVar12 & 0x40) == 0 || ((context & 4) != 0)))) goto LAB_00109b8d;
                }
                else if ((context & 1) != 0) {
                  uVar6 = uVar12 & 2;
joined_r0x00109bf6:
                  if (uVar6 == 0) goto LAB_00109b3f;
                }
                if ((-1 < lVar14 - lVar15) &&
