...
LAB_00105ac3:
            ...
            if (p_Var14->fts_info == 2) goto LAB_00105af3;
          }
...
LAB_00105d03:
    param_1->fts_cur = pFVar12;
    if (uVar6 == 0xb) goto LAB_00105d80;
  }
  if (uVar6 != 1) {
    return pFVar12;
  }
