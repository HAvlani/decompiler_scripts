...

{
  ...
  uVar4 = dcgettext(0,"Usage: %s [OPTION] DURATION COMMAND [ARG]...\n  or:  %s [OPTION]\n",5);
  __printf_chk(1,uVar4,pcVar5,pcVar5);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Start COMMAND, and kill it if still running after DURATION.\n",5);
  ...
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"  -v, --verbose  diagnose to stderr any signal sent upon timeout\n",
                             5);
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "timeout";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","timeout");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
