...
LAB_0010f6ce:
    ...
    if (cVar27 != '%') {
      ...
      if (maxsize - sVar31 <= uVar22) goto LAB_0010f6c0;
    ...
    do {
      while( true ) {
        do {
          ...
          pcVar23 = pcVar23 + 1;
          bVar10 = *pcVar19 - 0x23;
          if (0x3c < bVar10) goto LAB_0010f794;
...
LAB_0010f794:
    ...
    if ((cVar24 == 'E') || (cVar24 == 'O')) {
      ...
      switch(cVar24) {
      case '\0':
        goto switchD_0010f7c4_caseD_0;
      default:
        goto switchD_0010f7c4_caseD_1;
      case '%':
        goto switchD_0010f7c4_caseD_25;
      case ':':
        goto LAB_0010fcbd;
      case 'A':
        if (uVar4 == 0) goto LAB_0010fdcf;
        break;
      case 'B':
        if (uVar4 != 0x45) goto LAB_0010fdb9;
        break;
      case 'C':
        if (uVar4 != 0x45) goto LAB_0011064f;
        goto LAB_0010faa1;
      case 'D':
        goto switchD_0010f800_caseD_44;
      case 'F':
        goto switchD_0010f800_caseD_46;
      case 'G':
      case 'V':
      case 'g':
        if (uVar4 != 0x45) goto LAB_0010f909;
        break;
      case 'H':
        if (uVar4 != 0x45) goto LAB_001109f4;
        break;
      case 'I':
        if (uVar4 != 0x45) goto LAB_001109d9;
        break;
      case 'M':
        if (uVar4 != 0x45) goto LAB_00110833;
        break;
      case 'N':
        goto switchD_0010f800_caseD_4e;
      case 'P':
        goto switchD_0010f800_caseD_50;
      case 'R':
        goto switchD_0010f800_caseD_52;
      case 'S':
        if (uVar4 != 0x45) goto LAB_0011098e;
        break;
      case 'T':
        goto switchD_0010f800_caseD_54;
      case 'U':
        if (uVar4 != 0x45) goto LAB_00110933;
        break;
      case 'W':
        if (uVar4 != 0x45) goto LAB_001108c7;
        break;
      case 'X':
        if (uVar4 != 0x4f) goto LAB_001108b6;
        break;
      case 'Y':
        if (uVar4 == 0x45) goto LAB_0010faa1;
        if (uVar4 != 0x4f) goto LAB_00110852;
        break;
      case 'Z':
        goto switchD_0010f800_caseD_5a;
      case 'a':
        if (uVar4 == 0) goto LAB_001103af;
        break;
      case 'b':
      case 'h':
        if (cVar14 != '\0') {
        ...
        if (uVar4 != 0x45) goto switchD_0010f800_caseD_72;
        break;
      case 'c':
        if (uVar4 != 0x4f) goto LAB_001104b1;
        break;
      case 'd':
        if (uVar4 != 0x45) goto LAB_00110392;
        break;
      case 'e':
        if (uVar4 != 0x45) goto LAB_0011037e;
        break;
      case 'j':
        if (uVar4 != 0x45) goto LAB_00110349;
        break;
      case 'k':
        if (uVar4 != 0x45) goto LAB_00110335;
        break;
      case 'l':
        if (uVar4 != 0x45) goto LAB_0011030e;
        break;
      case 'm':
        if (uVar4 != 0x45) goto LAB_001102d9;
        break;
      case 'n':
        goto switchD_0010f800_caseD_6e;
      case 'p':
        goto switchD_0010f800_caseD_70;
      case 'q':
        goto switchD_0010f800_caseD_71;
      case 'r':
        goto switchD_0010f800_caseD_72;
      case 's':
        goto switchD_0010f800_caseD_73;
      case 't':
        goto switchD_0010f800_caseD_74;
      case 'u':
        goto switchD_0010f800_caseD_75;
      case 'w':
        if (uVar4 != 0x45) goto LAB_0010fe93;
        break;
      case 'x':
        if (uVar4 != 0x4f) goto LAB_0010fe82;
        break;
      case 'y':
        if (uVar4 != 0x45) goto LAB_0010fdfc;
        goto LAB_0010faa1;
      case 'z':
        goto switchD_0010f800_caseD_7a;
      }
LAB_0010fbd0:
    ...
    switch(uVar4 & 0xff) {
    case 0:
switchD_0010f7c4_caseD_0:
      pcVar23 = pcVar23 + -1;
      goto LAB_0010fbd0;
    default:
      goto switchD_0010f7c4_caseD_1;
    case 0x25:
switchD_0010f7c4_caseD_25:
      pcVar19 = pcVar23 + -1;
      pcVar30 = (char *)(maxsize - sVar31);
      if (pcVar19 == format) {
        if ((yr_spec_00 == 0x2d) || (iVar32 < 0)) {
          if ((char *)0x1 < pcVar30) {
            pcVar19 = (char *)0x1;
            if ((undefined8 *)s != (undefined8 *)0x0) goto LAB_0010fc98;
            goto LAB_0010fca4;
          }
        }
        else {
...
LAB_00110e1e:
      ...
      else if (yr_spec_00 == 0x2b) goto LAB_00110e1e;
      bVar2 = false;
      cVar24 = 'C';
      iVar25 = 2;
      goto LAB_0010fa86;
...
LAB_0010f909:
      ...
      if (cVar24 != 'G') {
        if (cVar24 == 'g') {
          ...
          if (yr_spec_00 != 0) goto LAB_0010fa65;
          goto joined_r0x0010fe55;
        }
        iVar25 = 2;
        uVar16 = iVar15 / 7 + 1;
        break;
      ...
      if (yr_spec_00 != 0) goto LAB_00110de5;
      if (yr_spec == 0x2b) {
        iVar25 = 4;
        uVar12 = 9999;
        goto LAB_00110dfc;
...
LAB_001106f8:
      ...
      if (1 < iVar25) {
        ...
        if (0x19999998 < (uVar16 >> 1 | (uint)((uVar16 & 1) != 0) << 0x1f)) goto LAB_00110734;
        goto LAB_001106f8;
      }
      if (iVar25 != 1) goto LAB_00110774;
LAB_00110734:
      lVar7 = (long)iVar25;
      do {
...
LAB_00110774:
      ...
      if (pcVar30 <= pcVar19) goto LAB_0010f6c0;
      if ((undefined8 *)s != (undefined8 *)0x0) {
      ...
      if ((yr_spec_00 == 0x2d) || (iVar32 - iVar25 < 0)) {
        if (maxsize == sVar31) goto LAB_0010f6c0;
      }
      else {
        uVar34 = (ulong)(iVar32 - iVar25);
        if (maxsize - sVar31 <= uVar34) goto LAB_0010f6c0;
        if ((undefined8 *)s == (undefined8 *)0x0) {
    ...
    case 0x50:
      uVar4 = 0;
switchD_0010f800_caseD_50:
      cVar21 = '\x01';
      goto LAB_0011023a;
    case 0x52:
switchD_0010f800_caseD_52:
      pcVar19 = "%H:%M";
      pcVar30 = (char *)(maxsize - sVar31);
      iVar33 = -1;
      goto subformat_width;
...
LAB_00110570:
      if (pcVar30 <= pcVar29) goto LAB_0010f6c0;
      if ((undefined8 *)s != (undefined8 *)0x0) {
        puVar35 = (undefined8 *)s;
        if (pcVar9 < pcVar17) {
...
LAB_00110dfc:
        bVar2 = true;
        yr_spec_00 = 0x2b;
        if (uVar16 <= uVar12) goto LAB_0010fe68;
        goto LAB_0010fa86;
      }
      if (yr_spec == 0x2b) {
        iVar25 = 4;
...
LAB_001102d9:
      ...
      goto do_number_body;
    case 0x6e:
switchD_0010f800_caseD_6e:
      if ((yr_spec_00 == 0x2d) || (iVar32 < 0)) {
        if (1 < maxsize - sVar31) {
          uVar34 = 1;
          if ((undefined8 *)s != (undefined8 *)0x0) goto LAB_001102c7;
          goto LAB_0010ffa2;
        }
      }
      else {
...
LAB_0011023a:
    ...
    case 0x71:
      uVar4 = 0;
switchD_0010f800_caseD_71:
      cVar24 = 'q';
      if (uVar4 == 0x4f) goto LAB_0010faa1;
      bVar2 = false;
      uVar12 = 0;
      negative_year = false;
      iVar25 = 1;
    ...
    case 0x72:
      uVar4 = 0;
switchD_0010f800_caseD_72:
      cVar21 = '\0';
      goto underlying_strftime;
    case 0x73:
switchD_0010f800_caseD_73:
      ...
      *piVar6 = 0x4b;
      goto LAB_0010f6cb;
    case 0x74:
switchD_0010f800_caseD_74:
      if ((yr_spec_00 == 0x2d) || (iVar32 < 0)) {
        if (1 < maxsize - sVar31) {
          uVar34 = 1;
          if ((undefined8 *)s != (undefined8 *)0x0) goto LAB_0010ff9a;
          goto LAB_0010ffa2;
        }
      }
      else {
...
joined_r0x0010fe55:
        yr_spec_00 = yr_spec;
        if (yr_spec != 0x2b) goto LAB_0010fa74;
LAB_0010fe5b:
        bVar3 = true;
        negative_year = false;
        iVar25 = 2;
...
LAB_0010fa65:
        if (yr_spec_00 == 0x2b) goto LAB_0010fe5b;
LAB_0010fa74:
        bVar3 = true;
        bVar2 = false;
        negative_year = false;
...
tz_hh_mm:
          ...
          if (local_4b0 != 3) goto LAB_0010fbd0;
...
LAB_00110bb5:
          ...
          sVar31 = sVar31 + 1;
          iVar32 = iVar25;
          if ((uint)local_4b0 == 0x2d) goto LAB_00110bfe;
LAB_00110bc9:
          pcVar29 = (char *)(long)iVar33;
          pcVar30 = (char *)0x0;
          if (-1 < iVar32) goto LAB_001100b2;
          goto LAB_001100bf;
        }
      }
LAB_0010f6c0:
...
LAB_0010fac0:
    ...
    *pcVar19 = cVar24;
    pcVar19[1] = '\0';
    lVar7 = FUN_00103820(buf,0x400,ufmt);
    if (lVar7 != 0) {
      ...
      if ((char *)(maxsize - sVar31) <= pcVar29) goto LAB_0010f6c0;
      if ((undefined8 *)s != (undefined8 *)0x0) {
        puVar35 = (undefined8 *)s;
