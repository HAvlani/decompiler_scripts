...

{
  ...
  *(undefined (*) [16])(puVar38 + -0x402) = (undefined  [16])0x0;
  if (lVar46 < 1) {
LAB_00115421:
    *(undefined8 *)(puVar38 + -0x42c) = 0x115430;
...
LAB_00114ea0:
          ...
          if (lVar46 != lVar39) goto LAB_00114b61;
          ...
          *puVar44 = 1;
          puVar44[1] = 1;
          *(undefined8 *)(puVar38 + -0x42c) = 0x11508e;
...
LAB_001150c8:
              ...
              do {
                ...
                *(undefined8 *)(puVar38 + -0x42c) = 0x1150ea;
                rpl_free(pvVar25);
                lVar39 = lVar49;
              } while (lVar49 < lVar46);
            }
          ...
          *puVar32 = uVar7;
          ...
          if ((uVar23 & 0x20) != 0) {
            ...
            *(undefined (*) [16])(puVar38 + -0x402) = (undefined  [16])0x0;
            if ((uVar29 & 0x400) == 0) goto LAB_00114b61;
            *(undefined8 *)(puVar38 + -0x406) = 0x400;
          }
          if ((uVar23 & 0x80) == 0) {
            if ((uVar23 & 4) != 0) {
              if ((bVar3 == 1) && ((*(byte *)((long)ppuVar47 + 10) & 0x40) == 0)) goto LAB_0011509e;
...
LAB_00114b61:
    ...
    if (lVar46 < 1) {
      if (lVar46 == 0) goto LAB_00115421;
    }
    else {
      *(undefined8 *)(puVar38 + -0x414) = 0;
      *(long *)(puVar38 + -0x416) = lVar46 + 1;
      *(undefined8 *)(puVar38 + -0x42c) = 0x114b9a;
          ...
          if (0 < *plVar48) {
            do {
              ...
              if (lVar43 != -1) {
                ...
                *(undefined8 *)(puVar38 + -0x42c) = 0x114c2a;
                rVar24 = re_node_set_merge(prVar45,prVar6 + lVar43);
                puVar38[-0x417] = rVar24;
                if (rVar24 != _REG_NOERROR) goto LAB_00115310;
              }
              lVar49 = lVar49 + 1;
            } while (*plVar48 != lVar49 && lVar49 <= *plVar48);
          }
          *(undefined8 *)(puVar38 + -0x42c) = 0x114c58;
...
LAB_00115310:
          ...
          if ((char)prVar26->field_0x68 < '\0') {
            ...
            *(undefined8 *)(puVar38 + -0x42c) = 0x115369;
            ...
            *(re_dfastate_t **)(puVar38 + lVar39 * 2 + -0x206) = prVar33;
            if (prVar33 == (re_dfastate_t *)0x0) {
              if (puVar38[-0x417] != 0) goto LAB_00115310;
LAB_00115384:
            ...
            else if (prVar26 != prVar33) goto LAB_00115384;
            *(undefined8 *)(puVar38 + -0x42c) = 0x1153b2;
            prVar26 = re_acquire_state_context
                                (*(reg_errcode_t **)(puVar38 + -0x42a),dfa_00,prVar45,2);
            *(re_dfastate_t **)(puVar38 + lVar39 * 2 + -6) = prVar26;
            if ((prVar26 == (re_dfastate_t *)0x0) && (puVar38[-0x417] != 0)) goto LAB_00115310;
          }
          else {
        ...
        *(undefined4 **)(puVar38 + -0x42a) = puVar38 + 0x7fa;
        ...
        if (*(char *)(puVar38 + -0x428) == '\0') {
          *(undefined8 *)(puVar38 + -0x42c) = 0x114cec;
...
LAB_00114d52:
            ...
            *(undefined8 *)(puVar38 + -0x42c) = 0x114d85;
            rpl_free(pvVar25);
            ppvVar1 = ppvVar37 + lVar46 * 3;
            do {
              pvVar25 = *ppvVar37;
              ppvVar37 = ppvVar37 + 3;
              *(undefined8 *)(puVar38 + -0x42c) = 0x114d9c;
              rpl_free(pvVar25);
          ...
          *(undefined8 *)(puVar38 + -0x42c) = 0x115497;
...
out_free:
      ppvVar37 = (void **)(puVar38 + 0x1fe);
      *(undefined8 *)(puVar38 + -0x42c) = 0x115325;
      rpl_free(pvVar25);
      ppvVar1 = ppvVar37 + lVar46 * 3;
      do {
        pvVar25 = *ppvVar37;
        ppvVar37 = ppvVar37 + 3;
        *(undefined8 *)(puVar38 + -0x42c) = 0x11533c;
        rpl_free(pvVar25);
      } while (ppvVar1 != ppvVar37);
    }
LAB_001150ef:
...
LAB_001150f1:
  ...
  *(undefined8 *)(puVar38 + -0x42c) = 0x11552e;
  __stack_chk_fail();
}
