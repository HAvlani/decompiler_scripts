...

{
  ...
  if (((1 < inlen) && (_Var4 = false, -1 < b64[(byte)*in])) &&
    ...
    if (inlen == 2) goto LAB_00104c14;
    if (in[2] == 0x3d) {
      if ((inlen != 4) || (in[3] != '=')) goto LAB_00104c14;
    }
    else {
      cVar2 = b64[(byte)in[2]];
      if (cVar2 < '\0') {
LAB_00104c14:
      ...
      if (inlen == 3) goto LAB_00104c14;
      if (in[3] == 0x3d) {
        if (inlen != 4) goto LAB_00104c14;
      }
      else {
        if (b64[(byte)in[3]] < '\0') goto LAB_00104c14;
        if (*outleft != 0) {
