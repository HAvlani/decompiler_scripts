...
LAB_00106b73:
            ...
            if (p_Var14->fts_info == 2) goto LAB_00106ba3;
          }
...
LAB_00106db3:
    param_1->fts_cur = pFVar12;
    if (uVar6 == 0xb) goto LAB_00106e30;
  }
  if (uVar6 != 1) {
    return pFVar12;
  }
