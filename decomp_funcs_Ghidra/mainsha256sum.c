...

{
  ...
  char *line;
  _Bool missing;
  uchar bin_buffer_unaligned [36];
  uchar bin_buffer_unaligned_1 [36];
  char *local_40;
  ...
  while( true ) {
    ...
    if (iVar7 < 0x62) {
      if (iVar7 == -0x83) {
        version_etc((FILE *)stdout,"sha256sum","GNU coreutils",Version,"Ulrich Drepper",
...
LAB_00102a40:
  ...
  do {
    local_e8 = (char **)((int *)argv + (long)(int)s * 2);
    if (optind == (int)s) {
      *local_e8 = "-";
      local_e8 = local_e8 + 1;
    }
    local_110 = (char **)((int *)argv + (long)optind * 2);
    if (local_110 < local_e8) {
      ...
      do {
        ...
        if (local_111 == '\0') {
          ...
          _Var5 = digest_file(local_108,(uchar *)argv,(_Bool *)__n,(uintmax_t *)poVar16,piVar22);
          uVar4 = digest_delim;
          if (_Var5 == false) {
            local_bf = 0;
          }
            ...
            _Var5 = false;
            if ((digest_delim == '\n') &&
               (((pcVar20 = strchr(local_108,0x5c), pcVar20 != (char *)0x0 ||
                 (pcVar20 = strchr(local_108,10), pcVar20 != (char *)0x0)) ||
                (pcVar20 = strchr(local_108,0xd), pcVar20 != (char *)0x0)))) {
            ...
            if (bVar2) {
              ...
              fwrite_unlocked(&DAT_0010b164,1,2,stdout);
              print_filename(local_108,_Var5);
              poVar16 = (option *)stdout;
              fwrite_unlocked(&DAT_0010b167,1,4,stdout);
...
LAB_0010327d:
                ...
                do {
                  ...
                  __printf_chk(1,&DAT_0010b16c,*puVar12);
...
LAB_00103303:
          ...
          iVar8 = strcmp(local_108,"-");
          if (iVar8 == 0) {
            have_read_stdin = true;
            local_108 = (char *)dcgettext(0,"standard input",5);
            __stream = stdin;
LAB_00102b16:
            local_be = '\0';
            piVar19 = (int *)0x1;
...
LAB_00103216:
                    ...
                    if (cVar27 == '=') {
                      ...
                      do {
                        do {
                          local_f0 = piVar22;
                          piVar22 = (int *)((long)local_f0 + 1);
                        } while (*(byte *)local_f0 == 0x20);
                      } while (*(byte *)local_f0 == 9);
                      cVar27 = hex_digits((uchar *)local_f0);
                      goto LAB_001034db;
                    }
                  }
                }
...
LAB_00102c47:
              do {
                local_100 = (FILE *)((long)&local_100->_flags + 1);
                if (warn != false) {
                  bin_result = (FILE *)quotearg_n_style_colon(0,3,local_108);
...
LAB_00102c5a:
                ...
                while( true ) {
                  ...
                  __stream = (FILE *)quotearg_n_style_colon(0,3,local_108);
...
LAB_001034db:
                  ...
                  _Var6 = digest_file(s,(uchar *)bin_result,&missing_1,(uintmax_t *)length,local_f0)
                  ;
                  if (_Var6 == false) {
...
LAB_00102e38:
                    ...
                    if (uVar10 == 0) {
                      ...
                      do {
                        ...
                        if (((*pp_Var11)[*(byte *)((long)local_f0 + uVar17 * 2)] !=
                             (int)"0123456789abcdef9.1"[bVar15 >> 4]) ||
                           (length = (FILE *)(ulong)*(byte *)((long)local_f0 + uVar17 * 2 + 1),
                           (*pp_Var11)[(long)length] != (int)"0123456789abcdef9.1"[bVar15 & 0xf])) {
                          local_d8 = (FILE *)((long)&local_d8->_flags + 1);
                    ...
                    local_be = status_only;
                    if ((status_only == false) && (local_be = quiet, quiet == false)) {
                      local_be = _Var6;
                      if (_Var5 == false) {
...
LAB_00102e95:
              if ((int)s < 0) {
                if (cVar3 == '\0') {
                  poVar16 = (option *)quotearg_n_style_colon(0,3,local_108);
...
LAB_00103165:
                  ...
                  if (local_100 != (FILE *)0x0) {
                    ...
                    uVar9 = dcngettext(0,"WARNING: %lu line is improperly formatted",
                                       "WARNING: %lu lines are improperly formatted",local_100);
                    poVar16 = (option *)local_100;
                    error(0,0,uVar9);
                    argv = (char **)local_100;
                  }
                  if (local_e0 != (FILE *)0x0) {
                    ...
                    uVar9 = dcngettext(0,"WARNING: %lu listed file could not be read",
                                       "WARNING: %lu listed files could not be read",local_e0);
                  ...
                  if (local_d8 != (FILE *)0x0) {
                    ...
                    uVar9 = dcngettext(0,"WARNING: %lu computed checksum did NOT match",
                                       "WARNING: %lu computed checksums did NOT match",local_d8);
                    poVar16 = (option *)local_d8;
                    error(0,0,uVar9);
                    argv = (char **)local_d8;
                  }
...
LAB_00102ef1:
                  if (((ulong)local_e0 | (ulong)local_d8) != 0) goto LAB_00103165;
                  bVar15 = strict ^ 1U | local_100 == (FILE *)0x0;
                }
                else {
LAB_00103328:
                  if (local_be != '\0') goto LAB_00102ef1;
                  bVar15 = 0;
                }
                bVar15 = bVar15 & 1;
                goto LAB_00102f1c;
...
LAB_00103195:
            ...
            __stream = (FILE *)fopen_safer(local_108,"r");
