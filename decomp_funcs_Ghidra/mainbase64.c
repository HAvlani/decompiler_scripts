...
LAB_00102e89:
        ...
        if ((char)pcVar7 == '\0') {
          ...
          local_90 = (char *)xmalloc(0xa000);
          local_80 = pFVar14;
          goto LAB_00102b67;
        }
        local_80 = stdout;
        pcVar7 = (char *)xmalloc(0x1000);
        local_70 = (FILE *)xmalloc(0xc00);
        local_68 = (_IO_FILE *)&ctx;
        base64_decode_ctx_init((base64_decode_context *)local_68);
        local_78 = &w;
        pFVar12 = pFVar9;
        pFVar14 = local_80;
        pFVar1 = local_70;
...
LAB_00102998:
        ...
        } while (((long)__n < 0x1000) && ((uVar6 & 0x10) == 0));
LAB_00102ad7:
        local_80 = __n;
        local_88 = pFVar9;
...
LAB_00102b18:
        ...
        w = 0xc00;
        _Var3 = base64_decode_ctx((base64_decode_context *)unaff_R15,pcVar7,(idx_t)pFVar12,
...
LAB_00102bb5:
        ...
        if ((uVar6 & 0x20) != 0) {
          ...
          do {
            pcVar7 = local_90;
            local_88 = (FILE *)(((long)((long)&__ptr->_flags + 2) / 3) * 4);
            base64_encode((char *)in,(idx_t)__ptr,local_90,(idx_t)local_88);
            pFVar1 = local_80;
            pFVar14 = local_88;
...
LAB_00102853:
    ...
    if (iVar4 != 100) {
      if (iVar4 < 0x65) {
        if (iVar4 == -0x83) {
          version_etc((FILE *)stdout,"base64","GNU coreutils",Version,"Simon Josefsson",0);
                    /* WARNING: Subroutine does not return */
          exit(0);
        }
        if (iVar4 == -0x82) {
...
LAB_00102ba2:
  if (((long)__n < 1) || (local_80 == (FILE *)0x0)) goto LAB_00102bb5;
  pcVar7 = pFVar12->_IO_write_ptr;
