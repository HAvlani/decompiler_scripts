...

{
  ...
  if (dest_nodes->nelem == 0) {
    ...
    if (err != _REG_NOERROR) goto LAB_0010f919;
...
LAB_0010f9f0:
      ...
      if (0 < dest_nodes->nelem) {
        do {
          ...
          if (rVar7 != _REG_NOERROR) goto LAB_0010f9f0;
          lVar21 = lVar21 + 1;
              ...
              if (0 < lVar14) {
                ...
                do {
                  while( true ) {
                    ...
                    plVar15 = plVar15 + 1;
                    if (plVar19 + lVar14 == plVar15) goto LAB_0010ff93;
                  }
...
LAB_0010ffa5:
    ...
    err = local_7c;
    if (local_7c != _REG_NOERROR) goto LAB_0010f919;
            ...
            do {
              if (((lVar14 == prVar23->node) &&
                ...
                if (_err == (re_dfastate_t **)0x0) {
                  ...
                  if (err == _REG_NOERROR) goto LAB_0010fc35;
                }
                else {
LAB_0010fc35:
                  local_68 = lVar14;
                ...
                if (_err == (re_dfastate_t **)0x0) goto LAB_0010f919;
                goto LAB_0010fe0c;
              }
LAB_0010fd10:
              lVar20 = lVar20 + 1;
