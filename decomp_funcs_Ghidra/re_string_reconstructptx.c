...

{
  ...
  if (idx < pstr->raw_mbs_idx) {
    ...
    lVar16 = idx;
    if (pstr->mbs_allocated != '\0') goto LAB_0010ed0a;
    pstr->mbs = pstr->raw_mbs;
    if (idx == 0) goto LAB_0010edf0;
LAB_0010ed13:
...
LAB_0010f05d:
        ...
        if (((lVar16 != lVar23) || (lVar3 <= lVar16)) || (pIVar5[lVar23] != lVar16)) {
          ...
          if (lVar23 < lVar3) {
            do {
              if (pstr->wcs[lVar23] != 0xffffffff) goto LAB_0010f154;
              lVar23 = lVar23 + 1;
            } while (lVar23 != lVar3);
LAB_0010f2f8:
            pstr->valid_len = 0;
            ...
            if (lVar23 == lVar3) goto LAB_0010f2f8;
LAB_0010f154:
...
LAB_0010ed89:
    ...
    if (1 < iVar10) {
      if (pstr->is_utf8 != '\0') {
        ...
        if (pbVar15 <= pbVar24) {
LAB_0010f1ed:
          if ((*pbVar24 & 0xc0) == 0x80) goto LAB_0010f1e0;
          puVar20 = pstr->trans;
...
LAB_0010ef11:
      ...
      if (lVar11 < idx) {
        ...
        pstr->valid_len = sVar22;
        wc2 = wVar17;
        if (wVar17 == 0xffffffff) goto LAB_0010f311;
LAB_0010ef92:
...
LAB_0010efc0:
    ...
    lVar11 = pstr->len - lVar16;
    lVar18 = pstr->stop - lVar16;
    if (pstr->mbs_allocated == '\0') goto LAB_0010ed89;
...
LAB_0010ed8d:
    ...
    pstr->len = lVar11;
    pstr->stop = lVar18;
    if (iVar10 < 2) goto LAB_0010eec8;
    if (pstr->icase == '\0') {
      build_wcs_buffer(pstr);
    }
    else {
      rVar9 = build_wcs_upper_buffer(pstr);
      if (rVar9 != _REG_NOERROR) goto LAB_0010edbd;
    }
  }
  pstr->cur_idx = 0;
  rVar9 = _REG_NOERROR;
...
LAB_0010f1e0:
  pbVar24 = pbVar24 + -1;
  if (pbVar24 < pbVar15) goto LAB_0010ef11;
  goto LAB_0010f1ed;
}
