...
LAB_0010ea73:
            ...
            if (p_Var14->fts_info == 2) goto LAB_0010eaa3;
          }
...
LAB_0010ecb3:
    param_1->fts_cur = pFVar12;
    if (uVar6 == 0xb) goto LAB_0010ed30;
  }
  if (uVar6 != 1) {
    return pFVar12;
  }
