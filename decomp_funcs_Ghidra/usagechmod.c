...

{
  ...
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"      --reference=RFILE  use RFILE\'s mode instead of MODE values\n"
                             ,5);
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"  -R, --recursive        change files and directories recursively\n"
                             ,5);
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "chmod";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","chmod");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
