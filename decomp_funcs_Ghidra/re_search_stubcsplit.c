...

{
  ...
  if (((length < lVar8) || ((-1 < range && (lVar8 < start)))) ||
    ...
    bVar2 = PTR_pthread_mutexattr_gettype_0011eff0 != (undefined *)0x0 ||
            PTR_thrd_exit_0011efe0 != (undefined *)0x0;
    if (PTR_pthread_mutexattr_gettype_0011eff0 != (undefined *)0x0 ||
        PTR_thrd_exit_0011efe0 != (undefined *)0x0) goto LAB_00114b7e;
LAB_00114b9e:
...
LAB_00114d88:
    ...
    if (((bufp->field_0x38 & 6) == 4) && (nmatch = regs->num_regs, nmatch <= bufp->re_nsub)) {
      if ((long)nmatch < 1) goto LAB_00114d88;
    }
    else {
...
LAB_00114ef1:
        ...
        if (((bVar3 & 3) == 1) && (cVar9 = '\x01', regs->num_regs < uVar7)) {
          ...
          if (prVar5 == (regoff_t *)0x0) goto LAB_00114ef1;
...
LAB_00114d2d:
      ...
      if ((cVar9 * '\x02' & 6U) == 0) goto LAB_00114c55;
    }
    lVar8 = pmatch->rm_so;
    if (ret_len != false) {
