...
LAB_001135b8:
    ...
    if ((long)uVar15 < (long)(uVar1 - 1)) goto LAB_0011357a;
...
LAB_00113a40:
        ...
        if (local_148 == (fs_res *)0x0) goto LAB_0011360d;
      }
      else {
LAB_001134c7:
        ...
        if (local_148 == (fs_res *)0x0) {
          if (utimecmpat::lexical_block_0::ht == (Hash_table *)0x0) goto LAB_0011360d;
          goto LAB_00113a40;
        }
...
LAB_00113857:
      if (((long)uVar15 < (long)uVar1) || ((iVar13 <= iVar16 && (bVar17)))) goto LAB_0011357a;
      if (((long)uVar1 < (long)uVar6) ||
         ((uVar1 == uVar6 && (iVar16 < iVar13 - iVar13 % (int)uVar14)))) goto LAB_001135b8;
