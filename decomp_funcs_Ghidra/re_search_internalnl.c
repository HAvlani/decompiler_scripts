...

{
  ...
  if ((((prVar2->init_state->nodes).nelem == 0) && ((prVar2->init_state_word->nodes).nelem == 0)) &&
    ...
    if ((start != 0) && (local_2c4 = _REG_NOMATCH, last_start != 0)) goto LAB_0010de63;
    last_start = 0;
    start = 0;
  }
  bVar38 = true;
...
LAB_0010db21:
    ...
    if ((1 < nmatch) || ((prVar2->field_0xb0 & 2) != 0)) {
      if (0x1ffffffffffffffe < (ulong)mctx.input.bufs_len) goto LAB_0010ea6e;
      mctx.state_log = (re_dfastate_t **)malloc(mctx.input.bufs_len * 8 + 8);
      pprVar23 = mctx.state_log;
      if (mctx.state_log != (re_dfastate_t **)0x0) goto LAB_0010db87;
      goto LAB_0010eac3;
    }
LAB_0010db87:
    local_288 = 8;
...
joined_r0x0010dc9e:
      ...
      if (local_288 == 7) {
        ...
        do {
          if (local_2b0[puVar3[(byte)string[match_first]]] != '\0') goto LAB_0010de90;
          match_first = match_first + 1;
          bVar8 = true;
        } while (match_first != lVar37);
        goto LAB_0010ddfe;
      }
      if (local_288 == 8) goto LAB_0010deaa;
      if ((int)local_288 < 6) {
        if (3 < (int)local_288) {
          if (lVar29 <= start) {
            bVar8 = false;
            while( true ) {
              ...
              match_first = match_first + -1;
              bVar8 = true;
              if (match_first < lVar29) goto LAB_0010de30;
            }
            if (bVar8) {
              start = match_first;
              IVar21 = match_first;
        ...
        if (lVar37 <= start) goto forward_match_found_start_or_reached_end;
        do {
          if (local_2b0[(byte)string[match_first]] != '\0') goto LAB_0010de90;
          match_first = match_first + 1;
          bVar8 = true;
        } while (match_first != lVar37);
        goto LAB_0010ddfe;
      ...
      while( true ) {
        ...
        if ((match_first < lVar29) || (lVar37 < match_first)) goto LAB_0010de30;
      }
      goto LAB_0010deaa;
    }
    goto LAB_0010de30;
...
LAB_0010ddfe:
      ...
      start = match_first;
      IVar21 = match_first;
      if (local_2b0[uVar18] == '\0') goto LAB_0010de30;
    }
  }
LAB_0010deaa:
  match_first = IVar21;
  ...
  if ((char)prVar24->field_0x68 < '\0') {
    ...
    if ((uVar30 & 1) == 0) {
      if (uVar30 == 0) goto LAB_0010df90;
      if ((uVar30 & 6) == 6) {
        prVar24 = prVar4->init_state_begbuf;
      }
      else if ((uVar30 & 2) == 0) {
        if ((uVar30 & 4) == 0) goto LAB_0010df90;
    ...
    if (prVar24 == (re_dfastate_t *)0x0) goto LAB_0010ea6e;
  }
LAB_0010df90:
      ...
      if (mctx.input.cur_idx < mctx.input.stop) {
        ...
        do {
          ...
          if (((lVar36 < mctx.input.bufs_len) || (mctx.input.len <= mctx.input.bufs_len)) &&
            ...
            if (rVar15 != _REG_NOERROR) goto LAB_0010ea6e;
            bVar10 = prVar24->field_0x68;
            uVar18 = mctx.input.cur_idx;
            prVar4 = mctx.dfa;
          }
                ...
                if ((prVar4->nodes[lVar7].field_0xa & 0x10) != 0) {
                  ...
                  if ((uVar30 & 0x3ff00) != 0) {
                    ...
                    if ((uVar30 & 4) == 0) {
                      if ((uVar30 & 8) != 0) {
                        uVar31 = uVar14 & 1;
                        goto joined_r0x0010e63b;
                      }
                    }
                    else {
                      if ((uVar14 & 1) == 0) goto LAB_0010e786;
                      uVar31 = uVar30 & 8;
joined_r0x0010e63b:
                      if (uVar31 != 0) goto LAB_0010e786;
                    }
                    if ((((uVar30 & 0x20) != 0) && ((uVar14 & 2) == 0)) ||
                       (((uVar30 & 0x80) != 0 && ((uVar14 & 8) == 0)))) goto LAB_0010e786;
                  }
                    ...
                    if ((reg_errcode_t)eps_via_nodes.alloc == _REG_NOERROR) {
                      ...
                      if (prVar19 == (re_dfastate_t *)0x0) {
                        ...
                        *pprVar23 = prVar19;
                        ...
                        if ((reg_errcode_t)eps_via_nodes.alloc != _REG_NOERROR) goto LAB_0010ea18;
                        uVar30 = re_string_context_at
                                           (&mctx.input,next_state_log_idx + -1,mctx.eflags);
                        pprVar23 = mctx.state_log + next_state_log_idx;
                        prVar19 = re_acquire_state_context
                      ...
                      if ((prVar19 != (re_dfastate_t *)0x0) ||
                         ((reg_errcode_t)eps_via_nodes.alloc == _REG_NOERROR)) goto LAB_0010e786;
                    }
LAB_0010ea18:
                    idx = idx & 0xffffffff00000000U |
                          (ulong)(uint)(reg_errcode_t)eps_via_nodes.alloc;
                    goto joined_r0x0010ea22;
                  }
                }
LAB_0010e786:
                lVar20 = lVar20 + 1;
...
LAB_0010e0f2:
              if (mctx.state_log != (re_dfastate_t **)0x0) goto LAB_0010e0fd;
              goto LAB_0010e110;
            }
...
LAB_0010e110:
          if (prVar19 == (re_dfastate_t *)0x0) {
            pprVar23 = mctx.state_log;
            if ((int)idx != 0) goto LAB_0010eac3;
            if ((mctx.state_log == (re_dfastate_t **)0x0) ||
            ...
            do {
              ...
              if ((int)idx != 0) {
                if (prVar19 == (re_dfastate_t *)0x0) goto LAB_0010e19e;
                break;
              }
...
LAB_0010e19e:
    ...
    if (rVar15 == _REG_NOERROR) {
      ...
      if ((bVar10 & 0x40) != 0) {
        ...
        idx = idx & 0xffffffff00000000U | (ulong)(uint)rVar15;
        if (rVar15 != _REG_NOERROR) goto LAB_0010f508;
        bVar10 = prVar24->field_0x68;
      }
      local_25b = false;
      goto LAB_0010dfc7;
...
LAB_0010e980:
    start = start + iVar12;
    match_first = start;
    if ((start < lVar29) || (lVar37 < start)) goto LAB_0010de30;
    goto joined_r0x0010dc9e;
  }
  if (uVar18 == 0xfffffffffffffffe) goto LAB_0010eac3;
  bVar10 = preg->field_0x38;
  mctx.match_last = uVar18;
  if ((bVar10 & 0x10) == 0) {
    if (nmatch < 2) {
      if (prVar2->nbackref == 0) {
        if (nmatch != 0) goto LAB_0010e282;
        goto free_return;
      }
LAB_0010eae3:
...
LAB_0010eafb:
      ...
      if (0x1ffffffffffffffe < uVar18) goto LAB_0010eac3;
      num = uVar18 + 1;
...
LAB_0010eca1:
        ...
        if (local_2f0 == (re_dfastate_t **)0x0) goto LAB_0010ea62;
        while( true ) {
          ...
          if ((*pprVar23 != (re_dfastate_t *)0x0) || (*local_2f0 != (re_dfastate_t *)0x0)) {
            ...
            rpl_free(local_2f0);
            if (rVar15 != _REG_NOERROR) goto LAB_0010eca1;
            goto LAB_0010ed60;
          }
          do {
            num = uVar18;
    ...
    mctx.last_node = check_halt_state_context(&mctx,mctx.state_log[uVar18],uVar18);
    if (((prVar2->field_0xb0 & 1) != 0) || (prVar2->nbackref != 0)) goto LAB_0010eafb;
  }
  else {
    if (prVar2->nbackref != 0) goto LAB_0010eae3;
LAB_0010eda0:
    pprVar23 = mctx.state_log;
...
LAB_0010f430:
      ...
      prev_match.u._0_8_ = 0;
      prev_match.u._8_8_ = 8;
      if (fs == (re_fail_stack_t *)0x0) goto LAB_0010ea6e;
LAB_0010f463:
      prev_match.u._8_8_ = 8;
      prev_match.u._0_8_ = 0;
...
LAB_0010f10d:
        ...
        if ((lVar29 == IVar22) && (IVar21 == mctx.last_node)) {
          if (fs != (re_fail_stack_t *)0x0) goto LAB_0010f088;
          rpl_free(eps_via_nodes.elems);
          if (prev_match.u._16_8_ != local_2f8) {
            rpl_free(prev_match.u._16_8_);
          }
...
LAB_0010f088:
          ...
          while ((prVar27->rm_so < 0 || (prVar27->rm_eo != -1))) {
            sVar33 = sVar33 + 1;
            prVar27 = prVar27 + 1;
            if (nmatch == sVar33) goto LAB_0010f0b6;
          }
...
LAB_0010f0b6:
            rpl_free(eps_via_nodes.elems);
            if (prev_match.u._16_8_ != local_2f8) goto LAB_0010f0d6;
            goto LAB_0010f105;
          }
...
LAB_0010f382:
                ...
                rpl_free(eps_via_nodes.elems);
                if (prev_match.u._16_8_ == local_2f8) goto LAB_0010f463;
                goto LAB_0010f430;
              }
              lVar36 = lVar36 + 1;
              lVar37 = IVar21;
...
LAB_0010e52d:
            if (-1 < IVar21) goto LAB_0010e400;
            if (IVar21 != -2) goto LAB_0010f5d1;
          }
LAB_0010f4df:
          rpl_free(eps_via_nodes.elems);
          goto LAB_0010f4ec;
        ...
        if ((prVar34->field_0xa & 0x10) == 0) {
          if (prVar34->field_0x8 != 4) goto LAB_0010efc3;
...
LAB_0010f6ef:
            ...
            IVar22 = idx;
            if (_Var11 == false) goto LAB_0010f4df;
            IVar21 = *prVar9->edests[(long)local_310].elems;
            IVar26 = re_node_set_contains();
            if (IVar26 != 0) goto LAB_0010e52d;
