  ...
  if (param_3 < 0x555555555555555) {
    ...
    if (1 < dfa->mb_cur_max) {
      if ((bVar1 & 4) == 0) {
        ...
        dfa->sb_char = pbVar22;
        if (pbVar22 == (re_bitset_ptr_t)0x0) goto LAB_0011e040;
        lVar26 = 0;
        do {
          uVar37 = (int)lVar26 * 8;
          iVar7 = 0;
...
LAB_0011e193:
              iVar7 = iVar7 + 1;
              uVar37 = uVar37 + 1;
              if (iVar7 == 0x40) goto LAB_0011e1e0;
            }
            puVar35 = (ulong *)((long)dfa->sb_char + lVar26);
            *puVar35 = *puVar35 | 1 << ((byte)iVar7 & 0x3f);
            if ((uVar37 & 0xffffff80) != 0) goto LAB_0011e193;
            if (wVar9 != uVar37) goto LAB_0011e18c;
            iVar7 = iVar7 + 1;
            uVar37 = uVar37 + 1;
          } while (iVar7 != 0x40);
LAB_0011e1e0:
    ...
    if ((dfa->nodes != (re_token_t *)0x0) && (dfa->state_table != (re_state_table_entry *)0x0)) {
      bVar40 = PTR_thrd_exit_0012bfd8 != (undefined *)0x0;
      local_10c = _REG_NOERROR;
      bVar41 = PTR_pthread_mutexattr_gettype_0012bfe8 != (undefined *)0x0;
      if (!bVar40 && !bVar41) {
LAB_0011d98c:
            ...
            if (1 < iVar7) {
              do {
                ...
                if (((long)param_3 <= local_d8.valid_raw_len) ||
                   (dfa->mb_cur_max + local_d8.valid_len < local_d8.bufs_len)) goto LAB_0011db47;
              ...
              if ((((pIVar18 != (Idx *)0x0) && (pIVar19 != (Idx *)0x0)) &&
                ...
                if (pIVar18 != (Idx *)0x0) {
                  ...
                  if (param_1->re_nsub == 0) {
                    ...
                    sVar31 = 0;
                    do {
                      if (pIVar18[sVar31] != sVar31) goto LAB_0011dd33;
                      sVar31 = sVar31 + 1;
...
LAB_0011dda0:
                ...
                case 4:
                  ...
                  if ((pbVar15->token).field_0x8 == '\x04') {
                    ...
                    if (pIVar18 != (Idx *)0x0) goto LAB_0011df13;
                    rVar8 = _REG_ESPACE;
                    prVar20->nelem = 0;
                    prVar20->alloc = 0;
                    goto LAB_0011daa8;
                ...
                if (pbVar16 == (bin_tree_t *)0x0) {
                  while( true ) {
                    ...
                    if (*ppbVar4 == (bin_tree_t *)0x0) {
                      ...
                      sVar31 = 0;
LAB_0011de28:
                      if (prVar36->nodes_len == sVar31) goto LAB_0011de4e;
LAB_0011de2e:
                      lVar26 = sVar31 * 0x18;
                      while( true ) {
                        ...
                        while (lVar29 != 0) {
                          sVar31 = sVar31 + 1;
                          if (prVar36->nodes_len != sVar31) goto LAB_0011de2e;
LAB_0011de4e:
                          if (local_128 == false) {
    ...
    do {
      ...
      if (0 < prVar20[uVar27].nelem) {
        do {
          ...
          if (_Var6 == false) goto LAB_0011e315;
          prVar20 = prVar36->eclosures;
          lVar26 = lVar26 + 1;
...
LAB_0011e8d0:
      ...
      do {
        ...
        case 0xc:
          ...
          else if (uVar37 != 0x80) goto switchD_0011e5bf_caseD_6;
        }
        sVar31 = sVar31 + 1;
        prVar34 = prVar34 + 1;
      } while (sVar31 != dfa->nodes_len);
      prVar34 = prVar11 + sVar31;
      if ((local_128 | bVar30) == 0) goto LAB_0011e8d0;
      do {
          ...
          do {
            ...
            if ((prVar34->field_0x8 == '\t') && (prVar34->opr == prVar11->opr)) {
              ...
              if (IVar23 == 0) {
                ...
                if (rVar8 != _REG_NOERROR) goto LAB_0011e4c8;
                lVar26 = 1;
                if (1 < local_f8._8_8_) goto LAB_0011e3e5;
                goto LAB_0011e488;
              }
              break;
            }
...
LAB_0011e4c8:
  ...
  re_string_destruct(&local_d8);
  rVar8 = local_10c;
  if (local_10c == _REG_NOERROR) goto LAB_0011e063;
  if (bVar40 || bVar41) {
LAB_0011e134:
