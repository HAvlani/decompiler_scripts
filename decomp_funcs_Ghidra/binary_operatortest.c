...
LAB_00102d8d:
    if (cVar4 == 'o') {
      if ((pcVar9[2] != 't') || (pcVar9[3] != '\0')) goto LAB_00103098;
      pos = pos + 3;
    ...
    if ('o' < cVar4) goto LAB_00103098;
    if (cVar4 == 'e') {
      cVar4 = pcVar9[2];
      goto LAB_00102e5d;
    }
    if (cVar4 != 'n') goto LAB_00103098;
    cVar4 = pcVar9[2];
  }
  else {
    if (cVar4 == 'e') {
      ...
      if (cVar4 == 'q') {
LAB_0010308d:
        if (pcVar9[3] != '\0') goto LAB_00103098;
        goto LAB_00102f06;
      }
LAB_00102e5d:
      if ((cVar4 != 'f') || (pcVar9[3] != '\0')) goto LAB_00103098;
      pos = pos + 3;
      uVar10 = (uint)(bVar11 | param_1);
      if ((bVar11 | param_1) != 0) {
    ...
    if (cVar4 != 'n') goto LAB_00102d8d;
    cVar4 = pcVar9[2];
    if (cVar4 == 'e') goto LAB_0010308d;
  }
