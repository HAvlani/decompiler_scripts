...

{
  ...
  if (dest_nodes->nelem == 0) {
    ...
    if (err != _REG_NOERROR) goto LAB_0010fa69;
...
LAB_0010fb40:
      ...
      if (0 < dest_nodes->nelem) {
        do {
          ...
          if (rVar7 != _REG_NOERROR) goto LAB_0010fb40;
          lVar21 = lVar21 + 1;
              ...
              if (0 < lVar14) {
                ...
                do {
                  while( true ) {
                    ...
                    plVar15 = plVar15 + 1;
                    if (plVar19 + lVar14 == plVar15) goto LAB_001100e3;
                  }
...
LAB_001100f5:
    ...
    err = local_7c;
    if (local_7c != _REG_NOERROR) goto LAB_0010fa69;
            ...
            do {
              if (((lVar14 == prVar23->node) &&
                ...
                if (_err == (re_dfastate_t **)0x0) {
                  ...
                  if (err == _REG_NOERROR) goto LAB_0010fd85;
                }
                else {
LAB_0010fd85:
                  local_68 = lVar14;
                ...
                if (_err == (re_dfastate_t **)0x0) goto LAB_0010fa69;
                goto LAB_0010ff5c;
              }
LAB_0010fe60:
              lVar20 = lVar20 + 1;
