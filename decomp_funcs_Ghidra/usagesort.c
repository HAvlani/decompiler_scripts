...

{
  ...
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Write sorted concatenation of all FILE(s) to standard output.\n",5);
  ...
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Ordering options:\n\n",5);
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,
  ...
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Other options:\n\n",5);
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,
  ...
  uVar4 = dcgettext(0,
                    ...
                    ,5);
  __printf_chk(1,uVar4,&DAT_00116c53);
  pFVar1 = stdout;
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "sort";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","sort");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
