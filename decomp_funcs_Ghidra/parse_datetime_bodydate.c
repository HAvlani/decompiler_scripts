...

{
  ...
  do {
    ...
    if ((char)bVar3 < '\x0e') {
      bVar43 = bVar3 < 8;
      bVar44 = bVar3 == 8;
      if ((char)bVar3 < '\t') goto LAB_00109f85;
    }
    else {
      bVar43 = bVar3 < 0x20;
      bVar44 = bVar3 == 0x20;
      if (!bVar44) goto LAB_00109f85;
    }
    pbVar42 = pbVar42 + 1;
  } while( true );
joined_r0x0010a828:
  ...
  *pbVar22 = 0;
  ...
  do {
    while( true ) {
      ...
      if ((char)bVar3 < '\t') goto LAB_0010a890;
    }
  } while (bVar3 == 0x20);
LAB_0010a890:
  ptVar18 = localtime_rz(tz,&now->tv_sec,&tmp);
  if (ptVar18 != (tm *)0x0) goto LAB_0010a01f;
  goto LAB_0010a750;
LAB_00109f85:
  uVar29 = 4;
  pbVar35 = pbVar42;
  pbVar22 = &DAT_00115f0e;
  do {
    if (uVar29 == 0) break;
    uVar29 = uVar29 - 1;
      ...
      do {
        if (bVar14 == 0x5c) {
          ...
          if (((long)__size < 0x65) ||
             ...
             pbVar22 != (byte *)0x0)) goto joined_r0x0010a828;
          goto LAB_0010a9e0;
        }
        bVar14 = pbVar22[1];
        __size = __size + 1;
  ...
  if (iVar40 == 0) {
    if (pc.parse_datetime_debug == false) {
      ...
      if (1 < (pc.times_seen | pc.dates_seen | pc.days_seen | pc.dsts_seen |
              pc.zones_seen + pc.local_zones_seen)) goto LAB_0010a750;
LAB_0010a2e2:
...
LAB_0010ad7f:
        ...
        else if (lVar21 < 0) goto LAB_0010ad7f;
      ...
      if ((bool)cVar34 == false) {
        ...
        if (uVar29 != (long)tm.tm_mon || SCARRY8(pc.month,-1)) goto LAB_0010ae21;
        tm.tm_mday = (int)pc.day;
        tm._8_8_ = tm._8_8_ & 0xffffffff | pc.day << 0x20;
        if (pc.day != tm.tm_mday) goto LAB_0010ae21;
        if (pc.times_seen == 0) {
...
LAB_0010ba4d:
          ...
          if (pc.days_seen == 0) goto LAB_0010b0b3;
          tm._0_8_ = 0;
          tm._8_8_ = pc.day << 0x20;
          pc.seconds.tv_nsec = 0;
          if (pc.parse_datetime_debug != false) goto LAB_0010ba4d;
          tm.tm_hour = 0;
          tm.tm_min = 0;
          tm.tm_sec = 0;
LAB_0010a3fd:
...
LAB_0010b0b3:
          ...
          if (pc.meridian != 0) {
            if (pc.meridian == 1) {
              ...
              if (pc.hour - 1U < 0xb) goto LAB_0010b0e3;
              if (pc.hour == 0xc) {
              ...
              if ((ulong)pc.hour < 0x18) goto LAB_0010b0e0;
              pcVar19 = "";
            }
LAB_0010bbe7:
...
LAB_0010b115:
        ...
        if (_Var15 == false) {
          if (pc.zones_seen != 0) {
            ...
            if (_Var15 != false) goto LAB_0010af6c;
          }
          iVar11 = tm0.tm_year;
          iVar10 = tm0.tm_mon;
          iVar9 = tm0.tm_mday;
...
LAB_0010bce8:
            ...
            bVar43 = false;
            bVar44 = false;
            if (iVar9 == iVar6) goto LAB_0010a60c;
LAB_0010a613:
            pcVar37 = "--";
            if (iVar10 == iVar41) {
              pcVar37 = "";
...
LAB_0010af6c:
        if (pc.days_seen != 0) {
          ...
          if (pc.parse_datetime_debug == false) goto LAB_0010b5b7;
LAB_0010b9d7:
...
LAB_0010b20a:
          ...
          if ((pc.rel.year | pc.rel.month | pc.rel.day) != 0) {
            if (pc.parse_datetime_debug == false) goto LAB_0010b5db;
...
LAB_0010baf7:
              ...
              if (pc.rel.day != 0) goto LAB_0010baf7;
            }
            local_470 = tm.tm_year + pc.rel.year;
            if ((local_470 == (long)(int)local_470) &&
               (SCARRY8((long)tm.tm_year,pc.rel.year) == false)) goto LAB_0010b2e8;
LAB_0010b634:
            if (pc.parse_datetime_debug != false) {
...
LAB_0010b3f1:
          ...
          if (SEXT816(lVar21) == SEXT816(pc.rel.hour) * SEXT416(0xe10)) {
            ...
            if ((!SCARRY8(local_478,lVar21)) &&
               ...
               SEXT816(lVar21) == SEXT816(pc.rel.minutes) * SEXT816(0x3c))) goto LAB_0010b501;
          }
LAB_0010ba1e:
          if (cVar34 == '\0') goto LAB_0010a750;
        ...
        if (pc.parse_datetime_debug != false) {
          ...
          if (pc.dates_seen == 0) {
            if (pc.days_seen == 0) {
              ...
              if (pc.days_seen != 0) goto joined_r0x0010ba84;
            }
          }
          else {
joined_r0x0010ba84:
            if (lVar21 != 0) goto LAB_0010b9d7;
          }
          goto LAB_0010b20a;
        }
LAB_0010b5b7:
...
LAB_0010b5db:
          local_470 = tm.tm_year + pc.rel.year;
          if ((local_470 != (long)(int)local_470) ||
             (SCARRY8((long)tm.tm_year,pc.rel.year) != false)) goto LAB_0010a750;
LAB_0010b2e8:
          ...
          if ((uVar26 == (long)iVar40) && (SCARRY8((long)tm.tm_mon,pc.rel.month) == false)) {
            ...
            if ((lVar21 == iVar41) && (SCARRY8((long)tm.tm_mday,pc.rel.day) == false)) {
              ...
              if (tm.tm_wday < 0) {
                ...
                if (pc.zones_seen == 0) goto LAB_0010b670;
...
LAB_0010a750:
      ...
      if ((pc.timespec_seen == false) && (pcVar19 = "parsed date/time string", pc.zones_seen == 0))
      {
        ...
        if (bVar44) {
          ...
          if ((!bVar43 && !bVar44) == bVar43) goto LAB_0010aa00;
...
LAB_0010aa3d:
        ...
        if (pc.zones_seen != 0) goto LAB_0010aa3d;
        if (0 < pc.local_isdst) {
          pFVar31 = stderr;
