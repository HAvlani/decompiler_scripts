...
LAB_001136b6:
    if ((prVar7->field_0x8 & 8) == 0) goto LAB_00113780;
    prVar9 = dfa->edests;
    prVar8 = prVar9 + node;
    if (prVar8->nelem < 1) goto LAB_00113780;
    lVar10 = 0;
    bVar4 = false;
    do {
      while( true ) {
        ...
        if (prVar8->nelem == 0) {
          ...
          if (rVar5 != _REG_NOERROR) goto LAB_001137ad;
        }
        else {
        ...
        prVar8 = prVar9 + node;
        bVar4 = bVar3;
        if (prVar8->nelem == lVar10 || prVar8->nelem < lVar10) goto LAB_00113808;
      }
      prVar8 = prVar9 + node;
      bVar3 = true;
      lVar10 = lVar10 + 1;
...
LAB_00113808:
    if ((root == true) || (!bVar3)) goto LAB_00113780;
    prVar6[node].nelem = 0;
  }
  else {
