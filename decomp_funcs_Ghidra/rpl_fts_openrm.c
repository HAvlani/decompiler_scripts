...
mem3:
    ...
    if (local_50 != (FTSENT *)0x0) {
      ...
      pcVar10 = *argv;
      if (compar != (anon_subr_int_FTSENT_ptr_ptr_FTSENT_ptr_ptr *)0x0) goto LAB_00106658;
LAB_00106667:
      if (pcVar10 == (char *)0x0) goto LAB_001068aa;
      local_40 = (FTSENT *)0x0;
      uVar11 = 0;
      p_Var9 = (_ftsent *)0x0;
      do {
        ...
        if ((p_Var9 == (_ftsent *)0x0) || (local_42 == 0)) {
          ...
          if (compar != (anon_subr_int_FTSENT_ptr_ptr_FTSENT_ptr_ptr *)0x0) goto LAB_001066f5;
          pFVar6->fts_link = (_ftsent *)0x0;
          if (p_Var9 != (_ftsent *)0x0) goto LAB_00106830;
        }
        else {
