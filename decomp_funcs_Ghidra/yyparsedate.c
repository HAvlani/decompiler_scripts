...
LAB_00108459:
      ...
      else if (cVar30 == ' ') goto LAB_00108459;
...
LAB_001086be:
        ...
        else if ((byte)(cVar30 + 0x9fU) < 0x1a) goto LAB_001086be;
        if (cVar30 != '(') {
          pc->input = (char *)(pbVar24 + 1);
          uVar48 = (uint)*pbVar24;
          if (*pbVar24 == 0) goto LAB_00108390;
          goto LAB_001085c0;
        }
        lVar28 = 0;
        do {
      ...
      do {
        while( true ) {
          ...
          if ((char)bVar42 < '\t') goto LAB_001084a2;
        }
      } while (bVar42 == 0x20);
LAB_001084a2:
    } while (9 < bVar42 - 0x30);
...
LAB_001084b9:
    ...
    if (!SCARRY8(lVar28,(long)iVar22)) {
      ...
      pbVar43 = pbVar24 + 1;
      if (uVar48 - 0x30 < 10) goto LAB_001085e0;
...
LAB_00108574:
        ...
        while (uVar48 < 10) {
          if ((char)iVar22 != '0') {
            ...
            goto joined_r0x00108551;
          }
          iVar22 = (int)(char)pbVar24[1];
          pbVar24 = pbVar24 + 1;
          uVar48 = iVar22 - 0x30;
        }
        if (uVar23 != 0) goto LAB_00108574;
        pc->input = (char *)pbVar24;
        iVar22 = 0x15;
        uVar48 = 0x114;
        local_5c0 = 0;
...
LAB_001086ee:
  do {
    ...
    uVar48 = (uint)bVar42;
    if ((char)bVar42 < '[') {
      if ('@' < (char)bVar42) goto LAB_001086ee;
    }
    else if ((byte)(bVar42 + 0x9f) < 0x1a) goto LAB_001086ee;
  } while (bVar42 == 0x2e);
  *(byte *)puVar33 = 0;
  puVar33 = (uint *)buff;
  bVar42 = buff[0];
...
LAB_00108390:
  ...
  if (pbVar24 == (byte *)0x1) {
    ...
    pcVar39 = "A";
    do {
      if (*pcVar39 == buff[0]) goto LAB_00109918;
      pcVar39 = ptVar36[1].name;
      ptVar36 = ptVar36 + 1;
    } while (pcVar39 != (char *)0x0);
  }
...
LAB_00108357:
      while ((((uVar46 == 0xffffffa3 || (uVar46 = uVar46 + 1, 0x70 < uVar46)) ||
             ...
             [(int)uVar46] < '\x01'))) {
        if (pcVar37 == yyssa) goto LAB_001082f0;
        pcVar39 = pcVar37 + -1;
        pcVar37 = pcVar37 + -1;
...
LAB_0010814d:
          ...
          if ((SEXT816(lVar40) != SEXT816(lVar26) * SEXT816(0x3c) | bVar49) != 0) goto LAB_001082f0;
        }
        if (0xb40 < lVar25 + 0x5a0U) goto LAB_001082f0;
...
LAB_001094ec:
        ...
        if (((byte)(SCARRY8(lVar9,lVar10) |
           ...
           (SCARRY8(lVar11,lVar12) != false)) goto LAB_001082f0;
        pc->rels_seen = true;
...
LAB_00109465:
        ...
        if ((0xb40 < lVar25 + 0x5a0U) ||
           ...
           lVar40 != iVar47 || SCARRY8(lVar26,lVar25))) goto LAB_001082f0;
        break;
      case 0x23:
      ...
      case 0x2a:
        ...
        if (3 < lVar25) {
          ...
          *(undefined4 *)((long)&(pc->year).value + 4) = uVar21;
          goto switchD_00108127_caseD_29;
        }
...
joined_r0x001091c2:
        if (lVar25 != -0x8000000000000000) goto LAB_001090a2;
        goto LAB_001082f0;
      case 0x2c:
...
LAB_0010892c:
      ...
      case 0x35:
        ...
        if (((byte)(SCARRY8(lVar9,lVar10) |
                   SCARRY8(lVar25,lVar26) | SCARRY4(iVar47,iVar22) | SCARRY8(lVar40,lVar4) |
                   SCARRY8(lVar5,lVar6) | SCARRY8(lVar7,lVar8)) == 0) &&
           (SCARRY8(lVar11,lVar12) == false)) goto LAB_0010892c;
LAB_001082f0:
        iVar47 = 1;
LAB_001082f5:
...
LAB_001085e0:
  lVar28 = uVar38 * 10;
  pbVar24 = pbVar43;
  if (SEXT816(lVar28) != SEXT816((long)uVar38) * SEXT816(10)) goto LAB_001085b6;
  goto LAB_001084b9;
LAB_001085b6:
  uVar48 = 0x3f;
LAB_001085c0:
