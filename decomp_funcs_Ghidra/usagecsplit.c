...

{
  ...
  uVar4 = dcgettext(0,"Usage: %s [OPTION]... FILE PATTERN...\n",5);
  ...
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"      --suppress-matched     suppress the lines matching PATTERN\n",
                             5);
  fputs_unlocked(pcVar5,pFVar1);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "csplit";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","csplit");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
