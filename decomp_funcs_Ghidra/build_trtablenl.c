...

{
  ...
  *(undefined (*) [16])(puVar38 + -0x402) = (undefined  [16])0x0;
  if (lVar46 < 1) {
LAB_0010a0c1:
    *(undefined8 *)(puVar38 + -0x42c) = 0x10a0d0;
...
LAB_00109b40:
          ...
          if (lVar46 != lVar39) goto LAB_00109801;
          ...
          *puVar44 = 1;
          puVar44[1] = 1;
          *(undefined8 *)(puVar38 + -0x42c) = 0x109d2e;
...
LAB_00109d68:
              ...
              do {
                ...
                *(undefined8 *)(puVar38 + -0x42c) = 0x109d8a;
                rpl_free(pvVar25);
                lVar39 = lVar49;
              } while (lVar49 < lVar46);
            }
          ...
          *puVar32 = uVar7;
          ...
          if ((uVar23 & 0x20) != 0) {
            ...
            *(undefined (*) [16])(puVar38 + -0x402) = (undefined  [16])0x0;
            if ((uVar29 & 0x400) == 0) goto LAB_00109801;
            *(undefined8 *)(puVar38 + -0x406) = 0x400;
          }
          if ((uVar23 & 0x80) == 0) {
            if ((uVar23 & 4) != 0) {
              if ((bVar3 == 1) && ((*(byte *)((long)ppuVar47 + 10) & 0x40) == 0)) goto LAB_00109d3e;
...
LAB_00109801:
    ...
    if (lVar46 < 1) {
      if (lVar46 == 0) goto LAB_0010a0c1;
    }
    else {
      *(undefined8 *)(puVar38 + -0x414) = 0;
      *(long *)(puVar38 + -0x416) = lVar46 + 1;
      *(undefined8 *)(puVar38 + -0x42c) = 0x10983a;
          ...
          if (0 < *plVar48) {
            do {
              ...
              if (lVar43 != -1) {
                ...
                *(undefined8 *)(puVar38 + -0x42c) = 0x1098ca;
                rVar24 = re_node_set_merge(prVar45,prVar6 + lVar43);
                puVar38[-0x417] = rVar24;
                if (rVar24 != _REG_NOERROR) goto LAB_00109fb0;
              }
              lVar49 = lVar49 + 1;
            } while (*plVar48 != lVar49 && lVar49 <= *plVar48);
          }
          *(undefined8 *)(puVar38 + -0x42c) = 0x1098f8;
...
LAB_00109fb0:
          ...
          if ((char)prVar26->field_0x68 < '\0') {
            ...
            *(undefined8 *)(puVar38 + -0x42c) = 0x10a009;
            ...
            *(re_dfastate_t **)(puVar38 + lVar39 * 2 + -0x206) = prVar33;
            if (prVar33 == (re_dfastate_t *)0x0) {
              if (puVar38[-0x417] != 0) goto LAB_00109fb0;
LAB_0010a024:
            ...
            else if (prVar26 != prVar33) goto LAB_0010a024;
            *(undefined8 *)(puVar38 + -0x42c) = 0x10a052;
            prVar26 = re_acquire_state_context
                                (*(reg_errcode_t **)(puVar38 + -0x42a),dfa_00,prVar45,2);
            *(re_dfastate_t **)(puVar38 + lVar39 * 2 + -6) = prVar26;
            if ((prVar26 == (re_dfastate_t *)0x0) && (puVar38[-0x417] != 0)) goto LAB_00109fb0;
          }
          else {
        ...
        *(undefined4 **)(puVar38 + -0x42a) = puVar38 + 0x7fa;
        ...
        if (*(char *)(puVar38 + -0x428) == '\0') {
          *(undefined8 *)(puVar38 + -0x42c) = 0x10998c;
...
LAB_001099f2:
            ...
            *(undefined8 *)(puVar38 + -0x42c) = 0x109a25;
            rpl_free(pvVar25);
            ppvVar1 = ppvVar37 + lVar46 * 3;
            do {
              pvVar25 = *ppvVar37;
              ppvVar37 = ppvVar37 + 3;
              *(undefined8 *)(puVar38 + -0x42c) = 0x109a3c;
              rpl_free(pvVar25);
          ...
          *(undefined8 *)(puVar38 + -0x42c) = 0x10a137;
...
out_free:
      ppvVar37 = (void **)(puVar38 + 0x1fe);
      *(undefined8 *)(puVar38 + -0x42c) = 0x109fc5;
      rpl_free(pvVar25);
      ppvVar1 = ppvVar37 + lVar46 * 3;
      do {
        pvVar25 = *ppvVar37;
        ppvVar37 = ppvVar37 + 3;
        *(undefined8 *)(puVar38 + -0x42c) = 0x109fdc;
        rpl_free(pvVar25);
      } while (ppvVar1 != ppvVar37);
    }
LAB_00109d8f:
...
LAB_00109d91:
  ...
  *(undefined8 *)(puVar38 + -0x42c) = 0x10a1ce;
  __stack_chk_fail();
}
