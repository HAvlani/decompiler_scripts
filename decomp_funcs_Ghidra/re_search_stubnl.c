...

{
  ...
  if (((length < lVar8) || ((-1 < range && (lVar8 < start)))) ||
    ...
    bVar2 = PTR_pthread_mutexattr_gettype_0011cfe0 != (undefined *)0x0 ||
            PTR_thrd_exit_0011cfd0 != (undefined *)0x0;
    if (PTR_pthread_mutexattr_gettype_0011cfe0 != (undefined *)0x0 ||
        PTR_thrd_exit_0011cfd0 != (undefined *)0x0) goto LAB_001137be;
LAB_001137de:
...
LAB_001139c8:
    ...
    if (((bufp->field_0x38 & 6) == 4) && (nmatch = regs->num_regs, nmatch <= bufp->re_nsub)) {
      if ((long)nmatch < 1) goto LAB_001139c8;
    }
    else {
...
LAB_00113b31:
        ...
        if (((bVar3 & 3) == 1) && (cVar9 = '\x01', regs->num_regs < uVar7)) {
          ...
          if (prVar5 == (regoff_t *)0x0) goto LAB_00113b31;
...
LAB_0011396d:
      ...
      if ((cVar9 * '\x02' & 6U) == 0) goto LAB_00113895;
    }
    lVar8 = pmatch->rm_so;
    if (ret_len != false) {
