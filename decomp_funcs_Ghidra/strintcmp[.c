  ...
  if (bVar3 != 0x2d) {
    ...
    if ((bVar9 == bVar3) && (uVar11 = uVar5, bVar9 - 0x30 < 10)) {
      do {
        ...
        uVar11 = (uint)bVar3;
        if (bVar3 != bVar9) goto LAB_0010628e;
      } while (bVar3 - 0x30 < 10);
      uVar5 = (uint)bVar3;
    }
LAB_0010628e:
...
LAB_00106618:
      ...
      if (uVar5 == 0x80) {
        iVar4 = uVar11 - 0x80;
        uVar5 = 0x50;
        if (9 < uVar11 - 0x30) goto LAB_001064e8;
      }
      else {
        iVar4 = uVar11 - uVar5;
        uVar5 = uVar5 - 0x30;
...
LAB_001062e2:
  ...
  if (bVar3 == bVar9) {
    if (uVar11 < 10) {
      ...
      uVar5 = (uint)bVar3;
      uVar11 = bVar3 - 0x30;
      if (uVar5 != 0x80) goto LAB_00106404;
      uVar5 = (uint)bVar9;
...
LAB_00106575:
    ...
    if (bVar9 != 0x80) {
      if (bVar3 == 0x80) goto LAB_001065a0;
      return 0;
    }
    if (bVar3 != 0x80) goto LAB_00106688;
    while( true ) {
      bVar3 = ((byte *)b)[1];
      bVar9 = ((byte *)a)[1];
      b = (char *)((byte *)b + 1);
...
LAB_00106423:
    ...
    uVar7 = bVar9 - 0x30;
    iVar4 = bVar9 - uVar5;
    if (uVar11 < 10) goto LAB_00106423;
LAB_001066f2:
    uVar8 = 0;
    if (9 < uVar7) {
      return 0;
