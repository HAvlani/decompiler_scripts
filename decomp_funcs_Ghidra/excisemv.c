...

{
  ...
  if (uVar3 == 0x1e) {
    ...
    if ((iVar7 == 0) || (*puVar9 != 2)) {
      ...
      *puVar9 = 0x1e;
      if (_Var1 == false) goto LAB_00104b68;
    }
    else {
      RVar8 = RM_OK;
      uVar12 = 2;
      if (x->ignore_missing_files != false) goto LAB_00104bcf;
    }
    if (ent->fts_info == 4) goto LAB_00104c1b;
  }
  else {
...
LAB_00104b59:
      ...
      RVar8 = RM_OK;
      if (uVar3 == 0x16) goto LAB_00104bcf;
      if ((int)uVar3 < 0x17) {
        if ((uVar3 == 2) || (uVar3 == 0x14)) goto LAB_00104bcf;
        goto LAB_00104b59;
      }
      if (uVar3 == 0x54) goto LAB_00104bcf;
      uVar2 = ent->fts_info;
    }
