...
mem3:
    ...
    if (local_50 != (FTSENT *)0x0) {
      ...
      pcVar10 = *argv;
      if (compar != (anon_subr_int_FTSENT_ptr_ptr_FTSENT_ptr_ptr *)0x0) goto LAB_001055a8;
LAB_001055b7:
      if (pcVar10 == (char *)0x0) goto LAB_001057fa;
      local_40 = (FTSENT *)0x0;
      uVar11 = 0;
      p_Var9 = (_ftsent *)0x0;
      do {
        ...
        if ((p_Var9 == (_ftsent *)0x0) || (local_42 == 0)) {
          ...
          if (compar != (anon_subr_int_FTSENT_ptr_ptr_FTSENT_ptr_ptr *)0x0) goto LAB_00105645;
          pFVar6->fts_link = (_ftsent *)0x0;
          if (p_Var9 != (_ftsent *)0x0) goto LAB_00105780;
        }
        else {
