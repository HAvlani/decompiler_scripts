...

{
  ...
  if (((length < lVar8) || ((-1 < range && (lVar8 < start)))) ||
    ...
    bVar2 = PTR_pthread_mutexattr_gettype_00128fd8 != (undefined *)0x0 ||
            PTR_thrd_exit_00128fc8 != (undefined *)0x0;
    if (PTR_pthread_mutexattr_gettype_00128fd8 != (undefined *)0x0 ||
        PTR_thrd_exit_00128fc8 != (undefined *)0x0) goto LAB_0011de0e;
LAB_0011de2e:
...
LAB_0011e018:
    ...
    if (((bufp->field_0x38 & 6) == 4) && (nmatch = regs->num_regs, nmatch <= bufp->re_nsub)) {
      if ((long)nmatch < 1) goto LAB_0011e018;
    }
    else {
...
LAB_0011e181:
        ...
        if (((bVar3 & 3) == 1) && (cVar9 = '\x01', regs->num_regs < uVar7)) {
          ...
          if (prVar5 == (regoff_t *)0x0) goto LAB_0011e181;
...
LAB_0011dfbd:
      ...
      if ((cVar9 * '\x02' & 6U) == 0) goto LAB_0011dee5;
    }
    lVar8 = pmatch->rm_so;
    if (ret_len != false) {
