...
void print_short(size_t fields,size_t blank,void *block,char *fmt_string,int width,int pad)

{
  ...
  if (blank < fields) {
    ...
    do {
      ...
      if (input_swap == false) {
        uVar3 = *(ushort *)((long)block + lVar6 * 2);
      }
      else {
        uVar3 = CONCAT11(*(undefined *)((long)block + lVar6 * 2),
