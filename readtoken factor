...
int readtoken()
{
    ...
    unsigned long long|char * v5;  // rax
    char *v6;  // rax
    struct_1 *v7;  // rax
    ...
    if (v9 != 0)
    {
        do
        {
            ...
            v12 += 1;
            tmp_34 = v8;
            v7 = ((long long)(((int)v8) % 8 & 24));
            *(&stack_base-104 + v7) = *(&stack_base-104 + v7) | 1 << (tmp_34 & 63);
        }
        while (v15 != v12);
        v5 = v11[1];
    }
    while (true)
    {
        ...
        while (true)
        {
            ...
            else
            {
                ...
                while (true)
                {
                    ...
                    if (v17 == v5 && ((int)rbx<8>) >= 0 || ((int)rbx<8>) >= 0 && v17 != v5)
                    {
        ...
        if ((((char)(((long long)*(&stack_base-408 + ((v10 & 63) >> 3))) >> ((long long)((char)(v10 & 63 & 7))))) & 1) != 0 && v11[1] >= v11[2])
        {
