...
int main()
{
    ...
    unsigned long long|unsigned long v13;  // [bp-0x10]
    unsigned long long|struct_3 *|unsigned long v14;  // [bp-0x8]
    unsigned int|unsigned long v15;  // [bp+0x0]
    unsigned int v16;  // [bp+0x8]
    unsigned int|unsigned long v17;  // [bp+0x10]
    ...
    unsigned long long|unsigned int|unsigned long v42;  // rax
    unsigned long long v5;  // [bp-0x78]
    struct_3 *v55;  // ecx
    unsigned int|unsigned long v56;  // rdx
    ...
    ignore_mode = 2;
    v27 = ((long long)ls_mode);
    rsp<8> = rsp<8> - 8;
    v15 = &g_405908;
    v42 = decode_line_length();
    v17 = v42;
    rsp<8> = rsp<8> - 8;
    v15 = &g_4058ca;
    v42 = human_options();
    ...
    *(ignore_patterns + 8) = ignore_patterns;
    ...
    rsp<8> = rsp<8> - 8 - 8 - 8;
    v13 = &g_4055fa;
    v42 = ((int)*(time_types + (long long)__xargmatch_internal() * 4));
    time_type = v42;
    v15 = v42;
    v14 = 1;
    rsp<8> = rsp<8> - 8 - 8 - 8;
    ...
    rsp<8> = rsp<8> - 8 - 8 - 8;
    v13 = &g_4056c1;
    v42 = ((int)*(quoting_style_vals + (long long)__xargmatch_internal() * 4));
    v15 = v42;
    v15 = v61;
    v14 = 1;
    rsp<8> = rsp<8> - 8 - 8 - 8;
    v13 = &g_40570b;
    v42 = ((int)*(indicator_style_types + (long long)__xargmatch_internal() * 4));
    indicator_style = v42;
    rsp<8> = rsp<8> - 8;
    v15 = &g_40579f;
    ...
    *(ignore_patterns + 8) = ignore_patterns;
    ...
    if (optarg != 0)
    {
        ...
        v13 = &g_405499;
        rsp<8> = rsp<8> + 8 + 8;
        v42 = ((int)*(when_types + (long long)__xargmatch_internal() * 4));
        v15 = v64;
        v14 = 1;
        rsp<8> = rsp<8> - 8 - 8 - 8;
        v13 = &g_405763;
        v56 = ((int)*(when_types + (long long)__xargmatch_internal() * 4));
        rsp<8> = rsp<8> + 8 + 8;
        v15 = v28;
        v14 = 1;
        rsp<8> = rsp<8> - 8 - 8 - 8;
    ...
    if (v42 == 1 || optarg == 0 || v42 == 2 && ((long long)v42) != 0)
    {
        indicator_style = 3;
    }
    print_hyperlink = v42;
    print_hyperlink = print_hyperlink & 1;
    print_with_color = v42;
