...
int transit_state_bkref.isra.0()
{
    ...
    unsigned long long|struct_6 * v10;  // [bp-0x90]
    ...
    struct_8 *|struct_0 *|unsigned long long [4]|unsigned long long [32]|struct_7 *|unsigned long long v17;  // rax
    unsigned long long v18;  // rax
    unsigned short|unsigned long long|unsigned int v19;  // rcx
    unsigned long|unsigned long long v2;  // [bp-0xd0]
    unsigned long|unsigned int|struct_0 *|unsigned long long [2]|struct struct_7 **|unsigned long long v20;  // rdx
    unsigned long|unsigned long long|unsigned long long [32]|struct_5 * v21;  // rbx
    struct_0 *|struct_6 * v22;  // rbp
    unsigned long long v23;  // rbp
    struct_0 *|unsigned long long v24;  // rsi
    struct_0 *|unsigned long long|unsigned long long [32] v25;  // rdi
    struct_6 * v26;  // r8
    unsigned long long|struct_6 * v28;  // r10
    struct_6 * v29;  // r11
    unsigned long|struct_6 * v3;  // [bp-0xc8]
    struct_6 *|unsigned long long [7]|unsigned long long v30;  // r12
    struct_0 *|unsigned long long v31;  // r13
    unsigned long long [28]|struct_4 *|unsigned long long v32;  // r14
    struct_6 *|unsigned long long|unsigned long long [32] v33;  // r15
    unsigned long long v34;  // cc_dep1
    struct_6 *|unsigned long|unsigned long long|char * v4;  // [bp-0xc0]
    struct_0 *|struct_6 *|unsigned long|unsigned long long v5;  // [bp-0xb8]
    struct_6 *|unsigned int v6;  // [bp-0xb0]
                        ...
                        while (true)
                        {
                            ...
                            if (...)
                            {
                                ...
                                if (v21->field_20 > 0)
                                {
                                    ...
                                    while (true)
                                    {
                                        ...
                                        if (!(((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, Sub(r13<8>, Load(addr=rbx<8>, size=8, endness=Iend_LE)), 0x0<64>, cc_ndep<8>))))
                                        {
                                            ...
                                            if ((v17 == 0 || v32->field_30 >= v22) && (v32->field_58 >= v22 || v32->field_30 >= v22))
                                            {
                                                ...
                                                v4 = r8<8>;
                                                v3 = r9<8>;
                                                v17 = memcmp(r9<8> + r8<8>, r9<8> + rcx<8>, v20);
                                                v28 = v3;
                                                v26 = v4;
                                                v19 = v5;
                                            }
                                    ...
                                    if (!(((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, Sub(r13<8>, Load(addr=rbx<8>, size=8, endness=Iend_LE)), 0x0<64>, cc_ndep<8>))) && (v32->field_58 < v22 || v17 != 0) && (v32->field_30 < v22 || v17 != 0) && (v32->field_58 < v22 || v17 == 0 || v32->field_30 >= v22))
                                    {
                                        v2 += 1;
                                        if (v2 >= *(r14<8> + 232))
                                        {
