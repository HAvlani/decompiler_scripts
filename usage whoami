...
extern unsigned int g_40600b;
extern unsigned int g_406081;
extern unsigned int g_4060aa;
...
int usage()
{
    ...
    if (v31 != 0)
    {
        dcgettext(0x0, &g_4060e8, 0x5);
        __fprintf_chk();
        exit(v29); /* do not return */
    }
    __printf_chk(0x1, dcgettext(0x0, &g_40600b, 0x5));
    fputs_unlocked(dcgettext(0x0, &g_406110, 0x5), stdout);
    ...
    if (v3 != 0)
    {
        __printf_chk(0x1, dcgettext(0x0, &g_406081, 0x5));
        v31 = setlocale();
        if (v31 != 0)
        {
    ...
    else
    {
        ...
        if (v31 == 0 || v21 == 0)
        {
            __printf_chk(0x1, dcgettext(0x0, &g_4060aa, 0x5));
