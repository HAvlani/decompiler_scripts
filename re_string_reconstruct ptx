...
int re_string_reconstruct()
{
    ...
    char * v11;  // rcx
    unsigned long|unsigned long long|char *|unsigned int v12;  // rdx
    unsigned long long v13;  // rdx
    struct_3 *v14;  // rbx
    unsigned long long v15;  // rbp
    unsigned long long|unsigned int v16;  // esi
    struct_0 *v17;  // rdi
    unsigned long|unsigned int v18;  // r8d
    unsigned long long v19;  // r9
    unsigned long v2;  // [bp-0x68]
    char * v20;  // r12
    unsigned long|unsigned long long v21;  // r13
    unsigned long long|char *|unsigned int v22;  // r14
    unsigned long long v23;  // r15
    char * v24;  // r15
    char|unsigned long long|unsigned int v25;  // cc_dep1
    unsigned long v3;  // [bp-0x60]
    unsigned int v4;  // [bp-0x54]
    unsigned long long v5;  // [bp-0x50]
    struct_2 *|unsigned long long|char * v7;  // rax
            ...
            if (v17->field_28 <= v16 || v16 != 0 || v25 != 0)
            {
                if (v14->field_38 > v15)
                {
                    ...
                    else
                    {
                        ...
                        while (true)
                        {
                            ...
                            v12 = *(v23 + ((v16 + v10 >> 63) + v16 + v10 >> 1) * 8);
                            v25 = *(v23 + ((v16 + v10 >> 63) + v16 + v10 >> 1) * 8);
                            if (*(v23 + ((v16 + v10 >> 63) + v16 + v10 >> 1 << 3)) > v15)
                            {
                                v10 = v7;
                            }
                            ...
                            if (((char)(v25 < v15)) || *(v23 + ((v16 + v10 >> 63) + v16 + v10 >> 1 << 3)) > v15)
                            {
                                v22 = v10 + 1;
                                if (v12 >= v15)
                                {
                            ...
                            v14->field_70 = re_string_context_at();
                            if (*(v23 + (v22 << 3)) == v15 && v15 < v17->field_30 && v15 == v22)
                            {
                            ...
                            if (*(v23 + (v22 << 3)) != v15 || v15 >= v17->field_30 || v15 != v22)
                            {
                                ...
                                if (((char)(v22 == v17->field_30)) && v22 >= v21 || v22 < v21 && v13 != 0)
                                {
                                    v14->field_30 = 0;
                                    v13 = 0;
                                    /* goto 4256159; */
                ...
                else
                {
                    ...
                    else
                    {
                            ...
                            else
                            {
                                while (true)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (v19 <= 18446744069414584317 && v19 >= v23)
                                        {
                                            v10 = ((int)v4);
                                            v19 -= v23;
                                            v14->field_20 = 0;
                                ...
                                if (v19 < v23 || ((char)(((int)*(v22)) & -64)) == 128 || v4 == -1 || v19 > 18446744069414584317)
                                {
                                    v24 = v19 + v7;
                                }
                            }
                        }
                        if (v14->field_89 == 0 || v14->field_0 + v19 + v15 - 1 < (v14->field_0 < v15 - v16 + v14->field_0 + v19? v12 : v14->field_0) || v20 > v19 + v7)
                        {
                            v24 = v19 + v7;
                        }
                        if (v20 <= v19 + v7 && (v14->field_89 == 0 || v14->field_0 + v19 + v15 - 1 < (v14->field_0 < v15 - v16 + v14->field_0 + v19? v12 : v14->field_0)))
                        {
                            v23 = v24 - v20;
                            v14->field_30 = v22;
                            v22 = v23;
                        ...
                        if (v20 > v19 + v7 && ((int)v10) == -1 || v20 <= v19 + v7 && (v14->field_89 == 0 || v14->field_0 + v19 + v15 - 1 < (v14->field_0 < v15 - v16 + v14->field_0 + v19? v12 : v14->field_0)))
                        {
                            v14->field_70 = re_string_context_at();
                        }
                        if (v20 > v19 + v7 && ((int)v10) != -1 || v14->field_89 != 0 && v14->field_0 + v19 + v15 - 1 >= (v14->field_0 < v15 - v16 + v14->field_0 + v19? v12 : v14->field_0) && v20 > v19 + v7)
                        {
                            if (v14->field_8e != 0)
                            {
                                v0 = v10;
    ...
    if (((int)v16) <= 1 && v14->field_38 <= v15 && (v25 == 0 || v15 != 0) && (v15 != 0 || v17->field_28 > v16) && (v17->field_28 <= v16 || v16 != 0 || v25 != 0) && v14->field_8b == 0 || (v25 == 0 || v15 != 0) && (((int)v16) > 1 || v14->field_38 > v15) && (v15 != 0 || v17->field_28 > v16) && (v17->field_28 <= v16 || v16 != 0 || v25 != 0) && ((long long)v12) == 0)
    {
