...
int mpz_cmpabs_d()
{
    ...
    uint128_t v7;  // xmm0
    uint128_t v8;  // xmm0
    uint128_t|unsigned long long v9;  // xmm1
    ...
    if (v4->field_4 != 0)
    {
        ...
        if ((((char)((long long)(BinaryOp CmpF))) & 1) != 0)
        {
            ...
            while (true)
            {
                ...
                if ((((char)((long long)(BinaryOp CmpF))) & 1) == 0 && (tmp_13 ^ 0x8000000000000000) >= *(v3 + (v2 << 3)) || tmp_6 >= *(v3 + (v2 << 3)) && (((char)((long long)(BinaryOp CmpF))) & 1) != 0)
                {
