...
int readlinebuffer_delim()
{
    ...
    struct_2 * v12;  // r12
    struct_2 * v13;  // r15
    struct_1 *|char * v3;  // rax
    struct_3 * v4;  // rax
    unsigned long long v5;  // rcx
    unsigned long v6;  // rdx
    unsigned long long|unsigned int v7;  // ebx
    struct_0 *v8;  // rbp
    struct_0 *v9;  // rsi
    ...
    if (((long long)(v9->field_0 & 16)) == 0)
    {
        ...
        while (true)
        {
            ...
            if (((int)v7) == -1 && ((long long)(v8->field_0 & 32)) == 0 && v8->field_8 >= v8->field_10 && v13 != v12 && *(v12 + 0x1) != v6 && v12 == v0 || (v8->field_8 < v8->field_10 || ((int)v7) != -1) && v12 == v5)
            {
                v0 = v11;
                tmp_7 = v13->field_0;
