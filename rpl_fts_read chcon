...
int rpl_fts_read()
{
    ...
    BOT tmp_11;  // tmp #11
    BOT tmp_9;  // tmp #9
    struct_8 *|unsigned long long|unsigned int v1;  // eax
    char *v10;  // rdx
    unsigned long long|struct_2 * v11;  // rbx
    struct_3 *v12;  // rbp
    unsigned long v13;  // rdi
    struct_1 *|void *|unsigned long long|unsigned int v14;  // rdi
    unsigned long long v15;  // rdi
    struct_6 *|unsigned long long v16;  // r12
    struct_4 *|void * v17;  // r13
    struct_5 *|struct_10 * v18;  // r14
    unsigned short v19;  // cc_dep1
    unsigned long long v6;  // rax
    unsigned long long|unsigned int v7;  // eax
    struct_2 *v9;  // rax
