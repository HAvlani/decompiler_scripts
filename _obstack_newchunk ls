...
int _obstack_newchunk()
{
    ...
    v5 = v8->field_8;
    tmp_21 = v6;
    tmp_23 = v6 + v8->field_18 - v8->field_10 + v8->field_30;
    ...
    tmp_102 = v6 + v8->field_18 - v8->field_10 + v8->field_30 + (v8->field_18 - v8->field_10 >> 3) + 100;
    tmp_108 = v6 + v8->field_18 - v8->field_10 + v8->field_30 <= v8->field_0;
    v7 = (v6 + v8->field_18 - v8->field_10 + v8->field_30 <= v8->field_0? v8->field_0 : v6 + v8->field_18 - v8->field_10 + v8->field_30);
    v9 = (tmp_102 <= (tmp_108? v8->field_0 : tmp_23)? v7 : tmp_102);
    if (((long long)[D] amd64g_calculate_condition(0x2<64>, 0x4<64>, t21, Sub(Load(addr=(rdi<8> + 0x18<64>), size=8, endness=Iend_LE), Load(addr=(rdi<8> + 0x10<64>), size=8, endness=Iend_LE)), cc_ndep<8>)) == 0)
    {
        ...
        if (v3 == 0)
        {
            ...
            if (v11 != 0)
            {
                ...
                v4->field_20 = v11 + v9;
                v11[0] = v11 + v9;
                v10 = v11 + v4->field_30 + 16 & !(v4->field_30);
                v1 = memcpy(v11 + v4->field_30 + 16 & !(v4->field_30), v4->field_10, v12);
                if (((long long)(v4->field_50 & 2)) == 0)
                {
                    v1 = !(v4->field_30) & v5 + v4->field_30 + 16;
