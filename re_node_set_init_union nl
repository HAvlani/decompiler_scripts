...
int re_node_set_init_union()
{
    ...
    unsigned long long|void *|unsigned long long [3] v10;  // rsi
    struct_0 *|unsigned long long|void * v11;  // rdi
    ...
    if (v10 == 0 || ((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, Load(addr=(rsi<8> + 0x8<64>), size=8, endness=Iend_LE), 0x0<64>, cc_ndep<8>)))
    {
        if (!(v7 != 0))
        {
            v14->field_10 = 0;
