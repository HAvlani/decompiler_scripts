...
int re_acquire_state_context()
{
    ...
    struct_4 *|unsigned long long|unsigned int v13;  // rdi
    ...
    struct_5 *|unsigned long long|unsigned int|struct_6 * v5;  // rax
                        ...
                        if (v9 != 0 || *((*(v20->field_10 + (v18 << 3)) << 4) + *(v18) + 8) != 1)
                        {
                            ...
                            *(v17 + 104) = ((char)(...));
                            ...
                            if (v9 != 0)
                            {
                                ...
                                if (((long long)(((char)v8) & 1)) == 0 && ((long long)(v14 & 1)) != 0 || ((long long)(((char)v8) & 4)) == 0 && (((char)v14) & 64) != 0 || ((long long)(((char)v8) & 2)) == 0 && ((long long)(v14 & 16)) != 0 || ((long long)(((char)v8) & 1)) != 0 && ((long long)(v14 & 2)) != 0)
                                {
                                    v9 = v18 - r10<8>;
