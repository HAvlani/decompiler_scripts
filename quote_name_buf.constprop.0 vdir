...
int quote_name_buf.constprop.0()
{
    ...
    void *|unsigned long long|char * v16;  // rsi
    struct_1 *|unsigned long long v17;  // rdi
    struct_1 *v18;  // r8
    char *v19;  // r9
    unsigned long long|char * v2;  // [bp-0x80]
    unsigned long|unsigned long long v20;  // r12
    unsigned long|unsigned long long v21;  // r13
    unsigned long long v22;  // r14
    unsigned long|unsigned int v23;  // r15
    char v3;  // [bp-0x69]
    struct_1 *v4;  // [bp-0x68]
    char v5;  // [bp-0x4c]
    unsigned long long v6;  // [bp-0x48]
    char|unsigned long|unsigned long long|char * v8;  // rax
    ...
    if (((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) == 0 && v12 != 0 || v12 != 0 && ((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) != 0)
    {
    ...
    {
        if (v23 != 0 && (((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) != 0 || v12 != 0))
        {
            v14 = v20;
            /* goto 4228089; */
        }
    ...
    if (v12 == 0 && ((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) != 0 || ((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) != 0 && v23 != 0 || v23 != 0 && v12 != 0)
    {
        v11 = __ctype_get_mb_cur_max();
        v16 = v2;
        v17 = v2 + v14;
        v1 = v2 + v14;
        if (v11 <= 1)
        {
            if (v1 > v2)
            {
                ...
                do
                {
                    if (((long long)(*(v11->field_0 + (((long long)*(v13)) << 1) + 1) & 64)) == 0)
                    {
                        *(v13) = 63;
                    }
                    v13 += 1;
        ...
        else if (v17 > v2)
        {
            ...
            {
                v11 = ((long long)*(v21));
                if (!(((char)(((long long)*(v21)) <= 95))) && (v11 - 97 & 255) > 29)
                {
                    /* goto 4228341; */
                }
                if ((((char)(((long long)*(v21)) <= 95)) || (v11 - 97 & 255) > 29) && (((char)(((long long)v11) <= 64)) || !(((char)(((long long)*(v21)) <= 95)))) && (((char)(((long long)v11) <= 31)) || !(((char)(((long long)*(v21)) <= 95))) || !(((char)(((long long)v11) <= 35)))) && (((char)(((long long)v11) <= 35)) || !(((char)(((long long)*(v21)) <= 95))) || (v11 - 37 & 255) > 26))
                {
                    v6 = 0;
                    v22 = v21;
                    while (true)
                    {
                        ...
                        if (v11 == 18446744069414584319 || v11 == 18446744069414584318)
                        {
                            break;
                        }
                    }
    ...
    if (align_variable_outer_quotes != 0 || v12 == 0 && ((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) != 0 || ((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) != 0 && v23 != 0 || v23 != 0 && v12 != 0)
    {
        *(v19) = v8;
        if (v18 != 0)
        {
