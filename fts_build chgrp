...
int fts_build()
{
    ...
    unsigned long long|unsigned int|struct_5 *|struct_1 *|char|unsigned long long [12] v15;  // rax
    ...
    struct_6 *v28;  // rbp
    struct_5 * v29;  // rbp
    unsigned long|struct_5 * v3;  // [bp-0x88]
    unsigned long long|unsigned int|void * v30;  // esi
    ...
    unsigned long long|struct_1 * v36;  // r14
    struct_6 * v37;  // r15
    struct_1 *v4;  // [bp-0x80]
    unsigned long v5;  // [bp-0x78]
    unsigned long|char *|unsigned long long v6;  // [bp-0x70]
    ...
    if (...)
    {
        ...
        if (v31 != 0)
        {
            ...
            while (true)
            {
                ...
                if (v37 != 0)
                {
                    if (((long long)(v37->field_48 & 32)) == 0 && v37->field_14 == 46 && v37->field_13 == 46 && v37->field_14 != 0)
                    {
                        /* goto 4215428; */
                    }
                    if (((long long)(v37->field_48 & 32)) != 0 || v37->field_13 != 46 || v37->field_14 != 46 && v37->field_14 != 0)
                    {
                        v35 = strlen(v37 + 19);
                    ...
                    if (!(((char)[D] amd64g_calculate_condition(0x2<64>, 0x4<64>, r13<8>, Load(addr=stack_base-160, size=8, endness=Iend_LE), cc_ndep<8>))))
                    {
                        ...
                        *(v1 + 120) = v37->field_0;
                        ...
                        if (v37->field_40 == 0 || ((long long)(dh<1> & 4)) != 0)
                        {
                            ...
                            if ((((int)v15) <= 11 || ((long long)(v30 & 251)) != 0) && (((int)v15) <= 11 || ((long long)(dl<1> & 8)) != 0) && (((long long)(v30 & 251)) == 0 || (((char)((int)rdx<8>)) & 16) == 0 || ((long long)(dl<1> & 8)) == 0) && (((long long)(v30 & 251)) == 0 || v30 == 10 || ((long long)(dl<1> & 8)) == 0))
                            {
                                v25 = 2;
                            }
                            if (((int)v15) <= 11 || (((char)((int)rdx<8>)) & 16) == 0 && v30 == 10 && ((long long)(v30 & 251)) != 0 && ((long long)(dl<1> & 8)) != 0)
                            {
