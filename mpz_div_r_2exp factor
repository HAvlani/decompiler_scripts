...
int mpz_div_r_2exp()
{
    ...
    char v13;  // bpl
    unsigned long long|struct_0 * v14;  // rsi
    unsigned long long|struct_1 * v15;  // rdi
    struct_0 *v16;  // r8
    ...
    struct_2 *|unsigned long long v8;  // rax
        ...
        if (!(((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr((rdx<8> + 0x3f<64>), 0x6<8>), Shr((rdx<8> + 0x3f<64>), 0x5<8>), cc_ndep<8>))))
        {
            ...
            else
            {
                ...
                if (v8 != 0)
                {
                    ...
                    {
                        v8 = v17 + ((long long)((v14->field_4 ^ ((int)(v20 >> 31))) - ((int)(v20 >> 31)))) * 8;
                        v10 = v17 + v22 * 8 - 8;
                        do
                        {
                            v8->field_0 = 18446744069414584319;
                            v8 += 8;
                        }
                        while (v8 != v10);
                    }
            ...
            if (v22 <= ((long long)((v21 ^ ((int)(v20 >> 31))) - ((int)(v20 >> 31)))) || v9 == reg_56<4> && v8 != 0 || v14 == v15 && v9 != reg_56<4> || v9 != reg_56<4> && v9->field_0 != 0)
            {
                while (true)
                {
                    if (v4 != 0)
