...
int update_cur_sifted_state()
{
    ...
    struct_2 *v17;  // [bp-0x48]
    unsigned long long [4]|unsigned long long|unsigned int|struct_12 * v19;  // rax
    unsigned long long|unsigned long long [9]|unsigned long long [10] v2;  // [bp-0xd0]
    unsigned long long v20;  // rax
    unsigned long long [28]|struct_2 *|unsigned long long|struct_11 * v21;  // rcx
    unsigned long long v22[3];  // rcx
    unsigned long long [4]|struct_2 *|unsigned long long v23;  // rdx
    unsigned long long v24;  // rdx
    struct_9 *|unsigned long long v25;  // rbx
    struct_2 * v26;  // rbp
    unsigned long long [4]|unsigned long long|unsigned int|struct_3 * v27;  // rsi
    ...
    unsigned long long|struct_8 * v32;  // r12
    struct_2 *|unsigned long long v33;  // r13
    unsigned long|unsigned long long v34;  // r14
    struct_10 *|struct_2 *|unsigned long long v35;  // r15
    ...
    unsigned long|struct_3 * v7;  // [bp-0xa8]
                ...
                if (v34 == *(v21[27] + tmp_6 + 8))
                {
                    ...
                    if (v19[2] > 0)
                    {
                        ...
                        do
                        {
                            ...
                            if (v19 == 4 && (v34 != v25->field_18 || *(v3->field_18 + (v2 << 3)) != v25->field_10))
                            {
                                v32 = v9;
                                v35 = v10 + v1->field_d8;
                                v6 = v13 * 24;
                                ...
                                while (true)
                                {
                                    ...
                                    if (v13 == v35->field_0 && ((long long)v19) == 0 && v29 <= v25->field_18 && ((long long)v12) != 0 && *(v25->field_0 + (v29 << 3)) != 0 && v19 != 0 || ((long long)v12) == 0 && v13 == v35->field_0 && ((long long)v19) == 0 && v29 <= v25->field_18 && *(v25->field_0 + (v29 << 3)) != 0 && v19 != 0 && ((int)v19) == 0)
                                    {
                                        v13 = *(v3->field_18 + 0 * 8);
                                        v7 = &stack_base-120;
                                        v14 = v34;
