...

{
  ...
  *(byte *)&token->opr = bVar10;
  uVar12 = (uint)syntax;
  if (iVar8 < 2) {
    if (bVar10 == 0x5c) goto LAB_00110490;
    ...
    *(uint *)&token->field_0x8 =
    ...
    if (bVar10 < 0x40) {
LAB_001103c4:
      if (bVar10 < 10) goto switchD_00110484_caseD_5c;
      switch(bVar10) {
      case 10:
        iVar8 = 1;
...
LAB_0011058e:
        ...
        break;
      default:
        goto switchD_00110484_caseD_5c;
      case 0x24:
...
LAB_0011046b:
    ...
    case 0x7b:
      iVar8 = 1;
      iVar7 = 1;
      if ((uVar12 & 0x1200) != 0x1200) goto LAB_001103ff;
      goto LAB_001106cb;
    case 0x7c:
      if ((uVar12 & 0x8400) == 0x8000) goto LAB_0011058e;
      break;
    case 0x7d:
      iVar8 = 1;
      iVar7 = 1;
...
switchD_00110484_caseD_5c:
    ...
    if (bVar10 != 0x5c) {
      ...
      if (0x3f < bVar10) goto LAB_0011046b;
      goto LAB_001103c4;
    }
LAB_00110490:
    lVar1 = lVar3 + 1;
...
LAB_0011097b:
        if (input->offsets_needed == '\0') {
          ...
          if ((bVar10 & 0x80) != 0) goto LAB_001104cf;
        }
        goto LAB_001104db;
      }
      pwVar11 = input->wcs + lVar1;
