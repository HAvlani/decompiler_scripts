      ...
      do {
        ...
        if (IVar8 != 0) {
          ...
          if (cur_str == lVar13) {
            ...
            if (IVar9 == 0) goto code_r0x00113be7;
          }
          else {
...
LAB_00113d1a:
              ...
              *new_dests.elems = IVar8;
              ...
              if ((err != _REG_NOERROR) || (_Var3 != true)) {
                ...
                rVar6 = err;
                if (err == _REG_NOERROR) goto LAB_00113d1a;
                goto LAB_00113ce0;
              }
              pprVar12 = mctx->state_log + lVar13;
            }
            ...
            *pprVar12 = prVar7;
            ...
            if ((mctx->state_log[lVar13] == (re_dfastate_t *)0x0) &&
               (rVar6 = err, err != _REG_NOERROR)) goto LAB_00113ce0;
          }
        }
LAB_00113b80:
        pcVar1 = &prVar14->more;
...
code_r0x00113be7:
  ...
  rpl_free(new_dests.elems);
  if ((rVar4 | rVar5 | err) != 0) goto LAB_00113d21;
  prVar14 = mctx->bkref_ents;
  goto restart;
LAB_00113d21:
  rVar6 = err;
