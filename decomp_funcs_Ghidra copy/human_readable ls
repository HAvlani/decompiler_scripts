...

{
  ...
  bVar26 = 0xf < sVar10 - 1;
  if (bVar26) {
    puVar24 = (undefined8 *)&DAT_00118dca;
  }
  ...
  if (from_block_size < to_block_size) {
    if (from_block_size != 0) {
      ...
      if (to_block_size % from_block_size == 0) {
        ...
        goto joined_r0x0010fbdd;
      }
    }
LAB_0010fa25:
    fVar27 = (float10)from_block_size;
    if ((long)from_block_size < 0) {
      fVar27 = fVar27 + (float10)_DAT_0011b338;
    }
    if ((long)to_block_size < 0) {
      fVar27 = fVar27 / ((float10)to_block_size + (float10)_DAT_0011b338);
      if ((long)n < 0) goto LAB_0010fe20;
LAB_0010fa62:
      fVar27 = (float10)n * fVar27;
      if ((opts & 0x10U) != 0) goto LAB_0010fa6f;
LAB_0010fd50:
      if ((uVar8 != 1) && (fVar27 < _DAT_0011b3a0)) {
      ...
      if (-1 < (long)n) goto LAB_0010fa62;
LAB_0010fe20:
      fVar27 = ((float10)n + (float10)_DAT_0011b338) * fVar27;
      if ((opts & 0x10U) == 0) goto LAB_0010fd50;
LAB_0010fa6f:
      uVar19 = 0;
      ...
      if (uVar8 == 1) {
        ...
        sVar11 = strlen(buf_1);
        if (sVar11 <= uVar22) goto LAB_0010ff48;
      }
      else {
        if (fVar27 < _DAT_0011b3a0) {
          adjust_value(uVar8,(longdouble)CONCAT610(uVar30,fVar27));
        }
        __sprintf_chk(buf_1,1,0xffffffffffffffff);
        sVar11 = strlen(buf_1);
...
LAB_0010ff48:
          ...
          if (uVar8 == 1) goto LAB_0010fb45;
        }
        if (fVar27 * (float10)_DAT_0011b394 < _DAT_0011b3a0) {
          adjust_value(uVar8,(longdouble)CONCAT610(uVar30,fVar27 * (float10)_DAT_0011b394));
        }
      }
LAB_0010fb45:
      __sprintf_chk(buf_1,1,0xffffffffffffffff);
...
LAB_0010fda2:
    ...
    if ((from_block_size % to_block_size != 0) ||
       ...
       SUB168(ZEXT816(uVar22) /
              ...
              (undefined  [16])0xffffffffffffffff),0) != n)) goto LAB_0010fa25;
    uVar15 = 0;
    uVar21 = 0;
    uVar7 = 0;
joined_r0x0010fbdd:
    ...
    if ((opts & 0x10U) == 0) {
      uVar19 = 0xffffffff;
LAB_0010fbf6:
      if (uVar8 != 1) goto LAB_0010fc06;
      puVar12 = local_c0;
      if (5 < (int)(uVar7 + (((uint)uVar22 & 1) + uVar15 != 0))) goto LAB_0010fc16;
LAB_0010fc40:
      do {
      ...
      uVar20 = (ulong)uVar6;
      uVar19 = 0;
      if (uVar22 < uVar20) goto LAB_0010fbf6;
      while( true ) {
        ...
        if (uVar19 == 8) goto LAB_0010fbf6;
      }
      if (9 < uVar13) goto LAB_0010fbf6;
      if (uVar8 == 1) {
...
LAB_00110168:
        if ((opts & 8U) != 0) goto LAB_001101b0;
        cVar5 = '0';
      }
      else {
        cVar5 = (char)uVar21 + '0';
...
LAB_001101b0:
      puVar12 = puVar25;
      if (uVar8 == 1) goto LAB_0010fc40;
      uVar7 = 0;
LAB_0010fc06:
      puVar12 = puVar25;
      if ((uVar8 != 0) || ((int)(uVar15 + uVar7) < 1)) goto LAB_0010fc40;
LAB_0010fc16:
      uVar22 = uVar22 + 1;
      puVar25 = puVar12;
      if ((((opts & 0x10U) == 0) || (uVar6 != uVar22)) || (uVar19 == 8)) goto LAB_0010fc40;
      uVar19 = uVar19 + 1;
      if ((opts & 8U) == 0) {
  ...
  if ((opts & 0x80U) == 0) goto LAB_0010fde7;
  if (uVar19 == 0xffffffff) {
    ...
    if ((opts & 0x40U) != 0) goto LAB_0010ffb1;
LAB_0010ffcc:
...
LAB_0011011c:
      ...
      *(char *)local_c0 = ""[(int)uVar19];
      if ((opts & 0x100U) == 0) goto LAB_0011011c;
      puVar24 = (undefined8 *)((long)local_c0 + 1);
      if (uVar16 != 0) {
...
LAB_0010fdd4:
    if ((opts & 0x100U | uVar19) == 0) goto LAB_0010fde7;
    if ((opts & 0x40U) != 0) {
LAB_0010ffb1:
      local_c0 = (undefined8 *)(buf_1 + 0x288);
      buf_1[0x287] = ' ';
    }
    if (uVar19 != 0) goto LAB_0010ffcc;
    puVar24 = local_c0;
    if ((opts & 0x100U) == 0) goto LAB_0010fde7;
  }
