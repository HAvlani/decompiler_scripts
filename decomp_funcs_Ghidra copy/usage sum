...

{
  ...
  __printf_chk(1,uVar4,&DAT_00108013,0x10);
  pFVar1 = stdout;
  ...
  if (puVar10 == (undefined1 *)0x0) {
    ...
    if (pcVar5 != (char *)0x0) {
      ...
      if (iVar3 != 0) {
        puVar10 = &DAT_00108072;
        goto LAB_00103442;
      }
    }
    uVar4 = dcgettext(0,"Full documentation <%s%s>\n",5);
    puVar10 = &DAT_00108072;
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/",&DAT_00108072);
    pcVar5 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
