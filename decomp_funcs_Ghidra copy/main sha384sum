...

{
  ...
  uchar bin_buffer_unaligned_1 [56];
  char *local_40;
...
LAB_00102a40:
  ...
  do {
    local_108 = (char **)((int *)argv + (long)(int)s * 2);
    if (optind == (int)s) {
      *local_108 = "-";
      local_108 = local_108 + 1;
    }
    local_130 = (char **)((int *)argv + (long)optind * 2);
    if (local_130 < local_108) {
      ...
      do {
        ...
        if (local_131 == '\0') {
          ...
          _Var5 = digest_file(local_128,(uchar *)argv,(_Bool *)__n,(uintmax_t *)poVar16,piVar22);
          uVar4 = digest_delim;
          if (_Var5 == false) {
            local_df = 0;
          }
            ...
            _Var5 = false;
            if ((digest_delim == '\n') &&
               (((pcVar20 = strchr(local_128,0x5c), pcVar20 != (char *)0x0 ||
                 (pcVar20 = strchr(local_128,10), pcVar20 != (char *)0x0)) ||
                (pcVar20 = strchr(local_128,0xd), pcVar20 != (char *)0x0)))) {
            ...
            if (bVar2) {
              ...
              print_filename(local_128,_Var5);
...
LAB_00103216:
                    ...
                    if (cVar27 == '=') {
                      ...
                      do {
                        do {
                          local_110 = piVar22;
                          piVar22 = (int *)((long)local_110 + 1);
                        } while (*(byte *)local_110 == 0x20);
                      } while (*(byte *)local_110 == 9);
                      cVar27 = hex_digits((uchar *)local_110);
                      goto LAB_001034db;
                    }
                  }
                }
...
LAB_00102c47:
              do {
                ...
                if (warn != false) {
                  bin_result = (FILE *)quotearg_n_style_colon(0,3,local_128);
...
LAB_00102c5a:
                ...
                while( true ) {
                  ...
                  __stream = (FILE *)quotearg_n_style_colon(0,3,local_128);
...
LAB_001034db:
                  ...
                  _Var6 = digest_file(s,(uchar *)bin_result,&missing_1,(uintmax_t *)length,local_110
                                     );
                  if (_Var6 == false) {
...
LAB_00102e38:
                    ...
                    if (uVar10 == 0) {
                      ...
                      do {
                        ...
                        if (((*pp_Var11)[*(byte *)((long)local_110 + uVar17 * 2)] !=
                             (int)"0123456789abcdef9.1"[bVar15 >> 4]) ||
                           (length = (FILE *)(ulong)*(byte *)((long)local_110 + uVar17 * 2 + 1),
                           (*pp_Var11)[(long)length] != (int)"0123456789abcdef9.1"[bVar15 & 0xf])) {
                          local_f8 = (FILE *)((long)&local_f8->_flags + 1);
                    ...
                    local_de = status_only;
                    if ((status_only == false) && (local_de = quiet, quiet == false)) {
                      local_de = _Var6;
                      if (_Var5 == false) {
...
LAB_00102e95:
              if ((int)s < 0) {
                if (cVar3 == '\0') {
                  poVar16 = (option *)quotearg_n_style_colon(0,3,local_128);
...
LAB_00103165:
                  ...
                  if (local_120 != (FILE *)0x0) {
                    ...
                    uVar9 = dcngettext(0,"WARNING: %lu line is improperly formatted",
                                       "WARNING: %lu lines are improperly formatted",local_120);
                  ...
                  if (local_100 != (FILE *)0x0) {
                    ...
                    uVar9 = dcngettext(0,"WARNING: %lu listed file could not be read",
                                       "WARNING: %lu listed files could not be read",local_100);
                  ...
                  if (local_f8 != (FILE *)0x0) {
                    ...
                    uVar9 = dcngettext(0,"WARNING: %lu computed checksum did NOT match",
                                       "WARNING: %lu computed checksums did NOT match",local_f8);
                    poVar16 = (option *)local_f8;
                    error(0,0,uVar9);
                    argv = (char **)local_f8;
                  }
...
LAB_00102ef1:
                  if (((ulong)local_100 | (ulong)local_f8) != 0) goto LAB_00103165;
                  bVar15 = strict ^ 1U | local_120 == (FILE *)0x0;
                }
                else {
LAB_00103328:
                  if (local_de != '\0') goto LAB_00102ef1;
                  bVar15 = 0;
                }
                bVar15 = bVar15 & 1;
                goto LAB_00102f1c;
...
LAB_00103195:
            ...
            __stream = (FILE *)fopen_safer(local_128,"r");
...
LAB_00102f1c:
          local_df = local_df & bVar15;
        }
        local_130 = local_130 + 1;
      } while (local_130 < local_108);
    }
    else {
      local_df = 1;
    }
