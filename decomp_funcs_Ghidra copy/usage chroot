...

{
  ...
  uVar4 = dcgettext(0,"Usage: %s [OPTION] NEWROOT [COMMAND [ARG]...]\n  or:  %s OPTION\n",5);
  __printf_chk(1,uVar4,pcVar5,pcVar5);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Run COMMAND with root directory set to NEWROOT.\n\n",5);
  ...
  pcVar5 = (char *)dcgettext(0,
                             ...
                             ,5);
  fputs_unlocked(pcVar5,pFVar1);
  pcVar5 = quotearg_style(shell_escape_always_quoting_style,"/");
  uVar4 = dcgettext(0,"      --skip-chdir           do not change working directory to %s\n",5);
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "chroot";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","chroot");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
