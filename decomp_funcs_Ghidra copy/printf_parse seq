...
LAB_00108976:
    do {
      ...
      if (bVar15 == 0x27) {
        ...
        if (bVar15 != 0x49) goto LAB_001089d8;
  ...
  sVar20 = 0xffffffffffffffff;
  if (*pbVar16 != 0x24) goto LAB_00108976;
  uVar12 = 0;
  do {
    pbVar17 = (byte *)format;
    ...
    while( true ) {
      ...
      if (9 < (byte)(bVar15 - 0x30)) goto switchD_00108c55_caseD_26;
      pbVar17 = pbVar17 + 1;
      uVar14 = 0xffffffffffffffff;
      uVar11 = (ulong)((char)bVar15 + -0x30);
    }
  ...
  goto switchD_00108c55_caseD_26;
LAB_001089d8:
  if (bVar15 != 0x2a) {
    uVar11 = local_80;
    pbVar16 = (byte *)format;
...
joined_r0x00108b76:
    ...
    uVar11 = local_78;
    local_70 = uVar12;
    if (bVar15 != 0x2e) goto LAB_001089f2;
    bVar15 = pbVar16[1];
    ...
    if ((byte)(pbVar16[2] - 0x30) < 10) {
      ...
      if (*pbVar16 != 0x24) goto LAB_00108bbe;
      uVar14 = 0;
      do {
      ...
      uVar14 = uVar14 - 1;
      if (0xfffffffffffffffd < uVar14) goto switchD_00108c55_caseD_26;
...
LAB_00108bbe:
      ...
      if (pcVar8->precision_arg_index == 0xffffffffffffffff) {
        ...
        local_70 = uVar12 + 1;
        uVar14 = uVar12;
        if (uVar12 == 0xffffffffffffffff) goto switchD_00108c55_caseD_26;
      }
    }
    __ptr = a->arg;
    if (uVar14 < uVar18) {
...
LAB_001089f2:
        ...
        do {
          ...
          if (bVar15 == 0x68) {
            ...
            if ((((bVar15 != 0x6c) && (bVar15 != 0x6a)) && ((bVar15 & 0xdf) != 0x5a)) &&
               (bVar15 != 0x74)) goto code_r0x00108c44;
            uVar4 = uVar4 + 8;
          }
          bVar15 = *pbVar16;
        } while( true );
    ...
    if (uVar18 < 0x800000000000000) {
      if (paVar2 == __ptr) {
        ...
        paVar6 = __ptr;
        __ptr = paVar10;
        if (paVar10 == (argument *)0x0) goto LAB_00109248;
LAB_001094f0:
...
LAB_0010930b:
      ...
      if (__ptr != (argument *)0x0) {
        paVar6 = paVar2;
        if (paVar2 == a->arg) goto LAB_001094f0;
        goto LAB_0010930b;
      }
      goto LAB_00109469;
    }
  ...
  if ((byte)(((byte *)format)[1] - 0x30) < 10) {
    ...
    if (*pbVar13 != 0x24) goto LAB_00108a7d;
    uVar14 = 0;
    do {
      uVar12 = (ulong)(iVar5 + -0x30);
      pbVar16 = pbVar17;
...
LAB_00108a7d:
    ...
    uVar14 = local_70;
    local_70 = local_70 + 1;
    if (bVar22) goto switchD_00108c55_caseD_26;
  }
  __ptr = a->arg;
  if (uVar14 < uVar18) {
    uVar12 = a->count;
LAB_00108b30:
  ...
  if (paVar2 != __ptr) {
    ...
    if (paVar6 != (argument *)0x0) {
      uVar12 = a->count;
      paVar10 = paVar2;
      if (paVar2 == __ptr) goto LAB_0010935d;
      goto LAB_00108b2c;
    }
    goto out_of_memory;
  }
...
code_r0x00108c44:
  switch(bVar15) {
  case 0x25:
    goto switchD_00108c55_caseD_25;
  default:
    goto switchD_00108c55_caseD_26;
  case 0x41:
  case 0x45:
...
LAB_00109469:
    ...
    if (pcVar1 != __ptr_00) {
      ...
      if (pcVar8 != (char_directive *)0x0) {
        __ptr_00 = d->dir;
        uVar12 = d->count;
        if (pcVar1 != __ptr_00) goto LAB_00108d81;
        goto LAB_00108eca;
      }
      goto LAB_00109469;
    }
...
LAB_00108d81:
    ...
    __ptr = a->arg;
    if (paVar2 == __ptr) goto LAB_00109258;
  }
  else {
    uVar18 = uVar18 * 2;
    if (uVar18 <= sVar20) {
...
LAB_0010910f:
      ...
      if (__ptr != (argument *)0x0) {
        paVar6 = paVar2;
        if (paVar2 == a->arg) goto LAB_001091ee;
        goto LAB_0010910f;
      }
      goto LAB_00109469;
    }
out_of_memory:
    if (paVar2 == __ptr) goto LAB_00109248;
  }
  rpl_free(__ptr);
LAB_00109248:
  if (pcVar1 != d->dir) {
