...
void sha1_process_bytes(void *buffer,size_t len,sha1_ctx *ctx)

{
  ...
  if (ctx->buflen != 0) {
    ...
    ctx->buflen = uVar11;
    if (0x40 < uVar11) {
      sha1_process_block(puVar13,(ulong)(uVar11 & 0xffffffc0),ctx);
      uVar11 = ctx->buflen;
  ...
  if (0x3f < len) {
    if (((ulong)buffer & 3) != 0) {
      if (len != 0x40) {
        ...
        do {
          ...
          sha1_process_block(ctx->buffer,0x40,ctx);
          puVar10 = puVar9;
    ...
    sha1_process_block(buffer,len & 0xffffffffffffffc0,ctx);
...
LAB_001057f2:
  ...
  if (0x3f < uVar4) {
    uVar4 = uVar4 - 0x40;
    sha1_process_block(puVar13,0x40,ctx);
