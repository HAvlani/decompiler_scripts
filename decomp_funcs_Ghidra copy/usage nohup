...

{
  ...
  uVar4 = dcgettext(0,"Usage: %s COMMAND [ARG]...\n  or:  %s OPTION\n",5);
  __printf_chk(1,uVar4,pcVar5,pcVar5);
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Run COMMAND, ignoring hangup signals.\n\n",5);
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "nohup";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","nohup");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
