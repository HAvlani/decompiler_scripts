...
LAB_0010a517:
  ...
  if ((mode == GMP_DIV_FLOOR) && ((int)uVar12 < 0)) {
    if (dn == 0) {
LAB_0010a670:
      if (q != (__mpz_struct *)0x0) goto LAB_0010a675;
LAB_0010a6c8:
      lVar8 = (long)tr[0]._mp_alloc;
      if (r != (__mpz_struct *)0x0) goto LAB_0010a6d7;
    }
    else {
      if (q != (__mpz_struct *)0x0) {
        mpz_sub_ui(tq,tq,1);
        if (r != (__mpz_struct *)0x0) goto LAB_0010a570;
        goto LAB_0010a675;
      }
      if (r != (__mpz_struct *)0x0) {
LAB_0010a570:
...
LAB_0010a869:
    ...
    goto LAB_0010a670;
    if (q == (__mpz_struct *)0x0) {
      if (r == (__mpz_struct *)0x0) goto LAB_0010a869;
    }
    else {
      mpz_add_ui(tq,tq,1);
      if (r == (__mpz_struct *)0x0) goto LAB_0010a675;
    }
    mpz_sub(tr,tr,d);
LAB_0010a848:
    if (q != (__mpz_struct *)0x0) {
