...
LAB_00108ed6:
    do {
      ...
      if (bVar15 == 0x27) {
        ...
        if (bVar15 != 0x49) goto LAB_00108f38;
  ...
  sVar20 = 0xffffffffffffffff;
  if (*pbVar16 != 0x24) goto LAB_00108ed6;
  uVar12 = 0;
  do {
    pbVar17 = (byte *)format;
    ...
    while( true ) {
      ...
      if (9 < (byte)(bVar15 - 0x30)) goto switchD_001091b5_caseD_26;
      pbVar17 = pbVar17 + 1;
      uVar14 = 0xffffffffffffffff;
      uVar11 = (ulong)((char)bVar15 + -0x30);
    }
  ...
  goto switchD_001091b5_caseD_26;
LAB_00108f38:
  if (bVar15 != 0x2a) {
    uVar11 = local_80;
    pbVar16 = (byte *)format;
...
joined_r0x001090d6:
    ...
    uVar11 = local_78;
    local_70 = uVar12;
    if (bVar15 != 0x2e) goto LAB_00108f52;
    bVar15 = pbVar16[1];
    ...
    if ((byte)(pbVar16[2] - 0x30) < 10) {
      ...
      if (*pbVar16 != 0x24) goto LAB_0010911e;
      uVar14 = 0;
      do {
      ...
      uVar14 = uVar14 - 1;
      if (0xfffffffffffffffd < uVar14) goto switchD_001091b5_caseD_26;
...
LAB_0010911e:
      ...
      if (pcVar8->precision_arg_index == 0xffffffffffffffff) {
        ...
        local_70 = uVar12 + 1;
        uVar14 = uVar12;
        if (uVar12 == 0xffffffffffffffff) goto switchD_001091b5_caseD_26;
      }
    }
    __ptr = a->arg;
    if (uVar14 < uVar18) {
...
LAB_00108f52:
        ...
        do {
          ...
          if (bVar15 == 0x68) {
            ...
            if ((((bVar15 != 0x6c) && (bVar15 != 0x6a)) && ((bVar15 & 0xdf) != 0x5a)) &&
               (bVar15 != 0x74)) goto code_r0x001091a4;
            uVar4 = uVar4 + 8;
          }
          bVar15 = *pbVar16;
        } while( true );
    ...
    if (uVar18 < 0x800000000000000) {
      if (paVar2 == __ptr) {
        ...
        paVar6 = __ptr;
        __ptr = paVar10;
        if (paVar10 == (argument *)0x0) goto LAB_001097a8;
LAB_00109a50:
...
LAB_0010986b:
      ...
      if (__ptr != (argument *)0x0) {
        paVar6 = paVar2;
        if (paVar2 == a->arg) goto LAB_00109a50;
        goto LAB_0010986b;
      }
      goto LAB_001099c9;
    }
  ...
  if ((byte)(((byte *)format)[1] - 0x30) < 10) {
    ...
    if (*pbVar13 != 0x24) goto LAB_00108fdd;
    uVar14 = 0;
    do {
      uVar12 = (ulong)(iVar5 + -0x30);
      pbVar16 = pbVar17;
...
LAB_00108fdd:
    ...
    uVar14 = local_70;
    local_70 = local_70 + 1;
    if (bVar22) goto switchD_001091b5_caseD_26;
  }
  __ptr = a->arg;
  if (uVar14 < uVar18) {
    uVar12 = a->count;
LAB_00109090:
  ...
  if (paVar2 != __ptr) {
    ...
    if (paVar6 != (argument *)0x0) {
      uVar12 = a->count;
      paVar10 = paVar2;
      if (paVar2 == __ptr) goto LAB_001098bd;
      goto LAB_0010908c;
    }
    goto out_of_memory;
  }
...
code_r0x001091a4:
  switch(bVar15) {
  case 0x25:
    goto switchD_001091b5_caseD_25;
  default:
    goto switchD_001091b5_caseD_26;
  case 0x41:
  case 0x45:
...
LAB_001099c9:
    ...
    if (pcVar1 != __ptr_00) {
      ...
      if (pcVar8 != (char_directive *)0x0) {
        __ptr_00 = d->dir;
        uVar12 = d->count;
        if (pcVar1 != __ptr_00) goto LAB_001092e1;
        goto LAB_0010942a;
      }
      goto LAB_001099c9;
    }
...
LAB_001092e1:
    ...
    __ptr = a->arg;
    if (paVar2 == __ptr) goto LAB_001097b8;
  }
  else {
    uVar18 = uVar18 * 2;
    if (uVar18 <= sVar20) {
...
LAB_0010966f:
      ...
      if (__ptr != (argument *)0x0) {
        paVar6 = paVar2;
        if (paVar2 == a->arg) goto LAB_0010974e;
        goto LAB_0010966f;
      }
      goto LAB_001099c9;
    }
out_of_memory:
    if (paVar2 == __ptr) goto LAB_001097a8;
  }
  rpl_free(__ptr);
LAB_001097a8:
  if (pcVar1 != d->dir) {
