      ...
      if (dfa->nodes[bkref_str].field_0x8 == '\x04') {
        ...
        if ((uVar8 & 0x3ff00) != 0) {
          ...
          if ((uVar18 & 4) == 0) {
            if ((uVar18 & 8) != 0) {
              uVar15 = uVar7 & 1;
              goto joined_r0x001112df;
            }
          }
          else {
            if ((uVar7 & 1) == 0) goto LAB_00111300;
            uVar15 = uVar18 & 8;
joined_r0x001112df:
            if (uVar15 != 0) goto LAB_00111300;
          }
          if ((((uVar18 & 0x20) != 0) && ((uVar7 & 2) == 0)) ||
             (((uVar8 & 0x8000) != 0 && ((uVar7 & 8) == 0)))) goto LAB_00111300;
        }
        ...
        if ((lVar22 < lVar25) &&
          ...
          do {
            if (bkref_str == prVar11->node) goto LAB_0011140b;
            pcVar1 = &prVar11->more;
            prVar11 = prVar11 + 1;
          } while (*pcVar1 != '\0');
        }
...
LAB_00111748:
                      ...
                      if (iVar9 == 0) goto LAB_0011177b;
                    }
                    if (lVar19 < (long)sub_last->nlasts) goto LAB_001116c5;
                    prVar21 = prVar20;
                    lVar17 = lVar24;
                    if (lVar19 == 0) goto joined_r0x00111886;
                    break;
                  }
LAB_0011177b:
                  rVar10 = get_subexp_sub(in_RDI,(re_sub_match_last_t *)sub_last,(Idx)prVar13,
                                          bkref_str,sub_top);
                  puVar23 = (in_RDI->input).mbs;
                  if (1 < (uint)rVar10) goto LAB_00111620;
                  lVar19 = lVar19 + 1;
                  prVar20 = prVar21;
                  lVar24 = lVar17;
              ...
              do {
                ...
                if (lVar24 != sub_last->str_idx && -1 < lVar24 - sub_last->str_idx) {
                  ...
                  if ((re_sub_match_top_t *)*pIVar2 == prVar20 || *pIVar2 < (long)prVar20) {
                    ...
                    if (rVar10 != _REG_NOERROR) goto LAB_00111620;
                    puVar23 = (in_RDI->input).mbs;
                  }
                  ...
                  do {
                    ...
                    if ((prVar6->nodes[last_node].field_0x8 == '\t') &&
                      ...
                      if (path == (state_array_t *)0x0) {
                        ...
                        if (path != (state_array_t *)0x0) goto LAB_00111940;
                      }
                      else {
LAB_00111940:
                        ...
                        if ((re_dfastate_t **)sub_last->nlasts == (re_dfastate_t **)sub_last->alasts
                          ...
                          if (pprVar14 == (re_sub_match_last_t **)0x0) goto LAB_00111a26;
...
LAB_00111570:
              lVar25 = lVar25 + 1;
              if (in_RDI->nbkref_ents <= lVar25) goto LAB_00111300;
            }
            ...
            if ((lVar22 != lVar24) ||
               ...
               *pIVar2 == local_d0 || *pIVar2 < local_d0)) goto LAB_00111570;
