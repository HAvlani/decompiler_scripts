...
LAB_0010d4ec:
    ...
    if (lVar10 != 0) {
      ...
      if (lVar10 == top_str) goto LAB_0010dabc;
      ...
      if ((prVar12 != (re_dfastate_t *)0x0) && ((prVar12->field_0x68 & 0x40) != 0)) {
        ...
        err = rVar9;
        if (rVar9 != _REG_NOERROR) goto LAB_0010d910;
        if ((prVar12->field_0x68 & 0x40) == 0) goto LAB_0010d572;
        goto LAB_0010d973;
      }
      ...
      if (top_str < last_str) {
        ...
        do {
          ...
          if (mctx->state_log[local_f8] == (re_dfastate_t *)0x0) {
            if (prVar12 != (re_dfastate_t *)0x0) goto LAB_0010d611;
          }
          else {
            err = re_node_set_merge(&next_nodes,&mctx->state_log[local_f8]->nodes);
            if (err != _REG_NOERROR) goto LAB_0010da38;
...
LAB_0010d7e0:
            if ((next_nodes.nelem != 0) &&
               ((err = check_arrival_expand_ecl(dfa,&next_nodes,IVar13,type), err != _REG_NOERROR ||
                ...
                err != _REG_NOERROR)))) goto LAB_0010da38;
          }
