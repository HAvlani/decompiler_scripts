...

{
  ...
  bVar26 = 0xf < sVar10 - 1;
  if (bVar26) {
    puVar24 = (undefined8 *)&DAT_0011e2c0;
  }
  ...
  if (from_block_size < to_block_size) {
    if (from_block_size != 0) {
      ...
      if (to_block_size % from_block_size == 0) {
        ...
        goto joined_r0x00114a1d;
      }
    }
LAB_00114865:
    fVar27 = (float10)from_block_size;
    if ((long)from_block_size < 0) {
      fVar27 = fVar27 + (float10)_DAT_0011e330;
    }
    if ((long)to_block_size < 0) {
      fVar27 = fVar27 / ((float10)to_block_size + (float10)_DAT_0011e330);
      if ((long)n < 0) goto LAB_00114c60;
LAB_001148a2:
      fVar27 = (float10)n * fVar27;
      if ((opts & 0x10U) != 0) goto LAB_001148af;
LAB_00114b90:
      if ((uVar8 != 1) && (fVar27 < _DAT_0011e340)) {
      ...
      if (-1 < (long)n) goto LAB_001148a2;
LAB_00114c60:
      fVar27 = ((float10)n + (float10)_DAT_0011e330) * fVar27;
      if ((opts & 0x10U) == 0) goto LAB_00114b90;
LAB_001148af:
      uVar19 = 0;
      ...
      if (uVar8 == 1) {
        ...
        sVar11 = strlen(buf_1);
        if (sVar11 <= uVar22) goto LAB_00114d88;
      }
      else {
        if (fVar27 < _DAT_0011e340) {
          adjust_value(uVar8,(longdouble)CONCAT610(uVar30,fVar27));
        }
        __sprintf_chk(buf_1,1,0xffffffffffffffff);
        sVar11 = strlen(buf_1);
...
LAB_00114d88:
          ...
          if (uVar8 == 1) goto LAB_00114985;
        }
        if (fVar27 * (float10)_DAT_0011e334 < _DAT_0011e340) {
          adjust_value(uVar8,(longdouble)CONCAT610(uVar30,fVar27 * (float10)_DAT_0011e334));
        }
      }
LAB_00114985:
      __sprintf_chk(buf_1,1,0xffffffffffffffff);
...
LAB_00114be2:
    ...
    if ((from_block_size % to_block_size != 0) ||
       ...
       SUB168(ZEXT816(uVar22) /
              ...
              (undefined  [16])0xffffffffffffffff),0) != n)) goto LAB_00114865;
    uVar15 = 0;
    uVar21 = 0;
    uVar7 = 0;
joined_r0x00114a1d:
    ...
    if ((opts & 0x10U) == 0) {
      uVar19 = 0xffffffff;
LAB_00114a36:
      if (uVar8 != 1) goto LAB_00114a46;
      puVar12 = local_c0;
      if (5 < (int)(uVar7 + (((uint)uVar22 & 1) + uVar15 != 0))) goto LAB_00114a56;
LAB_00114a80:
      do {
      ...
      uVar20 = (ulong)uVar6;
      uVar19 = 0;
      if (uVar22 < uVar20) goto LAB_00114a36;
      while( true ) {
        ...
        if (uVar19 == 8) goto LAB_00114a36;
      }
      if (9 < uVar13) goto LAB_00114a36;
      if (uVar8 == 1) {
...
LAB_00114fa8:
        if ((opts & 8U) != 0) goto LAB_00114ff0;
        cVar5 = '0';
      }
      else {
        cVar5 = (char)uVar21 + '0';
...
LAB_00114ff0:
      puVar12 = puVar25;
      if (uVar8 == 1) goto LAB_00114a80;
      uVar7 = 0;
LAB_00114a46:
      puVar12 = puVar25;
      if ((uVar8 != 0) || ((int)(uVar15 + uVar7) < 1)) goto LAB_00114a80;
LAB_00114a56:
      uVar22 = uVar22 + 1;
      puVar25 = puVar12;
      if ((((opts & 0x10U) == 0) || (uVar6 != uVar22)) || (uVar19 == 8)) goto LAB_00114a80;
      uVar19 = uVar19 + 1;
      if ((opts & 8U) == 0) {
  ...
  if ((opts & 0x80U) == 0) goto LAB_00114c27;
  if (uVar19 == 0xffffffff) {
    ...
    if ((opts & 0x40U) != 0) goto LAB_00114df1;
LAB_00114e0c:
...
LAB_00114f5c:
      ...
      *(char *)local_c0 = ""[(int)uVar19];
      if ((opts & 0x100U) == 0) goto LAB_00114f5c;
      puVar24 = (undefined8 *)((long)local_c0 + 1);
      if (uVar16 != 0) {
...
LAB_00114c14:
    if ((opts & 0x100U | uVar19) == 0) goto LAB_00114c27;
    if ((opts & 0x40U) != 0) {
LAB_00114df1:
      local_c0 = (undefined8 *)(buf_1 + 0x288);
      buf_1[0x287] = ' ';
    }
    if (uVar19 != 0) goto LAB_00114e0c;
    puVar24 = local_c0;
    if ((opts & 0x100U) == 0) goto LAB_00114c27;
  }
