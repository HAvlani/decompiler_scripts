  ...
  if (uVar2 == 0) {
    ...
    if (e->_mp_size < 0) {
      ...
      if (dn <= lVar8) {
        ...
        pmVar6 = base[0]._mp_d;
        lVar8 = dn;
        if (-1 < b->_mp_size) goto LAB_0010ad42;
LAB_0010aff9:
        pmVar6 = base[0]._mp_d;
        ...
        pmVar6 = base[0]._mp_d;
        lVar8 = dn;
        if (mVar5 == 0) goto LAB_0010ad42;
                    /* WARNING: Subroutine does not return */
        __assert_fail("__cy == 0","lib/mini-gmp.c",0xc48,"mpz_powm");
      }
      pmVar6 = base[0]._mp_d;
      if (b->_mp_size < 0) goto LAB_0010aff9;
    ...
    do {
      ...
      do {
        while (mpz_mul(tr,tr,tr), (uVar9 & uVar4) != 0) {
          mpz_mul(tr,tr,base);
          if (tr[0]._mp_size <= iVar11) goto LAB_0010ae5a;
LAB_0010ae8d:
          mpn_div_qr_preinv((mp_ptr)0x0,tr[0]._mp_d,(long)tr[0]._mp_size,local_c8,dn,&minv);
          lVar8 = dn;
          do {
            if (tr[0]._mp_d[lVar8 + -1] != 0) goto LAB_0010aec8;
            lVar8 = lVar8 + -1;
          } while (lVar8 != 0);
          lVar8 = 0;
LAB_0010aec8:
          ...
          uVar9 = uVar9 >> 1;
          iVar10 = iVar10 + -1;
          if (iVar10 == 0) goto LAB_0010aed8;
        }
        if (iVar11 < tr[0]._mp_size) goto LAB_0010ae8d;
LAB_0010ae5a:
        uVar9 = uVar9 >> 1;
        iVar10 = iVar10 + -1;
      } while (iVar10 != 0);
