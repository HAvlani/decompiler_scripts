...

{
  ...
  if (__stream == (FILE *)0x0) {
    ...
    if (pmVar8 == (mount_entry *)0x0) goto LAB_0010e7ce;
    local_80 = &mount_list;
    ppcVar11 = (char **)getmntent(pmVar8);
    while (ppcVar11 != (char **)0x0) {
      lVar14 = hasmntopt(ppcVar11,&DAT_00123fd9);
