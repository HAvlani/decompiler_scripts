...
LAB_00117f5b:
  ...
  if (pcVar7 == s) {
    if ((valid_suffixes != (char *)0x0) && (cVar1 = *s, cVar1 != '\0')) {
      ...
      uVar13 = 1;
      if (pcVar9 != (char *)0x0) goto LAB_00117f91;
    }
    goto LAB_00117f5b;
  }
  if (*piVar5 == 0) {
    ...
    if (*piVar5 != 0x22) goto LAB_00117f5b;
  }
  sVar14 = sVar16;
  if ((valid_suffixes == (char *)0x0) || (cVar1 = *pcVar7, cVar1 == '\0')) goto LAB_00117f1f;
  pcVar9 = strchr(valid_suffixes,(int)cVar1);
  uVar13 = uVar8;
  if (pcVar9 == (char *)0x0) {
switchD_00117fd4_caseD_43:
    *val = uVar13;
...
LAB_00117f91:
  ...
  case 't':
    ...
    if (pcVar9 == (char *)0x0) goto switchD_00117fab_caseD_46;
    cVar2 = pcVar7[1];
    if (cVar2 == 'D') {
      iVar11 = 2;
      iVar4 = 1000;
...
switchD_00117fab_caseD_46:
  ...
  case 'B':
    ...
    break;
  default:
    goto switchD_00117fd4_caseD_43;
  case 'E':
    iVar12 = 6;
    sVar15 = LONGINT_OK;
    do {
  ...
  case 'g':
    ...
    if ((SUB168(auVar3 >> 0x40,0) == 0) &&
       ...
       uVar10 = SUB168(auVar3,0), SUB168(auVar3 >> 0x40,0) == 0)) goto LAB_0011809a;
LAB_001180cc:
    sVar16 = LONGINT_OVERFLOW;
    uVar8 = 0xffffffffffffffff;
    sVar15 = LONGINT_OVERFLOW;
  ...
  case 'k':
    ...
    if (SUB168(ZEXT816(uVar13) * ZEXT816((ulong)(long)iVar4) >> 0x40,0) != 0) goto LAB_001180cc;
    break;
  case 'M':
  case 'm':
