      ...
      do {
        ...
        if (IVar8 != 0) {
          ...
          if (cur_str == lVar13) {
            ...
            if (IVar9 == 0) goto code_r0x00109597;
          }
          else {
...
LAB_001096ca:
              ...
              *new_dests.elems = IVar8;
              ...
              if ((err != _REG_NOERROR) || (_Var3 != true)) {
                ...
                rVar6 = err;
                if (err == _REG_NOERROR) goto LAB_001096ca;
                goto LAB_00109690;
              }
              pprVar12 = mctx->state_log + lVar13;
            }
            ...
            *pprVar12 = prVar7;
            ...
            if ((mctx->state_log[lVar13] == (re_dfastate_t *)0x0) &&
               (rVar6 = err, err != _REG_NOERROR)) goto LAB_00109690;
          }
        }
LAB_00109530:
        pcVar1 = &prVar14->more;
...
code_r0x00109597:
  ...
  rpl_free(new_dests.elems);
  if ((rVar4 | rVar5 | err) != 0) goto LAB_001096d1;
  prVar14 = mctx->bkref_ents;
  goto restart;
LAB_001096d1:
  rVar6 = err;
