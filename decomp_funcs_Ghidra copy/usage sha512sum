...

{
  ...
  __printf_chk(1,uVar4,"SHA512",0x200);
  pFVar1 = stdout;
  ...
  __printf_chk(1,uVar4,"FIPS-180-2");
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar5 = "sha512sum";
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/","sha512sum");
    pcVar7 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
