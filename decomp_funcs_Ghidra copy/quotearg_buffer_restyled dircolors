...
LAB_0010474f:
  ...
  case custom_quoting_style:
    if (param_5 != custom_quoting_style) {
      local_70 = (char *)dcgettext(0,&DAT_00108b51,5);
      if (local_70 == "`") {
...
switchD_00104bb0_caseD_1:
          ...
          if (sVar8 != 1) {
            ...
            do {
              ...
              if (sVar10 == 0xfffffffffffffffe) goto joined_r0x0010539a;
...
switchD_00104bb0_caseD_3f:
          ...
          goto force_outer_quoting_style;
        case 0x5c:
          if (param_5 != shell_always_quoting_style) goto switchD_001045a0_caseD_5c;
          if (!bVar20) {
LAB_00104be8:
            uVar13 = uVar13 + 1;
            bVar21 = false;
...
LAB_00104ac0:
      ...
      if (local_c8 != 0) {
        ...
        if (param_4 < uVar13 + local_c8) goto LAB_00104ce0;
        uVar25 = 0x104557;
        iVar7 = memcmp(__s1,local_98,local_c8);
        if (iVar7 != 0) goto LAB_00104ce0;
        if (!bVar20) {
          uVar15 = (ulong)*__s1;
          switch(uVar15) {
          case 0:
            goto switchD_001045a0_caseD_0;
          default:
          ...
          case 0x60:
          case 0x7c:
            goto switchD_001045a0_caseD_21;
          case 0x23:
          case 0x7e:
            goto LAB_00104d11;
          case 0x25:
          ...
          case 0x5c:
            goto switchD_001045a0_caseD_5c;
          case 0x7b:
          case 0x7d:
