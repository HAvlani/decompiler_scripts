...

{
  ...
  *(byte *)&token->opr = bVar10;
  uVar12 = (uint)syntax;
  if (iVar8 < 2) {
    if (bVar10 == 0x5c) goto LAB_0011aae0;
    ...
    *(uint *)&token->field_0x8 =
    ...
    if (bVar10 < 0x40) {
LAB_0011aa14:
      if (bVar10 < 10) goto switchD_0011aad4_caseD_5c;
      switch(bVar10) {
      case 10:
        iVar8 = 1;
...
LAB_0011abde:
        ...
        break;
      default:
        goto switchD_0011aad4_caseD_5c;
      case 0x24:
...
LAB_0011aabb:
    ...
    case 0x7b:
      iVar8 = 1;
      iVar7 = 1;
      if ((uVar12 & 0x1200) != 0x1200) goto LAB_0011aa4f;
      goto LAB_0011ad1b;
    case 0x7c:
      if ((uVar12 & 0x8400) == 0x8000) goto LAB_0011abde;
      break;
    case 0x7d:
      iVar8 = 1;
      iVar7 = 1;
...
switchD_0011aad4_caseD_5c:
    ...
    if (bVar10 != 0x5c) {
      ...
      if (0x3f < bVar10) goto LAB_0011aabb;
      goto LAB_0011aa14;
    }
LAB_0011aae0:
    lVar1 = lVar3 + 1;
...
LAB_0011afcb:
        if (input->offsets_needed == '\0') {
          ...
          if ((bVar10 & 0x80) != 0) goto LAB_0011ab1f;
        }
        goto LAB_0011ab2b;
      }
      pwVar11 = input->wcs + lVar1;
