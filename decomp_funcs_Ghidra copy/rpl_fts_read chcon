...
LAB_00105633:
            ...
            if (p_Var14->fts_info == 2) goto LAB_00105663;
          }
...
LAB_00105873:
    param_1->fts_cur = pFVar12;
    if (uVar6 == 0xb) goto LAB_001058f0;
  }
  if (uVar6 != 1) {
    return pFVar12;
  }
