...
LAB_00108d36:
    do {
      ...
      if (bVar15 == 0x27) {
        ...
        if (bVar15 != 0x49) goto LAB_00108d98;
  ...
  sVar20 = 0xffffffffffffffff;
  if (*pbVar16 != 0x24) goto LAB_00108d36;
  uVar12 = 0;
  do {
    pbVar17 = (byte *)format;
    ...
    while( true ) {
      ...
      if (9 < (byte)(bVar15 - 0x30)) goto switchD_00109015_caseD_26;
      pbVar17 = pbVar17 + 1;
      uVar14 = 0xffffffffffffffff;
      uVar11 = (ulong)((char)bVar15 + -0x30);
    }
  ...
  goto switchD_00109015_caseD_26;
LAB_00108d98:
  if (bVar15 != 0x2a) {
    uVar11 = local_80;
    pbVar16 = (byte *)format;
...
joined_r0x00108f36:
    ...
    uVar11 = local_78;
    local_70 = uVar12;
    if (bVar15 != 0x2e) goto LAB_00108db2;
    bVar15 = pbVar16[1];
    ...
    if ((byte)(pbVar16[2] - 0x30) < 10) {
      ...
      if (*pbVar16 != 0x24) goto LAB_00108f7e;
      uVar14 = 0;
      do {
      ...
      uVar14 = uVar14 - 1;
      if (0xfffffffffffffffd < uVar14) goto switchD_00109015_caseD_26;
...
LAB_00108f7e:
      ...
      if (pcVar8->precision_arg_index == 0xffffffffffffffff) {
        ...
        local_70 = uVar12 + 1;
        uVar14 = uVar12;
        if (uVar12 == 0xffffffffffffffff) goto switchD_00109015_caseD_26;
      }
    }
    __ptr = a->arg;
    if (uVar14 < uVar18) {
...
LAB_00108db2:
        ...
        do {
          ...
          if (bVar15 == 0x68) {
            ...
            if ((((bVar15 != 0x6c) && (bVar15 != 0x6a)) && ((bVar15 & 0xdf) != 0x5a)) &&
               (bVar15 != 0x74)) goto code_r0x00109004;
            uVar4 = uVar4 + 8;
          }
          bVar15 = *pbVar16;
        } while( true );
    ...
    if (uVar18 < 0x800000000000000) {
      if (paVar2 == __ptr) {
        ...
        paVar6 = __ptr;
        __ptr = paVar10;
        if (paVar10 == (argument *)0x0) goto LAB_00109608;
LAB_001098b0:
...
LAB_001096cb:
      ...
      if (__ptr != (argument *)0x0) {
        paVar6 = paVar2;
        if (paVar2 == a->arg) goto LAB_001098b0;
        goto LAB_001096cb;
      }
      goto LAB_00109829;
    }
  ...
  if ((byte)(((byte *)format)[1] - 0x30) < 10) {
    ...
    if (*pbVar13 != 0x24) goto LAB_00108e3d;
    uVar14 = 0;
    do {
      uVar12 = (ulong)(iVar5 + -0x30);
      pbVar16 = pbVar17;
...
LAB_00108e3d:
    ...
    uVar14 = local_70;
    local_70 = local_70 + 1;
    if (bVar22) goto switchD_00109015_caseD_26;
  }
  __ptr = a->arg;
  if (uVar14 < uVar18) {
    uVar12 = a->count;
LAB_00108ef0:
  ...
  if (paVar2 != __ptr) {
    ...
    if (paVar6 != (argument *)0x0) {
      uVar12 = a->count;
      paVar10 = paVar2;
      if (paVar2 == __ptr) goto LAB_0010971d;
      goto LAB_00108eec;
    }
    goto out_of_memory;
  }
...
code_r0x00109004:
  switch(bVar15) {
  case 0x25:
    goto switchD_00109015_caseD_25;
  default:
    goto switchD_00109015_caseD_26;
  case 0x41:
  case 0x45:
...
LAB_00109829:
    ...
    if (pcVar1 != __ptr_00) {
      ...
      if (pcVar8 != (char_directive *)0x0) {
        __ptr_00 = d->dir;
        uVar12 = d->count;
        if (pcVar1 != __ptr_00) goto LAB_00109141;
        goto LAB_0010928a;
      }
      goto LAB_00109829;
    }
...
LAB_00109141:
    ...
    __ptr = a->arg;
    if (paVar2 == __ptr) goto LAB_00109618;
  }
  else {
    uVar18 = uVar18 * 2;
    if (uVar18 <= sVar20) {
...
LAB_001094cf:
      ...
      if (__ptr != (argument *)0x0) {
        paVar6 = paVar2;
        if (paVar2 == a->arg) goto LAB_001095ae;
        goto LAB_001094cf;
      }
      goto LAB_00109829;
    }
out_of_memory:
    if (paVar2 == __ptr) goto LAB_00109608;
  }
  rpl_free(__ptr);
LAB_00109608:
  if (pcVar1 != d->dir) {
