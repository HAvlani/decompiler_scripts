...

{
  ...
  if (0x24 < (uint)strtol_base) {
    ...
    __assert_fail("0 <= strtol_base && strtol_base <= 36","lib/xstrtol.c",0x55,"xstrtoul");
  }
  if (ptr == (char **)0x0) {
    ptr = &t_ptr;
  }
...
LAB_00106a8b:
  ...
  uVar8 = strtoul(s,ptr,strtol_base);
  pcVar7 = *ptr;
  if (pcVar7 == s) {
    if ((valid_suffixes != (char *)0x0) && (cVar1 = *s, cVar1 != '\0')) {
      ...
      uVar13 = 1;
      if (pcVar9 != (char *)0x0) goto LAB_00106ac1;
    }
    goto LAB_00106a8b;
  }
  if (*piVar5 == 0) {
    ...
    if (*piVar5 != 0x22) goto LAB_00106a8b;
  }
  sVar14 = sVar16;
  if ((valid_suffixes == (char *)0x0) || (cVar1 = *pcVar7, cVar1 == '\0')) goto LAB_00106a4d;
  pcVar9 = strchr(valid_suffixes,(int)cVar1);
  uVar13 = uVar8;
  if (pcVar9 == (char *)0x0) {
switchD_00106b04_caseD_43:
    *val = uVar13;
...
LAB_00106ac1:
  ...
  case 't':
    ...
    if (pcVar9 == (char *)0x0) goto switchD_00106adb_caseD_46;
    cVar2 = pcVar7[1];
    if (cVar2 == 'D') {
      iVar11 = 2;
      iVar4 = 1000;
...
switchD_00106adb_caseD_46:
  ...
  case 'B':
    ...
    break;
  default:
    goto switchD_00106b04_caseD_43;
  case 'E':
    iVar12 = 6;
    sVar15 = LONGINT_OK;
    do {
  ...
  case 'g':
    ...
    if ((SUB168(auVar3 >> 0x40,0) == 0) &&
       ...
       uVar10 = SUB168(auVar3,0), SUB168(auVar3 >> 0x40,0) == 0)) goto LAB_00106bca;
LAB_00106bfc:
    sVar16 = LONGINT_OVERFLOW;
    uVar8 = 0xffffffffffffffff;
    sVar15 = LONGINT_OVERFLOW;
  ...
  case 'k':
    ...
    if (SUB168(ZEXT816(uVar13) * ZEXT816((ulong)(long)iVar4) >> 0x40,0) != 0) goto LAB_00106bfc;
    break;
  case 'M':
  case 'm':
