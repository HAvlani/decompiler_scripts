...

{
  ...
  *(byte *)&token->opr = bVar10;
  uVar12 = (uint)syntax;
  if (iVar8 < 2) {
    if (bVar10 == 0x5c) goto LAB_00114d00;
    ...
    *(uint *)&token->field_0x8 =
    ...
    if (bVar10 < 0x40) {
LAB_00114c34:
      if (bVar10 < 10) goto switchD_00114cf4_caseD_5c;
      switch(bVar10) {
      case 10:
        iVar8 = 1;
...
LAB_00114dfe:
        ...
        break;
      default:
        goto switchD_00114cf4_caseD_5c;
      case 0x24:
...
LAB_00114cdb:
    ...
    case 0x7b:
      iVar8 = 1;
      iVar7 = 1;
      if ((uVar12 & 0x1200) != 0x1200) goto LAB_00114c6f;
      goto LAB_00114f3b;
    case 0x7c:
      if ((uVar12 & 0x8400) == 0x8000) goto LAB_00114dfe;
      break;
    case 0x7d:
      iVar8 = 1;
      iVar7 = 1;
...
switchD_00114cf4_caseD_5c:
    ...
    if (bVar10 != 0x5c) {
      ...
      if (0x3f < bVar10) goto LAB_00114cdb;
      goto LAB_00114c34;
    }
LAB_00114d00:
    lVar1 = lVar3 + 1;
...
LAB_001151eb:
        if (input->offsets_needed == '\0') {
          ...
          if ((bVar10 & 0x80) != 0) goto LAB_00114d3f;
        }
        goto LAB_00114d4b;
      }
      pwVar11 = input->wcs + lVar1;
