...
with_shift:
            ...
            if (local_b0 == 0xffffffffffffffff) {
              ...
              if (local_b0 != 0xfffffffffffffffe) {
                if (local_b0 == 0) {
                  local_b0 = 1;
                  if (*local_b8 != 0) goto LAB_00107f56;
                  if (local_a4._0_4_ != 0) goto LAB_00107f75;
                }
                local_a8 = '\x01';
...
LAB_00107937:
      ...
      do {
        ...
        if (local_a4[28] == '\0') {
          ...
          local_68 = '\x01';
joined_r0x001079af:
          if (local_64[0] == 0) goto LAB_00107ac9;
        }
        else {
with_shift:
          sVar8 = __ctype_get_mb_cur_max();
          ...
          if (local_70 == 0xffffffffffffffff) {
            ...
            if (local_70 != 0xfffffffffffffffe) {
              if (local_70 == 0) {
                local_70 = 1;
                if (*local_78 != 0) goto LAB_00107f56;
                if (local_64[0] != 0) {
LAB_00107f75:
    ...
    if (local_b0 == 0xffffffffffffffff) {
      ...
      if (local_b0 != 0xfffffffffffffffe) {
        if (local_b0 == 0) {
          local_b0 = 1;
          if (*local_b8 != 0) goto LAB_00107f56;
          if (local_a4._0_4_ != 0) goto LAB_00107f99;
        }
        local_a8 = '\x01';
        mbsinit(&local_c4);
        local_bc = '\x01';
...
LAB_00107b1c:
    if ((local_a8 == '\0') || (iVar5 = iswalnum(wVar12), iVar5 == 0)) goto LAB_00107b2e;
  }
  else {
    wVar12 = local_a4._0_4_;
    if (local_a8 == '\0') goto LAB_00107b1c;
LAB_00107b18:
    if (wVar12 != 0) goto LAB_00107b1c;
LAB_00107b2e:
    if (local_c9 != false) goto LAB_00107b9b;
  }
  local_c4 = (mbstate_t)0x0;
  local_bc = '\0';
...
LAB_00107f99:
  ...
  local_a8 = '\x01';
  if (local_a4._0_4_ == 0) goto LAB_00107b96;
LAB_00107b85:
  param_1 = pbVar7 + local_b0;
  bVar1 = *param_1;
  goto joined_r0x0010772a;
}
