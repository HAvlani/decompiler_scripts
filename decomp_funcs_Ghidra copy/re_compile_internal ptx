  ...
  if (param_3 < 0x555555555555555) {
    ...
    if (1 < dfa->mb_cur_max) {
      if ((bVar1 & 4) == 0) {
        ...
        dfa->sb_char = pbVar22;
        if (pbVar22 == (re_bitset_ptr_t)0x0) goto LAB_00117550;
        lVar26 = 0;
        do {
          uVar37 = (int)lVar26 * 8;
          iVar7 = 0;
...
LAB_001176a3:
              iVar7 = iVar7 + 1;
              uVar37 = uVar37 + 1;
              if (iVar7 == 0x40) goto LAB_001176f0;
            }
            puVar35 = (ulong *)((long)dfa->sb_char + lVar26);
            *puVar35 = *puVar35 | 1 << ((byte)iVar7 & 0x3f);
            if ((uVar37 & 0xffffff80) != 0) goto LAB_001176a3;
            if (wVar9 != uVar37) goto LAB_0011769c;
            iVar7 = iVar7 + 1;
            uVar37 = uVar37 + 1;
          } while (iVar7 != 0x40);
LAB_001176f0:
    ...
    if ((dfa->nodes != (re_token_t *)0x0) && (dfa->state_table != (re_state_table_entry *)0x0)) {
      bVar40 = PTR_thrd_exit_00124fe0 != (undefined *)0x0;
      local_10c = _REG_NOERROR;
      bVar41 = PTR_pthread_mutexattr_gettype_00124ff0 != (undefined *)0x0;
      if (!bVar40 && !bVar41) {
LAB_00116e9c:
            ...
            if (1 < iVar7) {
              do {
                ...
                if (((long)param_3 <= local_d8.valid_raw_len) ||
                   (dfa->mb_cur_max + local_d8.valid_len < local_d8.bufs_len)) goto LAB_00117057;
              ...
              if ((((pIVar18 != (Idx *)0x0) && (pIVar19 != (Idx *)0x0)) &&
                ...
                if (pIVar18 != (Idx *)0x0) {
                  ...
                  if (param_1->re_nsub == 0) {
                    ...
                    sVar31 = 0;
                    do {
                      if (pIVar18[sVar31] != sVar31) goto LAB_00117243;
                      sVar31 = sVar31 + 1;
...
LAB_001172b0:
                ...
                case 4:
                  ...
                  if ((pbVar15->token).field_0x8 == '\x04') {
                    ...
                    if (pIVar18 != (Idx *)0x0) goto LAB_00117423;
                    rVar8 = _REG_ESPACE;
                    prVar20->nelem = 0;
                    prVar20->alloc = 0;
                    goto LAB_00116fb8;
                ...
                if (pbVar16 == (bin_tree_t *)0x0) {
                  while( true ) {
                    ...
                    if (*ppbVar4 == (bin_tree_t *)0x0) {
                      ...
                      sVar31 = 0;
LAB_00117338:
                      if (prVar36->nodes_len == sVar31) goto LAB_0011735e;
LAB_0011733e:
                      lVar26 = sVar31 * 0x18;
                      while( true ) {
                        ...
                        while (lVar29 != 0) {
                          sVar31 = sVar31 + 1;
                          if (prVar36->nodes_len != sVar31) goto LAB_0011733e;
LAB_0011735e:
                          if (local_128 == false) {
...
re_compile_internal_free_return:
        ...
        if (!bVar40 && !bVar41) goto LAB_00117558;
        goto LAB_00117644;
      }
      iVar7 = pthread_mutex_init((pthread_mutex_t *)&dfa->lock,(pthread_mutexattr_t *)0x0);
      if (iVar7 != 0) goto LAB_00117550;
      if (local_10c == _REG_NOERROR) goto LAB_00116e9c;
      goto LAB_00117558;
    }
  }
LAB_00117550:
    ...
    do {
      ...
      if (0 < prVar20[uVar27].nelem) {
        do {
          ...
          if (_Var6 == false) goto LAB_00117825;
          prVar20 = prVar36->eclosures;
          lVar26 = lVar26 + 1;
...
LAB_00117de0:
      ...
      do {
        ...
        case 0xc:
          ...
          else if (uVar37 != 0x80) goto switchD_00117acf_caseD_6;
        }
        sVar31 = sVar31 + 1;
        prVar34 = prVar34 + 1;
      } while (sVar31 != dfa->nodes_len);
      prVar34 = prVar11 + sVar31;
      if ((local_128 | bVar30) == 0) goto LAB_00117de0;
      do {
          ...
          do {
            ...
            if ((prVar34->field_0x8 == '\t') && (prVar34->opr == prVar11->opr)) {
              ...
              if (IVar23 == 0) {
                ...
                if (rVar8 != _REG_NOERROR) goto LAB_001179d8;
                lVar26 = 1;
                if (1 < local_f8._8_8_) goto LAB_001178f5;
                goto LAB_00117998;
              }
              break;
            }
...
LAB_001179d8:
  ...
  re_string_destruct(&local_d8);
  rVar8 = local_10c;
  if (local_10c == _REG_NOERROR) goto LAB_00117573;
  if (bVar40 || bVar41) {
LAB_00117644:
