...

{
  ...
  pFVar1 = stdout;
  pcVar5 = (char *)dcgettext(0,"Write each FILE to standard output, last line first.\n",5);
  ...
  if (puVar10 == (undefined1 *)0x0) {
    ...
    if (pcVar5 != (char *)0x0) {
      ...
      if (iVar3 != 0) {
        puVar10 = &DAT_00116034;
        goto LAB_00103bfa;
      }
    }
    uVar4 = dcgettext(0,"Full documentation <%s%s>\n",5);
    puVar10 = &DAT_00116034;
    __printf_chk(1,uVar4,"https://www.gnu.org/software/coreutils/",&DAT_00116034);
    pcVar5 = " invocation";
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
