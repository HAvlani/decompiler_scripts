...
LAB_00106243:
            ...
            if (p_Var14->fts_info == 2) goto LAB_00106273;
          }
...
LAB_00106483:
    param_1->fts_cur = pFVar12;
    if (uVar6 == 0xb) goto LAB_00106500;
  }
  if (uVar6 != 1) {
    return pFVar12;
  }
