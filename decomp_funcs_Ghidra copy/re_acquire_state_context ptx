            ...
            if ((cVar2 != '\x01') || ((uVar12 & 0x3ff) != 0)) {
              ...
              if ((uVar12 & 0x3ff) != 0) {
                if (dest == prVar11->entrance_nodes) {
                  ...
                  if (dest_00 == (re_node_set *)0x0) goto LAB_0010d069;
                  prVar11->entrance_nodes = dest_00;
                  rVar9 = re_node_set_init_copy(dest_00,nodes);
                  if (rVar9 != _REG_NOERROR) goto LAB_0010d069;
                ...
                if ((uVar12 & 1) == 0) {
                  if ((uVar12 & 2) != 0) {
                    uVar6 = context & 1;
                    goto joined_r0x0010d0a6;
                  }
LAB_0010cfef:
                  if ((((uVar12 & 0x10) == 0) || ((context & 2) != 0)) &&
                     (((uVar12 & 0x40) == 0 || ((context & 4) != 0)))) goto LAB_0010d03d;
                }
                else if ((context & 1) != 0) {
                  uVar6 = uVar12 & 2;
joined_r0x0010d0a6:
                  if (uVar6 == 0) goto LAB_0010cfef;
                }
                if ((-1 < lVar14 - lVar15) &&
