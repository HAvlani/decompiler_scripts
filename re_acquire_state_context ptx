...
int re_acquire_state_context()
{
    ...
    struct_1 *|unsigned long long|unsigned int v13;  // edi
    ...
    struct_5 *|struct_6 *|unsigned long long|unsigned int v5;  // rax
                        ...
                        if (*((*(v20->field_10 + (v18 << 3)) << 4) + *(v18) + 8) != 1 || v9 != 0)
                        {
                            ...
                            *(v17 + 104) = ((char)(...));
                            ...
                            if (v9 != 0)
                            {
                                ...
                                if (((long long)(v14 & 1)) == 0 && ((long long)(v14 & 2)) != 0 && ((long long)(((char)v8) & 1)) != 0)
                                {
                                    /* goto 4247568; */
                                }
                                if (((long long)(((char)v8) & 2)) == 0 && ((long long)(v14 & 16)) != 0 || ((long long)(((char)v8) & 1)) == 0 && ((long long)(v14 & 1)) != 0 || ((long long)(((char)v8) & 4)) == 0 && (((char)v14) & 64) != 0 || ((long long)(v14 & 2)) != 0 && ((long long)(((char)v8) & 1)) != 0)
                                {
                                    v9 = v18 - v15;
                                    if (!(((char)(v18 - v15 >> 63))))
                                    {
