...
int str_cd_iconv()
{
    ...
    unsigned long long|struct_0 * v1;  // [bp-0x80]
    unsigned long long v10;  // rax
    unsigned long long v11;  // rax
    unsigned long long|unsigned long|struct_0 * v12;  // rcx
    unsigned long long|unsigned long v13;  // rdx
    unsigned long v14;  // rbx
    unsigned int v15;  // ebp
    unsigned int|unsigned long v16;  // esi
    char *v17;  // rdi
    unsigned long long v18;  // r12
    unsigned long long|struct_0 * v19;  // r15
    unsigned long v2;  // [bp-0x78]
    unsigned long v3;  // [bp-0x70]
    unsigned long v4;  // [bp-0x60]
    unsigned long v5;  // [bp-0x58]
    unsigned long long|unsigned long v6;  // [bp-0x50]
