...
int dired_dump_obstack()
{
    ...
    if (v5->field_18 - v5->field_10 > 7)
    {
        ...
        tmp_7 = v1 + v5->field_30 & !(v5->field_30);
        v3 = v5->field_20;
        tmp_47 = !((v1 + v5->field_30 & !(v5->field_30)) - v5->field_8 <= v5->field_20 - v5->field_8);
        v5->field_18 = (!((v1 + v5->field_30 & !(v5->field_30)) - v5->field_8 <= v5->field_20 - v5->field_8)? v5->field_20 : v1 + v5->field_30 & !(v5->field_30));
