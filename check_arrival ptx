...
int check_arrival()
{
    ...
    struct_0 *v12;  // [bp-0xa0]
    unsigned long v13;  // [bp-0x98]
    unsigned long v14;  // [bp-0x90]
    unsigned int v15;  // [bp-0x80]
    unsigned int v16;  // [bp-0x7c]
    unsigned long long|uint128_t v17;  // [bp-0x78]
    unsigned long long v18;  // [bp-0x70]
    unsigned long long|struct_0 * v19;  // [bp-0x68]
    unsigned long v2;  // [bp-0xf0]
    uint128_t v20;  // [bp-0x58]
    unsigned long long v21;  // [bp-0x50]
    unsigned long long v22;  // [bp-0x48]
    unsigned long long|unsigned int|struct_0 * v24;  // rax
    unsigned long long|struct_0 * v27;  // rcx
    unsigned long long v28;  // rdx
    struct_0 *v29;  // rdx
    struct_0 * v3;  // [bp-0xe8]
    unsigned long long|unsigned long long [7] v30;  // rbx
    struct_5 *|struct_0 * v31;  // rbp
    unsigned long long|unsigned long long [3]|unsigned long v32;  // rsi
    struct_2 *v33;  // rdi
    unsigned long long|unsigned long v34;  // r8
    unsigned int|unsigned long v35;  // r9
    struct_3 *v36;  // r12
    unsigned long long|struct_0 * v37;  // r13
    unsigned long long|struct_0 *|unsigned long long [7] v38;  // r14
    unsigned long|struct_0 * v39;  // r15
                ...
                *(v36->field_b8 + v39 * 8) = v38;
                if (v39 < v8)
                {
                    ...
                    while (true)
                    {
                        ...
                        if (*(v36->field_b8 + (v30 << 3)) == 0 && r14<8> != 0 || v15 == 0 && *(v36->field_b8 + (v30 << 3)) != 0)
                        {
                            if (*(v36->field_b8 + (v30 << 3)) == 0 || r14<8> != 0)
                            {
                                ...
                                if (v40 > 0)
                                {
                                    ...
                                    else if (v24 == 0 && ((int)v24) > 1 && v16 != 0 && (*(v36->field_b8 + (v38 << 3)) == 0 || v32 != 0) && (v32 != 0 || ((long long)v24) != 0))
                                    {
                                        v30 = v1;
                                    }
                                }
                        ...
                        if (v15 == 0 && v18 != 0 && (*(v36->field_b8 + (v30 << 3)) != 0 || r14<8> != 0))
                        {
                            v15 = expand_bkref_cache();
                        }
                        if (False)
                        ...
                        if (v15 == 0 || *(v36->field_b8 + (v30 << 3)) == 0 && v18 == 0 || *(v36->field_b8 + (v30 << 3)) == 0 && r14<8> == 0)
                        {
