...
int check_arrival()
{
    ...
    unsigned long long|struct_0 *|unsigned int v24;  // rax
    ...
    unsigned long|unsigned long long|unsigned int v35;  // r9d
    struct_4 *v36;  // r12
    unsigned long long|struct_0 * v37;  // r13
    unsigned long long [7]|unsigned long long|struct_0 * v38;  // r14
                ...
                *(v36->field_b8 + v39 * 8) = v38;
                if (v39 < v8)
                {
                    ...
                    while (true)
                    {
                        ...
                        if (v15 == 0 || v18 == 0 && *(v36->field_b8 + (v30 << 3)) == 0 || *(v36->field_b8 + (v30 << 3)) == 0 && r14<8> == 0)
                        {
