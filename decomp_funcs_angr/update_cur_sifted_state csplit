...
int update_cur_sifted_state()
{
    ...
    struct_9 *|unsigned int v1;  // [bp-0xd8]
    ...
    struct_3 *v17;  // [bp-0x48]
    struct_8 *|unsigned long long [4]|unsigned long long|unsigned int v19;  // rax
    unsigned long long [9]|unsigned long long|unsigned long long [10] v2;  // [bp-0xd0]
    unsigned long long v20;  // rax
    unsigned long long [4]|unsigned long long [28]|unsigned long long|struct_3 * v21;  // rcx
    unsigned long long v22[3];  // rcx
    unsigned long long [4]|unsigned long long|struct_3 * v23;  // rdx
    unsigned long long v24;  // rdx
    struct_6 *|unsigned long long v25;  // rbx
    struct_3 * v26;  // rbp
    struct_0 *|unsigned long long [4]|unsigned long long|unsigned int v27;  // rsi
    unsigned long long [28]|unsigned long long v28;  // rdi
    unsigned long long v29;  // r8
    struct_11 *v3;  // [bp-0xc8]
    unsigned long long v30;  // r9
    unsigned long long v31;  // r11
    struct_10 *|unsigned long long v32;  // r12
    unsigned long long|struct_3 * v33;  // r13
    unsigned long|unsigned long long v34;  // r14
    struct_7 *|unsigned long long|struct_3 * v35;  // r15
    ...
    struct_0 *|unsigned long v7;  // [bp-0xa8]
                                    ...
                                    if (v2 != v23[3])
                                    {
                                        ...
                                        if (!(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, r14<8>, 0x0<64>, cc_ndep<8>))))
                                        {
                                            ...
                                            while (true)
                                            {
                                                ...
                                                if (((unsigned int)v19) == 0 || v26 != v19->field_0 || ((int)v19->field_8) - 8 > 1)
                                                {
                                                    if ((v26 == v19->field_0 || v34 < v32->field_8) && (v34 < v32->field_8 || ((int)v19->field_8) - 8 <= 1) && (v34 < v32->field_8 || v26 != v19->field_0 || ((int)v19->field_8) - 8 > 1))
                                                    {
                                                        v19 = v26->field_0;
                                                    }
                                    ...
                                    else if (!(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, r14<8>, 0x0<64>, cc_ndep<8>))))
                                    {
                                        ...
                                        else if (v32->field_8 > 0)
                                        {
                                            ...
                                            while (true)
                                            {
                                                ...
                                                if (v32->field_8 <= rbx<8> && (((unsigned int)v19) == 0 || v19 != 0 || v19 != 0))
                                                {
                                                    v25 = v7;
                                                }
                                            }
                        ...
                        do
                        {
                            ...
                            if (v19 == 4 && (*(v3->field_18 + (v2 << 3)) != v25->field_10 || v34 != v25->field_18))
                            {
                                ...
                                while (true)
                                {
                                            ...
                                            if (v19 != 0)
                                            {
                                                ...
                                                if (((long long)v19) == 0)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        v38 = v25->field_20;
                                                        tmp_31 = v25->field_28;
                                                        ((unsigned long long)v12) = v25->field_0;
                                                        v17 = tmp_31;
                                                        v13 = v37;
                                                        v15 = v38;
                                    ...
                                    if (v29 <= v25->field_18 && v12 == 0 && ((long long)v19) == 0 && v13 == v35->field_0 && *(v25->field_0 + (v29 << 3)) != 0 && v19 != 0 && ((int)v19) == 0 || v29 <= v25->field_18 && ((long long)v19) == 0 && v13 == v35->field_0 && v12 != 0 && *(v25->field_0 + (v29 << 3)) != 0 && v19 != 0)
                                    {
                                        v13 = *(v3->field_18 + 0 * 8);
                                        v7 = &stack_base-120;
                                        v14 = v34;
                                    ...
                                    if (...)
                                    {
                                        *(v23 + v4) = *(v4 + ((long long)v12));
                                        ...
                                        v23 = v19;
                                        if (((long long)*((long long *)(((char *)&v15) + 8))) > v23 && !(((char)(v23 - 1 >> 63))))
                                        {
