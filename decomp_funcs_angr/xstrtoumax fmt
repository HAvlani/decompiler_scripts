...
int xstrtoumax()
{
    ...
    struct_0 *v13;  // r12
    unsigned long|char *|unsigned long long|unsigned int v14;  // r13
    unsigned long long|struct_1 * v15;  // r14
    struct_1 *v16;  // r14
    ...
    if (v6 <= 36)
    {
        ...
        if (v17 != 45)
        {
            ...
            v4 = r13<8>;
            return v4;
            if (v13->field_0 == v11 && ((long long)*(v14)) != 0 && v8 != 0 && v2 != 0 || v8 != 0 && v13->field_0 != v11 && ((long long)v17[0]) != 0 && (v2 == 34 || v15->field_0 == 0) && v2 != 0)
            {
                v6 = v15 - 69;
                switch (v15 - 69 & 255)
                {
