...
int renameatu()
{
    ...
    char|unsigned long long v1;  // [bp-0x169]
    unsigned int|char|unsigned long long v10;  // rdx
    ...
    if (v7 < 0)
    {
        ...
        if (((long long)(((char)((((int)(v7 - 22)) & -17) != 0)) & ((char)(((int)v7) != 95)))) == 0)
        {
            ...
            if (v14 == 0 || v0->field_0 == 2 && v14 == 1 && v7 != 0 && v0->field_0 != 75)
            {
                v1 = v16;
                v0 = v15;
                v11 = strlen(v12);
