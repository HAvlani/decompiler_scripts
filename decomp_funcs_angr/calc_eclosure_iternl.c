...
int calc_eclosure_iter()
{
    ...
    unsigned long long|struct_8 * v10;  // rax
    unsigned long|unsigned long long|struct_4 * v12;  // rcx
    struct_7 *|unsigned long long|struct_6 *|struct_0 * v13;  // rdx
    struct_8 *v14;  // rbx
    ...
    struct_9 *|unsigned long long v21;  // r15
