...
int calc_eclosure_iter()
{
    ...
    struct_9 *|unsigned long long v10;  // rax
    struct_7 *|unsigned long|unsigned long long v12;  // rcx
    struct_4 *|unsigned long long|struct_5 *|struct_1 * v13;  // rdx
    struct_9 *v14;  // rbx
    ...
    struct_8 *|unsigned long long v21;  // r15
