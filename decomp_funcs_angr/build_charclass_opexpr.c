...
int build_charclass_op()
{
    ...
    unsigned long|unsigned int v1;  // [bp-0x88]
    ...
    char * v25;  // r13
    unsigned long|unsigned long long|struct_2 * v3;  // [bp-0x68]
    char v4;  // [bp-0x60]
            ...
            if (((int)v1) == 0)
            {
                ...
                if (((long long)*(v25)) != 0)
                {
                    do
                    {
                        ...
                        v16 = ((long long)*(v25));
                        *(v12 + ((((char)[D] amd64g_calculate_condition(0x9<64>, 0x14<64>, t2, 0x0<64>, cc_ndep<8>))? tmp_2 : tmp_54) >> &g_0) * 8) = *(v12 + ((((char)[D] amd64g_calculate_condition(0x9<64>, 0x14<64>, t2, 0x0<64>, cc_ndep<8>))? tmp_2 : tmp_54) >> &g_0) * 8) | &g_0 << (tmp_97 & 63);
                        tmp_53 = v16;
                    }
                ...
                if (v21->field_b4 > 1)
                {
                    ...
                    do
                    {
                        *(v12 + v12) = *(v12 + v12) & *(v21->field_78 + v12);
                        v12 += 8;
                    }
                    while (v12 != 32);
                }
