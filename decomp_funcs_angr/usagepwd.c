...
int usage()
{
    ...
    if (v34 != 0)
    {
        dcgettext(0x0, &g_407180, 0x5);
        __fprintf_chk();
        exit(v32); /* do not return */
    }
    __printf_chk(0x1, dcgettext(0x0, &g_40700f, 0x5));
    ...
    __printf_chk(0x1, dcgettext(0x0, &g_4072f8, 0x5));
    v6 = "sha256sum";
    v0 = "[";
    v1 = "test invocation";
    v2 = "coreutils";
    ...
    if (v3 != 0)
    {
        __printf_chk(0x1, dcgettext(0x0, &g_407085, 0x5));
        v34 = setlocale();
        if (v34 != 0)
        {
    ...
    else
    {
        ...
        if (v34 == 0 || v22 == 0)
        {
            __printf_chk(0x1, dcgettext(0x0, &g_4070ae, 0x5));
            __printf_chk(0x1, dcgettext(0x0, &g_407428, 0x5));
            exit(v32); /* do not return */
        }
    }
    if ((v3 == 0 || v34 != 0) && (v3 == 0 || v22 != 0) && (v34 != 0 || v3 != 0) && (v3 != 0 || v22 != 0))
    {
