...
int quote_name_buf.constprop.0()
{
    ...
    struct_1 *v18;  // r8
    char *v19;  // r9
    unsigned long|unsigned long long|char * v2;  // [bp-0x80]
    ...
    char|unsigned long long|char * v8;  // rax
    ...
    if (v12 == 0 && ((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) != 0 || ((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) != 0 && v23 != 0 || v12 != 0 && v23 != 0)
    {
        ...
        else if (v17 > v2)
        {
            ...
            {
                v10 = ((long long)*(v21));
                if ((v10 - 97 & 255) > 29 && !(((char)(((long long)*(v21)) <= 95))))
                {
                    /* goto 4228341; */
                }
                if ((v10 - 97 & 255) <= 29 && !(((char)(((long long)*(v21)) <= 95))) || ((char)(((long long)*(v21)) <= 95)) && !(((char)(((long long)v10) <= 64))) || ((char)(((long long)v10) <= 35)) && ((char)(((long long)*(v21)) <= 95)) && !(((char)(((long long)v10) <= 31))) || (v10 - 37 & 255) <= 26 && ((char)(((long long)*(v21)) <= 95)) && !(((char)(((long long)v10) <= 35))))
                {
                    *(v20) = v10;
                    v21 += 1;
                }
                if ((((char)(((long long)v10) <= 64)) || !(((char)(((long long)*(v21)) <= 95)))) && (((char)(((long long)*(v21)) <= 95)) || (v10 - 97 & 255) > 29) && (((char)(((long long)v10) <= 35)) || (v10 - 37 & 255) > 26 || !(((char)(((long long)*(v21)) <= 95)))) && (((char)(((long long)v10) <= 31)) || !(((char)(((long long)v10) <= 35))) || !(((char)(((long long)*(v21)) <= 95)))))
                {
                    v6 = 0;
                    v22 = v21;
                    while (true)
                    {
                        ...
                        if (v10 == 18446744069414584318 || v10 == 18446744069414584319)
                        {
                            break;
                        }
                    }
    ...
    if (align_variable_outer_quotes != 0 || v12 == 0 && ((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) != 0 || ((long long)(((char)(v8 <= 2)) & qmark_funny_chars)) != 0 && v23 != 0 || v12 != 0 && v23 != 0)
    {
        *(v19) = v8;
        if (v18 != 0)
        {
