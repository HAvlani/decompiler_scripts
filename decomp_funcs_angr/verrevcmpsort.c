int verrevcmp()
{
    ...
    if (0 < v5 || 0 < v12)
    {
        ...
        while (true)
        {
            ...
            if (v5 != rax<8> || r8<8> != v5 || v14 < v5 && ((int)*(v6 + v14)) - 48 > 9 && v4 != v12 && (((int)*(v13 + rax<8>)) - 48 <= 9 || v4 >= v12 || v4 >= v12) && ((int)(((long long)*(v13 + v4)) - 48)) <= 9)
            {
                v15 = ((long long)*(v6 + v14));
                v18 = 0;
            ...
            if (...)
            {
                ...
                else
                {
                    ...
                    if (((int)*(v13 + v4)) - 48 <= 9 && v12 > v4 && v14 >= v5)
                    {
                        v16 = 1;
                        v7 = v0;
                        v22 = v2;
                ...
                if (v4 < v12 || v14 < v5)
                {
                    if (v12 > v4 && (((int)*(v13 + v4)) - 48 > 9 || v14 >= v5))
                    {
                        v16 = 0;
                    }
                    if (((int)*(v13 + v4)) - 48 > 9 && (v14 < v5 || v12 > v4))
                    {
                        if (((int)*(v6 + v14)) - 48 <= 9)
                        {
                            v9 = v0;
                ...
                if (v14 >= v5 || v12 <= v4 && ((int)*(v13 + v4)) - 48 > 9 || ((int)v16) == 0 && ((int)*(v13 + v4)) - 48 > 9)
                {
                    v16 = 0;
                    v7 = v0;
                    v22 = v2;
