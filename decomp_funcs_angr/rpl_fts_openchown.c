...
{
    BOT tmp_28;  // tmp #28
    struct_2 *|unsigned long v0;  // [bp-0x50]
    char v1;  // [bp-0x42]
    char v10;  // ah
    ...
    struct_3 *|unsigned long long v7;  // rax
        ...
        if (v16 != 0)
        {
            ...
            *(v16 + 72) = (((long long)(((char)v14) & 2)) == 0? ((int)v9) : ((int)tmp_28) | 4);
            ...
            if (((long long)v1) != 0)
            {
                ...
                if (v11 == 0 && v7 == 0 || v7 == 0 && v19 == 0 || v7 == 0 && v7 != 0 || v19 == 0 && v0 != 0 || v0 != 0 && v7 != 0)
                {
                    v7 = fts_alloc();
                    *(v16) = v7;
                }
                if (v7 == 0 && v7 == 0 || v7 == 0 && ((long long)v7) == 0 || v7 == 0 && v0 != 0 || ((long long)v7) == 0 && v0 != 0)
                {
                    fts_lfree();
                    rpl_free();
                }
                if (v7 == 0 || ((long long)v7) == 0 || v0 == 0 && v7 != 0)
                {
                    rpl_free();
                    v16 = 0;
                    rpl_free();
