...
int check_arrival()
{
    ...
    unsigned long long [7]|struct_1 *|unsigned long long v38;  // r14
    struct_1 *|unsigned long v39;  // r15
                                    ...
                                    while (true)
                                    {
                                        ...
                                        if (...)
                                        {
                                            ...
                                            if (((int)v24) > 1)
                                            {
                                                ...
                                                if (v16 != 0)
                                                {
                                                    if ((*(v36->field_b8 + (v38 << 3)) == 0 || v32 != 0) && (((long long)v24) != 0 || v32 != 0))
                                                    {
                                                        rpl_free();
                                                        v24 = ((int)v16);
                                                        v15 = v16;
