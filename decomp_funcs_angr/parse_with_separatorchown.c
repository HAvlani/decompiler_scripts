...
extern char g_40d9b5;

int parse_with_separator()
{
    BOT tmp_31;  // tmp #31
    unsigned long|unsigned long long|unsigned int v0;  // [bp-0x80]
    struct_1 *v1;  // [bp-0x78]
    struct_1 *v11;  // rcx
    struct_1 *|unsigned long long v12;  // rdx
    unsigned long long|struct_0 * v13;  // rbx
    struct_0 *|unsigned long long v14;  // rbp
    ...
    struct_2 *|unsigned long long|unsigned long|unsigned int|unsigned int [6] v5;  // rax
    ...
    if ((v15 == 0 || *(v0 + 1) != 0) && (v15 == 0 || v15 != v16) && (v15 != 0 || *(v16) != 0))
    {
