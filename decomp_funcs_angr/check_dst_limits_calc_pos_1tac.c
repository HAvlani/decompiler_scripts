...
int check_dst_limits_calc_pos_1()
{
    ...
    unsigned long long [7]|struct_5 * v25;  // r15
    ...
    if (*(v24[6] + (v14 << 3) + 8) > 0)
    {
        ...
        while (true)
        {
            ...
            v12 = *(v23->field_10 + v16 * 8) * 16 + v25[0];
            v14 = ((long long)*(*(v23->field_10 + v16 * 8) * 16 + v25[0] + 8));
            if (*((*(v23->field_10 + (v16 << 3)) << 4) + v25[0] + 8) != 8)
            {
                if (v14 != 9)
                {
                    if (v14 == 4 && v0 != 18446744069414584319)
                    {
                        ...
                        while (true)
                        {
                            if (v22[0] == v25 && ((v5 & v22[4]) != 0 || v15 > 63))
                            {
                                if (v1 != *(*(v25->field_28 + v4 + 16)))
                                {
                                    v0 = v0;
