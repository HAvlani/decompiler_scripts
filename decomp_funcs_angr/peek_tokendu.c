...
int peek_token()
{
    ...
    char v1;  // [bp-0x50]
    unsigned long|unsigned long long|struct_0 * v10;  // rdi
    struct_6 * v11;  // r8
    struct_1 *v12;  // r12
    unsigned long long v13;  // r13
    struct_3 *v14;  // r14
    unsigned long long v15;  // r15
    unsigned long long|unsigned int|char v3;  // al
    unsigned long long|struct_6 *|char v4;  // rcx
    unsigned long long|char *|struct_6 *|char v5;  // dl
    unsigned long long v6;  // rdx
    unsigned long long v7;  // rbx
    struct_0 *v8;  // rbp
    char *|unsigned long long|struct_3 *|unsigned int|struct_1 * v9;  // rsi
    ...
    if (v9->field_68 > v14)
    {
        ...
        if (v3 <= 1 || v9->field_48 == v9->field_30 || *(v9->field_10 + (v9->field_48 << 2)) != -1)
        {
            if (*(v9->field_8 + v9->field_48) == 92)
            {
                ...
                if (v9->field_8b == 0 || v9->field_90 <= 1 && v12->field_8c != 0 && ((long long)(tmp_30 & 128)) != 0 || v12->field_30 == v14 + 2 && v12->field_8c != 0 && *(v12->field_10 + (v4 << 2)) != -1 && ((long long)(tmp_30 & 128)) != 0 || v12->field_8c != 0 && *(v10 + v5 + 4) != -1 && *(v12->field_10 + (v4 << 2)) != -1 && ((long long)(tmp_30 & 128)) != 0)
                {
                ...
                if (v3 > 1 || *(v12->field_10 + (v4 << 2)) == -1 && v9->field_90 > 1 && v9->field_8b != 0 || *(v10 + v5 + 4) == -1 && v12->field_30 != v14 + 2 && v9->field_90 > 1 && v9->field_8b != 0)
                {
