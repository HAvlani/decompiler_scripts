...
int re_acquire_state_context()
{
    ...
    unsigned long long|struct_3 *|unsigned int v13;  // edi
    ...
    struct_6 *|unsigned long long|unsigned int|struct_4 * v5;  // rax
    struct_2 * v6;  // rax
                        ...
                        if (*((*(v20->field_10 + (v18 << 3)) << 4) + *(v18) + 8) != 1 || v9 != 0)
                        {
                            ...
                            *(v17 + 104) = ((char)(...));
                            ...
                            if (v9 != 0)
                            {
                                ...
                                if (((long long)(((char)v8) & 4)) == 0 && (((char)reg_80<4>) & 64) != 0 || ((long long)(((char)v8) & 2)) == 0 && ((long long)(r8b<1> & 16)) != 0 || ((long long)(((char)v8) & 1)) == 0 && ((long long)(r8b<1> & 1)) != 0 || ((long long)(r8b<1> & 2)) != 0 && ((long long)(r8b<1> & 1)) != 0 || ((long long)(r8b<1> & 1)) == 0 && ((long long)(r8b<1> & 2)) != 0 && ((long long)(((char)v8) & 1)) != 0)
                                {
                                    v9 = v18 - r10<8>;
