...
int re_search_stub()
{
    ...
    unsigned long long|void *|struct_0 * v21;  // rdi
    ...
    else if (v16 <= v26)
    {
        ...
        if (v16 + v22 > v26 || v16 > v16 + v22 && !(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>))))
        {
            v26 = v17;
        }
        if (v16 + v22 > v26 || !(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>))))
        {
            v3 = ((char)(0 != 0)) | ((char)(0 != 0));
        }
        if (((long long)(((char)(0 != 0)) | ((char)(0 != 0)))) != 0)
        ...
        if (v16 + v22 > v26 || ((long long)(((char)(0 != 0)) | ((char)(0 != 0)))) != 0 || !(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>))))
        {
            v10 = ((int)(((long long)v21->field_38) >> 5)) & 3;
            if (v16 < v26)
            {
        ...
        if (v11 != 0)
        {
            if (((long long)(v21->field_38 & 16)) == 0)
            {
                ...
                if (!(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>))) || *(v24) > v21 || tmp_4 != 4)
                {
                    v21 = v20 * 16;
                    /* goto 4316809; */
                }
        ...
        if (v11 == 0 || ((long long)(v21->field_38 & 16)) != 0 || ((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>)) && *(v24) <= v21 && tmp_4 == 4)
        {
            v21 = 16;
            v20 = 1;
            v18 = 1;
