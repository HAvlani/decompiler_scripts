...
extern char g_407929;
extern unsigned int g_40792b;
extern struct_5 g_407ba8;
...
int quotearg_buffer_restyled()
{
    ...
    unsigned int|char|unsigned long|unsigned long long v3;  // [bp-0xe0]
    unsigned int|char|unsigned long|unsigned long long v30;  // rax
    unsigned long long v31;  // rax
    unsigned long long v32;  // rcx
    struct_5 *|unsigned long long|char|unsigned long|unsigned int|char * v33;  // rdx
    unsigned long long v34;  // rdx
    unsigned long long v35;  // rbx
    char [2]|unsigned long long v36;  // rbp
    unsigned long long v37;  // rdi
    unsigned int|unsigned long long v38;  // r8
    unsigned long|unsigned long long v39;  // r9
    unsigned int|char|unsigned long|unsigned long long v4;  // [bp-0xd8]
    unsigned int|unsigned long|unsigned long long v40;  // r10
    unsigned long long v41;  // r11
    unsigned long long v42;  // r12
    unsigned long long v43;  // r13b
    ...
    case 8: case 9: case 10:
        if (((int)v3) != 10)
        {
            v4 = ((int)v3);
            v3 = v41;
            v18 = dcgettext(0x0, &g_40792b, 0x5);
            if (v18 == "`")
            {
                v4 = v3;
                v3 = ((int)((int)v4));
            ...
            v4 = v4;
            v3 = v41;
            v17 = dcgettext(0x0, &g_407929, 0x5);
            if (v17 == 4225321)
            {
                v4 = v3;
                v3 = v40;
        ...
        while (true)
        {
            ...
            if (((long long)r13b<1>) != 0)
            {
                ...
                if (((long long)(((char)(reg_96<4> != 2)) & v4)) != 0)
                {
                    ...
                    if (v6 == 0 || v30 != 0 || v8 > r11<8>)
                    {
                        ...
                        case 32:
                            ...
                            if (((long long)(((char)(((int)r8<8>) ^ 1)) & dl<1>)) != 0 && (v7 != 0 || ((long long)r9b<1>) != 0))
                            {
                                if (r14<8> > r12<8>)
                                {
                                    *(v45 + r12<8>) = 39;
                ...
                else
                {
                    ...
                    {
                        v33 = ((long long)v36);
                        v30 = ((long long)*(g_407ba8 + v33 * 4)) + &g_407ba8;
                    }
                }
            }
            else
            ...
            if (((long long)v33) != 0)
            {
                ...
                while (true)
                {
                    ...
                    if ((((long long)v33) == 0 || v35 < tmp_9) && (((long long)v33) == 0 || ((long long)v14) == 0) && (v35 < tmp_9 || ((long long)v33) != 0))
                    {
                        if (v44 > r12<8>)
                        {
                            *(v45 + r12<8>) = bpl<1>;
            ...
            v33 = 0;
            if (reg_96<4> == 2 && v14 != 0 || reg_96<4> == 2 && v14 != 0 || reg_96<4> == 2 && v14 != 0 || ((long long)v33) != 0 && ((long long)v30) != 0 || v16 != 1 && ((long long)v33) != 0 || v14 != 0 || (((long long)r13b<1>) == 0 || ((long long)v30) != 0) && (((long long)r13b<1>) == 0 || v14 != 0) && (v42 == 0 || ((long long)v30) != 0) && (v42 == 0 || v14 != 0) && (((long long)(v33 & v14)) != 0 || ((long long)v30) != 0) && (((long long)(v33 & v14)) != 0 || v14 != 0))
            {
                v2 = v17;
                v1 = v18;
                v0 = 0;
