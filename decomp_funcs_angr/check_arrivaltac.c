...
int check_arrival()
{
    ...
    struct_0 *|unsigned long long v19;  // [bp-0x68]
    unsigned long v2;  // [bp-0xf0]
    uint128_t v20;  // [bp-0x58]
    unsigned long long v21;  // [bp-0x50]
    unsigned long long v22;  // [bp-0x48]
    struct_0 *|unsigned long long|unsigned int v24;  // rax
    struct_0 *|unsigned long long v27;  // rcx
    struct_0 *v28;  // rdx
    unsigned long v29;  // rdx
    struct_0 * v3;  // [bp-0xe8]
    unsigned long long|unsigned long long [7] v30;  // rbx
    struct_0 *|struct_4 * v31;  // rbp
    unsigned long long [3]|unsigned long|unsigned long long v32;  // rsi
    struct_3 *v33;  // rdi
    unsigned long|unsigned long long v34;  // r8
    unsigned long|unsigned long long|unsigned int v35;  // r9
    struct_5 *v36;  // r12
    struct_0 *|unsigned long long v37;  // r13
    struct_0 *|unsigned long long|unsigned long long [7] v38;  // r14
    ...
    if (((long long)v33->field_e0) + v35 < v37 || v37 + v39 <= 2305843009213693951 && v24 != 0 && 9223372036854775807 - v32[1] >= ((long long)v33->field_e0) + v35 + 1)
    {
        v39 = v11[0];
        v37 = v11[2];
        v12 = v36->field_b8;
                ...
                *(v36->field_b8 + v39 * 8) = v38;
                if (v39 < v8)
                {
                    ...
                    while (true)
                    {
                        ...
                        if (v15 == 0 || r14<8> == 0 && *(v36->field_b8 + (v30 << 3)) == 0 || *(v36->field_b8 + (v30 << 3)) == 0 && v18 == 0)
                        {
