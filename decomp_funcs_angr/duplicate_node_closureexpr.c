...
int duplicate_node_closure()
{
    ...
    struct_4 *|unsigned long long v14;  // r14
    struct_4 *v15;  // r15
    unsigned long long v16;  // cc_dep1
    struct_4 *|unsigned long long|struct_7 *|struct_5 * v3;  // rax
    unsigned long|unsigned long long v4;  // rcx
    unsigned long long v5;  // rdx
    struct_4 *|unsigned long long v6;  // rbx
    unsigned long long v7[6];  // rbp
    struct_4 *|struct_6 *|unsigned long long v8;  // rsi
    unsigned long|struct_1 *|unsigned long long v9;  // rdi
