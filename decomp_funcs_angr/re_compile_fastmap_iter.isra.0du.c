...
int re_compile_fastmap_iter.isra.0()
{
    ...
    unsigned long|struct_5 * v1;  // [bp-0x190]
    char v10;  // [bp-0x147]
    char v11;  // [bp-0x146]
    unsigned long v12;  // [bp-0x40]
    struct_8 *|unsigned long long|char *|unsigned int v14;  // eax
    unsigned long long v15;  // rax
    struct_8 *|unsigned long|unsigned long long v16;  // ecx
    struct_7 *|unsigned long|unsigned long long v17;  // rdx
    unsigned long long v18;  // rbx
    struct_4 *|unsigned long|unsigned long long v19;  // rsi
    struct_3 *v2;  // [bp-0x188]
    struct_2 *v20;  // rdi
    ...
    struct_1 *v26;  // fs
    struct_5 *|unsigned long long v3;  // [bp-0x180]
    struct struct_1 **v4;  // [bp-0x178]
    struct_1 *v5;  // [bp-0x168]
    struct struct_1 **v6;  // [bp-0x160]
    char v7;  // [bp-0x154]
    ...
    while (true)
    {
        ...
        if (v19->field_8 != 1)
        {
            ...
            {
                v23 = v19->field_0;
                if (v2->field_b4 > 1 && (v23->field_48 != 0 || v23->field_40 != 0 || ((long long)(v23->field_20 & 1)) != 0))
                {
                    v7 = 0;
                    do
                    {
