...
extern char g_40f8a1;
extern unsigned int g_40f8a3;
extern struct_5 g_40fb28;
...
int quotearg_buffer_restyled()
{
    ...
    unsigned int|char|unsigned long|unsigned long long v30;  // rax
    unsigned long long v31;  // rax
    unsigned long|unsigned long long v32;  // rcx
    unsigned long long v33;  // rdx
    unsigned long|unsigned long long v34;  // rbx
    char [2]|unsigned long|unsigned long long v35;  // rbp
    struct_5 *|unsigned long long|char|unsigned long|unsigned int|char * v36;  // rsi
    unsigned long long v37;  // rdi
    unsigned int|unsigned long|unsigned long long v38;  // r8
    unsigned long|unsigned long long v39;  // r9
    unsigned int|char|unsigned long v4;  // [bp-0xd8]
    unsigned int|unsigned long|unsigned long long v40;  // r10d
    ...
    case 8: case 9: case 10:
        if (((int)v3) != 10)
        {
            v4 = ((int)v3);
            v3 = v41;
            v18 = dcgettext(0x0, &g_40f8a3, 0x5);
            if (v18 == "`")
            {
                v4 = v3;
                v3 = ((int)((int)v4));
            ...
            v4 = v4;
            v3 = v41;
            v17 = dcgettext(0x0, &g_40f8a1, 0x5);
            if (v17 == 4257953)
            {
                v4 = v3;
                v3 = v40;
    ...
    while (true)
    {
        ...
        while (true)
        {
                            ...
                            if (v30 == 0)
                            {
                                if (v14 == 0)
                                {
                                    ...
                                    case 0:
                                        ...
                                        if ((((long long)(((char)(((int)0) ^ 1)) & ((char)(reg_96<4> == 2)))) == 0 || v44 > r12<8> + 3) && (v44 > r12<8> || ((long long)(((char)(((int)0) ^ 1)) & ((char)(reg_96<4> == 2)))) != 0))
                                        {
                                            *(v45 + rcx<8>) = 92;
                                            /* goto 4226467; */
                                        }
                ...
                else
                {
                    ...
                    case 32:
                        ...
                        if (v14 == 0)
                        {
                            ...
                            if (((long long)(((char)(((int)v38) ^ 1)) & dl<1>)) != 0)
                            {
                                if (r14<8> > r12<8>)
                                {
                                    *(v45 + r12<8>) = 39;
                    ...
                    {
                        v36 = ((long long)v35);
                        v30 = ((long long)*(g_40fb28 + v36 * 4)) + &g_40fb28;
                    }
                }
            }
            else
            ...
            v36 = 0;
            if (reg_96<4> == 2 && v14 != 0 || v14 != 0 || (((long long)v36) != 0 || v16 != 1) && ((long long)al<1>) != 0 || v16 != 1 || reg_96<4> == 2 && v14 != 0 || reg_96<4> == 2 && v14 != 0 || (((long long)r13b<1>) == 0 || v14 != 0) && (((long long)r13b<1>) == 0 || ((long long)al<1>) != 0) && (v42 == 0 || v14 != 0) && (v42 == 0 || ((long long)al<1>) != 0) && (v14 != 0 || ((long long)(v36 & v14)) != 0) && (((long long)(v36 & v14)) != 0 || ((long long)al<1>) != 0))
            {
                v2 = v17;
                v1 = v18;
                v0 = 0;
