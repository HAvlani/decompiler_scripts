...
int xstrtoumax()
{
    ...
    char [2]|unsigned long long|unsigned int v11;  // rdi
    unsigned long long|char * v12;  // r8
    struct_0 *v13;  // r12
    char [2]|unsigned long|unsigned long long|unsigned int v14;  // r13d
    unsigned long long|struct_1 * v15;  // r14
    struct_1 *v16;  // r14
    char [3]|unsigned long long|char * v17;  // r15
    unsigned long long|unsigned int v18;  // cc_dep1
    char [2]|unsigned long long|unsigned int v2;  // rax
    ...
    if (v6 <= 36)
    {
        ...
        if (v17 != 45)
        {
            ...
            v3 = r13<8>;
            return v3;
            if (v13->field_0 == v11 && ((long long)v14[0]) != 0 && v8 != 0 && v2 != 0 || v13->field_0 != v11 && v8 != 0 && ((long long)v17[0]) != 0 && (v15->field_0 == 0 || v2 == 34) && v2 != 0)
            {
                v6 = v15 - 69;
                switch (v15 - 69 & 255)
                {
