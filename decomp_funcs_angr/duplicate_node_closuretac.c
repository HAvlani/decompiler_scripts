...
int duplicate_node_closure()
{
    ...
    unsigned long long|struct_5 * v10;  // r8
    struct_5 * v11;  // r10
    struct_5 *v12;  // r12
    ...
    struct_7 *|unsigned long long|struct_4 *|struct_5 * v3;  // rax
    unsigned long|unsigned long long v4;  // rcx
    unsigned long long v5;  // rdx
    unsigned long long|struct_5 * v6;  // rbx
    unsigned long long v7[6];  // rbp
    unsigned long long|struct_6 *|struct_5 * v8;  // rsi
