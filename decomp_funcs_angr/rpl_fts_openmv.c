...
{
    BOT tmp_28;  // tmp #28
    unsigned long|struct_2 * v0;  // [bp-0x50]
    char v1;  // [bp-0x42]
    char v10;  // ah
    ...
    unsigned long long|struct_3 * v7;  // rax
    ...
    else if (((long long)(v14 & &g_10)) != 0)
    {
        ...
        if (v16 != 0)
        {
            ...
            *(v16 + 44) = -100;
            ...
            tmp_28 = rax<8>;
            *(v16 + 72) = (((long long)(((char)v14) & 2)) == 0? ((int)v6) : ((int)tmp_28) | 4);
            if (v15 != 0)
            {
                v19 = v12;
                v17 = 0;
            ...
            if (((long long)v1) != 0)
            {
                    ...
                    if (v19 != 0 && (v11 != 0 || v7 != 0))
                    {
                        ...
                        while (true)
                        {
                            ...
                            *(v13 + 48) = v13 + 0x100;
                            ...
                            if (v18 == 0 && (v13 != 0 || v1 != 0) && (v13 != 0 || v13 != 0))
                            {
                                v3 = v13;
                                g_10 = v13;
                            }
                ...
                if (v19 == 0 && v7 == 0 || v11 == 0 && v7 == 0 || v19 == 0 && v0 != 0 || v7 == 0 && v7 != 0 || v0 != 0 && v7 != 0)
                {
                    v7 = fts_alloc();
                    *(v16) = v7;
                }
                if (((long long)v7) == 0 && v7 == 0 || v7 == 0 && v7 == 0 || ((long long)v7) == 0 && v0 != 0 || v7 == 0 && v0 != 0)
                {
                    fts_lfree();
                    rpl_free();
                }
                if (((long long)v7) == 0 || v7 == 0 || v0 == 0 && v7 != 0)
                {
                    rpl_free();
                    v16 = 0;
                    rpl_free();
