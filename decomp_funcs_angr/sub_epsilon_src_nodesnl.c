...
int sub_epsilon_src_nodes()
{
    ...
    if (!(((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, Load(addr=((Load(addr=(rdi<8> + 0x38<64>), size=8, endness=Iend_LE) + ((rsi<8> + (rsi<8> << 0x1<8>)) << 0x3<8>)) + 0x8<64>), size=8, endness=Iend_LE), 0x0<64>, cc_ndep<8>))))
    {
        ...
        while (true)
        {
            ...
            if (((long long)(*((v4 << 4) + v12[0] + 8) & 8)) != 0 && v11 != *(v18->field_10 + (v10 << 3)))
            {
                ...
                if (v4 == 0 && (v16->field_8 <= 1 || !(((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, Load(addr=((Load(addr=(rdi<8> + 0x38<64>), size=8, endness=Iend_LE) + ((rsi<8> + (rsi<8> << 0x1<8>)) << 0x3<8>)) + 0x8<64>), size=8, endness=Iend_LE), 0x0<64>, cc_ndep<8>)))) && (v4 == 0 || v16->field_8 <= 1 || v4 != 0))
                {
                    v4 = re_node_set_contains.isra.0();
                }
            }
