...
int re_search_stub()
{
    ...
    struct_0 *|unsigned long long|void * v21;  // rdi
    ...
    else if (v16 <= v26)
    {
        ...
        if (v11 != 0)
        {
            if (((long long)(v21->field_38 & 16)) == 0)
            {
                ...
                if (tmp_4 != 4 || *(v24) > v21 || !(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>))))
                {
                    v21 = v20 * 16;
                    /* goto 4292777; */
                }
        ...
        if (v11 == 0 || ((long long)(v21->field_38 & 16)) != 0 || tmp_4 == 4 && *(v24) <= v21 && ((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>)))
        {
            v21 = 16;
            v20 = 1;
            v18 = 1;
