...
int readlinebuffer_delim()
{
    ...
    if (((long long)(v9->field_0 & 16)) == 0)
    {
        ...
        while (true)
        {
            ...
            if (((long long)(v8->field_0 & 32)) == 0 && ((int)v7) == -1 && v8->field_8 >= v8->field_10 && v12->padding_1 != v6 && v13 != v12 && v12 == v0 || (v8->field_8 < v8->field_10 || ((int)v7) != -1) && v12 == v5)
            {
                v0 = r11b<1>;
                tmp_7 = v13->field_0;
