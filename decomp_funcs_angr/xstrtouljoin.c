...
int xstrtoul()
{
    ...
    struct_1 *v13;  // r12
    unsigned long|unsigned long long|char *|unsigned int v14;  // r13
    struct_2 *v15;  // r14
    ...
    if (v6 <= 36)
    {
        ...
        if (v17 != 45)
        {
            ...
            v4 = r13<8>;
            return v4;
            if (v13->field_0 == v11 && ((long long)*(v14)) != 0 && v8 != 0 && v2 != 0 || ((long long)v17[0]) != 0 && v13->field_0 != v11 && v8 != 0 && (v16->field_0 == 0 || v2 == 34) && v2 != 0)
            {
                v6 = v16 - 69;
                switch (v16 - 69 & 255)
                {
