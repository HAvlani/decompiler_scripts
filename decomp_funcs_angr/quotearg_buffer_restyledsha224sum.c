...
extern char g_40bd71;
extern unsigned int g_40bd73;
extern struct_5 g_40c008;
...
int quotearg_buffer_restyled()
{
    ...
    unsigned long long|char|unsigned long|unsigned short|unsigned int v30;  // eax
    unsigned long long v31;  // rax
    unsigned long|unsigned long long v32;  // rcx
    struct_5 *|unsigned long long|char|unsigned long|unsigned int|char * v33;  // dl
    unsigned long long v34;  // rdx
    unsigned long|unsigned long long v35;  // rbx
    char [2]|unsigned long|unsigned long long v36;  // rbp
    ...
    case 8: case 9: case 10:
        if (((int)v3) != 10)
        {
            v4 = ((int)v3);
            v3 = v41;
            v18 = dcgettext(0x0, &g_40bd73, 0x5);
            if (v18 == "`")
            {
                v4 = v3;
                v3 = ((int)((int)v4));
            ...
            v4 = ((int)v4);
            v3 = v41;
            v17 = dcgettext(0x0, &g_40bd71, 0x5);
            if (v17 == 4242801)
            {
                v4 = v3;
                v3 = v40;
        ...
        while (true)
        {
            ...
            if (((long long)r13b<1>) != 0)
            {
                ...
                else
                {
                    ...
                    {
                        v33 = ((long long)v36);
                        v30 = ((long long)*(g_40c008 + v33 * 4)) + &g_40c008;
                    }
                }
            }
            else
            ...
            else
            {
                ...
                while (true)
                {
                    ...
                    v30 = rpl_mbrtowc();
                    v33 = v30;
                    if (v30 != 18446744069414584318 && v30 != 0 && v30 != 18446744069414584319)
                    {
                ...
                if (v30 == 18446744069414584318 || v30 == 0 || v30 == 18446744069414584319 || ((int)v30) != 0)
                {
                    v8 = r13b<1>;
                    v33 = 0;
                }
            }
            if (v16 != 1 || ((long long)v33) != 0)
            {
                v8 = r13b<1>;
                v33 = 0;
                while (true)
