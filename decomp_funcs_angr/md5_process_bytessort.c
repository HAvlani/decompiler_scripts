...
int md5_process_bytes()
{
    ...
    struct_3 *|unsigned long long|unsigned int v2;  // rax
    uint128_t v20;  // xmm0
    ...
    if (v6->field_18 != 0)
    {
        ...
        v19 = v6 + 28;
        v17 = (!(128 - v15 <= v11)? v11 : 128 - v15);
        memcpy(v6 + 28 + v15, v12, (!(128 - v15 <= v11)? v11 : 128 - v15));
        ...
        if (v11 > 64)
        {
            ...
            v2 = (v15 + v17 & 18446744069414584256) + v6 + 28;
            v6 = ((long long)(v18->field_18 & 63));
            v18->field_18 = v18->field_18 & 63;
            if (!(((int)v6) < 8))
            {
                v18->field_1c = v2->field_0;
                *(v19 + v6 + 8) = *(v2 + v6 + 8);
                v11 = v18 + 36 & 18446744069414584312;
                v2 -= v19 - (v18 + 36 & 18446744069414584312);
    ...
    if (v8 > 63)
    {
        ...
        else
        {
            ...
            v2 = md5_process_block();
        }
    }
    if (v8 <= 63 || ((long long)(v7 & 3)) == 0)
    {
        if (v8 == 0)
        {
            return v2;
    ...
    if (v8 != 0 || v8 > 63 && ((long long)(v7 & 3)) != 0)
    {
