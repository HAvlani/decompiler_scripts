                ...
                if (((long long)(*(v3->field_0 + (((long long)v10) << 1)) & 1)) == 0)
                {
                    if (v10 != 47)
                    {
                        if (v10 != 43)
                        {
                            ...
                            {
                                v8 = (long long)quote();
                                error(0x0, 0x0, dcgettext(0x0, &g_4074c8, 0x5));
                            ...
                            else
                            {
                                ...
                                {
                                    v11 = v0;
                                    strspn(((int)v0), &g_4076d5);
                                    v0 = v11;
                                    v10 = (long long)ximemdup0();
                                    v1 = (long long)quote();
                                    error(0x0, 0x0, dcgettext(0x0, &g_4076e0, 0x5));
                                    rpl_free();
                                    v1 = 0;
                                    /* goto 0x403100; */
                                }
                    ...
                    if (v10 == 43)
                    {
                        ...
                        {
                            v8 = (long long)quote();
                            error(0x0, 0x0, dcgettext(0x0, &g_407498, 0x5));
                            v1 = 0;
                            /* goto 0x403100; */
                        }
                    }
