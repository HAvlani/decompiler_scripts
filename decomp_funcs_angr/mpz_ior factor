...
int mpz_ior()
{
    ...
    if (v23 != 0)
    {
        ...
        v14 = 0 - ((long long)(((int)(((long long)*(v16 + 4)) >> 31)) & 1));
        v24 = 0 - v9;
        ...
        do
        {
            ...
            tmp_22 = (tmp_5 | (*(v17 + v7 * 8) ^ v15) + v20) ^ v24;
        ...
        if (v11 == 0)
        {
            if (v8 > v23)
            {
                ...
                if (rsi<8> != 0)
                {
                    *(v6 + v8 * 8) = 1;
                    v8 = ((int)v8) + 1;
                    v0->field_4 = (v24 != 0? 0 - ((unsigned int)v8) : ((int)rdx<8>));
                    return v0;
                }
            }
            else if (r11<8> != 0)
            ...
            if ((rsi<8> == 0 || v8 <= v23) && (r11<8> == 0 || v8 > v23) && (v8 != 0 || v8 > v23))
            {
                v8 = v21;
                while (*(v6 + (v8 << 3) + 8) == 0)
                {
