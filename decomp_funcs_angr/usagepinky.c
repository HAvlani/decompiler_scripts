...
int usage()
{
    ...
    if (v33 != 0)
    {
        dcgettext(0x0, &g_4071f8, 0x5);
        __fprintf_chk();
        exit(v31); /* do not return */
    }
    __printf_chk(0x1, dcgettext(0x0, &g_407220, 0x5));
    fputs_unlocked(dcgettext(0x0, &g_407248, 0x5), stdout);
    fputs_unlocked(dcgettext(0x0, &g_407390, 0x5), stdout);
    fputs_unlocked(dcgettext(0x0, &g_4074c8, 0x5), stdout);
    fputs_unlocked(dcgettext(0x0, &g_4074f8, 0x5), stdout);
    __printf_chk(0x1, dcgettext(0x0, &g_407538, 0x5));
    v6 = "sha256sum";
    v0 = "[";
    v1 = "test invocation";
    v2 = "coreutils";
    ...
    if (v27[1] != 0)
    {
        __printf_chk(0x1, dcgettext(0x0, &g_407117, 0x5));
        v33 = setlocale();
        if (v33 != 0)
        {
    ...
    else
    {
        ...
        if (v33 == 0 || v23 == 0)
        {
            __printf_chk(0x1, dcgettext(0x0, &g_407140, 0x5));
            __printf_chk(0x1, dcgettext(0x0, &g_407600, 0x5));
            exit(v31); /* do not return */
        }
    }
    if ((v27[1] == 0 || v23 != 0) && (v27[1] == 0 || v33 != 0) && (v33 != 0 || v27[1] != 0) && (v27[1] != 0 || v23 != 0))
    {
        fputs_unlocked(dcgettext(0x0, &g_4075b8, 0x5), stdout);
    }
    if (v27[1] != 0 || v33 != 0 && v23 != 0)
    {
        __printf_chk(0x1, dcgettext(0x0, &g_407140, 0x5));
        __printf_chk(0x1, dcgettext(0x0, &g_407600, 0x5));
        exit(v31); /* do not return */
