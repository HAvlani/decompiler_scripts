...
int fts_build()
{
    ...
    unsigned long long [12]|unsigned int|struct_3 *|char|struct_1 *|unsigned long long v15;  // rax
    unsigned long long [8] v17;  // rax
    unsigned long long [12]|unsigned long long v2;  // [bp-0x90]
    void *|unsigned long long v24;  // rcx
    unsigned long long v25;  // rdx
    unsigned long long v26;  // rdx
    unsigned long long|unsigned int v27;  // rbx
    struct_5 *v28;  // rbp
    struct_3 * v29;  // rbp
    struct_3 *|unsigned long v3;  // [bp-0x88]
    void *|unsigned long long|unsigned int v30;  // rsi
    struct_2 *v31;  // rdi
    unsigned long|unsigned long long|unsigned int v32;  // rdi
    unsigned long|unsigned long long|unsigned int v33;  // edi
    unsigned long long v34;  // r8
    unsigned long|unsigned long long v35;  // r12
    unsigned long long v36;  // r13
    struct_1 *|unsigned long long v37;  // r14
    struct_4 *|struct_5 * v38;  // r15
    struct_1 *v4;  // [bp-0x80]
    unsigned long v5;  // [bp-0x78]
    unsigned long|unsigned long long|char * v6;  // [bp-0x70]
    ...
    else
    {
        ...
        if (v2 != 0)
        {
            ...
            if (v29->field_68 == 11 || (((short)v38->field_48) & 0x100) == 0 || ((long long)v15) != 0)
            {
    ...
    if (...)
    {
        ...
        if (v32 != 0)
        {
            ...
            while (true)
            {
                ...
                if (v38 != 0)
                {
                    if (v38->field_14 == 46 && v38->field_13 == 46 && ((long long)(v38->field_48 & 32)) == 0 && v38->field_14 != 0)
                    {
                        /* goto 4250292; */
                    }
                    if (v38->field_13 != 46 || ((long long)(v38->field_48 & 32)) != 0 || v38->field_14 != 46 && v38->field_14 != 0)
                    {
                        v36 = strlen(v38 + 19);
                ...
                if (v37 <= v36 && v1 != 0 && v38 != 0 && (v38->field_14 != 46 || v38->field_13 != 46 || ((long long)(v38->field_48 & 32)) != 0) && (v38->field_14 != 0 || v38->field_13 != 46 || ((long long)(v38->field_48 & 32)) != 0) && ((long long)v15) != 0 || v1 != 0 && v38 != 0 && (v38->field_14 != 46 || v38->field_13 != 46 || ((long long)(v38->field_48 & 32)) != 0) && (v38->field_14 != 0 || v38->field_13 != 46 || ((long long)(v38->field_48 & 32)) != 0) && v37 > v36)
                {
                    v34 = v36 + v0;
                    if (!(((char)[D] amd64g_calculate_condition(0x2<64>, 0x4<64>, r13<8>, Load(addr=stack_base-160, size=8, endness=Iend_LE), cc_ndep<8>))))
                    {
                        ...
                        *(v1 + 120) = v38->field_0;
                        ...
                        if (((long long)(v25 & 4)) == 0 && v38->field_40 != 0)
                        {
                            *(v1 + 104) = (short)fts_stat();
                            /* goto 4250550; */
                        }
                        if (v38->field_40 == 0 || ((long long)(v25 & 4)) != 0)
                        {
                            v30 = ((long long)v38->field_12);
                            v15 = ((long long)(((int)v38->field_12) - 1));
                            if (((long long)(v30 & 251)) != 0 && ((long long)(v25 & 8)) != 0)
                            {
                                if ((((char)((int)v25)) & 16) == 0 && v30 == 10)
                                {
                                    *(v1 + 104) = 11;
                                    /* goto 4250912; */
                                }
                            ...
                            if ((((int)v15) <= 11 || ((long long)(v30 & 251)) != 0) && (((int)v15) <= 11 || ((long long)(v25 & 8)) != 0) && ((((char)((int)v25)) & 16) == 0 || ((long long)(v30 & 251)) == 0 || ((long long)(v25 & 8)) == 0) && (v30 == 10 || ((long long)(v30 & 251)) == 0 || ((long long)(v25 & 8)) == 0))
                            {
                                v25 = 2;
                            }
                            if (((int)v15) <= 11 || (((char)((int)v25)) & 16) == 0 && v30 == 10 && ((long long)(v30 & 251)) != 0 && ((long long)(v25 & 8)) != 0)
                            {
                        ...
                        *(v1 + 16) = 0;
                        ...
                        {
                            v15 = filesystem_type();
                            if (v15 != -11317950 && v15 != 26985 && v15 != 16914836)
                            {
                                v11 = 1;
                                /* goto 4250603; */
                            }
        ...
        if (v32 != 0 || ((long long)(v38->field_48 & 4)) != 0)
        {
            v6 -= 1;
            *(v6) = 0;
        }
