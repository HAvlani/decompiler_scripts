...
int check_dst_limits_calc_pos_1()
{
    ...
    struct_5 * v23;  // r13
    unsigned long long [28]|struct_1 *|struct_6 * v24;  // r14
    unsigned long long v25;  // r15
    struct_1 *|struct_4 * v26;  // r15
    ...
    v1 = v13;
    v14 = v13 * 3;
    v23 = v24->field_30 + v14 * 8;
    if (*(v24->field_30 + (v14 << 3) + 8) > 0)
    {
        v26 = v20[19];
        v16 = 0;
        v24 = v20;
        ...
        while (true)
        {
            ...
            v11 = *(v23->field_10 + v16 * 8) * 16 + v26->field_0;
            v14 = ((long long)*(*(v23->field_10 + v16 * 8) * 16 + v26->field_0 + 8));
            if (*((*(v23->field_10 + (v16 << 3)) << 4) + v26->field_0 + 8) != 8)
            {
                if (v14 != 9)
                {
                    if (v14 == 4 && v0 != 18446744069414584319)
                    {
                        ...
                        while (true)
                        {
                            if (v22[0] == v26 && (v15 > 63 || (v5 & v22[4]) != 0))
                            {
