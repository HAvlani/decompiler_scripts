...
int mpz_div_qr()
{
    ...
    struct_3 *|unsigned long long|unsigned int v20;  // rax
    unsigned long long v22;  // rax
    unsigned long long v24;  // rax
    unsigned long long|unsigned int|struct_2 * v26;  // ecx
    struct_0 *|unsigned long long|unsigned int v27;  // rdx
    unsigned long long v28;  // rbx
    struct_1 *v29;  // rbp
    unsigned long|unsigned long long v3;  // [bp-0xd0]
    unsigned long long v30;  // rsi
    unsigned long long|struct_1 * v31;  // rsi
    unsigned long long|struct_1 * v32;  // rdi
    unsigned long long v33;  // r8
    unsigned long long|unsigned int v34;  // r8
    ...
    if (v26->field_4 != 0)
    {
        ...
        if (((long long)v27->field_4) != 0)
        {
            ...
            if (v32 != 0)
            {
                v5 = v3;
                v14 = 0;
                v13 = ((int)((v24 * 64 - [D] amd64g_calculate_condition(0x5<64>, 0x20<64>, Shl(rax<8>, 0x6<8>), Shl(rax<8>, 0x5<8>), cc_ndep<8>) >> 6) + 1));
                v24 = gmp_default_alloc();
                v33 = v5;
                v37 = v4;
                v3 = v24;
                v15 = v24;
            ...
            if (v22 == 0 || v6 <= 2 || v12 == 0)
            {
                ...
                else if (((char)(v0 - 0 >> 63)) || ((long long)(((char)(!(*(&stack_base-224)) >> 63)) & ((char)(v1 == 1)))) != 0)
                {
                    if (((char)(v0 - 0 >> 63)) || ((long long)v27) != 0)
                    {
                        if (v1 == 0 || ((long long)(((char)(!(*(&stack_base-224)) >> 63)) & ((char)(v1 == 1)))) != 0)
                        {
                            if (v1 == 0 || ((long long)v27) != 0)
                            {
                                if (!(((char)(v0 - 0 >> 63))) || v1 != 0 || v28 != 0)
                                {
                                    if (v39 != 0)
                                    {
                                        /* goto 4229815; */
