...
int extract_dirs_from_files()
{
    ...
    while (true)
    {
        ...
        if (*(*(sorted_file + (v7 << 3)) + 168) == 3 || ((int)v1) == 9)
        {
            v10 = v8->field_0;
            if (v9 != 0)
            {
                ...
                if (*(v10) != 47 && (v1 != 47 || v1[0] != 46) && (((long long)tmp_11) != 0 || v1[0] != 46))
                {
        ...
        if (v8->field_a8 != 9 || *(*(sorted_file + (v7 << 3)) + 168) != 3 && ((int)v1) != 9 || v1 == 47 && v1[0] == 46 && v9 != 0 || ((long long)tmp_11) == 0 && v1[0] == 46 && v9 != 0)
        {
            v7 -= 1;
    ...
    if (cwd_n_used != 0)
    {
        ...
        do
        {
            tmp_19 = ((long long)v4[0]->field_a8);
            *(sorted_file + v6 * 8) = v4[0];
            v4 += 8;
            v6 += ((long long)(((int)tmp_19) != 9));
        }
        while (sorted_file + (cwd_n_used << 3) != v4);
        cwd_n_used = v6;
        return v4;
    }
    else
