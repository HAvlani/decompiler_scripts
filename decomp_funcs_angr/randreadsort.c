...
int randread()
{
    ...
    unsigned long|unsigned int v14;  // r14
    unsigned long|unsigned long long|char * v15;  // r15
    unsigned long long v5;  // rax
    unsigned long long v6;  // rcx
    unsigned long|unsigned long long v7;  // rdx
    unsigned long v8;  // rbx
    void *|unsigned long long v9;  // rbp
    ...
    if (v11[0] != 0)
    {
        ...
        while (true)
        {
            v5 = fread_unlocked(v9, 0x1, v8, v15);
