...
int mpz_div_q_2exp.isra.0()
{
    ...
    unsigned long|unsigned long long|struct_1 * v10;  // rsi
    ...
    unsigned long|unsigned int|char v17;  // r15
    unsigned long|unsigned long long|char v3;  // rax
    ...
    if (v10 != 0)
    {
        ...
        if (v13 == ((int)[D] amd64g_calculate_condition(0xf<64>, 0x14<64>, rsi<8>, 0x0<64>, cc_ndep<8>)) && ((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, rbx<8>, 0x0<64>, cc_ndep<8>)) || !(((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, rbx<8>, 0x0<64>, cc_ndep<8>))) && v17 != 0)
        {
            v3 = mpz_add_ui();
            if (!(((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, rbx<8>, 0x0<64>, cc_ndep<8>))))
            {
