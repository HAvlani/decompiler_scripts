...
int re_string_reconstruct()
{
    ...
    BOT tmp_25;  // tmp #25
    BOT tmp_1;  // tmp #1
    unsigned int|unsigned long v0;  // [bp-0x78]
    unsigned int v1;  // [bp-0x6c]
    unsigned int|char *|unsigned long|unsigned long long v10;  // rcx
    char * v11;  // rcx
    unsigned int|char *|unsigned long|unsigned long long v12;  // rdx
    unsigned long long v13;  // rdx
    struct_3 *v14;  // rbx
    unsigned long long v15;  // rbp
    unsigned int|unsigned long|unsigned long long v16;  // rsi
    unsigned long long v17;  // rsi
    struct_1 *v18;  // rdi
    unsigned int|unsigned long v19;  // r8
    unsigned long v2;  // [bp-0x68]
    unsigned long long v20;  // r9
    char * v21;  // r12
    unsigned long|unsigned long long v22;  // r13
    unsigned int|char *|unsigned long long v23;  // r14
    unsigned long long v24;  // r15
    char * v25;  // r15
    unsigned int|char|unsigned long long v26;  // cc_dep1
    unsigned long v3;  // [bp-0x60]
    unsigned int v4;  // [bp-0x54]
    unsigned long long v5;  // [bp-0x50]
    char *|struct_0 *|unsigned long long v7;  // rax
    unsigned long long v8;  // rax

    v19 = v12;
    v21 = v17;
    v14 = v18;
    v15 = v17 - v18->field_28;
    if (v18->field_28 > v17)
    {
        if (v18->field_90 > 1)
        {
    ...
    if (v26 == 0 || v15 != 0)
    {
        if (v15 != 0 || v18->field_28 > v17)
        {
            if (v18->field_28 <= v17 || v26 != 0 || v17 != 0)
            {
                if (v14->field_38 > v15)
                {
                    ...
                    else
                    {
                        ...
                        while (true)
                        {
                            v7 = (v17 + v10 >> 63) + v17 + v10 >> 1;
                            v12 = *(v24 + ((v17 + v10 >> 63) + v17 + v10 >> 1) * 8);
                            v26 = *(v24 + ((v17 + v10 >> 63) + v17 + v10 >> 1) * 8);
                            if (*(v24 + ((v17 + v10 >> 63) + v17 + v10 >> 1 << 3)) > v15)
                            {
                                v10 = v7;
                            }
                            ...
                            if (((char)(v26 < v15)) || *(v24 + ((v17 + v10 >> 63) + v17 + v10 >> 1 << 3)) > v15)
                            {
                                v23 = v10 + 1;
                                v23 = v10;
                                break;
                            ...
                            if (v15 < v18->field_30)
                            {
                                if (*(v24 + (v23 << 3)) == v15)
                                {
                                    ...
                                    if (!(((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, r14<8>, 0x0<64>, cc_ndep<8>))))
                                    {
                                        v10 = v14->field_18;
                                        v7 = 0;
                                        v17 = v14->field_18 + v15 * 8;
                                        do
                                        {
                                            *(v18->field_18 + v7 * 8) = *(v17 + v7 * 8) - v15;
                                            v7 += 1;
                                        }
                        ...
                        if (v15 >= v18->field_30 || *(v24 + (v23 << 3)) != v15 || v15 != v23)
                        {
                            tmp_18 = v14->field_50;
                            tmp_21 = v14->field_60;
                            v14->field_8c = 0;
                    ...
                    if (((long long)v18->field_8c) == 0 || v15 < v18->field_30 && *(v24 + (v23 << 3)) == v15 && v15 == v23)
                    {
                        v16 = ((long long)v14->field_90);
                        v12 = ((long long)v14->field_8b);
                    }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            v24 = v14->field_0 + v20;
                            v12 = v15 - v16 + v14->field_0 + v20;
                            v23 = v14->field_0 + v20 + v15 - 1;
                            v10 = (v14->field_0 < v15 - v16 + v14->field_0 + v20? v12 : v14->field_0);
                            if (v14->field_0 + v20 + v15 - 1 < (v14->field_0 < v15 - v16 + v14->field_0 + v20? v12 : v14->field_0))
                            {
                            }
                            else
                            {
                                ...
                                if (((char)(((int)*(v23)) & -64)) == 128 || v4 == -1 || v20 < v24 || v20 > 18446744069414584317)
                                {
                                    v25 = v20 + v7;
                                }
                            }
                        }
                        if (v14->field_0 + v20 + v15 - 1 < (v14->field_0 < v15 - v16 + v14->field_0 + v20? v12 : v14->field_0) || v14->field_89 == 0 || v21 > v20 + v7)
                        {
                            v25 = v20 + v7;
                        }
                        if (v21 <= v20 + v7 && (v14->field_0 + v20 + v15 - 1 < (v14->field_0 < v15 - v16 + v14->field_0 + v20? v12 : v14->field_0) || v14->field_89 == 0))
                        {
                            v24 = v25 - v21;
                            v14->field_30 = v23;
                            v23 = v24;
                        ...
                        if (v21 > v20 + v7 && ((unsigned int)v10) == -1 || v21 <= v20 + v7 && (v14->field_0 + v20 + v15 - 1 < (v14->field_0 < v15 - v16 + v14->field_0 + v20? v12 : v14->field_0) || v14->field_89 == 0))
                        {
                            v14->field_70 = re_string_context_at();
                        }
                        if (v21 > v20 + v7 && ((unsigned int)v10) != -1 || v14->field_0 + v20 + v15 - 1 >= (v14->field_0 < v15 - v16 + v14->field_0 + v20? v12 : v14->field_0) && v14->field_89 != 0 && v21 > v20 + v7)
                        {
                            if (v14->field_8e != 0)
                            {
                                v0 = ((unsigned int)v10);
                        ...
                        v16 = ((int)v14->field_90);
                    }
                }
            }
        }
    }
    if (((int)v16) <= 1 && v14->field_38 <= v15 && (v26 == 0 || v15 != 0) && (v15 != 0 || v18->field_28 > v17) && (v18->field_28 <= v17 || v26 != 0 || v17 != 0) && v14->field_8b == 0 || (v26 == 0 || v15 != 0) && (v15 != 0 || v18->field_28 > v17) && (((int)v16) > 1 || v14->field_38 > v15) && (v18->field_28 <= v17 || v26 != 0 || v17 != 0) && ((long long)v12) == 0)
    {
