...
int parse_bracket_element.constprop.0()
{
    ...
    struct_1 *v12;  // r10
    char *|struct_5 * v13;  // r11
    struct_4 *|unsigned long long v14;  // r12
    unsigned long long v15;  // r13
    unsigned long long v16;  // r14
    char *|unsigned long long v2;  // rax
    unsigned long long v3;  // rax
    unsigned long v4;  // rcx
    char [9]|struct_5 *|unsigned long long v5;  // rdx
    struct_6 *v6;  // rbx
    char v7[9];  // rbp
    struct_1 *v8;  // rsi
    struct_2 *v9;  // rdi
