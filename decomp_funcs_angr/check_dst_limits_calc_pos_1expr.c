...
int check_dst_limits_calc_pos_1()
{
    ...
    struct_4 * v23;  // r13
    struct_2 *|unsigned long long [7]|unsigned long long [28] v24;  // r14
    unsigned long long v25;  // r15
    struct_2 *|struct_5 * v26;  // r15
    ...
    if (*(v24[6] + (v13 << 3) + 8) > 0)
    {
        ...
        while (true)
        {
            ...
            v13 = ((long long)*(*(v23->field_10 + v16 * 8) * 16 + v26->field_0 + 8));
            if (*((*(v23->field_10 + (v16 << 3)) << 4) + v26->field_0 + 8) != 8)
            {
                if (v13 != 9)
                {
                    if (v13 == 4 && v0 != 18446744069414584319)
                    {
                        v8 = v23;
                        tmp_27 = v7;
                        v9 = v16;
