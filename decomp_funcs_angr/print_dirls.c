...
extern struct_1 active_dir_set;
...
extern struct_1 g_4240f8;
extern struct_1 g_424100;
extern struct_1 hide_patterns;
extern struct_2 ignore_mode;
extern struct_1 ignore_patterns;
...
{
    BOT tmp_9;  // tmp #9
    unsigned long v0;  // [bp-0x398]
    unsigned long|unsigned long long v1;  // [bp-0x380]
    unsigned long long v11;  // rax
    char *v18;  // rax
    char v2;  // [bp-0x375]
    unsigned long long|unsigned long long [2] v21;  // rax
    unsigned long long v22;  // rax
    unsigned long long v25;  // rax
    unsigned long long v28;  // rcx
    unsigned long|unsigned long long v29;  // rdx
    unsigned int v3;  // [bp-0x374]
    char [21]|unsigned long long|char *|unsigned long long [2] v30;  // rbx
    struct_2 *v31;  // rbp
    ...
    if (v33 != 0)
    {
        ...
        if (active_dir_set == 0 || ((long long)tmp_9) == 0 && v30 == v25 && v25 != 0)
        {
            clear_files();
            ...
            while (true)
            {
                ...
                if (v30 != 0)
                {
                    ...
                    if (ignore_mode == 2 || v30[19] != 46 || v30 + ((long long)(v30[20] == 46))[20] != 0 && ignore_mode != 0)
                    {
                        ...
                        if (sort_type == 6 && format == 1 && recursive == 0 && print_block_size == 0)
                        {
                            sort_files();
                            print_current_files();
                            clear_files();
