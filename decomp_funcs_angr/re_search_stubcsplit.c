...
int re_search_stub()
{
    ...
    struct_0 *|void *|unsigned long long v21;  // rdi
    ...
    unsigned long|unsigned int v5;  // [bp-0x60]
    unsigned long|unsigned int v6;  // [bp-0x58]
                ...
                if (v24 != 0)
                {
                    ...
                    if ((((char)((int)(((long long)v25->field_38) >> 1))) & 3) != 0)
                    {
                        ...
                        if (v13 == 1)
                        {
                            ...
                            {
                                v21 = *(v24 + 8);
                                ((unsigned int)v6) = v27 * 8;
                                v5 = realloc(v21, v27 * 8);
                                if (v5 != 0)
                                {
                                    v13 = realloc(*(v24 + 16), ((unsigned int)v6));
                                    if (v13 != 0)
                                    {
                                        *(v24 + 8) = v5;
                                        *(v24 + 16) = v13;
                    ...
                    {
                        ((unsigned int)v5) = v27 * 8;
                        *(v24 + 8) = v26;
                        v26 = malloc(v27 * 8);
                        if (v26 != 0)
                        {
                            v13 = malloc(((unsigned int)v5));
                            *(v24 + 16) = v13;
                            if (v13 != 0)
                            {
                                *(v24) = v27;
