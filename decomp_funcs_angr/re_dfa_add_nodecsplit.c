...
int re_dfa_add_node()
{
    ...
    if (v12->field_10 < v12->field_8 || v14 << 1 <= 768614336404564650 && v2 != 0 && v18 != 0 && v2 != 0 && v16 != 0 && v14 != 0)
    {
        v6 = ((long long)(((int)v7) & -261889));
        ...
        *(v10 * 16 + v8->field_0 + 8) = v9;
        ...
        if (v9 == 5)
        {
            v5 = ((char)(1 < v8->field_b4));
            v7 = ((long long)(((int)*(v3 + 0xa)) & -17 | ((int)v5) * 16));
            tmp_69 = v7;
            *(v3 + 0xa) = tmp_69;
