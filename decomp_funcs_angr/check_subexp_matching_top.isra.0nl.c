...
int check_subexp_matching_top.isra.0()
{
    ...
    unsigned long|struct_0 * v1;  // [bp-0x50]
    ...
    unsigned long|struct_0 * v2;  // [bp-0x48]
    unsigned long long v3;  // [bp-0x40]
    struct_0 *|unsigned long long|unsigned long long [2] v5;  // rax
    unsigned long long v6;  // rax
    unsigned long long v7;  // rcx
    struct struct_0 ** v8;  // rdx
