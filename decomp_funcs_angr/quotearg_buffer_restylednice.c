...
extern char g_407581;
extern unsigned int g_407583;
extern struct_5 g_407808;
...
int quotearg_buffer_restyled()
{
    ...
    unsigned long long|unsigned int|char v30;  // rax
    unsigned long long v31;  // rax
    unsigned long|unsigned long long v32;  // rcx
    char *|unsigned long long|unsigned int|char|struct_5 * v33;  // dl
    unsigned long long v34;  // rdx
    char *|unsigned long long v35;  // rbx
    ...
    case 8: case 9: case 10:
        if (((int)v3) != 10)
        {
            v4 = ((int)v3);
            v3 = v42;
            v18 = dcgettext(0x0, &g_407583, 0x5);
            if (v18 == "`")
            {
                v4 = v3;
                v3 = ((int)((int)v4));
            ...
            v4 = ((int)v4);
            v3 = v42;
            v17 = dcgettext(0x0, &g_407581, 0x5);
            if (v17 == 4224385)
            {
                v4 = v3;
                v3 = v41;
        ...
        while (true)
        {
            ...
            if (((long long)r13b<1>) != 0)
            {
                ...
                else
                {
                    ...
                    {
                        v33 = ((long long)v36);
                        v30 = ((long long)*(g_407808 + v33 * 4)) + &g_407808;
                    }
                }
            }
            else
