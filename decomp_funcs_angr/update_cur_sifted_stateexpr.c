...
int update_cur_sifted_state()
{
    ...
    struct_10 *|unsigned long long v1;  // [bp-0xd8]
    unsigned long long v10;  // [bp-0x90]
    unsigned int v11;  // [bp-0x7c]
    unsigned long|BOT|unsigned long long|unsigned int v12;  // [bp-0x78]
    unsigned long|BOT v13;  // [bp-0x68]
    unsigned long long v14;  // [bp-0x60]
    BOT v15;  // [bp-0x58]
    unsigned long v16;  // [bp-0x50]
    struct_0 *v17;  // [bp-0x48]
    struct_9 *|unsigned long long|unsigned int|unsigned long long [4] v19;  // rax
    unsigned long long [10]|unsigned long long [9]|unsigned long long v2;  // [bp-0xd0]
    struct_0 *|struct_12 *|unsigned long long|unsigned long long [28] v20;  // rcx
    unsigned long long v21[3];  // rcx
    struct_0 *|unsigned long long|unsigned long long [4] v22;  // rdx
    unsigned long long v23;  // rdx
    unsigned long long|struct_6 * v24;  // rbx
    struct_0 * v25;  // rbp
    struct_1 *|unsigned long long|unsigned int|unsigned long long [4] v26;  // rsi
    unsigned long long|unsigned long long [28] v27;  // rdi
    unsigned long long v28;  // r8
    unsigned long long v29;  // r9
    struct_8 *v3;  // [bp-0xc8]
    unsigned long long v30;  // r11
    unsigned long long|struct_11 * v31;  // r12
    struct_0 *|unsigned long long v32;  // r13
    unsigned long|unsigned long long v33;  // r14
    struct_0 *|struct_7 *|unsigned long long v34;  // r15
    ...
    unsigned long|struct_1 * v7;  // [bp-0xa8]
                                    ...
                                    if (v2 != v22[3])
                                    {
                                        ...
                                        if (!(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, r14<8>, 0x0<64>, cc_ndep<8>))))
                                        {
                                            ...
                                            while (true)
                                            {
                                                ...
                                                if (v25 == v19->field_0 && ((int)v19->field_8) - 8 <= 1)
                                                {
                                                ...
                                                if (v19 == 0 || v25 != v19->field_0 || ((int)v19->field_8) - 8 > 1)
                                                {
                                                    if ((v25 == v19->field_0 || v33 < v31->field_8) && (v33 < v31->field_8 || ((int)v19->field_8) - 8 <= 1) && (v33 < v31->field_8 || v25 != v19->field_0 || ((int)v19->field_8) - 8 > 1))
                                                    {
                                                        v19 = v25->field_0;
                                                    }
                                                    if ((v25 == v19->field_0 || v33 >= v31->field_8) && (((int)v19->field_8) - 8 <= 1 || v33 >= v31->field_8) && (v33 >= v31->field_8 || v25 != v19->field_0 || ((int)v19->field_8) - 8 > 1))
                                                    {
                                                        v25 = v34;
                                                    }
                                                }
                                    ...
                                    else if (!(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, r14<8>, 0x0<64>, cc_ndep<8>))))
                                    {
                                        ...
                                        else if (v31->field_8 > 0)
                                        {
                                            ...
                                            while (true)
                                            {
                                                ...
                                                if (v31->field_8 <= v24 && (v19 == 0 || v19 != 0 || v19 != 0))
                                                {
                                                    v24 = v7;
                                                }
                                            }
                ...
                if (v33 == *(v20[27] + tmp_6 + 8))
                {
                    ...
                    if (v19[2] > 0)
                    {
                        ...
                        do
                        {
                            ...
                            if (v19 == 4 && (v33 != v24->field_18 || *(v3->field_18 + (v2 << 3)) != v24->field_10))
                            {
                                v31 = v9;
                                v34 = v10 + v1->field_d8;
                                v6 = v13 * 24;
                                ...
                                while (true)
                                {
                                    ...
                                    if (v13 == v34->field_0 && v12 == 0 && ((long long)v19) == 0 && v28 <= v24->field_18 && v19 != 0 && *(v24->field_0 + (v28 << 3)) != 0 && ((int)v19) == 0 || v13 == v34->field_0 && ((long long)v19) == 0 && v28 <= v24->field_18 && v19 != 0 && v12 != 0 && *(v24->field_0 + (v28 << 3)) != 0)
                                    {
                                        v13 = *(v3->field_18 + 0 * 8);
                                        v7 = &stack_base-120;
                                        v14 = v33;
                                    ...
                                    if (...)
                                    {
                                        *(v22 + v4) = *(v4 + ((long long)v12));
                                        ...
                                        v22 = v19;
                                        if (!(((char)(v22 - 1 >> 63))) && ((long long)*((long long *)(((char *)&v15) + 8))) > v22)
                                        {
