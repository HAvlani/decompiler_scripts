...
int xstrtoumax()
{
    ...
    struct_0 *v13;  // r12
    unsigned long|unsigned long long|unsigned int v14;  // r13d
    ...
    if (v6 <= 36)
    {
        ...
        if (v17 != 45)
        {
            ...
            v3 = v14;
            return v3;
            if (v13->field_0 == v11 && ((long long)*(v14)) != 0 && v8 != 0 && v2 != 0 || v13->field_0 != v11 && ((long long)v17[0]) != 0 && v8 != 0 && (v15->field_0 == 0 || v2 == 34) && v2 != 0)
            {
                v6 = v15 - 69;
                switch (v15 - 69 & 255)
                {
