...
int usage()
{
    ...
    fputs_unlocked(dcgettext(0x0, &g_407170, 0x5), stdout);
    ...
    fputs_unlocked(dcgettext(0x0, &g_407348, 0x5), stdout);
    v6 = "sha256sum";
    v0 = "[";
    v1 = "test invocation";
    v2 = "coreutils";
    ...
    else
    {
        ...
        if (v26 == 0 || v34 == 0)
        {
            ...
            __printf_chk(0x1, dcgettext(0x0, &g_4073f8, 0x5));
            exit(v32); /* do not return */
        }
    }
    if ((v3 == 0 || v26 != 0) && (v3 == 0 || v34 != 0) && (v3 != 0 || v26 != 0) && (v3 != 0 || v34 != 0))
    {
