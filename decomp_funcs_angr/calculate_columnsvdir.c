...
{
    BOT tmp_16;  // tmp #16
    char *|unsigned long|struct_0 *|unsigned long long v1;  // rax
    struct_0 *|unsigned long long v10;  // rdi
    ...
    if (max_idx != 0)
    {
        ...
        {
            if (max_idx >= cwd_n_used || max_idx > column_info_alloc.11654)
            {
                if (max_idx >> 1 <= v13)
                {
                    v7 = max_idx;
    ...
    if (max_idx < cwd_n_used || v13 > column_info_alloc.11654)
    {
        ...
        {
            if (max_idx == 0 || max_idx >= cwd_n_used || max_idx > column_info_alloc.11654)
            {
    ...
    {
        if (v13 <= column_info_alloc.11654 || v5 == ((long long)((0 CONCAT v10) % v9)))
        {
            if (max_idx == 0 || max_idx >= cwd_n_used || max_idx > column_info_alloc.11654)
            {
                if (v13 == 0 || max_idx == 0)
                {
                    if (v13 == 0 || v13 <= column_info_alloc.11654)
                    {
                        ...
                        {
                            if (max_idx == 0 || v5 == ((long long)((0 CONCAT v10) % v9)) || max_idx >= cwd_n_used)
                            {
    ...
    if (max_idx < cwd_n_used || ((long long)[D] amd64g_calculate_condition(0x2<64>, 0x4<64>, Add(Load(addr=0x4232e0<64>, size=8, endness=Iend_LE), 0x1<64>), rbx<8>, cc_ndep<8>)) == 0 || v13 <= column_info_alloc.11654)
    {
        if (...)
        {
            v11 = column_info;
