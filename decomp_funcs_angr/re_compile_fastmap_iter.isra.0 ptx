...
int re_compile_fastmap_iter.isra.0()
{
    ...
    char *|unsigned long long|unsigned int|struct_6 * v14;  // rax
    unsigned long long v15;  // rax
    unsigned long|struct_6 *|unsigned long long v16;  // rcx
    unsigned long|unsigned long long|struct_7 * v17;  // rdx
