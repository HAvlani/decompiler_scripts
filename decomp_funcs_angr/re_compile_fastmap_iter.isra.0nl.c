...
int re_compile_fastmap_iter.isra.0()
{
    ...
    char *|unsigned long long|unsigned int|struct_7 * v14;  // rax
    unsigned long long v15;  // rax
    unsigned long|struct_7 *|unsigned long long v16;  // ecx
    unsigned long|unsigned long long|struct_4 * v17;  // rdx
    unsigned long long v18;  // rbx
    unsigned long|struct_5 *|unsigned long long v19;  // rsi
    struct_2 *v2;  // [bp-0x188]
    struct_3 *v20;  // rdi
    unsigned long long v21;  // r12
    unsigned long long v22;  // r13
    unsigned long long|struct_8 * v23;  // r14
