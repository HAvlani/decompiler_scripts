...
int mpz_and()
{
    ...
    unsigned long|unsigned long long|char v12;  // rsi
    ...
    unsigned long|unsigned int v9;  // rdx
    ...
    if (v23 != 0)
    {
        ...
        if (v12 == 0)
        {
            if (v9 > v23)
            {
                ...
                {
                    v12 = 0;
                    tmp_14 = (*(v14 + v8 * 8) ^ v15) + v11 & v16 ^ v24;
                    v11 = [D] amd64g_calculate_condition(0x2<64>, 0x4<64>, Xor(Load(addr=(rdi<8> + (rcx<8> << 0x3<8>)), size=8, endness=Iend_LE), r8<8>), rbp<8>, cc_ndep<8>);
            ...
            if ((rsi<8> == 0 || v9 <= v23) && (r11<8> == 0 || v9 > v23) && (v9 != 0 || v9 > v23))
            {
                v9 = v21;
                while (true)
                {
