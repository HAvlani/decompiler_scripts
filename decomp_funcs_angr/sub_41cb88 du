...
int sub_41cb88()
{
    ...
    char|unsigned long|unsigned int v11;  // [bp+0x60]
    ...
    char *v18;  // [bp+0x98]
    struct_0 *|unsigned long|unsigned int v19;  // [bp+0xa0]
    char|struct_3 * v2;  // [bp+0x8]
    ...
    unsigned long long v27;  // [bp+0x130]
    unsigned long v28;  // [bp+0x138]
    unsigned long long v29;  // [bp+0x140]
    unsigned long v3;  // [bp+0x10]
    struct_5 *|unsigned long long|struct_2 * v30;  // rax
    unsigned long long v31;  // rax
    unsigned long long v33;  // rax
    unsigned long long v35;  // rax
    struct_3 *|struct_5 *|unsigned long long v36;  // rcx
    unsigned long long v37;  // rcx
    unsigned long long v38;  // rdx
    char|unsigned long|unsigned long long v39;  // rbx
    struct_1 *v4;  // [bp+0x18]
    unsigned long long v40;  // rbx
    unsigned long long v41;  // rbp
    unsigned long long v42;  // rsi
    unsigned long long|void *|char * v43;  // rdi
    unsigned long long v44;  // r9
    unsigned long long|unsigned int v45;  // r10
    unsigned int v46;  // r10d
    unsigned long|unsigned long long|unsigned int v47;  // r11
    struct_0 *|unsigned long long v48;  // r12
    unsigned long long v49;  // r12
    struct_4 *|unsigned long long v5;  // [bp+0x20]
    unsigned long long v50;  // r13
    struct_2 *v51;  // r13
    unsigned long long v52;  // r14
    struct_4 *v53;  // r14
    struct_4 *|unsigned long long v54;  // r15
    ...
    unsigned long|BOT|uint128_t|unsigned long long v7;  // [bp+0x30]
    struct_5 *v8;  // [bp+0x40]
        ...
        while (true)
        {
            if (((char)v2) != 2 && ((char)v2) != 21)
            {
                ...
                if (((int)v30) == 0)
                {
                    ...
                    if ((((int)1) & -3) == 0)
                    {
                        /* goto ((long long)*(4344564 + 3 * 4)) + 4344564; */
                    }
                    else if (((char)v2) != 22)
                    {
                        /* goto ((long long)*(4344564 + 3 * 4)) + 4344564; */
                            ...
                            if (v30 == 0)
                            {
                                ...
                                if ((((int)1) & -3) != 0)
                                {
                                    ...
                                    if (((int)3) == 0)
                                    {
                                        ...
                                        {
                                            v38 = ((long long)((char)v20));
                                        }
                                    }
                                    if (v4->field_b4 > 1 && (v36 - 1 <= 1 || ((int)3) == 0) && (((int)3) == 3 || ((int)3) == 0) && (v11 == 0 || v4->field_b4 > 1) && (!(rcx<8>) - 1 <= 1 || ((int)3) != 3) && (v4->field_b4 > 1 || ((int)3) != 0))
                                    {
                                        v12 = ((int)v45);
                                        v11 = reg_104<4>;
                                        v38 = btowc(((int)rdx<8>));
                                ...
                                if (((int)3) == 3 && (((int)1) & -3) != 0 && v36 - 1 > 1 || v36 - 1 <= 1 && ((int)3) == 3 && (((int)1) & -3) != 0 && !(rcx<8>) - 1 > 1 || v47 == -1 && (((int)1) & -3) != 0 && (v36 - 1 <= 1 || ((int)3) != 3) && (!(rcx<8>) - 1 <= 1 || ((int)3) != 3) && (v4->field_b4 > 1 || ((int)3) != 0) && (v11 == 0 || v4->field_b4 > 1 || ((int)3) != 3) || reg_32<4> == -1 && v47 != -1 && (((int)1) & -3) != 0 && (v36 - 1 <= 1 || ((int)3) != 3) && (!(rcx<8>) - 1 <= 1 || ((int)3) != 3) && (v4->field_b4 > 1 || ((int)3) != 0) && (v11 == 0 || v4->field_b4 > 1 || ((int)3) != 3))
                                {
                                    v8->field_0 = 3;
                                    break;
                                }
                                ...
                                if (...)
                                {
                                    if (v4->field_b4 > 1)
                                    {
                                        ...
                                        if (v48->field_40 == v9)
                                        {
                                            ...
                                            v11 = v33;
                                            v44 = realloc(v48->field_10, ((unsigned int)v12));
                                            if (v11 != 0)
                                            {
                                                v47 = ((int)v14);
                                                v45 = ((long long)v16);
                                        ...
                                        if ((v48->field_40 != v9 || v6 != 0) && (v48->field_40 != v9 || v11 != 0))
                                        {
                                            v36 = v48->field_10;
                                            *(v48->field_8 + rax<8> * 4) = reg_104<4>;
                                            v48->field_40 = rax<8> + 1;
                                            *(v36 + rax<8> * 4) = ((int)rdx<8>);
                                        }
                                    }
                                    if (v4->field_b4 <= 1 || v48->field_40 != v9 || v6 != 0 && v11 != 0)
                                    {
                                        v30 = 0;
                                        do
                                        {
                                            v36 = v30;
                                            if (v47 <= ((int)v30) && ((int)rdx<8>) >= ((int)v30))
                                            {
                ...
                if ((((char)v2) == 22 || ((int)v30) != 0) && ((((int)1) & -3) != 0 || ((int)v30) != 0) && (v22 != 2 || ((int)v30) != 0) && (((int)v30) != 0 || v30 != 0) && (((int)v30) != 0 || v22 != 21))
                {
                    v8->field_0 = v30;
                    break;
                }
            ...
            if (((char)v2) == 21)
            {
                ...
                if (v48->field_38 == 0 && v48->field_28 == 0 && v48->field_30 == 0 && v48->field_40 == 0 && (v48->field_48 == 0 || v4->field_b4 <= 1) && (v4->field_b4 <= 1 || ((long long)(v48->field_20 & 1)) == 0))
                {
                    free_charset();
                    tmp_17 = v5;
                    v20 = 3;
            ...
            if (((char)v2) == 2 || v22 == 2 && ((int)v30) == 0 && ((char)v2) == 22 && (((int)1) & -3) != 0 && ((char)v2) != 21)
            {
                v8->field_0 = 7;
                break;
            }
        ...
        if (!((((char)(((long long)*(&stack_base-288 + ((v30 & 63) >> 3))) >> ((long long)((char)(v30 & 63 & 7))))) & 1) == 0))
        {
            ...
            while (true)
            {
                ...
                if (v6 != 0)
                {
                    ...
                    if (((long long)v39) == 0 || v41 != 1 && v30 != 0)
                    {
                        if (*(r15<8> + 48) == 17)
                        {
                            v30 = postorder();
                    ...
                    if (v9 != 0 && (((long long)v39) == 0 || v41 != 1) && (((long long)v39) == 0 || v30 != 0))
                    {
                        v21 = 0;
                        v22 = 16;
            ...
            if (v39 == 18446744069414584318 || v39 == 18446744069414584319 && v2->field_0 == 44 && v41 == 18446744069414584318 && v2->field_8 == 1 || v39 != 18446744069414584319 && v2->field_8 != 24 && v2->field_8 != 1 || v2->field_0 == 44 && v41 == 18446744069414584318 && v39 != 18446744069414584319 && v2->field_8 != 24)
            {
                if ((((int)v3) & 0x200000) == 0)
                {
                    if (v2->field_8 == 2)
