...
int re_compile_fastmap_iter.isra.0()
{
    ...
    unsigned int|char *|struct_4 *|unsigned long long v14;  // rax
    unsigned long long v15;  // rax
    struct_4 *|unsigned long long v16;  // rcx
    struct_5 *|unsigned long|unsigned long long v17;  // rdx
    unsigned long long v18;  // rbx
    struct_6 *|unsigned long|unsigned long long v19;  // rsi
    struct_3 *v2;  // [bp-0x188]
    struct_2 *v20;  // rdi
    unsigned long long v21;  // r12
    unsigned long long v22;  // r13
    struct_8 *|unsigned long long v23;  // r14
    unsigned long long v24;  // r15
    unsigned int|unsigned long long v25;  // cc_dep1
    struct_1 *v26;  // fs
    ...
    while (true)
    {
        ...
        else
        {
            ...
            *(v24 + ((long long)v19->field_0)) = 1;
            ...
            if (v2->field_b4 > 1 && ((long long)(*(v20 + 0x1a) & 64)) != 0)
            {
                v17 = *(v16);
                v16 = v2;
                v19 = &v10;
