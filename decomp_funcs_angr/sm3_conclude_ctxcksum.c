...
int sm3_conclude_ctx()
{
    ...
    if (v8 < v5)
    {
        ...
        v12->field_24 = ((int)v4);
        v7 = v6 - v5;
        *(v12 + v11 * 4 + 48) = (((int)v4) * 8 | ((int)v8) % 0x20000000) * 0x1000000 | (((int)v4) * 8 | ((int)v8) % 0x20000000) * 0x100 & 0xff0000 | (((int)v4) * 8 | ((int)v8) % 0x20000000) >> 8 & 0xff00 | (((int)v4) * 8 | ((int)v8) % 0x20000000) >> 24 & 255;
