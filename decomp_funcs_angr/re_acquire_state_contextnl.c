...
int re_acquire_state_context()
{
    ...
    struct_4 *|unsigned long long|unsigned int v13;  // edi
    unsigned long long v14;  // r8
    unsigned long long v15;  // r10
    unsigned long long v16;  // r11
    unsigned long long v17;  // r12
    unsigned long long v18;  // r13
    unsigned long|unsigned long long|unsigned int v19;  // r14d
    struct_4 *v2;  // [bp-0x48]
    struct_1 *v20;  // r15
    unsigned long long v21;  // cc_dep1
    unsigned long long v3[18];  // [bp-0x40]
    struct_6 *|unsigned long long|unsigned int|struct_5 * v5;  // rax
    struct_2 * v6;  // rax
                        ...
                        if (*((*(v20->field_10 + (v18 << 3)) << 4) + *(v18) + 8) != 1 || v9 != 0)
                        {
                            ...
                            *(v17 + 104) = ((char)(...));
                            ...
                            if (v9 != 0)
                            {
                                ...
                                if (((long long)(((char)v8) & 4)) == 0 && (((char)reg_80<4>) & 64) != 0 || ((long long)(((char)v8) & 2)) == 0 && ((long long)(r8b<1> & 16)) != 0 || ((long long)(((char)v8) & 1)) == 0 && ((long long)(r8b<1> & 1)) != 0 || ((long long)(r8b<1> & 1)) != 0 && ((long long)(r8b<1> & 2)) != 0 || ((long long)(r8b<1> & 1)) == 0 && ((long long)(r8b<1> & 2)) != 0 && ((long long)(((char)v8) & 1)) != 0)
                                {
                                    v9 = v18 - v15;
                                    if (!(((char)(v18 - v15 >> 63))))
                                    {
