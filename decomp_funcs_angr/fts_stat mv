...
int fts_stat()
{
    ...
    if (((long long)(((char)v11[18]) & 2)) == 0)
    {
        ...
        if (((long long)(((char)v11[18]) & 1)) == 0 || v9->field_58 != 0)
        {
            if (((long long)v6) == 0)
            {
                v2 = __fxstatat(0x1, v11[11], ((int)v9->field_30), ((int)v9) + 112, 0x100);
                if (v2 < 0)
                {
    ...
    if (((long long)(((char)v11[18]) & 2)) != 0 || ((long long)v6) != 0 || v9->field_58 == 0 && ((long long)(((char)v11[18]) & 1)) != 0)
    {
        v2 = __fxstatat(0x1, v11[11], ((int)v9->field_30), ((int)v9) + 112, 0x0);
    }
    if (v2 < 0)
    {
        if (v9->field_58 == 0 || ((long long)(((char)v11[18]) & 2)) != 0 || ((long long)v6) != 0)
        {
            if (((long long)(((char)v11[18]) & 1)) != 0 || ((long long)(((char)v11[18]) & 2)) != 0 || ((long long)v6) != 0)
            {
