...
int expand_bkref_cache()
{
    ...
    unsigned long|struct_0 *|unsigned long long v1;  // [bp-0xa0]
    ...
    struct_0 *|unsigned long|unsigned long long v2;  // [bp-0x98]
        ...
        if (v17 == *(v28 + (v19 + (v19 << 1) << 4) + 8))
        {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    if (v8 == 0 && v13 == 1 && v13 == 0 && v13 != 0 && v2->field_0 != 0 && v17 != v28[3] + v17 - v28[2] || v2->field_0 == 0 && v13 != 0 && v17 != v28[3] + v17 - v28[2] && v11 != 0)
                    {
                        v1 = r11<8>;
