...
extern char g_407a11;
extern unsigned int g_407a13;
extern struct_5 g_407ca8;
...
int quotearg_buffer_restyled()
{
    ...
    case 8: case 9: case 10:
        if (((int)v3) != 10)
        {
            v4 = ((int)v3);
            v3 = v42;
            v18 = dcgettext(0x0, &g_407a13, 0x5);
            if (v18 == "`")
            {
                v4 = v3;
                v3 = ((int)((int)v4));
            ...
            v4 = v4;
            v3 = v42;
            v17 = dcgettext(0x0, &g_407a11, 0x5);
            if (v17 == 4225553)
            {
                v4 = v3;
                v3 = v41;
        ...
        while (true)
        {
            ...
            if (((long long)r13b<1>) != 0)
            {
                ...
                else
                {
                    ...
                    {
                        v33 = ((long long)v36);
                        v30 = ((long long)*(g_407ca8 + v33 * 4)) + &g_407ca8;
                    }
                }
            }
            else
