...
int update_cur_sifted_state()
{
    ...
    unsigned int|struct_1 * v1;  // [bp-0xd8]
    unsigned long long v10;  // [bp-0x90]
    unsigned int v11;  // [bp-0x7c]
    unsigned long long|unsigned int|unsigned long v12;  // [bp-0x78]
    unsigned long|BOT v13;  // [bp-0x68]
    struct_2 *v14;  // [bp-0x60]
    BOT v15;  // [bp-0x58]
    unsigned long v16;  // [bp-0x50]
    struct_2 *v17;  // [bp-0x48]
    unsigned long long|unsigned int|struct_11 *|unsigned long long [4] v19;  // rax
    unsigned long long|unsigned long long [9]|unsigned long long [10] v2;  // [bp-0xd0]
    unsigned long long v20;  // rax
    unsigned long long|unsigned long long [4]|unsigned long long [28]|struct_2 * v21;  // rcx
    unsigned long long v22[3];  // rcx
    unsigned long long|unsigned long long [4]|struct_2 * v23;  // rdx
    unsigned long long v24;  // rdx
    unsigned long long|struct_9 * v25;  // rbx
    struct_2 * v26;  // rbp
    unsigned long long|unsigned int|unsigned long long [4]|struct_0 * v27;  // rsi
    ...
    unsigned long long|struct_7 * v32;  // r12
    unsigned long long|struct_2 * v33;  // r13
    unsigned long long|unsigned long v34;  // r14
    unsigned long long|struct_10 *|struct_2 * v35;  // r15
                                    ...
                                    else if (!(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, r14<8>, 0x0<64>, cc_ndep<8>))))
                                    {
                                        ...
                                        else if (v32->field_8 > 0)
                                        {
                                            ...
                                            while (true)
                                            {
                                                ...
                                                if (v32->field_8 <= v25 && (v19 == 0 || v19 != 0 || v19 != 0))
                                                {
                                                    v25 = v7;
                                                }
                                            }
                        ...
                        do
                        {
                            ...
                            if (v19 == 4 && (*(v3->field_18 + (v2 << 3)) != v25->field_10 || v34 != v25->field_18))
                            {
                                ...
                                while (true)
                                {
                                    ...
                                    if (v29 <= v25->field_18 && ((long long)v19) == 0 && v13 == v35->field_0 && v19 != 0 && v12 != 0 && *(v25->field_0 + (v29 << 3)) != 0 || v29 <= v25->field_18 && v12 == 0 && ((long long)v19) == 0 && v13 == v35->field_0 && v19 != 0 && *(v25->field_0 + (v29 << 3)) != 0 && ((int)v19) == 0)
                                    {
                                        v13 = *(v3->field_18 + 0 * 8);
                                        v7 = &stack_base-120;
                                        v14 = v34;
