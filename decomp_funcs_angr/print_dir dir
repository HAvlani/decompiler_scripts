...
int print_dir()
{
    ...
    unsigned long|unsigned long long [2] v14;  // rax
    ...
    struct_1 *v31;  // rbp
    unsigned long|unsigned int v33;  // r12d
    ...
    if (v33 != 0)
    {
        ...
        if (active_dir_set == 0 || v30 == v15 && ((long long)tmp_9) == 0 && v15 != 0)
        {
            clear_files();
            ...
            while (true)
            {
                ...
                if (v30 != 0)
                {
                    ...
                    if (ignore_mode == 2 || v30[19] != 46 || v30 + ((long long)(v30[20] == 46))[20] != 0 && ignore_mode != 0)
                    {
                        ...
                        if (format == 1 && sort_type == 6 && recursive == 0 && print_block_size == 0)
                        {
                            sort_files();
                            print_current_files();
                            clear_files();
