...
int xstrtoumax()
{
    ...
    unsigned long long|char [2]|unsigned int v2;  // eax
    ...
    if (v6 <= 36)
    {
        ...
        if (v17 != 45)
        {
            ...
            v3 = v14;
            return v3;
            if (v13->field_0 == v11 && ((long long)*(v14)) != 0 && v8 != 0 && v2 != 0 || v13->field_0 != v11 && ((long long)v17[0]) != 0 && v8 != 0 && (v2 == 34 || v16->field_0 == 0) && v2 != 0)
            {
                v6 = v16 - 69;
                switch (v16 - 69 & 255)
                {
