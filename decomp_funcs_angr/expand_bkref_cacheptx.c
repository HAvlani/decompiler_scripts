...
int expand_bkref_cache()
{
    ...
    unsigned long|struct_1 * v1;  // [bp-0xa0]
    unsigned long long v10;  // [bp-0x50]
    struct_1 * v11;  // [bp-0x48]
    unsigned long|unsigned long long|unsigned int v13;  // rax
    ...
    struct_1 *|unsigned long|unsigned long long v2;  // [bp-0x98]
    ...
    unsigned long long [4]|unsigned long long|unsigned int v28;  // r15
    ...
    {
        v14 = v16 + v19 >> 1;
        if (v17 <= *(((v16 + v19 & 18446744069414584318) + (v16 + v19 >> 1) << 4) + v18[27] + 8))
        {
            v16 = v14;
        }
        else
        ...
        if (v17 == *(v28 + (v19 + (v19 << 1) << 4) + 8))
        {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    if (v13 == 0 && v8 == 0 && v13 == 1 && v13 != 0 && v17 != v28[3] + v17 - v28[2] && v2->field_0 != 0 || v2->field_0 == 0 && v13 != 0 && v11 != 0 && v17 != v28[3] + v17 - v28[2])
                    {
                        v1 = v25;
