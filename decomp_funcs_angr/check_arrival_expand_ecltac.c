...
int check_arrival_expand_ecl()
{
    ...
    unsigned long long|struct_4 * v5;  // rax
    unsigned long long v6;  // rax
    unsigned long long|unsigned int v9;  // rcx
        ...
        while (true)
        {
            ...
            if (!(((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, Load(addr=(rsi<8> + 0x8<64>), size=8, endness=Iend_LE), 0x0<64>, cc_ndep<8>))))
            {
                ...
                while (true)
                {
                    v9 = *(v15 + v10 * 8);
                    v5 = *(v15 + v10 * 8) * 16 + v14;
                    if (v11 == v5->field_0 && v20 == ((int)*((*(v15 + (v10 << 3)) << 4) + v14 + 8)))
                    {
            ...
            if (((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, Load(addr=(rsi<8> + 0x8<64>), size=8, endness=Iend_LE), 0x0<64>, cc_ndep<8>)) || v5 != 0)
            {
                v5 = re_node_set_merge();
            }
            if (v5 == 0)
            {
                ...
                v19->field_8 = v3;
                v6 = 0;
                v19->field_0 = *((int128_t *)(((char *)&v2) + -8));
                return v6;
            }
            v0 = v5;
            rpl_free();
