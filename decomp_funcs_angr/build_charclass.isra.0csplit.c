...
int build_charclass.isra.0()
{
    ...
    struct_1 *|unsigned long long|char * v5;  // rdx
    struct_1 *v6;  // rbx
    unsigned long long v7;  // rbp
    struct_1 *|unsigned long|unsigned long long|char * v8;  // rsi
    char * v9;  // rdi
    ...
    if ((((int)v1) & 0x400000) == 0 && v12->field_0 == v15->field_0 || v12->field_0 == v15->field_0 && ((char)v17) == 0 || v12->field_0 == v15->field_0 && (((int)v1) & 0x400000) != 0 && ((char)v17) != 0)
    {
        v16 = v3 * 2 + 1;
        v0 = v5;
        v9 = realloc(v9, (v3 * 2 + 1) * 8);
    }
    if (v12->field_0 == v15->field_0 || (((int)v1) & 0x400000) != 0)
    {
        if (v12->field_0 == v15->field_0 || ((char)v17) != 0)
        {
            if (v12->field_0 == v15->field_0 || (((int)v1) & 0x400000) == 0 || ((char)v17) == 0)
            {
                if (v9 != 0)
                {
                    v0->field_0 = v9;
    ...
    if (v9 != 0 || (((int)v1) & 0x400000) == 0 && v12->field_0 != v15->field_0 || ((char)v17) == 0 && v12->field_0 != v15->field_0 || v12->field_0 != v15->field_0 && (((int)v1) & 0x400000) != 0 && ((char)v17) != 0)
    {
        v15->field_0 = v3 + 1;
        v15 = v9 + v3 * 8;
        ...
        if (((char)v17) != 0)
        {
            ...
            if (((char)v17) == 0)
            {
                ...
                do
                {
                    if (((long long)(*(v5 + (v3 << 1)) & 2)) != 0)
                    {
                        v8 = ((long long)(((int)(((long long)*(v7 + v3)) >> 3)) & 24));
                        *(v6 + v8) = *(v6 + v8) | 1 << (*(v7 + v3) & 63);
                    }
                    v3 += 1;
                }
                while (v3 != 0x100);
                                        ...
                                        if (((char)v17) == 0)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                do
                                                {
                                                    if (((char)[D] amd64g_calculate_condition(0x8<64>, 0x6<64>, Conv(16->64, Load(addr=(rsi<8> + (rax<8> << 0x1<8>)), size=2, endness=Iend_LE)), 0x0<64>, cc_ndep<8>)))
                                                    {
                                                        v5 = ((long long)(((int)(((long long)*(v7 + v3)) >> 3)) & 24));
                                                        *(v6 + v5) = *(v6 + v5) | 1 << (*(v7 + v3) & 63);
                                                    }
                                                    v3 += 1;
                                                }
                                                while (v3 != 0x100);
