...
int build_wcs_buffer()
{
    ...
    char v1;  // [bp-0x88]
    struct_1 *|struct_2 * v10;  // rdi
    unsigned long v11;  // r12
    unsigned long long v12;  // r15
    struct_0 *v13;  // fs
    unsigned long v2;  // [bp-0x40]
    unsigned long long|struct_2 * v4;  // rax
    ...
    if ((v10->field_40 <= tmp_47? v10->field_40 : tmp_47) > v8)
    {
        while (true)
        {
            ...
            {
                v5 = ((int)v0);
                if (v4 == 18446744069414584318 && v7->field_40 < v7->field_58)
                {
                    v7->field_20 = v12;
                    v7->field_30 = v8;
                    v7->field_38 = v8;
            ...
            if (v4 != 18446744069414584318 || v7->field_40 >= v7->field_58 || v4 - 1 > 18446744069414584317)
            {
                v6 = v7->field_10;
                v9 = v8 + 1;
                v10 = v8 * 4;
