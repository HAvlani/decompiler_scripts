...
int rpl_fts_read()
{
    ...
    struct_1 *|unsigned long long|void *|unsigned int v15;  // rdi
    struct_4 *|unsigned long long v16;  // r12
    struct_7 *|void * v17;  // r13
    struct_3 *|struct_10 * v18;  // r14
        ...
        if (((long long)(((char)(v15->field_48 >> 8)) & 32)) == 0)
        {
            ...
            if (tmp_4 != 1)
            {
                ...
                else if (((long long)v15->field_0->field_68) - 12 << 48 > 0x1000000000000 || v15->field_0->field_6c != 2)
                {
                            ...
                            if (v17->field_8->field_18 == 0 || v16 == 0 && ((long long)(*(v12 + 0x49) & 32)) == 0)
                            {
                                ...
                                if (v18->field_58 != 18446744069414584319)
                                {
                                    *(v15->field_20 + v18->field_48) = 0;
                                    ...
                                    if ((((short)v15) & 0x2000) != 0 && (v1 == 0 || v18->field_58 != 0 || v19 != 2) && (v18->field_58 == 0 || v1 == 0 || ((long long)(v1 & 1)) != 0 || ((long long)(((char)v18->field_6a) & 2)) != 0 || v19 != 2))
                                    {
                                        v6 = v16;
                                        return v6;
                                        v6 = v16;
                    ...
                    if (v16->field_6c != 4 && v16 != 0 && v16->field_58 != 0)
                    {
