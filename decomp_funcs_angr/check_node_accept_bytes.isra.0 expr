...
int check_node_accept_bytes.isra.0()
{
    ...
    struct struct_4 **v10;  // r10
    char v11;  // r11b
    unsigned long long v12;  // r12
    unsigned long long v2;  // rax
    struct_0 *|unsigned long long [12] v3;  // rcx
    char *|unsigned long long v4;  // rdx
    unsigned long long v5;  // rdx
    unsigned long long v6;  // rbp
    struct_3 *|unsigned long long v7;  // rsi
        ...
        else
        {
            if (((long long)*(v3[1] + v9)) > 223)
            {
                if (((long long)*(v3[1] + v9)) <= 239)
                {
                    ...
                    if (((long long)*(v3[1] + v9 + 1)) > 159 || *(v3[1] + v9) != 224)
                    {
                        v8 = 3;
                    }
                }
                else
                {
                    ...
                    else
                    {
                        if (((long long)*(v3[1] + v9)) <= 251)
                        {
                            ...
                            if (((long long)*(v3[1] + v9 + 1)) > 135 || *(v3[1] + v9) != 248)
                            {
                                v8 = 5;
                            }
                        }
    ...
    else if (v3->field_90 != 1)
    {
        ...
        if (v11 != 5)
        {
            ...
            {
                v7 = v10[0]->field_40;
                if (v10[0]->field_40 != 0 || (v10[0]->field_28 | v10[0]->field_48) != 0)
                {
                ...
                if (((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, rsi<8>, 0x0<64>, cc_ndep<8>)) || ((long long)(v10[0]->field_20 & 1)) != 0 || v10[0]->field_40 == 0 && (v10[0]->field_28 | v10[0]->field_48) == 0)
                {
                    if (((long long)(v10[0]->field_20 & 1)) != 0)
                    {
                        v2 = v12;
        ...
        else
        {
            ...
            if (((long long)(((char)v7->field_0) & 64)) != 0 || *(v3->field_8 + v9) != 10)
            {
