...
int mpz_export()
{
    ...
    if (v14 == 0)
    {
        ...
        else if (((int)(v13 + 1)) <= 2)
        {
            ...
            if (v2->field_4 != 0)
            {
                v16 = ((long long)((v2->field_4 ^ ((int)(v17 >> 31))) - ((int)(v17 >> 31))));
                v4 = *(v18->field_8 + v16 * 8 + 8);
                if (*(v18->field_8 + (v16 << 3) + 8) != 0)
                {
                    do
                    {
                        v7 = v14;
                    ...
                    v0 = v8 + v16 * 8 - 8 + v7;
                    v19 = ((long long)((0 CONCAT v8 + v16 * 8 - 8 + v7) % v8));
                    if (v12 == 0)
                    {
                        v1 = ((int)v13);
