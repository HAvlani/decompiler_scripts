...
int xpalloc()
{
    ...
    if (v6 <= 127 || ((char)[D] amd64g_calculate_condition(0x0<64>, 0x4<64>, rbx<8>, r10<8>, cc_ndep<8>)))
    {
    ...
    if (v4 - v10 < v3)
    {
        ...
        if (!(((char)[D] amd64g_calculate_condition(0x0<64>, 0x4<64>, rbx<8>, r10<8>, cc_ndep<8>))))
        {
            ...
            if (v4 <= v2 || ((char)[D] amd64g_calculate_condition(0x0<64>, 0x4<64>, rbx<8>, r10<8>, cc_ndep<8>)))
            {
                if (!(((char)[D] amd64g_calculate_condition(0x0<64>, 0x4<64>, rbx<8>, r10<8>, cc_ndep<8>))))
                {
                    v5->field_0 = v4;
