...
extern unsigned int g_40b0eb;
extern unsigned int g_40b0f3;
extern unsigned int g_40b102;
extern unsigned int g_40b13c;
extern unsigned int g_40b830;
extern unsigned int g_40ba98;
...
int main()
{
    ...
    unsigned long|unsigned long long v10;  // [bp-0xe0]
    unsigned long|unsigned long long v11;  // [bp-0xd8]
    unsigned long|unsigned long long v12;  // [bp-0xd0]
    unsigned long|unsigned long long v13;  // [bp-0xc8]
    char v14;  // [bp-0xc0]
    char v15;  // [bp-0xbf]
    unsigned long long|char v16;  // [bp-0xbe]
    char v17;  // [bp-0xbd]
    unsigned int v18;  // [bp-0xbc]
    char v19;  // [bp-0xa9]
    char v2;  // [bp-0x111]
    ...
    char v24;  // [bp+0xf]
    char v25;  // [bp+0x60]
    char *|unsigned long long|unsigned int|struct_2 * v26;  // rax
    unsigned long|unsigned int v29;  // rax
    struct_1 * v3;  // [bp-0x110]
    char *v33;  // rax
    ...
    unsigned long|char *|struct_2 *|struct_5 * v49;  // rdi
    unsigned long|unsigned long long v5;  // [bp-0x100]
    char *|unsigned long long v50;  // r8
    unsigned long long v52;  // r10
    unsigned long long|struct_5 * v53;  // r12
    ...
    unsigned long long|unsigned int|char v7;  // [bp-0xf4]
    unsigned long|char *|unsigned long long v8;  // [bp-0xf0]
    struct_1 * v9;  // [bp-0xe8]
    ...
    set_program_name();
    setlocale();
    bindtextdomain(&g_40b099, &g_40b830);
    textdomain(&g_40b099);
    atexit();
    setvbuf(stdout, NULL, 0x1, 0x0);
    v14 = 0;
    v2 = 0;
    v26 = getopt_long(((int)v49), ((int)((unsigned int)v48)), &g_40b0eb, &long_options, 0x0);
    if (!(v26 != -1))
    {
        min_digest_line_length = 66;
        digest_hex_bytes = 64;
        if (((long long)(((char)(v55 == 0)) & v14)) == 0)
        {
            ...
            if (...)
            {
                        ...
                        if (v57 != 0)
                        {
                            ...
                            if (v6 == 0 || v53 != 0)
                            {
                                ...
                                while (true)
                                {
                                    ...
                                    if (!(((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x4100f8<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x4100f8<64>, size=8, endness=Iend_LE), cc_ndep<8>))) && *(v20) != 35)
                                    {
                                        ...
                                        if (v57 != v43)
                                        {
                                            *(v56) = 0;
                                            ...
                                            if (((char)v57) == 0)
                                            {
                                                v41 = ((long long)*(0 + v26 + 6));
                                                if (*(0 + v26 + 6) == 32)
                                                {
                                                    v41 = ((long long)*(0 + v26 + 7));
                                                }
                                                if (v41 == 40)
                                                {
                                                    v48 += 1;
                                    ...
                                    if (...)
                                    {
                                        ...
                                        if (warn != 0)
                                        {
                                            ...
                                            error(0x0, 0x0, dcgettext(0x0, &g_40ba98, 0x5));
                                        }
                                    }
                                    if (...)
                                    {
                                        ...
                                        else if (v19 == 0 || ignore_missing == 0)
                                        {
                                            ...
                                            if (((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x4100f8<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x4100f8<64>, size=8, endness=Iend_LE), cc_ndep<8>)) || v8 != v12)
                                            {
                                                v16 = status_only;
                                        ...
                                        if (((long long)quiet) == 0 && ((long long)status_only) == 0 && ((long long)v12) != 0 && (v19 == 0 || ignore_missing == 0) && (((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x4100f8<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x4100f8<64>, size=8, endness=Iend_LE), cc_ndep<8>)) || v8 != v12) && v7 != 0 || !(((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x4100f8<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x4100f8<64>, size=8, endness=Iend_LE), cc_ndep<8>))) && ((long long)v12) != 0 && (v19 == 0 || ignore_missing == 0) && v8 != v12)
                                        {
                                            v26 = *(stdout + 40);
                                            if (*(stdout + 40) < *(stdout + 48))
                                            {
                                    ...
                                    if (...)
                                    {
                                            ...
                                            if (v47 < 0)
                                            {
                                                if (v7 != 0)
                                                {
                                                    if (status_only == 0)
                                                    {
                                                        if (v5 != 0)
                                                        {
                                                            error(0x0, 0x0, dcngettext(0x0, &g_40bb28, &g_40baf8, ((int)v5), 0x5));
                                                        }
                                                        if (v10 != 0)
                                                        {
                                                            error(0x0, 0x0, dcngettext(0x0, &g_40bb88, &g_40bb58, ((int)v10), 0x5));
                                                        }
                                                        if (v11 != 0)
                                                        {
                                                            error(0x0, 0x0, dcngettext(0x0, &g_40bbe8, &g_40bbb8, ((int)v11), 0x5));
                                                        }
                                                    ...
                                                    if ((v10 | v11) == 0 && v16 != 0)
                                                    {
                                                        v29 = ((long long)(((int)strict) ^ 1 | v43));
                                                        /* goto 4206361; */
                                                    }
                                                }
                                                else
                                        ...
                                        if ((v47 == 0 || v6 != 0) && (v47 == 0 || v39 != 0) && (v47 == 0 || v45 != 0) && (v6 != 0 || v47 >= 0) && (v47 >= 0 || v39 != 0) && (v47 >= 0 || v45 != 0))
                                        {
                                            v47 = 0;
                                            v43 = dcgettext(0x0, &g_40b13c, 0x5);
                                        }
                                        if (v47 >= 0 || v6 != 0 && v39 != 0 && v45 != 0)
                                        {
                                            error(0x0, v47, v43);
                                            v26 = 0;
                                            break;
                                    ...
                                    if (...)
                                    {
                                        ...
                                        error(0x1, 0x0, dcgettext(0x0, &g_40b102, 0x5));
                                    }
                                }
                            }
                            v15 &= v26;
                ...
                {
                    error(0x1, *(__errno_location()), dcgettext(0x0, &g_40b0f3, 0x5));
                }
            }
        }
        else
    ...
    else if (v26 > 97)
    {
        ...
        if (((int)v26) <= 34)
        {
            v37 = ((long long)*(g_40bc20 + v26 * 4)) + &g_40bc20;
            /* goto v37; */
        }
        else
        {
