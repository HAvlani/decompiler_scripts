...
int check_halt_state_context()
{
    ...
    struct_1 *|unsigned short|unsigned int v5;  // edi
    ...
    if (!(((char)[D] amd64g_calculate_condition(0xe<64>, 0x14<64>, Load(addr=(rbp<8> + 0x10<64>), size=8, endness=Iend_LE), 0x0<64>, cc_ndep<8>))))
    {
        ...
        while (true)
        {
            ...
            if (*((*(v8 + (v4 << 3)) << 4) + v7 + 8) == 2)
            {
                if (((long long)v5) != 0)
                {
                    if (((long long)(v2 & 4)) == 0 && (((char)((int)v2)) & 8) != 0 && v9 != 0)
                    {
                        /* goto 4238840; */
                    }
                    if (((((char)((int)v2)) & 8) == 0 || v9 == 0) && (((long long)(v5 & 32)) == 0 || (((char)((int)tmp_22)) & 2) != 0) && (((long long)(v2 & 4)) == 0 || v9 != 0))
                    {
