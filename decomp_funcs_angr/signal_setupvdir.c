...
int signal_setup()
{
    ...
    unsigned long long|struct_2 * v13;  // rbx
    unsigned long long|struct_2 *|unsigned int v14;  // rbp
    char v15;  // dil
    ...
    if (((long long)v15) == 0)
    {
        ...
        while (true)
        {
            v12 = sigismember(&caught_signals, ((unsigned int)v14));
            if (v12 != 0)
            {
                signal(((unsigned int)v14), 0x0);
                if (v13 == 4290192)
                {
                    return v10 ^ *(v18 + 0x28);
                }
            ...
            if (v13 != 4290192)
            {
                ((unsigned int)v14) = ((long long)v13->field_0);
                v13 += 4;
            }
        }
    }
    else
    {
        ...
        while (true)
        {
            ...
            if (v0 != 1)
            {
                sigaddset(&caught_signals, 0x14);
            }
            if (v13 == 4290192)
            {
                break;
            }
            20 = ((long long)v13->field_0);
            v13 += 4;
        }
        v9 = 0x10000000;
        v16 = 20;
