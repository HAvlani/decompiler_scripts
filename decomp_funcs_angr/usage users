...
int usage()
{
    ...
    if (v3 != 0)
    {
        __printf_chk(0x1, dcgettext(0x0, &g_4070a3, 0x5));
        v31 = setlocale();
        if (v31 != 0)
        {
    ...
    else
    {
        ...
        if (v20 == 0 || v31 == 0)
        {
            __printf_chk(0x1, dcgettext(0x0, &g_4070cc, 0x5));
            __printf_chk(0x1, dcgettext(0x0, &g_407298, 0x5));
            exit(v29); /* do not return */
        }
    }
    if ((v3 == 0 || v31 != 0) && (v3 == 0 || v20 != 0) && (v20 != 0 || v3 != 0) && (v3 != 0 || v31 != 0))
    {
