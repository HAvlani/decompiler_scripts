...
int usage()
{
    ...
    fputs_unlocked(dcgettext(0x0, &g_407160, 0x5), stdout);
    ...
    if (v22[1] != 0)
    {
        __printf_chk(0x1, dcgettext(0x0, &g_40706b, 0x5));
        v31 = setlocale();
        if (v31 != 0)
        {
    ...
    else
    {
        ...
        if (v19 == 0 || v31 == 0)
        {
            __printf_chk(0x1, dcgettext(0x0, &g_407094, 0x5));
            __printf_chk(0x1, dcgettext(0x0, &g_407328, 0x5));
            exit(v29); /* do not return */
        }
    }
    if ((v22[1] == 0 || v19 != 0) && (v22[1] == 0 || v31 != 0) && (v19 != 0 || v22[1] != 0) && (v22[1] != 0 || v31 != 0))
    {
        fputs_unlocked(dcgettext(0x0, &g_4072e0, 0x5), stdout);
    }
