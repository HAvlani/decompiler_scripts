...
int mbsnwidth()
{
    ...
    if (v4 > 1)
    {
        ...
        if (v10 < v10 + v9)
        {
            while (true)
            {
                ...
                if ((((char)(((long long)v4) <= 64)) || !(((char)(((long long)*(v12)) <= 95)))) && (((char)(((long long)*(v12)) <= 95)) || ((long long)tmp_3) > 29) && (((char)(((long long)v4) <= 35)) || !(((char)(((long long)*(v12)) <= 95))) || ((long long)tmp_3) > 26) && (((char)(((long long)v4) <= 31)) || !(((char)(((long long)v4) <= 35))) || !(((char)(((long long)*(v12)) <= 95)))))
                {
                    v2 = 0;
                    while (true)
                    {
                        ...
                        else if (v4 != 18446744069414584318)
                        {
                            ...
                            if ((((long long)(((char)v0) & 2)) == 0 || ((int)v4) >= 0) && (((int)v4) < 0 || 2147483647 - ((int)v11) >= ((int)v4)) && (((int)v11) != 2147483647 || v4 != 0 || ((int)v4) >= 0))
                            {
                                v12 += v8;
                                v4 = mbsinit(((int)&v2));
                            }
    ...
    else
    {
        ...
        while (true)
        {
            ...
            if (((long long)(((char)(*(v6 + (tmp_7 << 1)) >> 8)) & 64)) != 0 || ((long long)(v4 & 2)) == 0 && ((int)(v0 & 2)) == 0)
            {
                v5 = v11;
                return v5;
            }
