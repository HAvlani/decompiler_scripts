...
int savewd_chdir()
{
    unsigned long long|unsigned long|struct_0 *|unsigned int|char v1;  // rax
    ...
    if (v3 == 0 || ((int)v6) < 0)
    {
        if (v3 == 0 || v1->field_0 == 13)
        {
            if (((int)v6) < 0 || ((long long)(v4 & 1)) == 0)
            {
    ...
    if (v8->field_0 == 0 && ((char)[D] amd64g_calculate_condition(0x6<64>, 0x7<64>, Conv(32->64, Load(addr=rdi<8>, size=4, endness=Iend_LE)), 0x3<64>, cc_ndep<8>)) && (((char)((int)v4)) & 2) == 0 && ((int)v6) >= 0 && v8->field_0 != 3 && (v3 != 0 || ((long long)(v4 & 1)) != 0) || ((char)[D] amd64g_calculate_condition(0x6<64>, 0x7<64>, Conv(32->64, Load(addr=rdi<8>, size=4, endness=Iend_LE)), 0x3<64>, cc_ndep<8>)) && v8->field_0 == 0 && v8->field_0 != 3 && (v3 == 0 || ((int)v6) < 0) && (v3 == 0 || v1->field_0 == 13) && (((int)v6) < 0 || ((long long)(v4 & 1)) == 0) && (v1->field_0 == 13 || ((long long)(v4 & 1)) == 0))
    {
        v1 = open_safer();
        if (v1 >= 0)
        {
