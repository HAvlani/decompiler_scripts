...
int mpz_gcdext()
{
    ...
    BOT tmp_19;  // tmp #19
    BOT tmp_33;  // tmp #33
    unsigned int|unsigned long v0;  // [bp-0xe8]
    unsigned long v1;  // [bp-0xe0]
    unsigned long v10;  // [bp-0xa0]
    unsigned int|unsigned long|unsigned long long v11;  // [bp-0x98]
    unsigned int v12;  // [bp-0x94]
    unsigned long v13;  // [bp-0x90]
    unsigned int|unsigned long|unsigned long long v14;  // [bp-0x88]
    unsigned int v15;  // [bp-0x84]
    unsigned long|struct_3 * v16;  // [bp-0x80]
    unsigned int|unsigned long v17;  // [bp-0x78]
    ...
    unsigned int|unsigned long v28;  // rax
    struct_1 * v3;  // [bp-0xd0]
    struct_2 *|unsigned long long v31;  // rax
    unsigned long long v36;  // rax
    struct_2 * v4;  // [bp-0xc8]
    struct_2 * v5;  // [bp-0xc0]
    struct_1 *|unsigned int|struct_2 * v56;  // rcx
    unsigned int|unsigned long long v57;  // edx
    unsigned long long v58;  // rbx
    struct_1 *|unsigned int|struct_2 *|unsigned long long v59;  // rbx
    struct_2 *v6;  // [bp-0xb8]
    struct_2 *v60;  // rbx
    unsigned long long v61;  // rbp
    unsigned long long v62;  // rsi
    struct_2 *|unsigned long long v63;  // rdi
    struct_1 *|unsigned int v64;  // r8d
    struct_1 *v65;  // r12
    struct_2 *v66;  // r14
    ...
    else if (((int)v64->field_4) != 0)
    {
        ...
        tmp_24 = v68 <= v31;
        v7 = (v68 <= v31? v68 : v31);
        v67 = v68 - (v68 <= v31? v68 : v31);
        v61 = v31 - (tmp_24? tmp_2 : v31);
        if (v9 < v31)
        {
            tmp_16 = v8;
            v2 = v3;
        ...
        if (v1 != 0)
        {
            while (true)
            {
                ...
                if (((((int)(v15 != 0)) & v16->field_0) == 0 || (((int)(((int)*((int *)(((char *)&v20) + 4))) != 0)) & v22->field_0) == 0) && ((((int)(v15 != 0)) & v16->field_0) == 0 || (((int)(v15 != 0)) & v16->field_0) == 0) && ((((int)(((int)*((int *)(((char *)&v20) + 4))) != 0)) & v22->field_0) == 0 || (((int)(((int)*((int *)(((char *)&v20) + 4))) != 0)) & v22->field_0) == 0) && ((((int)(((int)*((int *)(((char *)&v20) + 4))) != 0)) & v22->field_0) == 0 || (((int)(v15 != 0)) & v16->field_0) == 0))
                {
                    v58 -= 1;
                    mpz_div_q_2exp.isra.0();
                    mpz_div_q_2exp.isra.0();
                    if (v58 == 18446744069414584319)
                    {
                        break;
                    }
                }
