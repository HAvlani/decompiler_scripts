...
int quotearg_buffer_restyled()
{
    ...
    unsigned int|struct_5 *|char|unsigned long long|char * v33;  // rdx
    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            if (((long long)al<1>) == 0 && ((long long)dl<1>) != 0 || v14 == 0 && v4 != 0 || v4 == 0 && (v14 == 0 || ((long long)r9b<1>) == 0) && (v14 == 0 || v7 == 0) && (((long long)r9b<1>) == 0 || v14 != 0))
            {
                if (r12<8> < r14<8>)
                {
                    *(v45 + r12<8>) = bpl<1>;
