...
int usage()
{
    ...
    fputs_unlocked(dcgettext(0x0, &g_407380, 0x5), stdout);
    v6 = "sha256sum";
    v0 = "[";
    v1 = "test invocation";
    v2 = "coreutils";
    ...
    if (v22[1] != 0)
    {
        __printf_chk(0x1, dcgettext(0x0, &g_40708e, 0x5));
        v35 = setlocale();
        if (v35 != 0)
        {
    ...
    else
    {
        ...
        if (v35 == 0 || v27 == 0)
        {
            __printf_chk(0x1, dcgettext(0x0, &g_4070b7, 0x5));
            __printf_chk(0x1, dcgettext(0x0, &g_407430, 0x5));
            exit(v33); /* do not return */
        }
    }
    if ((v22[1] == 0 || v27 != 0) && (v22[1] == 0 || v35 != 0) && (v35 != 0 || v22[1] != 0) && (v22[1] != 0 || v27 != 0))
    {
        fputs_unlocked(dcgettext(0x0, &g_4073e8, 0x5), stdout);
    }
    if (v22[1] != 0 || v35 != 0 && v27 != 0)
    {
        __printf_chk(0x1, dcgettext(0x0, &g_4070b7, 0x5));
        __printf_chk(0x1, dcgettext(0x0, &g_407430, 0x5));
        exit(v33); /* do not return */
