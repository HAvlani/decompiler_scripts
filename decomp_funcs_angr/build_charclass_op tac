...
int build_charclass_op()
{
    ...
    struct_2 *|unsigned long v1;  // [bp-0x88]
    ...
    char * v25;  // r13
    struct_4 *|unsigned long v3;  // [bp-0x68]
    char v4;  // [bp-0x60]
            ...
            if (((int)v1) == 0)
            {
                ...
                if (((long long)*(v25)) != 0)
                {
                    do
                    {
                        ...
                        v15 = ((long long)*(v25));
                        *(v11 + ((((char)[D] amd64g_calculate_condition(0x9<64>, 0x14<64>, t2, 0x0<64>, cc_ndep<8>))? tmp_2 : tmp_54) >> &g_0) * 8) = *(v11 + ((((char)[D] amd64g_calculate_condition(0x9<64>, 0x14<64>, t2, 0x0<64>, cc_ndep<8>))? tmp_2 : tmp_54) >> &g_0) * 8) | &g_0 << (tmp_97 & 63);
                        tmp_53 = v15;
                    }
                ...
                if (v21->field_b4 > 1)
                {
                    ...
                    do
                    {
                        *(v11 + v11) = *(v11 + v11) & *(v21->field_78 + v11);
                        v11 += 8;
                    }
                    while (v11 != 32);
                }
