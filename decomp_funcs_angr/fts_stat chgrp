...
int fts_stat()
{
    ...
    if (v1 < 0)
    {
        ...
        {
            if (((long long)(((char)v10->field_48) & 1)) != 0 || ((long long)v6) != 0 || ((long long)(((char)v10->field_48) & 2)) != 0)
            {
