...
int sha512_process_bytes()
{
    ...
    BOT tmp_54;  // tmp #54
    uint128_t [8] v10;  // rbp
    struct_1 *|unsigned long long|struct_3 * v11;  // rsi
    struct_1 *|struct_3 * v12;  // rsi
    void *|struct_3 * v13;  // rdi
    struct_0 *v14;  // r12
    ...
    if (v15 != 0 || v15 > 127 && ((long long)(v7 & 7)) != 0)
    {
        ...
        *(v12 + v15 + 8) = *(v17 + v15 + 8);
        ...
        v12 = v17 - (v12 - (v12 + 8 & 18446744069414584312));
