...
int try_tempname_len()
{
    ...
    unsigned int|unsigned long|unsigned long long v23;  // r8
    ...
    if (v21 + v23 <= v19)
    {
        ...
        v22 = v26;
        v9 = v26;
        v16 = strspn(v22, &g_40852c, ((int)v8));
        v24 = ((long long)v0);
        if (v16 >= v23)
        {
            v23 = 0;
                ...
                if (v2 != 0)
                {
                    ...
                    do
                    {
                        ...
                        else
                        {
                            ...
                            v12 = v25;
                            if (((long long)v24) != 0 || v25 > 17625286678940177407)
                            {
                                while (true)
                                {
                                ...
                                if (v25 <= 17625286678940177407 && v16 == 8)
                                {
                                    v23 = 9;
                                    v24 = 1;
                                }
                        ...
                        tmp_46 = r13<8>;
                        v20 += 1;
                        v19 = ((long long)(9520900167075897609 * r13<8> % 2 >> 64)) >> 4;
                        v12 = ((long long)(9520900167075897609 * r13<8> % 2 >> 64)) >> 4;
                        v25 = ((long long)(9520900167075897609 * r13<8> % 2 >> 64)) >> 4;
                        v17 = tmp_46 - v19 * 62;
