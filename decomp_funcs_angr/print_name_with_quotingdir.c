...
int print_name_with_quoting()
{
    ...
    char|unsigned long long v11;  // sil
    struct_0 *v12;  // rdi
    struct_0 *v13;  // r12
    unsigned long long v14;  // r12
    unsigned long long|char * v15;  // r13
    unsigned long long|unsigned int v3;  // rax
    unsigned long long v6;  // rax
    char|struct_2 *|unsigned long long v7;  // rcx
    ...
    else
    {
        ...
        if (color_symlink_as_referent == 0 || ((long long)v12->field_b9) == 0)
        {
    ...
    if (((long long)print_with_color) != 0)
    {
        if ((((long long)v3) == 0 || ((long long)v11) == 0) && (v12->field_b9 == 0 || ((long long)v11) == 0))
        {
            v7 = ((long long)v13->field_b8);
        }
        if (v12->field_b9 != 0 || ((long long)v13->field_b8) != 0)
        {
            if (((long long)v13->field_b8) != 0 || ((long long)v11) != 0)
            {
                if (((long long)v3) == 0 || ((long long)v11) == 0 || v12->field_b9 != 0)
                {
                    if (v12->field_b9 == 0 || ((long long)v11) == 0 || ((long long)v13->field_b8) != 0)
                    {
                        ...
                        if ((((short)((int)v11)) & 0xf000) != 0x8000)
                        {
                            ...
                            else
                            {
                                ...
                                if (((long long)v3) == 0 || (((short)((int)v11)) & 514) != 514)
                                {
                                    ...
                                    if (((long long)v3) == 0 || ((long long)(v11 & 2)) == 0)
                                    {
        ...
        if ((((long long)v13->field_b8) == 0 || v12->field_b9 != 0) && (((long long)v13->field_b8) == 0 || ((long long)v11) != 0) && (((long long)v13->field_b8) == 0 || v12->field_b9 == 0 || ((long long)v11) == 0) && (((long long)v3) == 0 || ((long long)v11) == 0 || v12->field_b9 != 0))
        {
    ...
    if (...)
    {
        ...
        if (v7->field_8 != 0 || ((long long)v3) != 0)
        {
            v0 = v13->field_10;
            v14 = (long long)quote_name();
            process_signals();
            ...
            else if (((long long)((0 CONCAT v10) % v7)) == ((long long)((0 CONCAT v14 + v10 - 1) % v7)))
            {
                v6 = v14;
                return v6;
            }
