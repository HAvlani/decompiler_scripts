...
int usage()
{
    ...
    fputs_unlocked(dcgettext(0x0, &g_406228, 0x5), stdout);
    fputs_unlocked(dcgettext(0x0, &g_4062f8, 0x5), stdout);
    fputs_unlocked(dcgettext(0x0, &g_406328, 0x5), stdout);
    ...
    else
    {
        ...
        if (v20 == 0 || v34 == 0)
        {
            ...
            __printf_chk(0x1, dcgettext(0x0, &g_406498, 0x5));
            exit(v32); /* do not return */
        }
    }
    if ((v27[1] == 0 || v34 != 0) && (v27[1] == 0 || v20 != 0) && (v20 != 0 || v27[1] != 0) && (v27[1] != 0 || v34 != 0))
    {
        fputs_unlocked(dcgettext(0x0, &g_406450, 0x5), stdout);
    }
    if (v27[1] != 0 || v20 != 0 && v34 != 0)
    {
        __printf_chk(0x1, dcgettext(0x0, &g_406095, 0x5));
        __printf_chk(0x1, dcgettext(0x0, &g_406498, 0x5));
        exit(v32); /* do not return */
