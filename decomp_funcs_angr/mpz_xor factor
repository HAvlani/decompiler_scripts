...
int mpz_xor()
{
    ...
    char|unsigned long|unsigned long long v11;  // rsi
    ...
    if (v23 != 0)
    {
        ...
        v21 = 0 - ((long long)(((int)(((long long)*(v17 + 4)) >> 31)) & 1));
        ...
        do
        {
            ...
            tmp_22 = tmp_5 ^ (*(v16 + v7 * 8) ^ v15) + v20 ^ v14;
        ...
        if (v11 == 0)
        {
            if (v22 > v23)
            {
                ...
                if (rsi<8> != 0)
                {
                    *(v6 + v22 * 8) = 1;
                    v8 = ((int)v22) + 1;
                    v0->field_4 = (v14 != 0? 0 - ((unsigned int)v8) : ((int)rdx<8>));
                    return v0;
                }
            }
            else if (r11<8> != 0)
