...
extern unsigned int g_40ec39;
extern struct_5 g_40eec8;
...
int quotearg_buffer_restyled()
{
    ...
    char *|char|struct_5 *|unsigned long long|unsigned long|unsigned int v36;  // rsi
    ...
    case 8: case 9: case 10:
        if (((int)((int)v3)) != 10)
        {
            v4 = ((int)((int)v3));
            v3 = v41;
            v18 = dcgettext(0x0, &g_40ec39, 0x5);
            if (v18 == "`")
            {
                v4 = v3;
                v3 = ((int)((int)v4));
            ...
            v4 = ((int)v4);
            v3 = v41;
            v17 = dcgettext(0x0, &g_40fc3b, 0x5);
            if (v17 == "'")
            {
                v4 = v3;
                v3 = v40;
        ...
        while (true)
        {
            ...
            if (((long long)v43) != 0)
            {
                ...
                else
                {
                    ...
                    {
                        v36 = ((long long)v35);
                        v30 = ((long long)*(g_40eec8 + v36 * 4)) + &g_40eec8;
                    }
                }
            }
            else
