...
int peek_token()
{
    ...
    char v1;  // [bp-0x50]
    unsigned long|unsigned long long|struct_1 * v10;  // rdi
    struct_6 * v11;  // r8
    struct_0 *v12;  // r12
    unsigned long long v13;  // r13
    struct_4 *v14;  // r14
    unsigned long long v15;  // r15
    char|unsigned long long|unsigned int v3;  // rax
    char|struct_6 *|unsigned long long v4;  // cl
    char|unsigned long|unsigned long long|char * v5;  // dl
    unsigned long long v6;  // rdx
    unsigned long long v7;  // rbx
    struct_1 *v8;  // rbp
    struct_4 *|unsigned int|struct_0 *|unsigned long long|char * v9;  // rsi
    ...
    if (v9->field_68 > v14)
    {
        ...
        if (v3 <= 1 || v9->field_48 == v9->field_30 || *(v9->field_10 + (v9->field_48 << 2)) != -1)
        {
            if (*(v9->field_8 + v9->field_48) == 92)
            {
                v4 = v14 + 1;
                ...
                if (v9->field_8b == 0 || v9->field_90 <= 1 && v12->field_8c != 0 && ((long long)(tmp_30 & 128)) != 0 || v12->field_30 == v14 + 2 && *(v12->field_10 + (v4 << 2)) != -1 && v12->field_8c != 0 && ((long long)(tmp_30 & 128)) != 0 || *(v12->field_10 + (v4 << 2)) != -1 && v12->field_8c != 0 && *(v10 + v5 + 4) != -1 && ((long long)(tmp_30 & 128)) != 0)
                {
                ...
                if (v3 > 1 || *(v12->field_10 + (v4 << 2)) == -1 && v9->field_90 > 1 && v9->field_8b != 0 || *(v10 + v5 + 4) == -1 && v9->field_90 > 1 && v9->field_8b != 0 && v12->field_30 != v14 + 2)
                {
