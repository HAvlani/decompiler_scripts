...
int xstrcat()
{
    ...
    char *|unsigned long long|void * v8;  // rbp
    struct_0 *v9;  // rsi
    ...
    if (v10 != 0)
    {
        ...
        do
        {
            ...
            v7 = (((char)[D] amd64g_calculate_condition(0x2<64>, 0x4<64>, rbx<8>, Call (target: 0x402450<64>, prototype: (char*) -> unsigned long (64 bits), args: [Load(addr=rdx<8>, size=8, endness=Iend_LE)]), cc_ndep<8>))? 18446744069414584319 : rbx<8> + strlen(*(rdx<8>)));
            v8 -= 1;
        }
        while (v8 != 1);
        if (v7 <= 2147483647)
