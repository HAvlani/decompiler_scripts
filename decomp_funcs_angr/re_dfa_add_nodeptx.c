...
int re_dfa_add_node()
{
    ...
    if (v13->field_10 >= v13->field_8)
    {
        ...
        {
            v13 = v13->field_0;
            v2 = realloc(v13, v14 * 32);
            if (v2 != 0)
            {
                v8->field_8 = v16;
                v12 = v8->field_18;
                v8->field_0 = v2;
                v16 = realloc(v12, v14 * 16);
                if (v16 != 0)
                {
                    v8->field_18 = v16;
                }
    ...
    if (v13->field_10 < v13->field_8 || v14 << 1 <= 768614336404564650 && v2 != 0 && v14 != 0 && v17 != 0 && v16 != 0 && v2 != 0)
    {
        v6 = ((long long)(((int)v5) & -261889));
        v4 = v10 * 16 + v8->field_0;
