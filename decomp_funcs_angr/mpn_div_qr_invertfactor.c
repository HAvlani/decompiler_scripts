    ...
    if (v7 != 0)
    {
        ...
        if (v7 != 2)
        {
            ...
            if (*(v9 + (v7 << 3) + 8) != 0)
            {
                ...
                if ((0xfeffffff00000000 & v13) == 0 || !(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rax<8>, 0x0<64>, cc_ndep<8>))))
                {
                    ...
                    if (((int)v5) != 0)
                    {
                        v13 = v13 << (((char)v5) & 63) | v16 >> (((char)(64 - ((int)v5))) & 63);
                        v9 = *(v9 + v15 + 24) >> (((char)(64 - ((int)v5))) & 63);
                        v16 = v16 << (((char)v5) & 63) | v9;
                        v8->field_8 = v13;
                        v8->field_10 = v16;
                        v4 = mpn_invert_3by2();
                        v8->field_18 = v4;
        ...
        else
        {
            ...
            if (v10[1] != 0)
            {
                ...
                if ((0xfeffffff00000000 & v12) == 0 || !(((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rax<8>, 0x0<64>, cc_ndep<8>))))
                {
                    v8->field_0 = ((int)rdx<8>);
                    if (((int)rdx<8>) != 0)
                    {
                        v1 = v14 >> (((char)(64 - ((int)rdx<8>))) & 63);
                        v14 <<= ((char)rdx<8>) & 63;
                        v12 = v12 << (((char)rdx<8>) & 63) | v1;
                        v8->field_8 = v12;
                        v8->field_10 = v14;
                        v3 = mpn_invert_3by2();
                        v8->field_18 = v3;
