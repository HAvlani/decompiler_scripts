...
int read_utmp()
{
    ...
    while (true)
    {
        ...
        while (true)
        {
            if (v10->field_0 == 7 && ((long long)(v9 & 1)) != 0 && v10->field_2c != 0 && v10->field_4 > 0)
            {
                v2 = kill();
                if (v2 < 0)
                {
            ...
            if (v10->field_0 == 7 && v2 < 0 && v0 == v5 && ((long long)(v9 & 1)) != 0 && v10->field_2c != 0 && v2->field_0 != 3 && v10->field_4 > 0 || (v10->field_2c == 0 && v6 == 0 || v6 == 0 && v10->field_0 != 7 || v10->field_0 == 7 && ((long long)(v9 & 1)) == 0 && v10->field_2c != 0 || v10->field_0 == 7 && v10->field_4 <= 0 && v10->field_2c != 0 || v10->field_0 == 7 && v2 >= 0 && v10->field_2c != 0) && v0 == v5)
            {
