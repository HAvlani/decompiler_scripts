...
extern char g_408481;
extern unsigned int g_408483;
extern struct_5 g_408708;
...
int quotearg_buffer_restyled()
{
    ...
    case 8: case 9: case 10:
        if (((int)v3) != 10)
        {
            v4 = ((int)v3);
            v3 = v41;
            v18 = dcgettext(0x0, &g_408483, 0x5);
            if (v18 == "`")
            {
                v4 = v3;
                v3 = ((int)((int)v4));
            ...
            v4 = v4;
            v3 = v41;
            v17 = dcgettext(0x0, &g_408481, 0x5);
            if (v17 == 4228225)
            {
                v4 = v3;
                v3 = v40;
        ...
        while (true)
        {
            ...
            if (((long long)r13b<1>) != 0)
            {
                ...
                else
                {
                    ...
                    {
                        v33 = ((long long)v36);
                        v30 = ((long long)*(g_408708 + v33 * 4)) + &g_408708;
                    }
                }
            }
            else
            ...
            if (((long long)v33) != 0)
            {
                ...
                while (true)
                {
                    ...
                    if ((v35 < tmp_9 || ((long long)v33) == 0) && (((long long)v14) == 0 || ((long long)v33) == 0) && (v35 < tmp_9 || ((long long)v33) != 0))
                    {
                        if (v44 > v42)
                        {
                            *(v45 + v42) = v36;
            ...
            v33 = 0;
            if (((long long)r9b<1>) == 0 && (v7 == 0 || ((long long)(((char)(((int)v4) ^ 1)) | dl<1>)) != 0))
            {
            ...
            if (reg_96<4> == 2 && v14 != 0 || ((long long)v33) != 0 && ((long long)al<1>) != 0 || v16 != 1 && ((long long)v33) != 0 || v14 != 0 || reg_96<4> == 2 && v14 != 0 || reg_96<4> == 2 && v14 != 0 || (((long long)r13b<1>) == 0 || ((long long)(((char)(reg_96<4> == 2)) & v14)) != 0) && (v42 == 0 || ((long long)(((char)(reg_96<4> == 2)) & v14)) != 0) && (((long long)(v33 & v14)) != 0 || ((long long)(((char)(reg_96<4> == 2)) & v14)) != 0))
            {
                v2 = v17;
                v1 = v18;
                v0 = 0;
