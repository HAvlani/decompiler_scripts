...
int calc_eclosure_iter()
{
    ...
    struct_9 *|unsigned long|unsigned long long v12;  // rcx
    struct_0 *|struct_8 *|unsigned long long|struct_4 * v13;  // rdx
    struct_7 *v14;  // rbx
