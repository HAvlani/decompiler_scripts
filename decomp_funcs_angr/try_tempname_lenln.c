...
int try_tempname_len()
{
    ...
    unsigned long|char *|unsigned long long v22;  // rdi
    ...
    unsigned long long|char v4;  // [bp-0x99]
    struct_0 *v5;  // [bp-0x98]
